...
Thereafter you focused more on understanding how to connect different cmdlets together to form powerful expressions called pipelines. The idea is that one cmdlet's output serves as the input for the upcoming connected cmdlet.

Finally you learned about important principles like _filter left_ and _format right_ to ensure the expressions you write are constructed in the most efficient way possible.

You should now have a good understanding of what PowerShell, what it's used for and how you use it and its commands efficiently.
