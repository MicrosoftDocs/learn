...
The exact output you see depends on your machine, but you should see a result whose CPU value is greater than 2. These processes are sorted in descending order, with the greatest CPU value at the top of the list. Your output will look similar to the following example:
