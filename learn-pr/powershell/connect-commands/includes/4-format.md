Formatting and filtering is an important part to understand, when dealing with PowerShell. Creating a pipeline to get what you want, is the first part. The second part involves doing so in a way that's efficient. Efficient both in terms of how data you pull over the network but also to ensure the end result is something you can work with.
