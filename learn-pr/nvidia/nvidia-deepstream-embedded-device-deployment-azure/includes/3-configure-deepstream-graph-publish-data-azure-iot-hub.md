...
1. In the DeepStream Graph Composer application, select **File** > **Open Graph**. Go to */opt/nvidia/deepstream/deepstream/reference_graphs/deepstream-test4* and select the *deepstream-test4.yaml* file. Then, select **Okay**.
    ...
    :::image type="content" source="../media/composer-open-test.png" alt-text="Screenshot that shows opening the DeepStream Test4 application in Graph Composer." lightbox="../media/composer-open-test.png":::
    ...
    :::image type="content" source="../media/composer-test.png" alt-text="Screenshot of the opened DeepStream Test4 application in Graph Composer." lightbox="../media/composer-test.png":::
