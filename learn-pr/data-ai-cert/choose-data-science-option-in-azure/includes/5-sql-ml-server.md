...
Integrating data science processing into the local SQL server environment eliminates the need to switch between the database and machine learning environments. You get all the features of SQL Server with scalable machine learning.

![Screenshot of ML / SQL Server](../media/5-ml-server-sql-server.png)

Let's briefly walk through how you would use ML Server in SQL Server.

1. First, you would need to install Machine Learning Server on SQL Server.
2. Next, choose the tool (Python or R) that you would like to use for machine learning and run the tool you chose using the environment of your choice.
