...
1. Click Bot Template and choose **SDK v3** and **C#** for the language.

    ![Selecting SDK v3 and C# for the language](../media/5-integrate-qna-with-bot-sdk-choice.png)

1. Choose the Question and Answer template, then click **Select**.
...
1. Switch back to the Bot tab and in the Application Settings section locate the **QnAKnowledgebaseId** entry.
