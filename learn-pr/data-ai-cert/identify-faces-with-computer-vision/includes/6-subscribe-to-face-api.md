...
Because the APIs are exposed through REST-based web services, any language that can build and send an HTTP message can use the services. Two things are needed: a subscription key and the endpoint.
