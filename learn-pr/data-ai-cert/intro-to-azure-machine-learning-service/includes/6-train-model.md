...
>
If you cannot get the data within the constraints, then [follow these instructions](https://docs.microsoft.com/azure/machine-learning/service/how-to-save-write-experiment-files#limits) to explore your options.
