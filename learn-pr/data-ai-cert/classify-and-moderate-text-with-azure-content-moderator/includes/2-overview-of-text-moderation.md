...
You can also use custom term lists with this API. In that case, if a profane term is identified in the text, a `ListId` is also returned, showing where in your custom list the item is. A sample JSON response is shown here:
