...
![Diagram showing a client-side front-end proxy service operation.](../media/4-client-flowchart.png)
...
![Diagram showing a server-side SAS operation.](../media/4-server-flowchart.png)