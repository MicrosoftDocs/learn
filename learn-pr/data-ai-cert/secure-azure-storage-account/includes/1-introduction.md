Azure Storage accounts provide a wealth of security options that protect your cloud-based data. Because many services such as Blob storage, File shares, Table storage, and Azure Data Lake Storage all build on top of Azure Storage, they all benefit from the find-grained security controls provided.
