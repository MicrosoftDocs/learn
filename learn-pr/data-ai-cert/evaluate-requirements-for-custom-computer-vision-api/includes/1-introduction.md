...
You can use these capabilities directly through the Custom Vision service web portal to create and train a model, test the model for accuracy, and then use it to evaluate and apply labels to images. But this isn't sufficient for your use case.
