Azure Data Lake Storage Gen2 is a Hadoop-compatible data repository that can store any size or type of data.
...
In Data Lake Storage Gen2, data engineers query data by using use the Azure Blob Storage API or the Azure Data Lake System (ADLS) API.

## Data security

Because Data Lake Storage supports Microsoft Entra ACLs, security administrators can control data access by using the familiar Active Directory Security Groups. Role-based access control (RBAC) is available in Data Lake Storage Gen2. Built-in security groups include ReadOnlyUsers, WriteAccessUsers, and FullAccessUsers. 
