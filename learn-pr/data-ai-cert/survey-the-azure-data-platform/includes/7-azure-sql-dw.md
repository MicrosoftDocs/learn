...
Importantly, Azure Synapse Analytics can also pause and resume the compute layer. This capability is useful in data warehousing, and means that you pay only for the computation you use.

## Ingesting and processing data

Azure Synapse Analytics uses the extract, load, and transform (ELT) approach for bulk data. SQL professionals are already familiar with bulk-copy tools such as bcp and the SQLBulkCopy API. Data engineers who work with Azure Synapse Analytics soon learn how quickly PolyBase can load data.
