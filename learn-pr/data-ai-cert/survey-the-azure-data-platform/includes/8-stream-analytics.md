...
To define job transformations, use a declarative Stream Analytics query language. The language should let you use straightforward SQL constructs to write complex temporal queries and analytics.
...
Stream Analytics handles security at the transport layer between the device and Azure IoT Hub. Generally, streaming data is discarded after the windowing operations finish. Event Hubs uses a shared key to secure the data transfer. If you want to store the data, your storage device can provide security.