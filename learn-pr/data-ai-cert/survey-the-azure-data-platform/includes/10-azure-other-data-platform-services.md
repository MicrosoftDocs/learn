Azure Data Bricks is a serverless platform optimized for Microsoft Azure which provides one-click setup, streamlined workflows and an interactive workspace for Spark-based applications.  Azure Databricks adds additional capabilities to Apache Spark including fully managed Spark clusters and an interactive workspace.  Clusters are programmable by using REST APIs.  Azure Data Bricks notebooks support familiar programming tools such as R, Python, Scala, or SQL.  Azure Active Directory and Azure Databricks role-based security provide enterprise-grade security.
