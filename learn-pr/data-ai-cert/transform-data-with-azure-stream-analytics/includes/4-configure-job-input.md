...
1. Leave the rest of the fields as default values.
    ...
    ![Screenshot of Adding Storage Account Name "streamsrc"](../media/4-add-storage-account.png)
...
1. Select **Add stream input** and select **Blob storage** from the drop-down list.
...
1. Leave the rest of the fields as the current default values.
    ...
    ![Screenshot of assigning the input](../media/4-create-blob-input.png)
