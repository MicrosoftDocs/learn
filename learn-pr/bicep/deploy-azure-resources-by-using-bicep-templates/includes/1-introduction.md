...
Suppose you're responsible for deploying and configuring the Azure infrastructure at a toy company. You are launching a new toy. You have been asked to deploy a new marketing website and other resources into Azure in preparation for the launch of the new product. You need to build this using Infrastructure as Code (IaC) techniques so that you can re-use the same templates for future product launches.

## What will we be doing?

Here, you'll create a template using Bicep to deploy a set of Azure resources for your product launches, and use a number of elements of the Bicep language in the process:
