...
* Next, you give the resource a _symbolic name_. In the example above the resource's symbolic name is simply `storageAccount`. Symbolic names are used within Bicep to refer to the resource - but they won't ever show up in Azure.
