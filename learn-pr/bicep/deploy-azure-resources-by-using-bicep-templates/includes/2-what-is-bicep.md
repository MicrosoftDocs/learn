...
You may already be familiar with ARM templates. These are JSON files that represent Azure resources. One common problem with JSON template is that they are difficult to work with, and have quite a complex syntax. It can be hard to get started with writing ARM templates using JSON.
