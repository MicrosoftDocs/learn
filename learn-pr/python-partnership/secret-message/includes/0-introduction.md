Unexpectedly, you are handed a piece of paper that contains a secret, encoded message. The person who hands you the message tells you that a treasure is hidden at a secret location, and to meet them there on a specific day to have the treasure revealed. You'll use Python to decode the secret message and find the location and date that can reveal the hidden treasure! 

![Image of an encoded secret message.](../media/encoded-secret-message.png)

You can crack the code by using the Python programming language and find the hidden treasure in this beginner's lesson. For the best experience, make sure your local developer environment is ready with [Visual Studio Code](https://code.visualstudio.com/?azure-portal=true). Follow the steps in the [Set up your Python beginner development environment with Visual Studio Code](https://docs.microsoft.com/learn/modules/python-install-vscode/?azure-portal=true) Learn module.
...
- Discover the location to reveal the hidden treasure in this module
