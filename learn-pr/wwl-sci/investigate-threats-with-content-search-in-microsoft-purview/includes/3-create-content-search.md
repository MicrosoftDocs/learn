Organizations can use Content search in the Microsoft Purview portal to search for in-place content, such as:
...
> [!IMPORTANT]
> Most organizations limit access to Content search in the Microsoft Purview portal to an administrator, compliance officer, or eDiscovery manager. These individuals must be a member of the **eDiscovery Manager role group** in the Microsoft Purview portal. To assign permissions, you must be a member of the **Organization Management** role group in the Microsoft Purview portal.
...
1. On the **Locations** page, choose the content locations that you want to search. You can search mailboxes, sites, and public folders. :::image type="content" source="../media/new-search-wizard-locations-page-unit-3.png" alt-text="Screenshot of the Locations page in the New Search wizard." lightbox="../media/new-search-wizard-locations-page-unit-3.png":::
     ...
     - **Exchange mailboxes**. Set the toggle to **On** and then under the **Included** column, select **Choose users, groups, or teams** to specify the mailboxes to place on hold. Use the search box to find user mailboxes and distribution groups. You can also search the mailbox associated with a Microsoft Team (for channel messages), Office 365 Group, and Viva Engage. For more information about the application data stored in mailboxes, see [Content stored in mailboxes for eDiscovery](/microsoft-365/compliance/what-is-stored-in-exo-mailbox?azure-portal=true).
