This unit will look at design considerations for privileged access workstations as well as bastion services.
...
![Workflow to acquire and deploy a secure workstation](https://learn.microsoft.com/security/privileged-access-workstations/media/privileged-access-devices/secure-workstation-deployment-flow.png)
...
![Secure workstation Levels](https://learn.microsoft.com/security/privileged-access-workstations/media/privileged-access-devices/supplychain.png)
...
![Secure workstation profiles](https://learn.microsoft.com/security/privileged-access-workstations/media/privileged-access-devices/secure-workstations-levels.png)
...
![Diagram showing Azure Bastion architecture.](https://learn.microsoft.com/azure/bastion/media/bastion-overview/architecture.png)
<!-- 
...
![Diagram showing the Azure Bastion architecture.](https://learn.microsoft.com/azure/bastion/media/bastion-overview/architecture.png)
