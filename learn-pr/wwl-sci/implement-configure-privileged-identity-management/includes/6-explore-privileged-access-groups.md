...
> [!NOTE]
> At scale, the risk isn't just operational overhead. Non-uniform activation settings across dozens of individual assignments create policy drift that auditors flag and that attackers probe for.
