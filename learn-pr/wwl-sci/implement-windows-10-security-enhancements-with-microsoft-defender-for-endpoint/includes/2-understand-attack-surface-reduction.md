Attack Surface Reduction rules is hardening the places where a threat is likely to attack.  As a Security Analyst, it is your role to understand the protection options and provide recommendations.   While you are performing alert investigations, you should know the events generated by Attack Surface Reduction on the host, which might provide forensics evidence.
