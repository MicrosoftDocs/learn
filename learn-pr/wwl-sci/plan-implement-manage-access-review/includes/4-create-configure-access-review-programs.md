...
<a name='azure-ad-access-reviews-data-model'></a>
...
<a name='register-an-azure-ad-application-which-has-permissions-to-call-the-access-reviews-api-in-graph'></a>

## Register a Microsoft Entra application which has permissions to call the access reviews API in Graph
...
1. Navigate to the Microsoft Entra extension, and select **App registrations** in the **Manage section**, to land at the page register apps
...
1. Microsoft Entra access reviews uses the following delegated permissions:
