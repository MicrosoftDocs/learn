...
2. Navigate to the Azure AD extension, and select **App registrations** in the **Manage section**, to land at the page register apps
...
5. Change the Application type to **Native**, and provide the following as the Redirect URI:
...
10. Azure AD access-reviews uses the following delegated permissions:
