...
- **Plugins**: The Microsoft Threat Intelligence plugin is required. The Microsoft Defender External Attack Surface Management plugin is optional but adds more context to the output.
