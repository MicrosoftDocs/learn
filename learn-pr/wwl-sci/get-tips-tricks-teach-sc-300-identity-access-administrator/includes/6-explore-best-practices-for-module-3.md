...
- Lesson 1 – What is Microsoft Entra multifactor authentication?
...
- Demo 3.1: [Enable Microsoft Entra multifactor authentication](https://github.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/blob/master/Instructions/Labs/Lab_04_ConfigureExternalCollaborationSettings.md)
...
- Demo 3.4: [Configure Microsoft Entra multifactor authentication registration policy](https://github.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/blob/master/Instructions/Labs/Lab_02_WorkingWithTenantProperties.md)
- Demo 3.5: [Using Azure Key Vault for managed identities](https://aka.ms/ldc)

Module 3 Labs

- Lab 3.1: [Enable Microsoft Entra multifactor authentication](https://aka.ms/ldc)
...
- Lab 3.3: [Microsoft Entra authentication for Windows and Linux VM](https://aka.ms/LearnTV)
...
- Lab 3.5: [Manage Microsoft Entra smart lockout values](https://github.com/MicrosoftLearning/SC-300-Identity-and-Access-Administrator/blob/master/Instructions/Labs/Lab_00_SetUpLabResources.md)
...
- Lab 3.8: [Configure Microsoft Entra multifactor authentication registration policy](https://aka.ms/SC300exam)
