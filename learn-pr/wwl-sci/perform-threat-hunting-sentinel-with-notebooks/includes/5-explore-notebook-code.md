...
:::image type="content" source="../media/threat-hunt-1.png" alt-text="Screen shot of a Sentinel Notebook Sample 1 Query":::
...
:::image type="content" source="../media/threat-hunt-3.png" alt-text="Screen shot of a Sentinel Notebook Sample 2 Query":::
...
:::image type="content" source="../media/threat-hunt-2.png" alt-text="Screen shot of a Sentinel Notebook Sample 3 Query":::