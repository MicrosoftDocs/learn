...
:::image type="content" source="../media/conditional-access.png" alt-text="Image showing Conditional Access policy flow.  Signals are used to decide whether to allow or block access to apps and data.":::
