...
![Diagram Description automatically generated](../media/security-posture-management.png) 
...
environments. Defender for IoT systems include the following components:
...
![Graphical user interface, text, application Description automatically generated](../media/defender-iot.png) 
