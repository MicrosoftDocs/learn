...
The CIO of Contoso defined the following set of requirements that the technology team must address in its design of an Azure AD-based architecture for identity and access:
...
- How would you use Azure AD capabilities to provide access to the on-premises web-based applications?
