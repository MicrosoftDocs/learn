...
:::image type="content" source="../media/azure-app-proxxy.png" alt-text="Diagram of the Azure A D Application Proxy process flow.  A successful configuration is shown.":::
