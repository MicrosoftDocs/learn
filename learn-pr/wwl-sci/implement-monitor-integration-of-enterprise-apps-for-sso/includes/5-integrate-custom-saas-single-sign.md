:::image type="content" source="../media/app-single-sign-on.png" alt-text="Diagram of Azure AD being the single sign on provider for cloud apps.  User and external users log into Azure AD, then connect to cloud applications.":::
