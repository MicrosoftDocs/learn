:::image type="content" source="../media/app-single-sign-on.png" alt-text="Diagram of Azure A D being the single-sign-on provider for cloud apps.  User and external users log into Azure A D, then connect to cloud applications.":::
