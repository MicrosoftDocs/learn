...
Applications in the Microsoft Entra gallery support either manual or automatic provisioning.
...
In the Microsoft Entra gallery, applications that support automatic provisioning are designated by a **Provisioning** icon.
...
<a name='build-a-system-for-cross-domain-identity-management-endpoint-and-configure-user-provisioning-with-azure-ad'></a>
...
:::image type="content" source="../media/system-for-cross-domain-identity-management-provision-overview-9d92fdf9.png" alt-text="Screen shot of the Provisioning dialogs from Microsoft Entra ID to an app with S C I M capabilities.":::
