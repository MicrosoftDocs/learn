...
:::image type="content" source="../media/system-for-cross-domain-identity-management-provision-overview.png" alt-text="Screen shot of the Provisioning dialogs from Azure A D to an app with S C I M capabilities.":::
