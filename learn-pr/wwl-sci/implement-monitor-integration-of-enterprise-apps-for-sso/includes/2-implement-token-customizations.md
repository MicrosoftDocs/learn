...
:::image type="content" source="../media/token-customize-timeline.png" alt-text="Diamgram of the Refresh token lifetime - token is valid for a specified amount of time and the access token must be refreshed before it expires.":::
...
:::image type="content" source="../media/token-configuration-claims.png" alt-text="Screenshot of the Configure custom roles and claims for the S A M L token issued when you configure sign-sign-on.":::
