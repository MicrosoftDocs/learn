...
:::image type="content" source="../media/token-configuration-claims.png" alt-text="Screenshot of the Configure custom roles and claims for the SAML token issued when you configure sign-sign-on.":::
