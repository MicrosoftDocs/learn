...
- What is the Cloud Adoption Framework, and how it can be used to accelerate and secure an organizations move to the cloud.
- What is the Well-Architected Framework, and how it can be used to design solutions in the cloud that adhere to sound design principles including security.

To continue exploring the topics discussed in this module, we recommend the following resources:
