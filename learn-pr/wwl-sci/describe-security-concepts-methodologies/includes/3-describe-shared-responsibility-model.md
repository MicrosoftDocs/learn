The *shared responsibility model* identifies which security tasks are handled by the cloud provider, and which security tasks are handed by you, the customer.
...
The shared responsibility model makes responsibilities clear. Organizations move data to the cloud, some responsibilities transfer to the cloud provider, and some the customer organization is responsible for.
