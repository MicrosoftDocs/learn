...
:::image type="content" source="../media/6-encryption-3-inline.png" lightbox="../media/6-encryption-3-expanded.png" alt-text="The concept of symmetric and asymmetric encryption":::
...
:::image type="content" source="../media/6-hashing-3-inline.png" lightbox="../media/6-hashing-3-expanded.png" alt-text="The concept of hashing":::