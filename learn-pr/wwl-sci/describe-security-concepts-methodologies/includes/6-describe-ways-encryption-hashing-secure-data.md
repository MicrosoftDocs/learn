...
:::image type="content" source="../media/6-encryption-inline.png" lightbox="../media/6-encryption-expanded.png" alt-text="The concept of symmetric and asymmetric encryption":::
...
:::image type="content" source="../media/6-hashing-inline.png" lightbox="../media/6-hashing-inline.png" alt-text="The concept of hashing":::
