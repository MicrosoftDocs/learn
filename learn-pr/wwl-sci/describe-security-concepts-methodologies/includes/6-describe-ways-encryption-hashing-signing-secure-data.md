...
> ![A private key generates the signature](../media/6-private-key-generates-signature.png)
...
> [!div class="mx-imgBorder"]
> ![The message is hashed using a hashing algorithm, then signed](../media/6-hashed-using-hash-algorithm.png)
...
> [!div class="mx-imgBorder"]
> ![The hash value is verified against the signature using signer’s public key](../media/6-hash-value-verified.png)

If they match, you can be confident that the message is the same one that the signer originally signed, and that it hasn't been tampered with.