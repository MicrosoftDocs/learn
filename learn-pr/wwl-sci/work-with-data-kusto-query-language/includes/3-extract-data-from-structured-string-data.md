...
| :--- | :--- |
| parse_json() or todynamic()| Interprets a string as a JSON value and returns the value as dynamic. Use either of these to refer to a field: <br> JsonField.Key <br> JsonField["Key"]|
