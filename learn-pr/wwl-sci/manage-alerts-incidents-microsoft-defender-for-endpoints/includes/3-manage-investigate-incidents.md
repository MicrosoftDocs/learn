...
:::image type="content" source="../media/incident-alert.png" alt-text="Screenshot of alerts tab with incident details page showing the reasons the alerts were linked together in that incident.":::
