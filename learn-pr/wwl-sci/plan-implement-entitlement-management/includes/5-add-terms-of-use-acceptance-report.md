...
2. On the Overview page, select VIEW SETTINGS AND PRIVACY.
   ...
   :::image type="content" source="../media/my-account-settings-privacy.png" alt-text="Screenshot of a popup, which says View settings and privacy. So the user sees data used and shared.":::
