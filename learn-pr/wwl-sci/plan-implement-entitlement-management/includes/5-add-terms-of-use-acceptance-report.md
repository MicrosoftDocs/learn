...
1. In the **Name** box, enter **Testing terms of use**. Set the name the terms-of-use will be used in the Azure portal.
1. In the **Display name** box, enter **Contoso Terms of Use**. The title that users see when they sign-in.
1. Select the **Terms of use document box**, browse to your finalized terms of use PDF, and select it. For this exercise, you can choose any PDF you may have. Another option is use Microsoft Word to create the terms of use doc and then save as PDF.
...
1. Use the **Duration before reacceptance requires (days)** setting to specify the number of days before the user must reaccept the terms of use. This setting allows users to follow their own schedule. For example, if you set the duration to **30** days, here is how expirations might occur for two users:
...
1. For the terms of use, select the numbers under **Accepted** or **Declined** to view the current state for users.
...
1. On the Settings and Privacy page, select the **Privacy** tab.
...
1. In the Edit terms of use pane, you can change the following settings:
...
1. Once you have uploaded your new pdf and decided on reaccept, select **Add**.
