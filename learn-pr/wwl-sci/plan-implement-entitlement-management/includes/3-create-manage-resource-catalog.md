...
8.  Under **Enabled, select No**. You may choose to enable the catalog for immediate use or disable if you intend to stage it or keep it unavailable until you intend to use it. For this exercise, the catalog does not need to be enabled.
...
6.  You might not have selected any resources in Groups and Teams, Applications, or SharePoint sites. To add a resource to the catalog elect any resource category and then select a resource from that category. For this exercise, it is okay to choose any resource you may have available.

:::image type="content" source="../media/catalog-add-resources-e20559c7.png" alt-text="Add resources to a catalog":::


7.  When finished, click **Add**. These resources can now be included in access packages within the catalog.
