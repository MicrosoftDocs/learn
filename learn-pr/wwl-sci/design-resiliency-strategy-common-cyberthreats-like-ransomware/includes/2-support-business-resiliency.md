...
[![Security Resilience Cycle](/azure/cloud-adoption-framework/secure/media/security-resilience-cycle.png)](/azure/cloud-adoption-framework/secure/media/security-resilience-cycle-popout.png#lightbox)
