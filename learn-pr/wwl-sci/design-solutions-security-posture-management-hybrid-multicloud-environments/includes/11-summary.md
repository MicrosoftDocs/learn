In this module, you learned how to design security posture management solutions for hybrid and multicloud environments. You explored how organizations like Contoso can achieve unified visibility and consistent security policies across Azure, AWS, Google Cloud, and on-premises infrastructure.
...
- [Connect your non-Azure machines to Microsoft Defender for Cloud with Azure Arc](/azure/defender-for-cloud/quickstart-onboard-machines)
- [What is Microsoft Defender External Attack Surface Management?](/azure/external-attack-surface-management/overview)
