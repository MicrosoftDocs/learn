...
1. Once the account is created, you will be redirected to the **GitHub Enterprise Cloud – Enterprise Account** blade.
...
1. In the **Users and groups** pane, select your administrator account and then **Select**.
