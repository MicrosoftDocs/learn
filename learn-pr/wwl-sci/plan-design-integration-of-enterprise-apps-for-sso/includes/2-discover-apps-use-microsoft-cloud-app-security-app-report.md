...
:::image type="content" source="../media/app-integration-after-migration.png" alt-text="Screenshot of the same Applications connected through Azure A D, after using app discovery.":::
...
3.  Under **Activity**, select **Usage and insights**, and then select **AD FS application activity** to open a list of all AD FS applications in your organization.
    ...
    :::image type="content" source="../media/active-directory-federation-services-application-activity.png" alt-text="Screenshot of A D F S application activity. Track what application you have.":::
