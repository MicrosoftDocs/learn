...
:::image type="content" source="../media/architecture-4d1ab4b7.png" alt-text="What is Azure AD Connect":::
...
:::image type="content" source="../media/azure-active-directory-authentication-2-3100ed8b.png" alt-text="Azure AD hybrid identity with password hash synchronization":::


 -  Agent requirements of pass-through authentication, using two agents for redundancy:

:::image type="content" source="../media/azure-active-directory-authentication-3-fd5f417b.png" alt-text="Azure AD hybrid identity with pass-through authentication":::


 -  Components required for federation in your perimeter and internal network of your organization:

:::image type="content" source="../media/azure-active-directory-authentication-4-4d34c92c.png" alt-text="Azure AD hybrid identity with federated authentication":::
...
:::image type="content" source="../media/azure-active-directory-connect-internal-492e2666.png" alt-text="Diagram shows how the connected directories and Azure AD Connect provisioning engine interact, including Connector Space and Metaverse components in an SQL Database":::
...
Azure AD Connect cloud sync is designed to accomplish hybrid identity goals for synchronization of users, groups and contacts to Azure AD. It accomplishes this by using the **Azure AD cloud provisioning agent** instead of the Azure AD Connect application. It can be used alongside Azure AD Connect sync and it provides the following benefits:
...
:::image type="content" source="../media/azure-active-directory-cloud-sync-55397427.png" alt-text="Process flow graphic that shows on-premises Active Directory items like users and group being synchronized into the cloud by Cloud Sync into the Azure Active Directory.  You have a picture of an on-premises AD on the left, a cloud Azure AD on the right and an arrow representing cloud sync connecting them.":::
