...
:::image type="content" source="../media/password-hash-sync-architecture-1-e3833a51.png" alt-text="Diagram of how Azure A D Connect passes a password hash for a user between on-premises and in the cloud.":::
...
:::image type="content" source="../media/pingfederate-domain-2e41c11d.png" alt-text="Screenshot of Azure A D Connect interface showing the domain you want to create a federation with.":::
