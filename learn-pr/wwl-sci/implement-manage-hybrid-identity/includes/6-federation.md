...
> ![Process flow diagram of federation between on-premises and Azure AD. Shows users able log into both on-premises and cloud resources with a single shared login.](../media/sc300-federation-flow-diagram.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot from Azure AD Connect application showing the create / connect an AD FS farm dialog.  From here an admin can set up a federation from on-premises to Azure AD to allow for federation.](../media/sc300-federation-setup-dialog.png)
