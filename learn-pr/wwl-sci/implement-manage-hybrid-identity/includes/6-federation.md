...
<a name='requirement-to-deploy-federation-with-ad-fs-and-azure-ad-connect'></a>
...
<a name='set-up-your-federation-using-azure-ad-connect-to-connect-to-an-ad-fs-farm'></a>

## Set up your federation using Microsoft Entra Connect to connect to an AD FS farm

:::image type="content" source="../media/sc300-federation-setup-dialog-f995542d.png" alt-text="Screenshot of Microsoft Entra Connect application showing the create and connect to an A D F S farm dialog.":::
...
<a name='azure-ad-connect-tools-to-manage-your-federation'></a>
