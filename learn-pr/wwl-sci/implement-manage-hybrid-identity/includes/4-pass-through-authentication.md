...
:::image type="content" source="../media/single-sign-on.png" alt-text="Screenshot of the Azure A D Connect user interface. The User sign-in option is selected and the user has choices of different types of sign-in options.":::
...
:::image type="content" source="../media/change-user-sign-in.png" alt-text="Screenshot of the Azure A D Connect Tasks screen when you can select how users sign into Azure A D after the on-premises connection is made.":::
