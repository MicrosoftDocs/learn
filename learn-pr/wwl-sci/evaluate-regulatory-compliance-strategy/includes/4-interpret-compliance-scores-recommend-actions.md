...
![These controls don't have any Defender for Cloud assessments associated with them. Check their requirements and assess them in your environment.](../media/azure-security-benchmark.png)
...
![When reviewing the dashboard, he noticed the following item was not compliant.](../media/azure-security-benchmark-1.png)
...
![Use the Compliance Over Time Workbook to track your compliance status over time with the various standards you've added to your dashboard.](../media/microsoft-defender-cloud-workbooks-compliance-over-time.png)
