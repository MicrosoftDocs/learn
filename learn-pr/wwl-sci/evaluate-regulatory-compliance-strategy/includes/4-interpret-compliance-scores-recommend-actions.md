...
![Screenshot showing controls that don't have any Defender for Cloud assessments associated with them. Check their requirements and assess them in your environment.](../media/azure-security-benchmark.png)
...
![Screenshot showing non compliant items on the dashboard.](../media/azure-security-benchmark-1.png)
...
![Screenshot showing the Compliance Over Time Workbook to track your compliance status with the various standards you've added to your dashboard.](../media/microsoft-defender-cloud-workbooks-compliance-over-time.png)
