...
* [Azure and other Microsoft cloud services compliance offerings -
    Azure Compliance](https://docs.microsoft.com/azure/compliance/offerings/)
* [Operational compliance in Azure - Cloud Adoption Framework](/azure/cloud-adoption-framework/manage/azure-management-guide/operational-compliance?tabs=UpdateManagement%2CAzurePolicy%2CAzureBlueprints)
...
topic.
* Watch [this video](https://youtu.be/S_zJ2QBkk-0) more information
...
Security Center, the content and rationale are still applicable for this
topic.
* Watch [this video](https://youtu.be/n469bC2V2Wo) for a quick demo
