...
:::image type="content" source="../media/alert-response-step2-decision.png" alt-text="Decision tree for Step 2: suspicious IP or TOR leads to firewall controls, unauthorized identity leads to RBAC removal, Microsoft Entra role leads to identity administrator escalation." lightbox="../media/alert-response-step2-decision.png":::
