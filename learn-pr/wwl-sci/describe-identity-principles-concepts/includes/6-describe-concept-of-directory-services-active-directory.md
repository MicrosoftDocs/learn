...
To learn more about the differences between Active Directory concepts and Azure Active Directory, see **Compare Active Directory to Azure Active Directory** in the Learn More section below.
