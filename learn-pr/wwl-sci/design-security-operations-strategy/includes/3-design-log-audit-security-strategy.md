...
-   **Processed events** provide information about analyzed
    ...
    Cloud alerts](/azure/security-center/security-center-managing-and-responding-alerts), where [Microsoft
    Defender for Cloud](/azure/security-center/security-center-introduction) has processed and analyzed subscriptions and provides concise security
    alerts.
