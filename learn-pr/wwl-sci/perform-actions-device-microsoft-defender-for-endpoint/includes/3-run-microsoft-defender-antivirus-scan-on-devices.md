...
> [!IMPORTANT]
> This action is available for devices on Windows 10 version 1709 or later, or Windows 11.
...
The Action center shows the scan information, and the device timeline includes a new event, reflecting that a scan action was submitted on the device. Microsoft Defender AV alerts reflect any detections that surfaced during the scan.
