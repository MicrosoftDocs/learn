...
1. Select **Azure Active Directory Identity Protection**.

1. Then select the **Open connector** page on the preview pane.

1. Select **Connect** to start streaming the Azure AD Identity Protection alerts.

1. Select whether alerts from Azure AD Identity Protection automatically generate incidents by selecting **Enable**.

:::image type="content" source="../media/azure-active-directory-protocol.png" alt-text="Screen shot of the Azure Active Directory Identity Protection connector page.":::
