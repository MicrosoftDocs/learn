...
1. In the **Properties** screen, under **Tenant properties**, locate **Location** and review the information.
    ...
    :::image type="content" source="../media/azure-active-directory-properties-country-location-5411f783.png" alt-text="Screenshot of the Azure Active Directory Properties with the Country/Region and Location settings highlighted.":::
