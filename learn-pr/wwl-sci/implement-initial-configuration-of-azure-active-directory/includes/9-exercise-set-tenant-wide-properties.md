...
2. Select the **Show portal menu** hamburger icon and then select **Azure Active Directory**.
      ...
      :::image type="content" source="../media/azure-portal-menu-azure-active-directory.png" alt-text="Screenshot of the Azure portal menu with Azure Active Directory selected.":::
...
8. In the **Properties** screen, under **Tenant properties**, locate **Location** and review the information.
      ...
      :::image type="content" source="../media/azure-active-directory-properties-country-location.png" alt-text="Screenshot of the Azure Active Directory Properties with the Country and Location settings highlighted.":::
