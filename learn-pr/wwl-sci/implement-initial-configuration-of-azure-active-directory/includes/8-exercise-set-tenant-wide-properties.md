...
10. Under **Tenant properties**, locate **Tenant ID**. This is your unique tenant identifier.
    ...
    > [!div class="mx-imgBorder"]
    > ![Screen image displaying the Tenant properties page with the Tenant ID box highlighted.](../media/portal-tenant-identifier.png)
...
> [!NOTE]
> For information about viewing or deleting personal data, see [Azure Data Subject Requests](https://docs.microsoft.com/microsoft-365/compliance/gdpr-dsr-azure). For more information see the [Service Trust portal](https://servicetrust.microsoft.com/ViewPage/GDPRGetStarted).
