...
- The new **Solution catalog** card, links to collections of [integrated solutions](https://docs.microsoft.com/microsoft-365/compliance/microsoft-365-solution-catalog?view=o365-worldwide) that are used to manage end-to-end compliance scenarios across three compliance solutions areas:
...
[![Interactive guide](../media/-compliance-center-interactive-guide-expanded.png)](https://edxinteractivepage.blob.core.windows.net/edxpages/Security%20fundamentals/LP04M02%20-%20Explore%20Compliance%20Center/index.html?azure-portal=true)