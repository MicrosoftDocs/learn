...
For more information on pricing and a free trial of Microsoft Sentinel on an Azure Monitor Log Analytics workspace, visit [Microsoft Sentinel pricing](https://azure.microsoft.com/pricing/details/azure-sentinel/).
