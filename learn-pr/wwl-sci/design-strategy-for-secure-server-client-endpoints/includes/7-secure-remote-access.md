...
![Strategy for secure remote access](../media/strategy-secure-remote-access.png) 
...
![Remote Desktop Protocol (RDP) or Secure Shell Protocol (SSH)](../media/remote-desktop-protocol.png) 
...
>  https://learn-video.azurefd.net/vod/player?show=azure-friday&ep=enabling-secure-remote-work-using-windows-virtual-desktop
