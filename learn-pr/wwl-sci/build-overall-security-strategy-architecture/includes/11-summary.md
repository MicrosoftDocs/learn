...
-   [Microsoft Cybersecurity Reference Architectures - Security
    documentation](/security/cybersecurity-reference-architecture/mcra)

-   [Governance in the Microsoft Cloud Adoption Framework for Azure -
    Cloud Adoption Framework](/azure/cloud-adoption-framework/govern/)
...
-   [Organize and manage multiple Azure subscriptions - Cloud Adoption
    Framework](/azure/cloud-adoption-framework/ready/azure-best-practices/organize-subscriptions)
