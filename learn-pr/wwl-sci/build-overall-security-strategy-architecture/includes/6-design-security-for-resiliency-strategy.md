...
* BCDR as a service for platform-as-a-service (PaaS) services:
    ...
    * Availability Zones support for specific virtual machine (VM) stock-keeping units (SKUs)
    * For example, Azure Ultra Disk Storage requires using Availability Zones
