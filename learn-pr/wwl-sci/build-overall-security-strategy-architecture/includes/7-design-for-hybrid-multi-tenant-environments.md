...
* [Architectural considerations for a multitenant solution](https://docs.microsoft.com/en-us/azure/architecture/guide/multitenant/considerations/overview)
* [Tenancy models to consider for a multitenant solution](https://docs.microsoft.com/en-us/azure/architecture/guide/multitenant/considerations/tenancy-models)
