...
| [Data ownership](/azure/azure-monitor/logs/workspace-design#data-ownership?&preserve-view=true) | You might choose to create separate workspaces to define data ownership. For example, you might create workspaces by subsidiaries or affiliated companies. |
