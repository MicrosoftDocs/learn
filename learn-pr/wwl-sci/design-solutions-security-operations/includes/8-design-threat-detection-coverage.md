...
![Screenshot of the MITRE coverage page with both active and simulated indicators selected.](https://learn.microsoft.com/azure/sentinel/media/mitre-coverage/mitre-coverage.png)
