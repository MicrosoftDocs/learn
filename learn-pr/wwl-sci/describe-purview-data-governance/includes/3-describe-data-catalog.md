...
Microsoft Purview Unified Catalog provides a platform for data governance and drives business value creation in your organization. It builds on the metadata captured by Data Map and provides a rich set of features that align to data governance principles. The sections that follow describe some of the key features of Microsoft Purview Unified Catalog.

## Governance domains

Governance domains are a way of organizing your data estate through business concepts, like Marketing or Finance, providing context for your data assets. A governance domain is a boundary that enables the common governance, ownership, and discovery of data products and business concepts like glossary terms, objectives and key results (OKRs), or critical data. You can establish many kinds of boundaries such as:

- Fundamental business areas—human resources, sales, finance, supply chain
...
Governance domains are connected to several other business concepts that are incorporated as features of the Unified Catalog.

### Data products

Related to governance domains are data products. A data product is a business construct with a name, description, owners, and most importantly a list of associated data assets. The data product provides context for the assets that are included within it, and provides a use case for data consumers.
...
Consider the example where a data scientist creates a set of data assets to be used by a data model and to be used by others. Although the data scientist can use the Unified Catalog to add a glossary term to all the relevant data assets and can add a description to each asset to make it more relevant in search, it doesn't guarantee that a data consumer knows what glossary term to use or that they find all the data assets. This is where a data product fits nicely. The data scientist creates a data product that lists all the assets used to create their data model. The description provides a full use case, with examples or suggestions on how to use the data. The data scientist is now a data product owner and they've improved their data consumer's search experience by helping them get everything they need in this one data product.
...
Glossary terms provide data governance based on the business context, because they contain policies. Policies in a business term apply specific business health goals, data governance requirements, and terms of use to any data product that a term is applied to.
...
Critical data elements are created within governance domains and can have policies set to manage these important pieces of information. By creating CDEs, organizations can allocate resources strategically, focusing governance effort on areas that have the most significant impact on the business.
...
Unified Catalog access policies allow you to manage access to your data products and set up a system to provide access to users who request it. Access policies promote innovation and flexibility in your data estate by creating self-service access opportunities, while upholding security and right-use standards.

## Search and browse

Data discovery can be time consuming because you might not know where to find the data that you want. Search enables data consumers to easily find the data needed for their analytics or governance workloads. Searching is great if you know what you're looking for, but there are times where data consumers wish to explore the data available to them. The Unified Catalog offers a browse experience that enables users to explore what data is available to them either by collection or through the hierarchy of each data source in the catalog.

Unified Catalog also includes an AI-powered copilot that lets users search using natural language. Instead of needing to know the exact name of a data asset or glossary term, you can describe what you're looking for in everyday language and the copilot helps locate the right data.

## Health management

Health management has features to enhance your data governance strategy and management.

**Health controls** allow your team to analyze and track your journey to complete data governance by monitoring your governance health, and using the provided health controls to track your progress. Data health controls are specific measures, processes, and tools implemented to monitor, maintain, and improve the quality, security, and overall health of an organization's data. The benefits of data health controls include:
...
**Health actions** give you and your users steps to take to improve data health and governance across your data estate. These actions correspond to the checks made to calculate a data product's data governance health control score. Addressing these actions raises your health score and promotes a more usable and discoverable catalog.

## Data quality

Microsoft Purview Data Quality empowers governance domain and data owners to assess and oversee the quality of their data ecosystem, facilitating targeted actions for improvement.

Data Quality offers users the ability to evaluate data quality using no-code/low-code rules, including out-of-the-box rules and AI-generated rules. AI-generated rules analyze your data and suggest quality checks automatically, reducing the manual effort needed to set up monitoring. These rules are aggregated to provide scores at the levels of data assets, data products, and governance domains, ensuring end-to-end visibility of data quality within each domain. Unified Catalog also provides AI-enabled recommendations for data curation, helping data stewards identify gaps in metadata and improve the discoverability of data assets.