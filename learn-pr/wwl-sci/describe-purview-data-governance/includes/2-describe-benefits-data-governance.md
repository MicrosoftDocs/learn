...
With the growing use of artificial intelligence (AI) across businesses, data governance is more important than ever. AI systems depend on trusted, high-quality data to produce accurate insights and support sound business decisions. When AI models ingest poorly governed data—data that's incomplete, inconsistent, or mislabeled—the results are unreliable. At the same time, evolving regulations around AI use add new requirements for how organizations manage and protect their data. Good data governance helps you meet those requirements while also making sure your data is ready for AI workloads.

Microsoft Purview data governance solutions help ensure data quality, security, and compliance while also accelerating value creation. Before going into the descriptions of these solutions, it's important to understand some key principles and concepts associated with data governance.

## Data governance concepts

- **Federated governance** provides a centralized place to develop data safety, quality, and standards, but also provides tools to create self-service access control, discoverability, and maintenance. Federated data governance spreads ownership across your business, reducing bottlenecks and encouraging participation in the life cycle of managing, governing, consuming, and applying data.

- **Data access** is about quickly providing the right access and enforcing the right use to balance safety and innovation.

- **Data curation** is about organizing, annotating, and publishing your data so that it's safely accessible, reusable, and protected.
...
- **Data understanding** is about ensuring data has quality descriptors that help users understand what the data is and how it should be used.

## Data roles and responsibilities

- **Data consumers** quickly find and use relevant, trusted datasets through streamlined access request workflows.
...
- For organization-wide data consumers:
  ...
  - Data understanding—provides what you need to know about the data.
...
Microsoft Purview data governance delivers on these benefits through the capabilities of Data Map and Unified Catalog, described in the units that follow.