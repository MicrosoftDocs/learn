...
The best way to understand the Microsoft cloud security benchmark is to access it from GitHub [Microsoft_cloud_security_benchmark_v1.xlsx](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Microsoft%20Cloud%20Security%20Benchmark). Spoiler alert, it's an excel spreadsheet. Some of the key pieces of information in MCSB V1 are:
