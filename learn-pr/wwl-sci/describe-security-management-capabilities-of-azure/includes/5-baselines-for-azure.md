...
:::image type="content" source="../media/azure-security-benchmark-inline.png" lightbox="../media/azure-security-benchmark-expanded.png" alt-text="A subset of information from the Azure Security Benchmark v3":::
...
:::image type="content" source="../media/azure-ad-security-baseline-inline.png" lightbox="../media/azure-ad-security-baseline-expanded.png" alt-text="A subset of information from the Azure Active Directory security baseline":::
