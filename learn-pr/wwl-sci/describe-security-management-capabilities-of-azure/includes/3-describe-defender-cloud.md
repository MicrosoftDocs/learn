...
Microsoft Defender for Cloud also provides hardening recommendations based on any identified security misconfigurations and weaknesses. Use these security recommendations to strengthen the security posture of your organization's Azure, hybrid, and multi-cloud resources.
...
Additional information on secure score is covered in the subsequent topic.

#### Network map

One of the most powerful Microsoft Defender for Cloud tools for continuously monitoring the security status of your network is the network map. Use the map to look at the topology of your workloads, so you can see if each node is properly configured. You'll see how your nodes are connected, which helps you block unwanted connections that could potentially make it easier for an attacker to creep along your network.

> [!div class="mx-imgBorder"]
> ![Diagram showing the Microsoft Defender for Cloud network map.](../media/3-network-map.png)
...
Through the Microsoft Defender plans specific to the types of resources in your subscriptions, organizations can take advantage of enhanced security features.
The benefits of enabling enhanced security features of Microsoft Defender for Cloud are covered in a subsequent unit.
