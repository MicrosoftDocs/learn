...
In this module, you’ll explore the capabilities and benefits of using Microsoft Defender for Cloud, what Azure secure score says about your organization's level of security readiness, and how Microsoft Defender for Cloud can protect your organization's assets and resources.  Finally, you’ll explore the use of cloud security posture management and understand the security baseline in Azure.

After completing this module, you’ll be able to:  

- Describe the security management capabilities of Azure.
- Describe the benefits and use cases of Microsoft Defender for Cloud.
