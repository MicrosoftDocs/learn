...
| [Security recommendations to fix misconfigurations and weaknesses](review-security-recommendations.md) | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png)| Azure, AWS, GCP, on-premises |
| [Secure score](secure-score-security-controls.md) | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS, GCP, on-premises |
| [Governance](concept-regulatory-compliance.md) | - | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS, GCP, on-premises |
| [Regulatory compliance](concept-regulatory-compliance.md) | - | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS, GCP, on-premises |
| [Cloud security explorer](how-to-manage-cloud-security-explorer.md) | - | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS |
| [Attack path analysis](how-to-manage-attack-path.md) | - | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS |
| [Agentless scanning for machines](concept-agentless-data-collection.md) | - | ![Icon for a check mark](https://learn.microsoft.com/azure/defender-for-cloud/media/icons/yes-icon.png) | Azure, AWS |
...
Learn how to use the [cloud security explorer](https://learn.microsoft.com/azure/defender-for-cloud/how-to-manage-cloud-security-explorer), or check out the [cloud security graph components list](https://learn.microsoft.com/azure/defender-for-cloud/attack-path-reference#cloud-security-graph-components-list).


## Agentless scanning for machines
<!--
https://learn.microsoft.com/azure/defender-for-cloud/concept-agentless-data-collection
-->
