...
The Azure Container Apps application lifecycle revolves around [revisions](https://learn.microsoft.com/en-us/azure/container-apps/revisions).

When you deploy a container app, the first revision is automatically created. [More revisions are created](https://learn.microsoft.com/en-us/azure/container-apps/revisions) as [containers](https://learn.microsoft.com/en-us/azure/container-apps/containers) change, or any adjustments are made to the `template` section of the configuration.
...
<!--
[](https://learn.microsoft.com/en-us/azure/container-apps/application-lifecycle-management#update)
-->


## Update

As a container app is updated with a [revision scope-change](https://learn.microsoft.com/en-us/azure/container-apps/revisions#revision-scope-changes), a new revision is created. You can [choose](https://learn.microsoft.com/en-us/azure/container-apps/revisions#revision-modes) whether to automatically deactivate old revisions (single revision mode), or allow them to remain available (multiple revision mode).
...
In multiple revision mode, you control when revisions are activated or deactivated and which revisions receive ingress traffic. If a [traffic splitting rule](https://learn.microsoft.com/en-us/azure/container-apps/revisions-manage#traffic-splitting) is configured with `latestRevision` set to `true`, traffic does not switch to the latest revision until it is ready.
<!--
[](https://learn.microsoft.com/en-us/azure/container-apps/application-lifecycle-management#deactivate)
-->

## Deactivate

Once a revision is no longer needed, you can deactivate a revision with the option to reactivate later. During deactivation, containers in the revision are [shut down](https://learn.microsoft.com/en-us/azure/container-apps/application-lifecycle-management#shutdown).

![Diagram which shows the deactivation phase with Azure Container Apps.](https://learn.microsoft.com/en-us/azure/container-apps/media/application-lifecycle-management/azure-container-apps-lifecycle-deactivate.png)
<!--
