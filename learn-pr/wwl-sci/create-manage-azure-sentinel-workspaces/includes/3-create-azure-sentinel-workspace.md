...
The next page, **Add Azure Sentinel to a workspace** will display a list of available Log Analytics workspaces to add Azure Sentinel.  Select the **+ create a new workspace** button to start the "Create Log Analytics workspace" process.
