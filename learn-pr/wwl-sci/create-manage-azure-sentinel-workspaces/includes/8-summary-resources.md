You should have learned how the Azure Sentinel provisioning process includes creating a Log Analytics workspace and configuring the Azure Sentinel options.
