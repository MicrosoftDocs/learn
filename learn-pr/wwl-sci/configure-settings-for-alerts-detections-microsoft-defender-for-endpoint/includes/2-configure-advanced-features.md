...
| Feature| Description|
| :--- | :--- |
| Live Response| Allows users with appropriate RBAC permissions to investigate devices that they are authorized to access, using a remote shell connection.|
