...
As stated at the beginning of this page, when you build and apply you need a method to grant it access to resources. With the concept of **zero trust**,you can use managed identity. You only assign the minimum privileges that the managed identity needs.  Then only assign access the minimum resources needed.  Least-privilege will keep your applications and data protected.
