...
## To learn more, research using these links
 ...
 -  [Configure managed identities using the Azure portal - Azure AD \| Microsoft Docs](/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm)
 -  [Assign a managed identity access to a resource using the Azure portal - Azure AD \| Microsoft Docs](/azure/active-directory/managed-identities-azure-resources/howto-assign-access-portal)
