...
Because sponsorship is required for blueprint and agent identity creation, sponsor assignment isn't optional governance cleanup. It's part of secure setup, and it must be recorded on the relevant Agent ID object at creation time rather than filled in later.
