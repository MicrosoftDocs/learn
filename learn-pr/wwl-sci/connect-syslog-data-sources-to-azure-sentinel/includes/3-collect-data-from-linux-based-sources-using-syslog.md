...
:::image type="content" source="../media/syslog-connector.png" alt-text="Screen shot of the Syslog connector page." lightbox="../media/syslog-connector.png":::
...
:::image type="content" source="../media/syslog-agent-management.png" alt-text="Screen shot of Agent Management for Linux hosts.":::