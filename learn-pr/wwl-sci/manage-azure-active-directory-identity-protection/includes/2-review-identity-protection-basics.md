...
Always remember that Microsoft Entra ID, part of Microsoft Entra ID Protection requires a Microsoft Entra ID P2 license to operate. Licensing is covered in more detail in a later unit.
...
Using this feature requires a Microsoft Entra ID P2 license.
