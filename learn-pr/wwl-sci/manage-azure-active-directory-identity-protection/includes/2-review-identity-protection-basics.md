...
Always remember that Azure Active Directory (Azure AD), part of Microsoft Entra Identity Protection requires an Azure AD Premium P2 license to operate. Licensing is covered in more detail in a later unit.
