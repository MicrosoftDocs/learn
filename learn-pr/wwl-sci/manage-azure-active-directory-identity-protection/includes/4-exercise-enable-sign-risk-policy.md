**Exercise Environment needs** - This lab assumes you have access to a Microsoft Entra tenant with basic admin rights to complete. If you want to set up a trail environment, [Try Azure for Free](https://azure.microsoft.com/free).
