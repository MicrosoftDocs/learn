...
1. The case study description, which includes
...
1. A conceptual walkthrough video which shows the proposed architecture at a high level, including which capabilities were selected for the final solution and how the elements fit together
