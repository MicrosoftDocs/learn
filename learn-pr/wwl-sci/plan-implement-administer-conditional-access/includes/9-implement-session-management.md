...
:::image type="content" source="../media/conditional-access-flow-chart.png" alt-text="Screenshot of the Sign-in frequency and MFA with Azure A D conditional access.":::
