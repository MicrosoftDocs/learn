...
:::image type="content" source="../media/conditional-access-app-control.png" alt-text="Screenshot of Azure A D Conditional Access policy wizard with the Use Conditional Access App Control highlighted.":::
