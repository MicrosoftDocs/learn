...
:::image type="content" source="../media/sc300-conditional-access-app-control-5d1f169d.png" alt-text="Screenshot of Azure AD Conditional Access policy wizard with the Use Conditional Access App Control highlighted.  The feature is under the SESSION section of the dialog.":::
