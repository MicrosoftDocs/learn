...
2.  Select the Show portal menu hamburger icon and then select Identity - Overview.
    ...
    :::image type="content" source="../media/azure-portal-menu-azure-active-directory-33e41fde.png" alt-text="Screenshot of the Microsoft Entra admin center menu with Idenity - Overivew - Properties selected.":::
