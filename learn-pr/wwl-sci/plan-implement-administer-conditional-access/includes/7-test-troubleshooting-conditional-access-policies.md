...
:::image type="content" source="../media/image-1-0ae1e058.png" alt-text="Sign in error - compliant device required":::
...
:::image type="content" source="../media/image-2-c55e6d55.png" alt-text="More details from a Conditional Access interrupted web browser sign-in.":::
...
:::image type="content" source="../media/image-3-02fd59a2.png" alt-text="Selecting the Conditional access filter in the sign-ins log":::
...
:::image type="content" source="../media/image-5-626fdc2f.png" alt-text="Sign in event Conditional Access tab":::


:::image type="content" source="../media/policy-details-138b5d50.png" alt-text="Policy details (preview)":::
...
:::image type="content" source="../media/image-6-84a6e95f.png" alt-text="The Troubleshooting and support tab of the Sign-in event":::
