...
1. Browse to **Azure Active Directory**, then **Sign-ins**.
...
:::image type="content" source="../media/image-5-413a87aa.png" alt-text="Screenshot of the Sign-in event Conditional Access tab. Waiting for user input.":::
 :::image type="content" source="../media/policy-details-41ee5be2.png" alt-text="Screenshot of the Policy details (preview) screen in Azure A D conditional access.":::
