...
2.  Browse to **Azure Active Directory**, then **Sign-ins**.
...
:::image type="content" source="../media/policy-details.png" alt-text="Screenshot of the Policy details (preview) screen in Azure A D conditional access.":::
