...
:::image type="content" source="../media/conditional-access-2.png" alt-text="Screenshot of the Azure Active Directory Conditional Access screen, listing policies that currently exist.":::
...
:::image type="content" source="../media/conditional-access-1.png" alt-text="Screenshot of the Azure A D Conditional Access: Cloud apps or actions page for configuration.":::
...
2.  Browse to **Azure Active Directory**, then **Security**, then **Conditional Access**, and then **Named locations**.
...
1.  Sign in to the **Azure portal** as a Global Administrator, Security Administrator, or Conditional Access Administrator.
2.  Browse to **Azure Active Directory**, then **Security**, and then **Conditional Access**.
3.  Select **New policy**.
...
:::image type="content" source="../media/create-terms-identity-governance.png" alt-text="Screenshot of the Identity Governace dialog to create a new Terms of Use for your cloud solutions.":::
