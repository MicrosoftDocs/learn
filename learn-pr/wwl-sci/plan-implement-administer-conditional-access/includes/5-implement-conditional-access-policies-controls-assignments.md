...
:::image type="content" source="../media/conditional-access-2-fe151f52.png" alt-text="Screenshot of the Azure Active Directory Conditional Access screen, listing policies that currently exist.":::
...
:::image type="content" source="../media/conditional-access-1-a9a442b4.png" alt-text="Screenshot of the Azure A D Conditional Access: Cloud apps or actions page for configuration.":::
...
1. In the **Azure portal**, browse to **Azure Active Directory**, then **Security**, and then **Conditional Access**.
1. Select **New policy**.
...
1. Browse to **Azure Active Directory**, then **Security**, then **Conditional Access**, and then **Named locations**.
...
:::image type="content" source="../media/terms-of-use-conditional-access-a2c6eca2.png" alt-text="Screenshot of the Azure A D conditional access setup page that shows adding Terms-of-Use rules for being able to access resources.":::
