Microsoft Defender for Office 365 is a cloud-based email and collaboration security service that provides protection against threats like phishing and malware that arrive through email links (URLs), attachments, or collaboration tools like SharePoint, Teams, and Outlook. Defender for Office 365 provides real-time views of threats. It also provides investigation, hunting, and remediation capabilities to help security teams identify, prioritize, investigate, and respond to threats.
...
- Safe attachments that provide an extra layer of protection against malware. After files are scanned by the common virus detection engine in Microsoft 365, Safe Attachments opens files in a virtual environment to see what happens (a process known as detonation).
...
Some of the features of Microsoft Defender for Office 365 that help organizations investigate email and collaboration based threats include: by users with appropriate permissions such as admins, insider risk teams, compliance and legal investigators, to provide visibility into the activities of the organization.
...
Some of the features of Microsoft Defender for Office 365 that help organizations respond to email and collaboration based threats include:
...
Microsoft Defender for Office 365 integrates with Microsoft Security Copilot. With Security Copilot embedded in the Microsoft Defender portal, security teams can summarize incidents involving email threats, get guided response recommendations, and investigate suspicious messages faster.

Security Copilot also enables autonomous AI agents that work directly within Defender for Office 365. The **Phishing Triage Agent** automatically reviews and classifies user-reported phishing submissions. The agent operates autonomously to determine whether a submission is a genuine phishing attack or a false positive, provides a transparent rationale for its verdict in natural language, and continuously improves its accuracy based on analyst feedback. The Phishing Triage Agent requires Microsoft Defender for Office 365 Plan 2 and Microsoft Security Copilot.

The Copilot integration for Microsoft Defender for Office 365 is covered in more detail in the unit, "Describe Microsoft Security Copilot in Microsoft Defender XDR," included in this module.
