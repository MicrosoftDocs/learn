...
Also, subscribers to **Microsoft Defender Threat Intelligence** (Defender TI) can now access threat intelligence from inside the Microsoft 365 Defender portal.
