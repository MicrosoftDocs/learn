...
Through the Microsoft Defender portal, Microsoft delivers on the promise of a unified security operations platform so you can view the security health of your organization. To access the portal, You must be assigned an appropriate role, such as Global Administrator, Security Administrator, Security Operator, or Security Reader in Microsoft Entra ID to access the Microsoft Defender portal.

The Microsoft Defender portal combines protection, detection, investigation, and response to threats across your entire organization and all its components, in a central place. The Defender portal emphasizes quick access to information, simpler layouts, and bringing related information together for easier use.
...
The left navigation pane provides easy access to the suite of Microsoft Defender XDR services including Defender for Identity, Defender for Office 365, Defender for Endpoints, and Defender for Cloud Apps, which were described in the previous units. You get also get access to Microsoft Sentinel, which is covered in a separate module, and many other capabilities  The sections that follow provide a brief description  of the other capabilities accessible from the left navigation bar in the Microsoft Defender portal.
...
Using data connectors you can connects data sources for a richer, more centralized exposure management experience.

### Investigation & response

The investigation and response section on the left navigation pane of the Microsoft Defender portal includes access to incidents and alerts, hunting

:::image type="content" source="../media/investigation-response.png" alt-text="A screenshot of the Microsoft Defender portal showing the selections available for investigation and response. They are incidents and alerts, hunting, actions and submissions, and partner catalog.":::

#### Incidents and alerts

An incident in the Microsoft Defender portal is a collection of related alerts, assets, investigations, and evidence to give you a comprehensive look into the entire breadth of an attack. It serves as a case file that your SOC can use to investigate that attack and manage, implement, and document the response to it. Because the Microsoft Defender portal is built upon a unified security operations platform, you get a view of all incidents including the suite of Microsoft Defender XDR solutions, Microsoft Sentinel, and Microsoft Defender for Cloud.
...
:::image type="content" source="../media/hunting.png" lightbox="../media/hunting.png" alt-text="A screenshot of the incident details page for a selected incident in the Microsoft Defender portal.":::
