...
:::image type="content" source="../media/entra-cloud-sync-inline.png" lightbox="../media/entra-cloud-sync-inline.png" alt-text="An illustration that depicts a hybrid identity. It shows a user in an on-premises Active Directory that includes Microsoft Entra Cloud Sync with an arrow pointing to the cloud-based Microsoft Entra ID.":::
