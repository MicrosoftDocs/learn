...
:::image type="content" source="../media/microsoft-entra-cloud-connect-sync-inline.png" alt-text="An illustration that depicts a hybrid identity. It shows a user in an on-premises Active Directory that includes Microsoft Entra ID Connect cloud sync with an arrow pointing to the cloud-based Microsoft Entra ID.":::
