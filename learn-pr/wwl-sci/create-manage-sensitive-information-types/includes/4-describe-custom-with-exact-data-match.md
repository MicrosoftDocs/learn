...
|Phase|Requirements|
|---|---|
|[Phase 1: Export source data for exact data match based sensitive information type](/sit-get-started-exact-data-match-export-data?azure-portal=true#export-source-data-for-exact-data-match-based-sensitive-information-type)|- Read access to the sensitive data|
