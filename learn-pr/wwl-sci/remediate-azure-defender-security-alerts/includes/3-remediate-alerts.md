...
:::image type="content" source="../media/alerts-page.png" alt-text="Screen shot of the Defender for Cloud Alerts list page.":::
...
:::image type="content" source="../media/alerts-details-pane.png" alt-text="Screen shot of the Defender for Cloud Alert Details Flyout.":::
...
:::image type="content" source="../media/security-center-alert-remediate.png" alt-text="Screen shot of the Defender for Cloud Alert Detail page.":::
...
:::image type="content" source="../media//alert-take-action.png" alt-text="Screen shot of the Defender for Cloud Alert Take Action tab.":::
...
:::image type="content" source="../media/add-workflow.png" alt-text="Screen shot of the Defender for Cloud Workflow Automation Add a workflow.":::
...
:::image type="content" source="../media/sample-logic-app.png" alt-text="Screen shot of the Logic App U I and a sample logic app.":::
