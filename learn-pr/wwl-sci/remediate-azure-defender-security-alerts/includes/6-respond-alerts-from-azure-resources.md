...
Every alert from Microsoft Defender for Key Vault includes the following elements:
...
- Resolve any Microsoft Defender for Cloud recommendations for the machine, remediating highlighted security issues to prevent future breaches.
