...
The following image shows the principle of hidden folders in a mailbox and describes an example process from the delivery of a message until its final purge from the mailbox by the Managed Folder Assistant (MFA).
