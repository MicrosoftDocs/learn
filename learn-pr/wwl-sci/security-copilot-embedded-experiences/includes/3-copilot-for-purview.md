...
:::image type="content" source="../media/purview-plugin-requirement.png" lightbox="../media/purview-plugin-requirement.png" alt-text="Screen capture of the setting to allow Security Copilot to access data from your Microsoft 365 services, which is required to enable the Microsoft Purview plugin.":::
