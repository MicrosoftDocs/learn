...
An example of this system is when the user provides something they know, such as a password, to authenticate. Simple passwords are straightforward to remember but easy for criminals to hack. Complex passwords might seem more secure, but they're hard to remember. It's more likely that someone will write down this type of password, making it much less secure.
...
As mentioned earlier, biometric authentication is most often used with another method of authentication. Consider the example of a bank that has a secured area where it keeps customers’ safety deposit boxes. Before someone can gain access, they're typically required to successfully enter both a password and a fingerprint scan.
