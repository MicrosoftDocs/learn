...
:::image type="content" source="../media/sc300-external-user-flow-65ab0061.png" alt-text="Diagram showing the flow of how a guest user is invited to the directory, and how they can access resources once they are granted access.":::
...
:::image type="content" source="../media/understand-template-229b4041.png" alt-text="Spreadsheet picture that shows the common values for a CSV file.  You will always have a version in row 1.  Row two contains the column headings, these values should not be modified in the template.  Third row and down contain the information about each user to bulk invite.":::
