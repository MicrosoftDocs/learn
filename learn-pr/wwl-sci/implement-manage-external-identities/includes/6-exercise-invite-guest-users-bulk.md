...
7.  Open the .csv template and add a line for each guest user. Required values are
    ...
    ::::image type="content" source="../media/template-csv.png" alt-text="Screenshot of the example bulk invite guests template C S V.":::
...
12. To view the job status, select **Click here to view the status of each operation**. Or, you can select **Bulk operation results** in the Activity section.
