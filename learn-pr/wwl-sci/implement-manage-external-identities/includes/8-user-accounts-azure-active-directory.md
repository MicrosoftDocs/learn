...
:::image type="content" source="../media/default-role-783e26c5.png" alt-text="Screenshot showing the default directory role.":::


### Global Administrator role

:::image type="content" source="../media/global-admin-role-d1a7ce65.png" alt-text="Screenshot showing the global administrator role.":::


### Limited Administrator role

:::image type="content" source="../media/limited-admin-role-5351ec15.png" alt-text="Screenshot showing the limited administrator role.":::
...
:::image type="content" source="../media/redemption-diagram-3bf4a6bc.png" alt-text="Diagram depicting the four user states.":::
...
:::image type="content" source="../media/before-redemption-96621cf7.png" alt-text="Screenshot showing user properties before offer redemption.":::
...
:::image type="content" source="../media/after-redemption-state-1-80686a7d.png" alt-text="State 1 guest user after offer redemption.":::


For guest users in State 2, the **Source** is **Microsoft Account**.

:::image type="content" source="../media/after-redemption-state-2-b227f2ac.png" alt-text="State 2 guest user after offer redemption.":::
...
:::image type="content" source="../media/filter-guest-users-b41bed4a.png" alt-text="Screenshot showing the filter for guest users.":::
...
## Remove guest user limitations<br>
