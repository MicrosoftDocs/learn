...
> ![Screenshot showing the default directory role.](../media/default-role.png)

### Global Administrator role

> [!div class="mx-imgBorder"]
> ![Screenshot showing the global administrator role.](../media/global-admin-role.png)

### Limited Administrator role

> [!div class="mx-imgBorder"]
> ![Screenshot showing the limited administrator role.](../media/limited-admin-role.png)
...
- State 4: Homed in the host organization's Azure AD with UserType = Guest and credentials that the host organization manages.
    ...
    > [!div class="mx-imgBorder"]
    > [ ![Diagram depicting the four user states.](../media/redemption-diagram.png) ](../media/redemption-diagram.png#lightbox)
...
> [!div class="mx-imgBorder"]
> ![Screenshot showing user properties before offer redemption.](../media/before-redemption.png)
...
> [!div class="mx-imgBorder"]
> ![State 1 guest user after offer redemption.](../media/after-redemption-state-1.png)

For guest users in State 2, the **Source** is **Microsoft Account**.

> [!div class="mx-imgBorder"]
> ![State 2 guest user after offer redemption.](../media/after-redemption-state-2.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot showing the filter for guest users.](../media/filter-guest-users.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot showing the External users option in the user settings.](../media/remove-guest-limitations.png)
