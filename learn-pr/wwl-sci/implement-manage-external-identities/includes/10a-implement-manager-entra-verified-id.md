:::image type="content" source="../media/entra-verified-identity.png" alt-text="Screenshot of the Azure AD security settings screen, with the Verifiable credentials selected.":::
