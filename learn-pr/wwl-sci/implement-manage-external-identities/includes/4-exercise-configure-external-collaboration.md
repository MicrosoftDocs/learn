...
12. :::image type="content" source="../media/guest-invite-settings-3dd14ea3.png" alt-text="Screenshot of the guest invite settings with the Guests can invite set to No and highlighted.":::
    
13. Under **Collaboration restrictions**, review the available options and accept the default settings.
...
14. When finished, save your changes.
