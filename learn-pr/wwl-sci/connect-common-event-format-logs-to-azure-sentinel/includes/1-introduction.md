...
You are a Security Operations Analyst working at a company that implemented Microsoft Sentinel.  You need to collect log data from on-premises network appliances.  You can use the Common Event Format connector as the network appliances' data is provided in a structured format.  
