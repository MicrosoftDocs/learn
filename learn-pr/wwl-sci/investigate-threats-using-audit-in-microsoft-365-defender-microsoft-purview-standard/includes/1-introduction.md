...
You're a Security Operations Analyst working at a company that is implementing Microsoft Purview and Microsoft 365 Defender solutions.  You need to understand how to search the Unified Audit Log (UAL) to find and investigate threats, and to conduct forensic investigations. After completing this module, you'll be able to:
