...
The SC-400: Microsoft Information Protection Administrator course is not a fundamentals course. Students should be familiar with Microsoft security and compliance technologies. Demos are provided in the trainer materials; however you may want to use a lab environment to go through some of the steps in the lab to demonstrate the examples. Showing examples in a lab environment will also provide your learners with a head start on the actual labs.
