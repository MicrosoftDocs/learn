...
1. On the **Locations** page, choose the content locations that you want to search. You can search mailboxes, sites, and public folders. :::image type="content" source="../media/new-search-wizard-locations-page-067651ea.png" alt-text="Screenshot of the Locations page in the New Search wizard.":::
