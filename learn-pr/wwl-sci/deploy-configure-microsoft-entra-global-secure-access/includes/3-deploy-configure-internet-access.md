...
| Steps | Description |
| :--- | :--- |
| 1. Enable the Microsoft trafic forwarding profile. | With the Microsoft profile enabled, Microsoft Entra Internet Access acquires the traffic going to Microsoft services, like Exchange Online and SharePoint Online. |
...
## Enable Microsoft trafic forwarding profile

![Screenshot of the the Microsoft trafic profile enabled in Microsoft Entra.  This enables 3 trafic policies, a conditional access policy, and user - group assignment.](../media/trafic-profile-enabled.png)

1. Sign in to the Microsoft Entra admin center as a Global Secure Access Administrator.
1. Browse to Global Secure Access > Connect > Traffic forwarding.
1. Enable the Microsoft traffic profile.

This turns on Microsoft trafic forwarding and creates the following configurations in Microsoft Entra:
| Configuration Setup | Description |
| :--- | :--- |
| Policies (network routing) | 1. **Exchange Online**, 2. **SharePoint Online and OneDrive for Business**, and 3. **Entra ID and MSGraph** - These use fully qualified domain names or IP subnets to manage network trafic. |
| Conditional Access Policy | **Linked Conditional Access policies** - Captures all trafic to Microsoft Services, routes to the network policies defined above if conditions are met. |
| User and Group | Specify specific users or groups that this trafic forward applies to. |
| | |
Refer to the documentation article for more details - [Enable and manage Microsoft trafic forwarding](/entra/global-secure-access/how-to-manage-microsoft-profile).

## Deploy Global Secure Access client for Windows (or Android)

The client is quick and easy to install. It can be deployed via mobile device management tools like Microsoft Intune, or manually installed on each device.  You will need to download the client from the Entra admin center, then use your choice of deployment methods.
...
1. Under Target resources > Include, and select Select apps.
   - Choose Office 365 Exchange Online, and/or Office 365 SharePoint Online, and/or any of your third-party SaaS apps.
