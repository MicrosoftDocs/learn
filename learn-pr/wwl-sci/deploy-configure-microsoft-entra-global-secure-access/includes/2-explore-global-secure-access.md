...
It's recommended that you visit the [Zero Trust Guidance Center](/security/zero-trust/) to plan out your implementation. Additionally, you can make all configuration changes in the Microsoft Entra admin center at [https://entra.microsoft.com](https://entra.microsoft.com).
