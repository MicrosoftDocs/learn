...
In this interactive guide, you create a custom promptbook in Security Copilot by reusing prompts from an earlier identity investigation session. The scenario involves a security analyst who regularly reviews failed login attempts and authentication activity in Microsoft Entra. Rather than manually entering the same prompts each time, you save those prompts as a custom promptbook — allowing you to reuse the workflow in future investigations.
