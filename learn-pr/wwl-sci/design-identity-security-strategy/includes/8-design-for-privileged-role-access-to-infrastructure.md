...
see the [Microsoft Security Intelligence
Report](https://www.microsoft.com/security/operations/security-intelligence-report).
...
-   Technical components such as host defenses, account protections, and
    identity management
...
in Active Directory at [Securing Privileged
Access](https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access).
...
![Stages of the roadmap with time
lines](media\Stages.png) 
...
![Stage 1 Critical items to do
first](media\Stage1.png) 
...
![Stage 2 Mitigate frequently used
attacks](media\Stage2.png) 
...
![Stage 3: take control of administrator
activity](media\Stage3.png) 
...
![Stage 4: adopt an active security
posture](media\Stage4.png) 
...
-   [Secure Access Practices for Administrators in Azure
    AD](https://docs.microsoft.com/azure/active-directory/roles/security-planning)
