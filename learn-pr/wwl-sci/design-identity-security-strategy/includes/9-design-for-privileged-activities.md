...
![Human operated ransomware](../media/hum-o-r.png) 
...
flood over time](../media/attackersare-like-water.png) 
...
![Attack surface unprotected](../media/business-critical-assets2.png) 
