...
principle is ever compromised. Azure AD RBAC supports over 65 [built-in roles](https://docs.microsoft.com/azure/active-directory/roles/permissions-reference).
