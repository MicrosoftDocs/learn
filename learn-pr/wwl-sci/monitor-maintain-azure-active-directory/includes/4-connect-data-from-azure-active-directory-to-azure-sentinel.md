...
3.  Under **Configuration**, select the **Azure Active Directory Sign in logs** and **Audit logs** checkboxes and then select **Apply changes**.
    ...
    :::image type="content" source="../media/sentinel-configure-azure-active-directory-connector.png" alt-text="Screenshot of the Azure Active Directory logs collected by Azure Sentinel selections highlighted.":::
