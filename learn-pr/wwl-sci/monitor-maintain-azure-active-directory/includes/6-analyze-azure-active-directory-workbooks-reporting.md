...
3. From the **Activity** section, select **Usage and insights** to open the report.
   ...
   :::image type="content" source="../media/main-menu.png" alt-text="Screenshot of the Usage and Insights selected from the Activity section. Use the logs to find the data you need.":::
...
:::image type="content" source="../media/usage-insights-report.png" alt-text="Screenshot of Usage and Insights for Application activity where you can select a range and view sign-in activity for different apps.":::
