...
:::image type="content" source="../media/select-azure-active-directory-2b3983f9.png" alt-text="Select Azure Active Directory":::


Under **Monitoring**, select **Sign-ins** to open the Sign-ins report.

:::image type="content" source="../media/sign-ins-azure-active-directory-95f94f2b.png" alt-text="Screenshot shows Sign-ins selected from the Monitoring menu.":::
...
:::image type="content" source="../media/sign-activity-bd5ebaf3.png" alt-text="Screenshot shows the Office 365 SharePoint Online Sign-ins.":::


You can customize the list view by clicking Columns in the toolbar.

:::image type="content" source="../media/columns-option-6852dce6.png" alt-text="Screenshot shows the Columns option in the Sign-ins page.":::
...
:::image type="content" source="../media/columns-2-4e4025c0.png" alt-text="Screenshot shows the Columns dialog box where you can select attributes.":::


Select an item in the list view to get more detailed information.

:::image type="content" source="../media/basic-sign-b8127d6a.png" alt-text="Screenshot shows a detailed information view.":::
...
:::image type="content" source="../media/add-filters-option-7c883d0c.png" alt-text="Screenshot shows the Add filters option.":::
...
:::image type="content" source="../media/client-app-filter-18a97da6.png" alt-text="Client app filter":::
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Shows all sign-in attempts where the EAS protocol has been attempted.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
  ...
  :::column-end:::
  :::column:::
    Shows all sign-in attempts from users using web browsers.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
  ...
  :::column-end:::
  :::column:::
    Shows all sign-in attempts from users with client apps using Exchange ActiveSync to connect to Exchange Online.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
  ...
  :::column-end:::
  :::column:::
    Used to connect to Exchange Online with remote PowerShell. If you block basic authentication for Exchange Online PowerShell, you need to use the Exchange Online PowerShell module to connect.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Shows all sign-in attempts from users using mobile apps and desktop clients.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Shows all sign-in attempts from users where the client app is not included or unknown.
  :::column-end:::
:::row-end:::
...
:::image type="content" source="../media/download-2-f5ddc816.png" alt-text="Download":::
...
:::image type="content" source="../media/sign-ins-over-month-2d3f9482.png" alt-text="Screenshot shows a graph of Sign-ins over a month.":::
...
:::image type="content" source="../media/activity-section-d79a79e3.png" alt-text="Screenshot shows the Activity section where you can select Sign-ins.":::
...
:::image type="content" source="../media/select-overview-54e6c0cf.png" alt-text="Screenshot shows where you can select Overview.":::
...
:::image type="content" source="../media/graph-chart-ccdc19ad.png" alt-text="Screenshot shows the App usage for a one month period.":::


If you want to, you can set the focus on a specific application.

:::image type="content" source="../media/single-app-usage-graph-3002f248.png" alt-text="Reporting":::
