...
:::image type="content" source="../media/select-azure-active-directory.png" alt-text="Screenshot of the Select Azure Active Directory screen, so you can modify Azure AD settings.":::
