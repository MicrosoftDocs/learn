...
:::image type="content" source="../media/groups-1-50fac818.png" alt-text="Screenshot of the Azure A D view all groups page.  It shows a list of several groups that already exist, along with attributes about group like Group Type and Membership Type.":::
