...
:::image type="content" source="../media/groups-1-87fedea7.png" alt-text="View all groups in Azure AD":::
...
:::image type="content" source="../media/sc300-dynamic-groups-6559e839.png" alt-text="Screenshot of the Dynamic Group membership rule generator.  In this dialog you can add rules to let you define exactly what users can be a part of the group.  You could set up a rule that includes on members from a specific country.":::
