...
:::image type="content" source="../media/groups-1-50fac818-939b28e2.png" alt-text="Screenshot of the Microsoft Entra ID view all groups page.  It shows a list of several groups that already exist, along with attributes about group like Group Type and Membership Type.":::
...
:::image type="content" source="../media/sc300-dynamic-groups-1e66a2ce-28a60b5d.png" alt-text="Screenshot of the Dynamic Group membership rule generator.  In this dialog you can add rules to let you define exactly what users can be a part of the group.  You could set up a rule that includes on members from a specific country.":::
