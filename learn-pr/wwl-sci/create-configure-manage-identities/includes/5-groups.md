...
:::image type="content" source="../media/groups-1-50fac818-939b28e2.png" alt-text="Screenshot of the Microsoft Entra ID view all groups page. Shows a list of several groups.":::
...
:::image type="content" source="../media/sc300-dynamic-groups-1e66a2ce-28a60b5d.png" alt-text="Screenshot of the Dynamic Group membership rule generator. Set up a rule that includes members from a specific place.":::
