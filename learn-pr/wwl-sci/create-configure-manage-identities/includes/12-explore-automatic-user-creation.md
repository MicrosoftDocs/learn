...
The key, is keeping you identity systems up to date.  If a user can be automatically deprovisioned from Azure AD, as soon as they are removed from your HR-systems; you have less worry on a possible breach.
