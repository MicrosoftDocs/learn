:::image type="content" source="../media/custom-security-attributes.png" alt-text="Screenshot from Azure AD new feature Custom Security Attributes.  You get to the feature in the base menu of Azure AD.  You have the ability to create new security attributes of type String, Integer, or Boolean.":::
