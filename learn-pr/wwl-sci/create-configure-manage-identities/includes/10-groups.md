...
You can view all groups through the **Groups** item under the **Manage** group from the Microsoft Entra dashboard. A new Microsoft Entra ID install won't have any groups defined.

:::image type="content" source="../media/groups-1-50fac818-0b5dfae2.png" alt-text="Screenshot of the Microsoft Entra ID view all groups page.  It shows a list of several groups that already exist, along with attributes about group like Group Type and Membership Type.":::
