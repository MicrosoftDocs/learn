<a name='remove-a-user-from-azure-active-directory'></a>

## Remove a user from Microsoft Entra ID

1.  Browse to Microsoft Entra ID in the [Azure portal](https://portal.azure.com/).
...
3.  In the **Users** list, select the check box for a user that will be deleted. For example, select **Chris Green**.
    ...
    :::image type="content" source="../media/remove-user-8ee7c315-84ab7f6c.png" alt-text="Screenshot of Microsoft Entra all users' list with one user check box selected and another check box highlighted indicating the ability to select multiple users from the list.":::
