...
Much like a passport, digital certificates have a short lifespan, which tends to be one year, after which, the certificate expires. When that happens, you'll see a warning messages about expired certificates when visiting some websites. Which means the authentication of the server can't be confirmed.
