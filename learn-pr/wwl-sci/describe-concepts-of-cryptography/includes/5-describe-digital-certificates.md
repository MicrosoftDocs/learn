...
Previously, we shared an example of Quincy and Monica wanting to share secure ciphertext messages in the encryption unit. While Asymmetric encryption supports this and creates confidence that the ciphertext is safe, there is another consideration.
...
To prevent this, instead of using a key pair that Quincy originally used, he uses a certification authority (CA) to create a digital certificate that links his identity with the CA-generated key pair.
