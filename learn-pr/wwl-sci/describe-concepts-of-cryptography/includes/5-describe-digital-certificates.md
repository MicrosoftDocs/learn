...
:::image type="content" source="../media/digital-certificates-step-2-inline.png" lightbox="../media/digital-certificates-step-2-expanded.png" alt-text="The site has a valid certificate issued by a trusted authority. Information is securely sent to the site and can't be intercepted.":::
