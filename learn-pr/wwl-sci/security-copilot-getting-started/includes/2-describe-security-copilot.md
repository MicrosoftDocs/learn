...
:::image type="content" source="../media/copilot-standalone-landing-page-prompt-bar-v2.png" lightbox="../media/copilot-standalone-landing-page-prompt-bar-v2.png" alt-text="Diagram that shows the landing page for the Microsoft Copilot for Security standalone experience. The prompt bar is at the bottom center of the page.":::
