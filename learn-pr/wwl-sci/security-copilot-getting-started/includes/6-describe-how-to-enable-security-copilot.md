...
To add the recommended Microsoft Security roles group, the Everyone group must be removed. Both groups can't be included as a Copilot contributor at the same time.
