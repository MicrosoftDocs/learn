Identity governance is about balancing identity security with user productivity in a way that can be justified and audited. Identity protection is about detecting and remediating identity-based risks and potential vulnerabilities.
