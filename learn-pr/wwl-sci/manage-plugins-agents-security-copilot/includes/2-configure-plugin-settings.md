...
:::image type="content" source="../media/plugin-permission-dependency.png" alt-text="Diagram of the Security Copilot plugin permission dependency: user-scope must be set to Owners and Contributors before organization-scope permissions become available.":::
...
:::image type="content" source="../media/plugin-control-options-update.png" alt-text="Screenshot of the user-scope and organization-scope plugin permissions configuration in Security Copilot.":::
