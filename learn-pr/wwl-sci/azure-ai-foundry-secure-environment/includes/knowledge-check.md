A cloud security engineering team at Contoso Ltd. is preparing to secure a shared Microsoft Foundry resource that supports several AI development projects. The resource connects to Azure services such as Storage, Key Vault, and model endpoints.
