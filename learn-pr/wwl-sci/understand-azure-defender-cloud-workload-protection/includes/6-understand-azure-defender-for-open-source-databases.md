...
This Microsoft Defender plans brings threat protections for the following open-source relational databases:
...
### Security alerts for open-source relational databases
