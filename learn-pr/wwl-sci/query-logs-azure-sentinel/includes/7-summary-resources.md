You should have a basic understanding of the provided tables and their intended purpose in Azure Sentinel.

You should now be able to:

- Use the Logs page to view tables in Azure Sentinel
- Query the most used tables in Azure Sentinel
