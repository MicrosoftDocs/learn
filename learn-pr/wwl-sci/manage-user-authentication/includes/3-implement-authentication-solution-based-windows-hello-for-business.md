...
:::image type="content" source="../media/authentication-flow-2bf3e07f.png" alt-text="How authentication works in Windows Hello":::
...
:::image type="content" source="../media/sc300-pluton-4e022b1c.png" alt-text="Diagram showing how the new Microsoft Pluton CPU chip on the motherboard next to the CPU and TPM chips.":::
