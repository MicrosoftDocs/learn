...
Licensing requirements:
 ...
 -  Cloud based accounts - A user has to be enrolled into self-service password reset, and that an Microsoft Entra ID Premium P1 or P2 license or a Microsoft 365 Business Standard license is required.
 -  On-premises accounts - A user has to be enrolled into self-service password reset, and that an Microsoft Entra ID Premium P1 or P2 license or a Microsoft 365 Business Premium license.
