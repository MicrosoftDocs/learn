...
To learn more about some of the topics we've examined in this module, check out the following links to documentation.
 ...
 -  [Configure and enable users for SMS-based authentication using Azure Active Directory (preview)](/azure/active-directory/authentication/howto-authentication-sms-signin)
