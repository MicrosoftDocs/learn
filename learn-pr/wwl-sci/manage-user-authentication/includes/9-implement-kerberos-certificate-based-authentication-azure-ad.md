...
:::image type="content" source="../media/kerberos-authentication.png" alt-text="Diagram of the authentication process flow with Kerberos is configured for Application Proxy authentication.":::
