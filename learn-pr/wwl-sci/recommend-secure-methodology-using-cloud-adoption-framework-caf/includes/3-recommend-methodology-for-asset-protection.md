...
This dynamic affects all parts of security, including [security operations](/azure/cloud-adoption-framework/secure/security-operations), [access control](/azure/cloud-adoption-framework/secure/access-control), and particularly DevSecOps in [Innovation security](/azure/cloud-adoption-framework/secure/innovation-security).
...
Isolation itself is considered access control, even though the assets that can't be secured are identified as part of asset protection. For more information, see [Avoid firewall and forget](/azure/cloud-adoption-framework/secure/access-control).
