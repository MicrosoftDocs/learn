...
1. In the Add assignments pane, on the **Membership** tab, review the settings.
1. Select the **Select role** menu and then select **Compliance Administrator**. You can use the **Search role by name** filter to help located a role.
...
1. In the Add assignments screen, select **Next**.
...
1. In the My roles pane, review the list of eligible assignments.
...
1. In the Activate – Compliance Administrator pane, select **Additional verification required,** and then follow the instructions to provide extra security verification. You're required to authenticate only once per session.
...
1. After you've completed the security verification, in the Activate – Compliance Administrator pane, in the **Reason** box, enter the justification for activating this role.
1. Select **Activate**.
...
1. In the Roles pane, on the top menu, select **+ Add assignments.**
1. In the Add assignments screen, select the **Select role** menu, and then select **User administrator.**
1. Select the **Scope type** menu and review the available options. For now, you'll use the **Directory** scope type.
    
    > [!TIP]
    > Go to [Manage administrative units in Azure Active Directory](/content/dam/wwl/learn-paths/sc-300/azure/active-directory/roles/admin-units-manage.html) to find more information about the administrative unit scope type.
1. Similar to assigning a role without a restricted scope. Add members, and complete the settings options. For now, select **Cancel**.
