...
:::image type="content" source="../media/privileged-groups-assignments.png" alt-text="Screenshot of the Azure Privileged Identity Manager with the Groups Assignments page open.":::
