...
1.  In the Role setting details page, on the top menu, select **Edit**.
    ...
    :::image type="content" source="../media/privileged-identity-management-edit-compliance-role.png" alt-text="Screenshot of the top portion of the Role setting details -Compliance Administrator page with Edit highlighted.":::
...
4.  In the Select a member pane, select your administrator account, and then select **Select**.
    ...
    :::image type="content" source="../media/privileged-identity-management-add-approver.png" alt-text="Screenshot of the edit role settings blade and select a member pane with the selected members highlighted.":::
