...
:::image type="content" source="../media/prompt-response-actions.png" lightbox="../media/prompt-response-actions.png" alt-text="Screen capture showing the information a user can provide for a response that needs improvement.":::
