...
- [Use data loss prevention policies for non-Microsoft cloud apps](/purview/dlp-use-policies-non-microsoft-cloud-apps?azure-portal=true)

- [Data policies in Power Platform](/power-platform/admin/wp-data-loss-prevention?azure-portal=true)

- [File policies in Microsoft Defender for Cloud Apps](/defender-cloud-apps/data-protection-policies?azure-portal=true)
