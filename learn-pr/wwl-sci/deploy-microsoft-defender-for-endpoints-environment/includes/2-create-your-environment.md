When accessing Microsoft Defender Security Center ([https://securitycenter.windows.com](https://securitycenter.windows.com/)) for the first time, a wizard will guide you through some initial steps. You must be a global administrator or security administrator for the tenant. On the Set up preferences page, you can set the:
