...
:::image type="content" source="../media/defender-containers-architecture.png" alt-text="Diagram of Defender for Containers architecture. Includes registry scanning, admission control, and runtime sensors." lightbox="../media/defender-containers-architecture.png":::
