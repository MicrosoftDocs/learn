...
2. Run the [`Test-Setup-Config.ipynb`](https://github.com/v-rajagt/learn-pr/blob/master/learn-pr/reactors/includes/set-up-environment.md
) file to ensure you're ready to continue through the module.
