...
2. Run the [`Test-Setup-Config.ipynb`](https://github.com/microsoft/Reactors/blob/main/Learn/Intro-python-data-science/Test-Setup-Config.ipynb) file to ensure you're ready to continue through the module.
