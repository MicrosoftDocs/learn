...
:::image type="content" source="..\media\ppgdp-lifeexpf-purban-3d.svg" alt-text="Scatter plot output for GDP per capita, percent urbanized, and life expectancy.":::
...
:::image type="content" source="..\media\ppgdp-lifeexpf-purban-3d-model-linear-regression.svg" alt-text="Scatter plot output that shows a linear model for GDP per capita, percent urbanized, and life expectancy.":::
...
:::image type="content" source="..\media\ppgdp-lifeexpf-purban-3d-model-polynomial.svg" alt-text="Scatter plot output that shows a polynomial model for GDP per capita, percent urbanized, and life expectancy.":::
