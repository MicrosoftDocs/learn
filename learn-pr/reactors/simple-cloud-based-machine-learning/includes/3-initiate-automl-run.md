From inside Azure Machine Learning Studio, create an AutoML experiment and initiate a set of runs to determine the most accurate machine learning model.

1. Select **Automated ML** and create a new Automated ML.
...
1. Configure the run experiment.
   ...
   1. Choose an experiment named **ms-learn-exp**.
   1. Select **y** as the target column.
   1. Create a new compute cluster called **ms-learn-compute**.

1. Choose **Classification** as the task type.

1. After the run completes, select **Models** to see the most accurate model. The **VotingEnsemble** model is the best with 90.85 accuracy.
