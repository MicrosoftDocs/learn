...
:::image type="content" source="../media/matplotlib-scatter-1.svg" alt-text="Screenshot shows scatter plot output with dramatic correlation.":::
***
...
<details>
  ...
  :::image type="content" source="../media/matplotlib-scatter-2.svg" alt-text="Screenshot shows scatter plot output with problematic correlation.":::
  ***
