...
In that case, you can use a programming language called [Solidity](https://solidity.readthedocs.io/) to code how your supply chain, online marketplace, or other use case operates and what actions participants can take. By programming these actions allowed on the network, you can create your own blockchain networks that are secure and transparent for all participants involved.
