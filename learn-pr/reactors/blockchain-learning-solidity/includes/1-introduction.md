...
In that example, you can use a programming language called [Solidity](https://solidity.readthedocs.io/?azure-portal=true) to code the operation of your supply chain, online marketplace, or other use cases. By using Solidity, you can also specify user actions. By programming these actions allowed on the network, you are able to create your own blockchain networks that are secure and transparent for all participants involved.
