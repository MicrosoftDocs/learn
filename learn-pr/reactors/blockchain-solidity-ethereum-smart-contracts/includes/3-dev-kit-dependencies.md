...
- To install Node, visit the [Node.js downloads page](https://nodejs.org/download/?azure-portal=true). Select the installer for your platform

   :::image type="content" source="../media/node-download.png" alt-text="Download Node":::
...
- Visit the [Git downloads page](https://git-scm.com/downloads?azure-portal=true) and select your platform. Follow the instructions to download Git.
