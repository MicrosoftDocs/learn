...
:::image type="content" source="media\metamask-balance-after-deploy-to-ropsten.png" alt-text="Screenshot showing the MetaMask balance after deploying to Ropsten.":::
