...
There is a [Corda VS https://github.com/corda/vscode-corda) which supports Corda development. From VS Code, go to the **Extensions** icon, select the icon, and then enter **Corda** to install the extension.
