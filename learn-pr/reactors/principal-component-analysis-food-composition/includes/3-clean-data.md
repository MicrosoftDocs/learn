...
:::image type="content" source="../media/correlation-2.png" alt-text="Screenshot that shows the results of running nutr_df.drop and nutr_df.head, in table format." lightbox="../media/correlation-2.png" loc-scope="Azure":::
