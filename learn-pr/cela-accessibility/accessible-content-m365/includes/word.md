...
3. Select **Home** > **Styles** (or press <kbd>Alt</kbd> + <kbd>H</kbd>, then <kbd>L</kbd>), then select the heading level you want, such as the **Heading 1** button.
...
:::image type="content" source="../media/heading-1-heading-2.png" alt-text="Screenshot of the Heading 1 and Heading 2 buttons highlighted in Word Home ribbon.":::
...
:::image type="content" source="../media/alt-text-decorative.png" alt-text="Screenshot of the Mark as decorative option selected in the Alt Text window.":::

To add alt text to an image:

1. Right-click or press the applications key when focused on an image or object and select **View Alt Text**.
2. Enter a description of the image in the **Alt Text** field or approve the AI-created alternative text.
...
2. From the **Insert** tab, select **Links** > **Link** > **Insert Link** (or press **Ctrl** + **K** to open the **Insert Hyperlink** dialog).
...
:::image type="content" source="../media/bullets-and-numbering.png" alt-text="Screenshot of the Bullets and Numbering list options highlighted in the Paragraph section of the Word Home tab.":::
