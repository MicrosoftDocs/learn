...
Slide titles allow for easy navigation of slides. They give context to each slide and provide the audience an understanding of the slide content. When moving through slides in Slide Show mode, slide titles are announced by screen readers. To make a presentation accessible for screen reader users, every slide needs a title and each slide title should be unique.
...
:::image type="content" source="../media/missing-slide-title.png" alt-text="Screenshot that shows the Accessibility Checker with the 'Missing slide title' drop-down menu highlighted.":::
...
The layout and design of PowerPoint content is not described as a whole by a screen reader. If you use a complicated slide layout, someone using a screen reader or someone with a cognitive disability may have difficulty understanding how the content is being presented. Choose layouts that are simple and easy to follow, and group items to make them easier for screen readers to navigate. For example, SmartArt provides pre-formatted charts and graphics to help you make your content simple to understand.
