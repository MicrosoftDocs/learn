...
:::image type="content" source="../media/axes-options.png" alt-text="Screenshot shows Axes expanded under Add Chart Element from the toolbar. Primary Horizontal, Primary Vertical and More Axis Options is displayed for Axes.":::
