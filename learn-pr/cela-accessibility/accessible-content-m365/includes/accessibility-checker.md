...
:::image type="content" source="../media/AccessibilityChecker.png" alt-text="Screenshot showing the Accessibility Checker reminder in the Microsoft Word Status Bar":::
...
:::image type="content" source="../media/AltTextError.png" alt-text="Accessibility Checker in Word showing an error for missing alternative text":::
...
:::image type="content" source="../media/CheckAccessibility.png" alt-text="Check Accessibility button highlighted in Word":::
...
:::image type="content" source="../media/CheckAccOutlook.png" alt-text="Check Accessibility button highlighted in Outlook":::
