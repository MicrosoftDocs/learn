...
:::image type="content" source="../media/LargeText.png" alt-text="People viewing large text on a computer screen":::
...
:::image type="content" source="../media/ThreeDescriptiveLinkNames.png" alt-text="Web page with a series of three descriptive link names":::

Figure 3. Series of descriptive link names

**Inaccessible links example:**

:::image type="content" source="../media/ThreeNondescriptiveLinkNames.png" alt-text="Web page with a series of three descriptive link names":::
...
:::image type="content" source="../media/ExamplesOfNontextElements.png" alt-text="Example of non-text elements requiring and not requiring descriptive alternative text attributes":::
