...
:::image type="content" source="../media/microsoft-teams-1.png" alt-text="The box for a Microsoft Service device. It is empty and a documentation envelope in the box is visible.":::
...
:::image type="content" source="../media/microsoft-teams-2.png" alt-text="The box for a Microsoft Service device. The empty cable box is displayed prominently.":::
...
:::image type="content" source="../media/series-s-cavity-1.png" alt-text="The Xbox Series X packaging, opened and empty. Two orange circles highlight a section inside the packaging as well as on the front of the packaging.":::

:::image type="content" source="../media/series-s-cavity-2.png" alt-text="The Xbox Series X packaging, opened with a console inside. Two orange circles highlight a section inside the packaging as well as on the front of the packaging.":::
