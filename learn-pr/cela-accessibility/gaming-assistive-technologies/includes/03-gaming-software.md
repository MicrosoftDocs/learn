Gaming assistive technologies can also include software programs, settings, or features. These technologies can be provided by individual game titles or game platforms; they may also exist as third-party software programs that players purchased separately.
...
1. When developing game titles, it is important to assess whether or not assistive tools are supported by the platform(s) your title will ship on. If these tools are available at the platform level, are players able to leverage them in your title specifically? Either way, you should consider providing these tools at the game title level. This will ensure that regardless of the platform a player is on, these tools will provide a more accessible experience.
2. When developing gaming platforms or platform features, it is important to assess whether or not the platform provides these assistive tools. If players cannot navigate the platform because it is not accessible, they will not be able to launch the games, applications, and other aspects of the platform that they wish to use. Additionally, platform developers can assess whether the assistive tools provided are accessible for game titles to leverage. For example, if a player has screen narration turned on at the platform level, are game titles able to access this information and enable screen narration upon game title launch as well?
