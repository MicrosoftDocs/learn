You’ve learned about the common hardware-based assistive technologies used in gaming. Next, you’ll learn about common software-based assistive technologies used by players with disabilities.

As you learn about these technologies, think about how developers can support the needs of players who use them. For example, can efforts be made at the platform or game title level to support compatible third-party software programs?

## What are the common types of software assistive technologies used in gaming?

Depending on the technology, platform or title, developers may need to create their software with similar capabilities to support players use of assistive technologies to access game experiences. The following software-based programs and tools are used by players with disabilities to access technology in gaming contexts:
