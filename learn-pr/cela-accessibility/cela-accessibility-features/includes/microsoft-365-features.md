...
If you receive a message in another language, just go to the top of the message and select **More options** :::image type="content" source="../media/more-options.png" alt-text="More options button"::: > **Translate** to get an instant translation of the message into the language you\'ve set for Teams.
...
While setting up your video and audio before joining a meeting, select **Background effects** :::image type="content" source="../media/background-effects.png" alt-text="Background settings"::: next to the mic switch and choose **Blur** to blur your background.
...
To launch Immersive Reader from a Teams message, hover over a message with your cursor or tap with your finger on a touch screen device. Select **More options** :::image type="content" source="../media/more-options2.png" alt-text="More options icon":::, and then **Immersive Reader** :::image type="content" source="../media/immersive-reader.png" alt-text="Immersive Reader icon":::.
