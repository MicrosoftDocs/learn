Intune uses Microsoft Entra groups to manage devices and users effectively. As an Intune administrator, you can set up groups tailored to your organization’s needs, organizing users or devices by geographic location, department, or hardware characteristics. This strategic grouping simplifies management tasks, enabling you to apply policies or configurations to specific sets of users or devices efficiently.

For instance, creating groups based on departments allows you to deploy department-specific applications seamlessly. Similarly, organizing devices by hardware characteristics ensures targeted updates and policies, enhancing security and functionality. By using these groups, you can manage tasks at scale, such as rolling out security policies to multiple users or deploying new software across several devices with minimal effort. This approach not only saves time but also ensures consistency and compliance across your organization’s IT infrastructure.
...
2. Select **Groups** > **New group**:
   ...
   :::image type="content" source="../media/groups-add-new.png" alt-text="Screenshot that shows the Azure portal with New Group selected."  lightbox="../media/groups-add-new.png":::
...
5. Enter the **Membership type**. Your options:
    ...
    - **Dynamic Device**: Administrators create dynamic group rules to automatically add and remove devices.
      ...
      :::image type="content"  source="../media/groups-add-properties.png" alt-text="Screenshot that shows Intune group properties.":::
...
You can also use [device categories](/mem/intune/enrollment/device-group-mapping) to automatically join devices to groups when they enroll.
...
- [Performance recommendations for Grouping, Targeting and Filtering in large Microsoft Intune environments](/mem/intune/fundamentals/filters-performance-recommendations)