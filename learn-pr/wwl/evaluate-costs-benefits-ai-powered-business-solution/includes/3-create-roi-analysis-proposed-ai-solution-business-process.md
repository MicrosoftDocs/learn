...
Admins can disable moneybased savings; if so, keep tracking _time_ and convert to currency in your ROI workbook.

Add or edit the Savings panel on the agent's **Analytics** page to keep the model current. 
