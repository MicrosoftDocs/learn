...
1. In the URL bar, enter `https://github.com/MicrosoftLearning/MSLearn-Read-and-Write-Files-in-C-Sharp.git`
...
1. In Explorer, expand the **M04-Guided-Project** folder.

1. Expand the **Langstons-Ant** folder.

    You should see a Game folder and a Program.cs file.

1. Right-click the **Langstons-Ant** folder and click **Open in Integrated Terminal**.
