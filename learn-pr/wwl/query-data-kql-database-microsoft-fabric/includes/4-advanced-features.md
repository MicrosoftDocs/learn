...
![Image of command to create materialized view with its results and a display of the columns after it's created](../media/materialized-view.png)
...
![Image of a rendered time chart by number of trips and date](../media/render-timechart.png)
...
![Image of a rendered time chart by number of trips and date](../media/render-columnchart.png)
