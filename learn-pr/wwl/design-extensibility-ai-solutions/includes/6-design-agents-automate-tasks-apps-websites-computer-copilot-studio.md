...
- It analyzes the UI by using vision and reasoning.
...
### D. Human-like reasoning is needed
...
- Use descriptive instructions, such as "Click the blue 'Submit' button."
...
- Ensure transparency so users know what the agent is doing.
