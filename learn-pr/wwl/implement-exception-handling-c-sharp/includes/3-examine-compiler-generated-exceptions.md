...
- `StackOverflowException`: Thrown when the execution stack is exhausted by having too many pending method calls; usually indicates a deep or infinite recursion.
