...
> [!NOTE]
> For more detailed information on the content certification process, see [Certify Fabric content](https://github.com/MicrosoftDocs/fabric-docs-pr/blob/release-public-preview/docs/governance/endorsement-certify.md).
...
> [!IMPORTANT]
> Before metadata scanning can be run, it needs to be set up in your organization by an Admin. For more information, see [Set up metadata scanning](https://github.com/MicrosoftDocs/fabric-docs-pr/blob/release-public-preview/docs/governance/metadata-scanning-setup.md).
