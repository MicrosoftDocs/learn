...
## Designing high-quality prompt actions

### Use the Prompt Coach template
...
- Increase predictability and reduce incorrect information
...
### Principles for effective prompt actions
...
## Embedding prompt actions in Copilot Studio
...
## Best practices for designing prompt actions
