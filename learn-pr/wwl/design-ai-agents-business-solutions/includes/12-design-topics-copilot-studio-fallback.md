...
## 1. Introduction to topics in Copilot Studio
...
## 5. Chart: Topic types in Copilot Studio
...
| System Topic | Handles system level eventslevel events | Greeting, escalation, fallback |
| Reusable Topic | Shared logic across topics | Authentication |

## 6. Best practices for topic and fallback design
