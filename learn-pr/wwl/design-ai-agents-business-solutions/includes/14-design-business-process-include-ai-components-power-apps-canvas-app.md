...
|---|---|---|
| **Data Capture** | AI-generated form fields | Reduce manual build time |
| **Evaluation / Decision** | Copilot suggestions | Improve decision quality |
| **Document/Record Creation** | AI-generated text | Faster, consistent output |
| **Navigation & Help** | Copilot assistant | Reduce training effort |
...
- [Edit your app with Copilot in Power Apps Studio (preview)](/power-apps/maker/canvas-apps/ai-edit-app)

- [Use plans to create a business solution with Copilot](/power-apps/maker/plan-designer/build-solution)
