...
Intune Advanced Analytics features build on top of the existing base Endpoint analytics experience. You must onboard and enroll your Intune-managed devices to Endpoint analytics to use the advanced features.
...
In addition to license requirements for Endpoint analytics, an add-on license is required to use features in Intune Advanced Analytics.
