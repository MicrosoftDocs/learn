...
Visual Studio Code supports code debugging in most software development languages and runtimes (including PHP, Ruby, Go, C#, Python, C++, PowerShell and many others) through the use of Extensions. You can find Debugger extensions in the Visual Studio Code Marketplace.
...
In this module, you'll learn how to effectively debug C# programs in Visual Studio Code. The faster you can find and identify bugs, the faster you can get your code stabilized and released. Once you've learned to use Visual Studio Code's debug tools, you'll spend less time scratching your head and wondering why your code worked five seconds ago but doesn't work now.
...
Ultimately, you'll be able to isolate code bugs efficiently using the debugger tools, and you won't need to rely only on `Console.WriteLine` anymore.
