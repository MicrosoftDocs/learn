...
In this challenge, you're provided with a code sample that is not producing the expected result. You need to use breakpoints and the VARIABLES section of the RUN AND DEBUG view to help you figure out the issues.
