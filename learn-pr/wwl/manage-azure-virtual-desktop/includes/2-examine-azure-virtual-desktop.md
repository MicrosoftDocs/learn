...
Azure Virtual Desktop offers familiar management tools for Azure administrators, such as Azure Active Directory, role-based access controls, automated VM deployments, VM updates, and disaster recovery. It also utilizes Azure Monitor for monitoring and alerts.
