...
:::image type="content" source="../media/activator.png" alt-text="Screenshot of the Activator canvas in Microsoft Fabric showing the rule definition interface with events, objects, and rules." :::
