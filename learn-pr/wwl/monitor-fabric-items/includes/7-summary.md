...
With these tools, you can build a monitoring strategy that catches failures early, surfaces performance trends, and ensures the right people are notified when something goes wrong.

> [!TIP]
> For more information, see:
> - [Use the monitoring hub](/fabric/admin/monitoring-hub)
> - [What is workspace monitoring?](/fabric/fundamentals/workspace-monitoring-overview)
