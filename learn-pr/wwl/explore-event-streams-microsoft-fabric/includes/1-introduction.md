When your company chooses Microsoft Fabric for real-time analytics (RTA), the first step is seamlessly ingesting data into your Fabric lakehouse. Eventstreams is a Microsoft Fabric feature that lets you handle real-time events without coding. You can set up event sources, destinations, and processors in the eventstream. Event processing is another option within eventstream for collecting and aggregating, filtering, grouping, transforming, expanding, and joining other events from Microsoft Fabric eventstreams for extra insights into the in-flight data.

eventstream main editor is the primary interface for setting up Fabric eventstreams and can be used to:
