...
- **Dashboard tile authoring**: Copilot is also available directly inside Real-Time Dashboard tile editing. You can describe what you want to visualize in plain language, and Copilot generates or refines the KQL query without you needing to switch to a separate queryset.
