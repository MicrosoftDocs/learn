...
**Data source integration** means you don't have to worry about where your data lives. Whether your information is in lakehouses, warehouses, KQL databases, Power BI semantic models, or ontologies, Fabric data agents can connect and pull insights from all these sources. If you've ever struggled to combine data from multiple systems, this feature streamlines the process and saves you time.
...
**Integration with external systems** extends the agent's use beyond Fabric. If you need to collaborate in Microsoft Teams or automate workflows with Copilot Studio, Microsoft Foundry, or Azure AI Agent Service, the agent can connect with these tools. This can help with sharing insights, building multi-agent solutions, and automating tasks across your organization.
