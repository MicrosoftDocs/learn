...
|:---:|---|
| ![Icon for shift left](../media/5-2-shift.png)</br>**Shift left** | **Shift left** means to anticipate security activities and conduct them earlier in the software delivery process instead of downstream from the process. Studies have demonstrated that fixing bugs earlier in the development cycle has a significant impact on costs and losses. |
| ![Icon for automation](../media/5-2-automation.png)**Automation**          | **Automation** of repetitive actions is key to helping reduce the possibility of mistakes. This approach allows tasks and processes that are typically infrequent, such as deployment, to be conducted more frequently. |
| ![Icon for continuous improvement](../media/5-2-ci.png)**Continuous improvement** | **Continuous improvement** is achieved through analysis of current behaviors and identification of possibilities for optimization.                                                                                                                                                                             |
