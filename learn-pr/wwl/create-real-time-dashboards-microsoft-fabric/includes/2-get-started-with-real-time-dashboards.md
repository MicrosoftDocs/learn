...
![Edit and View reports](../media/edit-view-rtd.png)
...
![Create Tool Bar in RTI](../media/real-time-intelligence-services.png)
...
![New Real-Time Dashboard](../media/new-real-time-dashboard.png)
...
![Data sources](../media/data-source.png)
...
1. In the ***Query pane***
    ...
    ![Adding a tile to the dashboard](../media/adding-tile.png)
...
1. We can now add a visual by going into the ***Visual formatting tab*** by selecting ***Add visual***.
    ...
    ![Adding a visual for the tile based on KQL query](../media/adding-visual.png)
...
1. When you're happy with the visualization and the formatting of it, select ***Apply Changes*** to add more visualizations, adjust its size, or rearrange your visualization on the canvas.
    ...
    ![Viewing the visualization when completed](../media/adjust-visual-on-canvas.png)
