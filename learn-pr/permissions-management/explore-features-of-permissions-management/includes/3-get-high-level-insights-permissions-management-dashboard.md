...
:::image type="content" source="../media/permissions-management-dashboard.png" alt-text="Screenshot of the Permissions Management dashboard."lightbox="../media/permissions-management-dashboard.png":::
...
:::image type="content" source="../media/permissions-management-bubble-data.png" alt-text="Screenshot showing a closer look at the Permissions Management PCI bubble information."lightbox="../media/permissions-management-bubble-data.png":::
...
**Microsoft Azure**
:::image type="content" source="../media/permissions-management-pci-score-azure.png" alt-text="Screenshot showing a closer look at the Permissions Management PCI score information in a Microsoft Azure environment."lightbox="../media/permissions-management-pci-score-azure.png":::

**Amazon Web Service (AWS)**
:::image type="content" source="../media/permissions-management-pci-score-aws.png" alt-text="Screenshot showing a closer look at the Permissions Management PCI score information in an Amazon Web Services (AWS) environment."lightbox="../media/permissions-management-pci-score-aws.png":::

**Google Cloud Platform (GCP)**
:::image type="content" source="../media/permissions-management-pci-score-gcp.png" alt-text="screenshot showing closer look at the Permissions Management PCI score information in a Google Cloud Platform environment."lightbox="../media/permissions-management-pci-score-gcp.png":::
...
:::image type="content" source="../media/permissions-management-findings-snapshot.png" alt-text="Screenshot showing a snapshot of Permissions Management findings for identities."lightbox="../media/permissions-management-findings-snapshot.png":::
...
:::image type="content" source="../media/permissions-management-inactive-identities-snapshot.png" alt-text="Screenshot showing a snapshot of Permissions Management Inactive Identities."lightbox="../media/permissions-management-inactive-identities-snapshot.png":::
