...
:::image type="content" source="../media/permissions-management-custom-roles.png" alt-text="Screenshot of the Permissions Management Creating Custom Roles view."lightbox="../media/permissions-management-custom-roles.png":::
...
:::image type="content" source="../media/permissions-management-custom-roles-tasks.png" alt-text="Screenshot of the Permissions Management Creating Custom Roles task tab."lightbox="../media/permissions-management-custom-roles-tasks.png":::
...
:::image type="content" source="../media/permissions-management-roles-policies.png" alt-text="Screenshot of the Permissions Management Roles and Policies tab."lightbox="../media/permissions-management-roles-policies.png":::
...
:::image type="content" source="../media/permissions-management-quick-actions-users.png" alt-text="Screenshot of the Permissions Management Quick Actions to manage users."lightbox="../media/permissions-management-quick-actions-users.png":::
...
:::image type="content" source="../media/permissions-management-remediation-automation-autopilot.png" alt-text="Screenshot of the Permissions Management automating remediation tasks."lightbox="../media/permissions-management-remediation-automation-autopilot.png":::
...
:::image type="content" source="../media/permissions-management-request-roles-user.png" alt-text="Screenshot of the Permissions Management request roles as a user."lightbox="../media/permissions-management-request-roles-user.png":::
...
:::image type="content" source="../media/permissions-management-schedule-permissions-immediate.png" alt-text="Screenshot of the Permissions Management schedule permissions for a user immediately."lightbox="../media/permissions-management-schedule-permissions-immediate.png":::

:::image type="content" source="../media/permissions-management-schedule-permissions-options.png" alt-text="Screenshot of the Permissions Management schedule permissions for varying timeframes."lightbox="../media/permissions-management-schedule-permissions-options.png":::
...
:::image type="content" source="../media/permissions-management-request-tab-details.png" alt-text="Screenshot of the Permissions Management request tab details."lightbox="../media/permissions-management-request-tab-details.png":::
