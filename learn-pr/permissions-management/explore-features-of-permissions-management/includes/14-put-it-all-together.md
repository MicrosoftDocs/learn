...
:::image type="content" source="../media/permissions-management-dashboard-2.png" alt-text="Screenshot of the Permissions Management dashboard featuring Permissions Creep Index."lightbox="../media/permissions-management-dashboard-2.png":::
...
:::image type="content" source="../media/permissions-management-findings-2.png" alt-text="Screenshot of the Permissions Management findings."lightbox="../media/permissions-management-findings-2.png":::
...
:::image type="content" source="../media/permissions-management-users-walkthrough.png" alt-text="Screenshot of the Permissions Management user view."lightbox="../media/permissions-management-users-walkthrough.png":::

With this information, you can view the Remediation tab of Permissions Management to act on your findings. 

:::image type="content" source="../media/permissions-management-remediation-2.png" alt-text="Screenshot of the Permissions Management Remediation tab."lightbox="../media/permissions-management-remediation-2.png":::
...
:::image type="content" source="../media/permissions-management-new-alert-trigger.png" alt-text="Screenshot of the Permissions Management creating a new alert trigger."lightbox="../media/permissions-management-new-alert-trigger.png":::
