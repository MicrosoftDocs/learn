You’ve founded your first company, FashionFindr, and build a prototype for your first app, which uses AI to identify the brands of clothes from photographs. The prototype is the first pass of your solution. It's not pretty, nor complete, and often not tested. Frank Robinson said when he coined the MVP term:
...
The next step is to get your app in front of potential investors and customers to enable you to grow it into a full-fledged product. Your prototype isn’t complete, so you need to wrap your core concepts into a story that showcases what you have now and what your goals are for the app.
