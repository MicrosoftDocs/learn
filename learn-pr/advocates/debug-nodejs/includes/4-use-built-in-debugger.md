...
A [development container](https://containers.dev/) environment is available to use in the training module with all dependencies required to complete every exercise in this project. You can run the development container in GitHub Codespaces or locally using Visual Studio Code.
