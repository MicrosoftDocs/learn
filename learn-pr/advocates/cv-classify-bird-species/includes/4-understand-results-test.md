...
> [!NOTE]
> In our model, you might not see this warning, especially if you uploaded a fraction of the dataset. Our model Red-tailed Hawk (Dark morph) data subset contains fewer than 60 photos compared to the other model's 114-120 photos. Using unbalanced data is something to watch for in any machine learning model.
