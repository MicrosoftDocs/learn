...
In this Microsoft Learn module, you'll use the Azure Cognitive Services Custom Vision service to create a machine learning model that can identify species in images of birds. We'll use the NABirds dataset from the Cornell Lab of Ornithology (CLO) to train a model to recognize photos of bird species. You can use the model to help you document trends and patterns of bird habits.
