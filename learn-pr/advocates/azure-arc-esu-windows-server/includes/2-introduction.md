You are in IT Operations at Tailwind Traders. You are responsible for managing 150 servers running the Windows Server 2012 R2 operating system that hosts important workloads. The Windows Server 2012 R2 operating system is beyond the end of Microsoft's extended support period. Your organization presently doesn’t have the resources to migrate the workloads hosted on Windows Server 2012 R2 to new servers running Windows Server 2022. As a stopgap measure you would like to take advantage of the extended security update (ESU) program for the Windows Server operating system. When you enable extended security updates, your organization will have access to several years of update support beyond Microsoft's existing extended support window. Enabling ESUs provides your organization with time to migrate workloads to a newer Windows Server platform.
