...
2. In the next dialog, select **App Service** on the left, and **Select Existing** App Service.
3. In the next dialog, make sure the correct App Service name is selected as deployment target.
...
4. Once this is completed, you will have a deployment profile created, and can deploy with one click of a **Publish** button:
