...
:::image type="content" source="../media/system-message.png" alt-text="A screenshot of the Azure AI Studio chat playground. There's a pop-up to select safety system messages." lightbox="../media/system-message.png":::
...
:::image type="content" source="../media/content-filter.png" alt-text="A screenshot of the content filters configuration in Azure AI Studio."  lightbox="../media/content-filter.png":::