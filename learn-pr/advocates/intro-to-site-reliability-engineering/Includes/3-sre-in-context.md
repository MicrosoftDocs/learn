...
- SRE is commonly used as a job title — someone is "an SRE". DevOps is primarily a cultural movement and set of practices; although "DevOps engineer" has become a common job title in the industry (and Microsoft offers a [DevOps Engineer Expert certification](https://learn.microsoft.com/credentials/certifications/devops-engineer/)), the core idea of DevOps describes how teams work together rather than a single role.
