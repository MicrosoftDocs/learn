...
1. Copy the following code into the **index.js** file:
    ...
    :::code language="json" source=""~/../microsoftdocs-node-essentials/nodejs-intro/5-try-esm/index-1.js":::
...
1. Add the following code to the `index.js` file to create an asynchronous HTTP request:
    ...
    :::code language="json" source=""~/../microsoftdocs-node-essentials/nodejs-intro/5-try-esm/top-level-async-await.js":::
