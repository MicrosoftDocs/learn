...
:::image type="content" source="../media/lifecycle-remediation.png" alt-text="Cycle diagram of circles labeled with incident response phases. Circles are connected to next circle with arrows from phase to phase. Detection, Response, and Remediation are highlighted.":::
...
:::image type="content" source="../media/troubleshooting-guide-samples.png" alt-text="Screenshot of example workbook templates as found in the Azure portal.":::
