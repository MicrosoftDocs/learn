...
You will first analyze NASA data log files to understand their content and create a unified data log. Then you will create more complex instructions to transform logs and extract key information from this new log.
...
5. Do basic text transformations on input streams using `sed` and `regex`
