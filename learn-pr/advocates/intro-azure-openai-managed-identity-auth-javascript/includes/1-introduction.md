Good security practices require that you control access to applications that you develop. Developing an application that uses Azure OpenAI in Azure AI Foundry Models is no different. In this module, you learn about configuring authentication to Azure OpenAI by using JavaScript, the available roles in Azure OpenAI, and the benefits of using managed identities over API keys.
