...
:::image type="content" source="../media/composite-test-transparency.png" alt-text="Screenshot that shows the steps to take to debug a Flask app, with a border.":::

:::image type="content" source="../media/composite-test-transparency.png" border="false" alt-text="Screenshot that shows the steps to take to debug a Flask app, without a border.":::
