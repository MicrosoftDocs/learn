...
A responsible bot has a clear goal. For instance, our geography bot might have the goal of assisting students by providing information about capital cities. Before developers start working on the bot, they carefully consider how to communicate that purpose to users. When a bot expresses its purpose and limitations in a responsible way, you can reduce frustration and unmet expectations for your users.
