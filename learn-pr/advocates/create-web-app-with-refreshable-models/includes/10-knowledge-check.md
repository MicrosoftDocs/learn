In this module you learned how to build a Progressive Web App infused with a machine learning model created with Custom Vision AI. Apps can be deployed by using GitHub Actions.
