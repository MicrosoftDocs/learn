...
1. Configure the repository we previously created:
    1. Add the repository URL, for example `git@github.com:<YOUR_USERNAME>/azure-spring-cloud-config.git` or `https://github.com/<YOUR_USERNAME>/azure-spring-cloud-config`.
