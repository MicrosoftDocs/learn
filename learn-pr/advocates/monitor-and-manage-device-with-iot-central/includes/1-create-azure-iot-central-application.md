...
1. On the **New application** page:
    ...
    1. Enter a friendly application name, such as **Coffee Maker 01-A**.

    1. Optionally edit the URL - this is required if the name you selected is already in use.
    
    1. Select **Custom application** as the application template.
