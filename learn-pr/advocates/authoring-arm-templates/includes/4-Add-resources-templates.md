...
For that you go to the **[Define resources in Azure Resource Manager templates](https://docs.microsoft.com/en-us/azure/templates/)** page and in the left side menu find the resource you are trying to deploy. Right now you should be scrolling down to **Storage**.
