...
You've updated the server code to return stocks with SignalR and you've deployed to an Azure Functions App. Next, you'll update the client to use SignalR to receive updates.
