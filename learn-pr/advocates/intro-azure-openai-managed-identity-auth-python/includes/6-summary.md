Now that you've completed this module, you have a comprehensive understanding of how to help secure applications developed in Azure OpenAI in Microsoft Foundry Models by using Python. You learned how to configure authentication, explored the RBAC roles available in Azure OpenAI, and learned about the benefits of using managed identities over API keys.
...
- [Use Azure OpenAI without keys](/azure/developer/ai/keyless-connections?tabs=python%2Cazure-cli)
