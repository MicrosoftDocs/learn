...
In this module, you created resources using your Azure subscription. You need to clean up these resources so that you won't continue to be charged for them. Use the following command to delete all the resources:
