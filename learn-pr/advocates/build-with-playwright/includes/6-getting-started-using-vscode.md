...
[![A youtube video on how to get started with Playwright in VS Code](../media/vscode-youtube.jpeg)](https://youtu.be/Xz6lhEzgI5I)
...
![A screenshot showing how to use the Playwright extension in Visual Studio Code to find specs](../media/vsc-find-specs.png)
...
![A screenshot showing how to run tests in a headless manner in Visual Studio Code](../media/vsc-run-headless.png)
...
![A screenshot showing the history of test executions](../media/vsc-re-run-test-run.png)
...
![A screenshot showing how to run tests in a headed mode using in Visual Studio Code](../media/vsc-see-browser.png)
...
![A screenshot showing the timeline view in a trace viewer window](../media/vsc-trace-viewer-timeline.png)
...
![A screenshot showing the actions performed during the test execution](../media/vsc-trace-viewer-select-action.png)
...
![A screenshot showing selection of an assertion in trace viewer](../media/vsc-trace-viewer-select-assertion.png)
...
![A screenshot showing how to inspect a DOM snapshot while debugging your test](../media/vsc-trace-viewer-dom-snapshot.png)
...
![A screenshot showing you how to use the Pick Locator button](../media/vsc-trace-viewer-pick-locator.png)
...
[![A youtube video showing you how to generate playwright test in Visual Studio Code](../media/tests-in-playwright-vscode-youtube.jpeg)](https://youtu.be/LM4yqrOzmFE)
...
![A screenshot showing how to use the Record test button to generate a test](../media/vsc-record-test.png)
...
![A screenshot showing how to recreate a simple test](../media/vsc-record-test-assertion.png)
