...
You'll use a third-party communications service called Twilio to manage sending and receiving SMS messages, and you'll coordinate app functionality by using Azure Functions.
...
- Deploy an existing application to Azure Functions by using Twilio and Azure Maps to manage and send temperature alerts for specific locations.
