...
In this module, we use the term "post-incident review."
...
- You should try to include _everyone who was
    ...
    important because different people have different perspectives and
    recollections of the same event.
- You should perform the post-incident review _as soon as practical after
    the event is resolved_, ideally within a day or two, if at all possible.
    Human memory is notoriously unreliable; people forget things. The more
    time that passes after an event, the less detailed and specific
    memories tend to be.
