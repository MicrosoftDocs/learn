...
:::image type="content" source="../media/dickerson-hierarchy.svg" alt-text="Pyramid diagram of the Dickerson Hierarchy of Reliability with seven tiers; the Post-incident Review tier is highlighted as this module's focus.":::

From the base up, the seven tiers are:

1. **Monitoring**: You can't improve what you can't see.
1. **Incident Response**: Reliable, repeatable processes to react when alerts fire.
1. **Post-incident Review**: Learning from the incidents that occur (the focus of this module).
1. **Testing and Release**: Catching regressions before they reach production.
1. **Capacity Planning**: Ensuring the system has the resources it needs to meet demand.
1. **Development**: Writing reliable software.
1. **Product**: Building the right thing for users.

This module addresses the tier roughly in the middle of the pyramid.
Having addressed your monitoring and your incident response (perhaps with the
...
In this module, we're focusing on post-incident reviews that can help
...
actually; we get to the second part later in this module):
...
and we don't know exactly how many there were. It was wartime, and many of the details were secret and remains secret. What we do know is that there
were a significant number of similar incidents involving many individual
aircraft. Historical retellings tend to focus on damaged aircraft rather
than serious injuries, but the wartime record is incomplete.
...
hangar, something strange would happen. Something serious would happen. The
B-17 would be on the ground and all of a sudden the landing gear would
retract, and the plane would collapse onto the runway.
...
Here are two additional pieces of information: the investigators were
