...
:::image type="content" source="../media/ai-security-controls-overview.png" alt-text="Diagram showing the seven AI security control areas covered in this module." lightbox="../media/ai-security-controls-overview.png":::
