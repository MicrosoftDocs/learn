...
* [Continuous deployment with custom containers in Azure App Service](https://learn.microsoft.com/azure/app-service/deploy-ci-cd-custom-container?tabs=acr&pivots=container-linux)
