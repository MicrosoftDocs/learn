...
Using components with known vulnerabilities is a huge problem in our industry. It is so problematic that it has made the [OWASP top 10 list](https://owasp.org/www-project-top-ten/) of worst web application vulnerabilities, holding at #9 for several years.
