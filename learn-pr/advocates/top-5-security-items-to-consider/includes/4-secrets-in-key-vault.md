...
Learn more about using an Azure Key Vault in [Manage secrets in your server apps with Azure Key Vault](../../azure/manage-secrets-with-azure-key-vault/index.yml).
