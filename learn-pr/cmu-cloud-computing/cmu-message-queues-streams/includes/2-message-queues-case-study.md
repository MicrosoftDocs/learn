...
- Triggering a rebalance of partitions when the number brokers or consumers change
...
- Each slave must replicate the master’s updates and should not fall "too far" behind. The replica lag is a configurable property in a Kafka cluster.
