...
Cloud object storage is an important facet in cloud storage, and is one of the earliest public cloud computing services to emerge (case in point: Amazon S3). 
...
In this module, you will:
  ...
  - List the common operations in HBase, Cassandra, MongoDB, and DynamoDB.
  - Summarize the architectures of HBase, Cassandra, MongoDB, and DynamoDB.
  - List the use cases of HBase, Cassandra, MongoDB, and DynamoDB.
  - Explain the Amazon S3 and OpenStack Swift cloud object storage data models.
  - Discuss the consistency guarantees provided by S3 and Swift.
