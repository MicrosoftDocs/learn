...
Applications can also extract knowledge for analysis. As an example, Google<sup>[1][^1]</sup> discovered that search trends of certain keywords are highly correlated with physician visits for influenza-like symptoms. This enables Google to publish information about flu trends that is updated daily.
