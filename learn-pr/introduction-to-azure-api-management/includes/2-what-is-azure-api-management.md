...
:::image type="content" source="../media/2-what-is-azure-api-management-overview.png" alt-text="The main components of Azure API Management, including the administration interface, gateway, and developer portal.":::
...
> [!NOTE]
> The pricing for the Consumption tier is per API call, where you get the first million calls free and are then billed a fixed rate per million calls. The pricing for all the other tiers is per hour.
