Code is only as useful as what it's used for. Coding for data science discoveries is becoming more prominent in all aspects of the technical world. It's critical in almost every industry. Maybe you're gathering data about the [Moon to drive space exploration decisions](/training/topics/nasa?azure-portal=true&WT.mc_id=LearnDrG-c9-niner). Or maybe you're being inspired by basketball champion LeBron James to use data to learn more about the sport. Whatever you pursue, you can develop new skills to help you explore what *you* are passionate about.
