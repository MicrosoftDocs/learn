:::image type="content" source="../media/space-jam-a-new-legacy-end-card.png" alt-text="Image that shows the SPACE JAM: A NEW LEGACY logo." border="false":::
...
Inspired by the film, this Microsoft Learn module explores how data can play a significant role in athletic games, specifically in basketball. If you're a sports fan, you know that coaches do more than watch what's happening in the moment of each game. Coaches use what they know about their team and players, what they know about the other team and players, *and* what's happening on a higher level throughout the season to make every decision during a game.
...
- An [Azure account](/training/modules/create-an-azure-account?azure-portal=true)
- A [GitHub account](/training/modules/introduction-to-github?azure-portal=true)
