...
Once the app is running, the debugging controls will appear next to the **Start** button you clicked to launch the app.
...
You can also use Temporary breakpoint if you want to break the code just once. You can apply Temporary breakpoints by right-clicking in the breakpoint column and selecting **Insert temporary breakpoint**. The Temporary breakpoints will be removed after they're hit the first time.
