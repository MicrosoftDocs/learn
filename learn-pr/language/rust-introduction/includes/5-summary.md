...
The Rust Cookbook contains *recipes* for code that follows recommended practices for common programming tasks. By following the recipes, you can learn how to work with commonly used crates in Rust. The recipes cover a wide-range of topics, including processing text and numbers, working with databases, applying common algorithms, and debugging programs. You can read the Rust Cookbook on the [Rust website](https://rust-lang-nursery.github.io/rust-cookbook/?azure-portal=true).
...
- [Rust cookbook](https://rust-lang-nursery.github.io/rust-cookbook/?azure-portal=true)
