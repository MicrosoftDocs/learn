...
Select the extension that's published by Microsoft (usually the first one in the list). The details about that extension appear in a tab in the main area to the right.
