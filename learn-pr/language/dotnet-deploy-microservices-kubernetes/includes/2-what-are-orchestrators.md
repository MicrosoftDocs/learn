...
![Image showing some tasks of orchestration, including dynamic scaling and automatically updating running instances](../media/2-tasks-of-orchestrator.svg)
...
![Image showing the benefits of Kubernetes including that it is self-healing, it can scale dynamically, and has rolling updates](../media/2-kubernetes-benefits.svg)
