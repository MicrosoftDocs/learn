...
> [!TIP]
> The `print()` method is flexible.  It can display the string data type, the int data type and the float data type, and other data types we haven't talked about yet.
