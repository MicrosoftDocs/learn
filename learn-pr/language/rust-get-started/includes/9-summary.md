...
- What types of applications you can build by using Rust.
- Why Rust is useful for both low-level and high-level types of development.
- How to set up your development environment by using `rustup`.
