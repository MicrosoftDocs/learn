In this module, you've built several programs. You learned to declare and use variables to store data. Variables can be declared with or without the type. If it's the former, the type is inferred from the value it's assigned initially.
