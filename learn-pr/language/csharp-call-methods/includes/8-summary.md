...
Using C# syntax, we called different kinds of methods in the .NET Class Library: methods that returned values, methods that accepted multiple input parameters, and methods that maintained state. We used Intellisense and Microsoft Learn to research and better understand what the methods do and how they work.
