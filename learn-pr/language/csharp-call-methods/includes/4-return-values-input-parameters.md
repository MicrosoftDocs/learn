...
One of the top search results should lead to a URL that begins with `https://learn.microsoft.com`. In our case, the link's title should appear as **Random.Next Method (System) | Microsoft Docs**.
