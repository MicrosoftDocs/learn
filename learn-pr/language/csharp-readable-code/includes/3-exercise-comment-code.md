...
Now, run the application. You'll get the following result in the output console:
...
If you run the code, you'll get *No output* in the output console. The C# compiler is now ignoring all of your code.
...
Use the **Run** button or type or copy the following code into the .NET Editor:
...
But can you guess why this code exists? Wouldn't it be helpful if there was some explanation as to its purpose above this code to provide some context?
