...
This code is merely *one possible solution*. You may have come up with some different variable names and different vertical spacing and tab indentation. Here's a list of changes that we made:

- We added a higher-level description of what the entire code listing is attempting to accomplish in a multi-line comment at the top. We could argue that our description is a small improvement over the original code comments; however, given the challenge's description of the code, there wasn't much more context available.
