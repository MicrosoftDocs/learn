...
We saw how the compiler doesn't care how we write the code. However, since we'll write the code once but read the code many times, improving readability will help us maintain and support our code long term.
