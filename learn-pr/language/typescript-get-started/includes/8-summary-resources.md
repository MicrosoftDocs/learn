...
- [TypeScript tutorial in Visual Studio Code](https://code.visualstudio.com/docs/typescript/typescript-tutorial?azure-portal=true). Learn more about using TypeScript in Visual Studio Code.
