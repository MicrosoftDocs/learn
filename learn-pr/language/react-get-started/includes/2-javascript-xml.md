...
Browsers don't natively support JSX. So JavaScript and HTML must be generated from the JSX files to be rendered by a browser. Several bundlers and other tools can perform the necessary tasks. These tools include [Webpack](https://webpack.js.org/?azure-portal=true), [Parcel](https://parceljs.org/?azure-portal=true), and [Snowpack](https://www.snowpack.dev/?azure-portal=true). We'll use Snowpack because it doesn't require code or extra scripting.
