...
Browsers do not natively support JSX. As a result, JavaScript and HTML must be generated from the JSX files to be rendered by a browser. There are several bundlers and other tools that can perform the necessary tasks, including [Webpack](https://webpack.js.org/), [Parcel](https://parceljs.org/), and [Snowpack](https://www.snowpack.dev/). We'll use Snowpack because it doesn't require code or additional scripting.
