...
With Docker Compose, Contoso Pizza can use a YAML file to configure an application's services. The Docker Compose tool then provides a way to build the individual services, as well as a means to start them.
