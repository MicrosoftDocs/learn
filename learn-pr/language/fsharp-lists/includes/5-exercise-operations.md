Your team is happy with tthe code youu write so far for the card game. They wish you to develop it further and start implementing game rule specific logic like calculate the value of a hand. For this exercise you will use some of the functions in the list module.

## Calculate a hand for the game 31

As part of calculating a card hand, you have the cards, represented as a number between 0 and 51. You need to translate those numbers to something that makes sense within the domain of cards, like for example "Ace of Hearts", rather than a 0. Luckily, a colleague of your already wrote that code:
