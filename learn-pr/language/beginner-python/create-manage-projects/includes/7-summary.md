...
Within the virtual machine, you bring your own Python runtime and libraries that are installed only within the virtual environment. A benefit to using a virtual environment is that you don't affect other Python projects running on the same machine that needs libraries and Python runtimes of a version that's not compatible with what your project needs.
