...
5) In the new app service dialog, enter the following values:
    ...
    * **Resource Group**: Select an existing resource group, or select **New...** and enter a name of `mslearn-github-browser` for the resource group name.

    * **Hosting Plan**: Select an existing hosting plan, or choose **New...** and enter a name of `mslearn-github-browser-plan`.
