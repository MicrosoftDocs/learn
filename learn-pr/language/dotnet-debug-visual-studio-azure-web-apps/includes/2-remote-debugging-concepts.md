...
However, in the exercise ahead, you'll debug an app hosted Azure App Service. In this scenario, many of these types of configurations are handled for us. You can simply use the **Attach to process** feature of Visual Studio to connect directly to our App Service process.  Assuming the correct debugging symbols and source code are loaded, you can then debug the application as though it were running locally on yoru computer.