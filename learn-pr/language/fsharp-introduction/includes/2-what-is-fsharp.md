...
- **Immutable by default**: Having immutability by default makes you can process your data without affecting the original data. Therefore you're able to apply changes to your data and have a high degree of certainty in what the outcome is making code simpler to reason about and test.
