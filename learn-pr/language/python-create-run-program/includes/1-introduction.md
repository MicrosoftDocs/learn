...
If you want to try out the code in the explanations, you might want to work through [Get started with Python in Visual Studio Code](/learn/language/python-install-vscode?azure-portal=true) first, if you haven't already. This module will help you prepare a Python environment.
