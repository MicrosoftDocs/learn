...
How are these commands captured on the coding side? By using the `sys` module, you can retrieve the command-line arguments and use them in your code. Look at the following code:
...
Another way to pass data to the program is having the user enter the data. You can write the code so the program tells the user to enter information. You'll save that entered data in the program and then act on it.
