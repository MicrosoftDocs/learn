...
*Keywords* are specific words reserved by a programming language that have special meaning and behavior. In PowerShell, many of the keywords read like English. For example, *if*, *while*, and *return* are some of the keywords you can use to write code in PowerShell and many other languages.
