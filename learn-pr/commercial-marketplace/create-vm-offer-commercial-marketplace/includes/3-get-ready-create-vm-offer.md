...
VM offer pricing is hourly in Azure Marketplace. Your customers will see your software’s pricing split into two components in the Azure Marketplace online store—Azure infrastructure cost and your software's price per hour.
...
When you publish your offer, you’ll only be asked to provide pricing information for your software. Infrastructure costs are automatically calculated based on the Azure VM type and size the customer uses to deploy your software.
