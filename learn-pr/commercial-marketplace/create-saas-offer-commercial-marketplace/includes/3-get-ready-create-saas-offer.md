...
Let's spend some time reviewing concepts that help you decide how you want to package your SaaS offer for commercial marketplace customers.
...
After choosing a pricing model, you'll also be able to choose the billing term, which dictates the duration of customer subscription periods. You can select monthly or annual billing terms and set the associated price per period.
