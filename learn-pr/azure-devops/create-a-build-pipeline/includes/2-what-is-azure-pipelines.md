...
A _pipeline_ defines the continuous integration process for the app. It's made up of steps called _tasks_ ![Callout 1](../../shared/media/callout-01.png). It can be thought of as a script that defines how your build, test, and deployment steps are run. I'm going to try and map our scripts to tasks.
