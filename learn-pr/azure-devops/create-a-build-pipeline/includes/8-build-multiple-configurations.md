...
> [!TIP]
> This step in the module is optional. If you don't want to learn about templates at this time, you may proceed to the next step, [Clean up your Azure DevOps environment](../9-clean-up-environment.yml). For more information about templates, see [Template types & usage](/azure/devops/pipelines/process/templates).
