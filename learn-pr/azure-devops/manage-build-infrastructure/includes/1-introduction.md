The idea here is to demonstrate how to connect pipelines to [self-hosted](https://docs.microsoft.com/azure/devops/pipelines/agents/agents?view=azdevops#install) / private build infrastructure.
