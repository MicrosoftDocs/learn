...
Here, you'll move the work item you assigned to yourself earlier in this module, **Check open source code for vulnerabilities and licensing terms**, to the **Done** state.
...
1. From Azure DevOps, navigate to your project. Earlier, we recommended that you name this project **Space Game - web - WhiteSource**.
