...
1. Run the following `git` commands to fetch a branch named `release` from the Microsoft repository and to switch to that branch.
...
1. In Visual Studio Code, modify *azure-pipelines.yml*:
    ...
    [!code-yml[](code/4-azure-pipelines.yml?highlight=6,69,62-77,95)]
