...
1. Go to the URL that corresponds to the *production* slot for your _Staging_ environment. This slot is the default slot that you configured when you set up the pipeline earlier.
    ...
    :::image type="content" source="../media/5-app-service-staging.png" alt-text="Screenshot of a browser showing the Space Game website with color and text changes.":::
...
1. Go to the URL that corresponds to the *swap* slot for your _Staging_ environment. The URL includes "-swap.azurewebsites.net" in its name.
    ...
    :::image type="content" source="../media/5-app-service-staging-swap.png" alt-text="Screenshot of a browser showing the normal Space Game website.":::
...
1. Go to the URLs that correspond to the *swap* slot and *production* slot for your _Staging_ environment.
    ...
    :::image type="content" source="../media/5-app-service-staging-revert.png" alt-text="Screenshot of a browser showing the original Space Game website after reverting the changes. The website doesn't include the color and text changes.":::

    The *swap* slot now points to the previous change.

    :::image type="content" source="../media/5-app-service-staging-swap-revert.png" alt-text="Screenshot of a browser showing the Space Game website after reverting the change. The website shows the color and text changes.":::
