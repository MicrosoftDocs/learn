...
1. As an optional step, go to your site in a browser. You see the default home page because you haven't yet deployed your code to this slot.
    ...
    :::image type="content" source="../../shared/media/app-service-default.png" alt-text="Screenshot of default home page in Azure App Service.":::
...
1. As an optional step, in a browser, go to the URL that corresponds to each stage.
    ...
    :::image type="content" source="../media/3-app-service-dev.png" alt-text="Screenshot of a browser showing the Space Game website in the Dev environment.":::
