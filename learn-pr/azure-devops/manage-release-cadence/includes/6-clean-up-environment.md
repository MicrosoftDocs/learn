...
Here, you'll move the work item you assigned to yourself earlier in this module, **Improve release cadence**, to the **Done** column.
...
1. Move the **Improve release cadence** work item from the **Doing** to the **Done** column.
...
1. From Azure DevOps, navigate to your project. Earlier, we recommended that you name this project **Space Game - web - Deployment patterns**.
