...
![A diagram of a load balancer distributing traffic in a blue-green deployment.](../media/2-blue-green-deployment.png)
...
![A diagram of a load balancer sending traffic to a canary version.](../media/2-canary-deployment.png)
...
![A diagram of a coded "if" statement for an on-off feature.](../media/2-feature-toggles.png)
...
![A diagram of a load balancer sending traffic to the new feature.](../media/2-dark-launches.png)
...
![A diagram of two apps and their analytics.](../media/2-a-b-testing.png)
...
![A diagram of a progression of larger groups.](../media/2-progressive-exposure-deployment.png)
...
![A diagram of applications swapping IP addresses.](../media/2-zero-downtime-deployment.png)
