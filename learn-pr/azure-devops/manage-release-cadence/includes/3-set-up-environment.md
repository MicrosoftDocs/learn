...
1. Select **Save**.
    ...
    Azure DevOps does a test connection to verify that it can connect to your Azure subscription. If Azure DevOps can't connect, then you'll have the chance to sign in again.
