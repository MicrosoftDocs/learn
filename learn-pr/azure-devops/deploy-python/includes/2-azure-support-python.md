...
![A screenshot of Azure Pipelines showing a list of starter projects for Python.](../media/2-configure-pipeline-python.png)
...
![A screenshot of Azure Pipelines showing starter code for a Python build pipeline.](../media/2-starter-code-python.png)
