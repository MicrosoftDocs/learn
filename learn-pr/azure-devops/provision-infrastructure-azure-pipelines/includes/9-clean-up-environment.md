...
Here, you delete your App Service deployment, your storage account, and your service principal. Earlier, worked with Azure resources through Cloud Shell in the Azure portal. Here, you do the same.
...
Here, you'll move the work item you assigned to yourself earlier in this module, **Scale out the website**, to the **Done** column.

In practice, the definition of "Done" often means working software in the hands of your users. For learning purposes, here you'll mark this work as complete because the goal for the Tailspin team is to define a way to automatically provision infrastructure in their pipeline.
...
1. Move the **Scale out the website** work item from the **Doing** to the **Done** column.
...
1. From Azure DevOps, navigate to your project. Earlier, we recommended that you name this project **Space Game - web - Terraform**.
