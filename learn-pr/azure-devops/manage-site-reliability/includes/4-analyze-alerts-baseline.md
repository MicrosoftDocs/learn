...
![A drawing of ...](../media/4-flow-of-alerts.png)
...
![A drawing of ...](../media/4-all-alerts-page.png)
...
![A drawing of ...](../media/4-manage-alert-rules.png)
...
Pick the target for the alert.
Select the signal from the available signals for the target.
...
Monitor source|Signal type | Description Service health | Activity log | Not supported. See Create activity log alerts on service notifications. Application Insights | Web availability tests | Not supported. See Web test alerts. Available to any website that's instrumented to send data to Application Insights. Receive a notification when availability or responsiveness of a website is below expectations.
...
![A drawing of ...](../media/4-all-alerts-page2.png)
