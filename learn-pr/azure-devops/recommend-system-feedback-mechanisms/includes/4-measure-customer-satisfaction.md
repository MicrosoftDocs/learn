...
What types of metrics measure customer satisfaction? When you create a customer satisfaction surveys, you have a few options to choose from. A few popular methods are:
...
You still measure satisfaction, but in this way, you're gauging effort. The assumption here is that, the easier it is to complete a task, the better the overall experience is for the customer. As it turns out, making tasks require little effort is one of the best ways to reduce frustration and disloyalty.

### NPS

NPS asks the question: "How likely is it that you would recommend this company to a friend or colleague?"

NPS measures not only customer satisfaction but also customer loyalty. In doing so, you can come up with an aggregate score, but you can also easily segment your responses into three categories: *detractors*, *passives*, and *promoters*. You calculate NPS by subtracting the percentage of detractors from the percentage of promoters.
...
Depending on your business or organizational capabilities, there's a lot you can do with the information. One use is simply to make you aware of the reality of your business. A portion of your customers is going to have an unsatisfactory experience. Every business faces this problem.
