...
You can bring up App Service in several ways. Here you use the Azure portal because it's a great way to explore and visualize available services. In later modules, you'll use more automated ways to bring up and manage App Service.
...
1. From the dialog box, ensure that **Service Principal Authentication** is selected. Then fill in these fields:
...
1. From your project in Visual Studio Code, open the *azure-pipelines.yml* file and replace its contents with this:
