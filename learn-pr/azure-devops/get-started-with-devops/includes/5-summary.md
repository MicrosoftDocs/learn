In this module, you learned about what DevOps is (and what it is *not*) and about the Microsoft DevOps suite, Azure DevOps. You also set up an account in Azure DevOps and created an organization.
