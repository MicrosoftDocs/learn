...
1. From the **Create New Project** page, select your Azure DevOps organization and enter a project name, such as **Space Game - web - Tests**.
...
> [!IMPORTANT]
> The [Clean up your Azure DevOps environment](/learn/modules/run-quality-tests-release-pipeline/8-clean-up-environment?azure-portal=true) page in this module contains important cleanup steps. Cleaning up helps ensure that you don't run out of free build minutes. Be sure to perform the cleanup steps even if you don't complete this module.
...
1. From the **Create unit tests** work item, click the down arrow at the bottom of the card. Then assign the work item to yourself.
...
## DEPLOY THE SPACE GAME WEB APP TO APP SERVICE
