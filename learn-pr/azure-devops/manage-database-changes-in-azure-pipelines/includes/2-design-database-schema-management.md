...
:::image type="content" source="../../assess-your-development-process/media/2-space-game-leaderboard.png" alt-text="A web page showing the Space Game leaderboard.":::
...
:::image type="content" source="../media/2-database-project.png" alt-text="The database project open in Visual Studio on Windows.":::
...
**Andy:** I found an Azure Pipelines task that we can use. The [SqlAzureDacpacDeployment@1](/azure/devops/pipelines/tasks/deploy/sql-azure-dacpac-deployment?azure-portal=true) task generates a file that identifies the schema differences between the current database schema and the _dacpac_.
