...
In this module, you worked with ASP.net Core, SQL Server Data Tools, Azure SQL, and Configuring the App Service. Here are some additional resources you can use to learn more.
