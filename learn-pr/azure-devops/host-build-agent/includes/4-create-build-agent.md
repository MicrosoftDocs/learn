...
1. Create an SSH connection to your VM. In place of $IPADDRESS, enter the IP address you recieved in the previous step . At the prompt, enter **yes** to continue connecting.
