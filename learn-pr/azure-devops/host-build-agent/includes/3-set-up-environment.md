...
> [Run the template](https://azuredevopsdemogenerator-mslearn.azurewebsites.net/?name=host-build-agent&azure-portal=true)
...
1. From the **Create New Project** screen, select your Azure DevOps organization and enter a project name, such as **Space Game - web - Agent**.
