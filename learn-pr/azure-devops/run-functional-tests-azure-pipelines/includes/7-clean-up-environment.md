...
Here, you'll move the work item you assigned to yourself earlier in this module, **Automate quality tests**, to the **Done** column.

In practice, the definition of "Done" often means putting working software into the hands of your users. For learning purposes, here you'll mark this work as complete because you have working UI tests set up in your pipeline.
...
1. Move the **Automate quality tests** work item from the **Doing** to the **Done** column.
...
1. From Azure DevOps, navigate to your project. Earlier, we recommended that you name this project **Space Game - web - Functional tests**.
