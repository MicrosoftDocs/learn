...
1. Select **Code**. Then, from the **HTTPS** tab, select the button next to the URL that's shown to copy the URL to your clipboard.
    ...
    :::image type="content" source="../../shared/media/github-clone-button.png" alt-text="A Screenshot showing how to locate the URL and copy button from the GitHub repository.":::
