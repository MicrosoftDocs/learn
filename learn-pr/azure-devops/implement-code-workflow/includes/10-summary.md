...
* Visual Studio Code includes Git support in-the-box. Here are resources where you can learn more:
  ...
  * [Working with GitHub in VS Code](https://code.visualstudio.com/docs/editor/github?azure-portal=true)
* [GitHub Desktop](https://desktop.github.com?azure-portal=true) is another great way to branch, commit, and visually compare and commit your changes.
...
[Build pipeline triggers](/azure/devops/pipelines/build/triggers?azure-portal=true&tabs=yaml) explains how triggers enable you to control which files or Git branches cause a build to occur.
