...
> [Run the template](https://azuredevopsdemogenerator-mslearn.azurewebsites.net/?name=implement-code-workflow&azure-portal=true)
...
1. From the **Create New Project** screen, select your Azure DevOps organization and enter a project name, such as **Space Game - web - Workflow**.
...
1. From the **Create a Git-based workflow** work item, click the down arrow at the bottom of the card. Then assign the work item to yourself.
