...
Here, you'll move the work item you assigned to yourself earlier in this module, **Move model data to its own package**, to the **Done** column.

In practice, the definition of "Done" often means working software in the hands of your users. For learning purposes, here you'll mark this work as complete because you set up a build pipeline that publishes NuGet packages to Azure Artifacts.
...
1. Move the **Move model data to its own package** work item from the **Doing** to the **Done** column.

    ![Azure Boards showing the card in the Done column](../media/8-azure-boards-wi6-done.png)
...
1. From Azure DevOps, navigate to your project. Earlier, we recommended that you name this project **Space Game - web - Dependencies**.
