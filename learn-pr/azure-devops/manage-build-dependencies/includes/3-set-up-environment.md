...
> [Run the template](https://azuredevopsdemogenerator-mslearn.azurewebsites.net/?name=manage-build-dependencies&azure-portal=true)
...
1. From the **Create New Project** screen, select your Azure DevOps organization and enter a project name, such as **Space Game - web - Dependencies**.
...
1. From the **Move model data to its own package** work item, click the down arrow at the bottom of the card. Then assign the work item to yourself.
...
1. Move the work item from the **To Do** to the **Doing** column.
    ...
    ![Azure Boards showing the card in the Doing column](../media/3-azure-boards-wi6-doing.png)
