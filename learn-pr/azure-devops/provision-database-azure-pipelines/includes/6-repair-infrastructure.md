...
1. From the list of resources, select your App Service instance.
    ...
    :::image type="content" source="../media/6-portal-select-app-service.png" alt-text="Selecting the App Service resource in the Azure portal.":::
...
1. After the build finishes, select the back button to return to the summary page.
    ...
    :::image type="content" source="../media/6-pipeline-stages-overview.png" alt-text="Azure Pipelines showing the completed stages.":::
