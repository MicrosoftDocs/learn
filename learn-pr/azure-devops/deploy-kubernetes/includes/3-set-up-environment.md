...
1. On the **Create New Project** page, select your Azure DevOps organization. Enter a project name, such as *Space Game - web - Kubernetes*.
    ...
    ![A screenshot of the Azure DevOps Demo Generator showing the process to create the project.](../media/3-create-new-project.png)
...
1. Under **Pipelines**, select **Library**.
    ...
    ![A screenshot of Azure Pipelines showing the Library menu option.](../media/3-pipelines-library.png)
...
1. Near the top of the page, select **Save** to save your variable to the pipeline.
    ...
    ![A screenshot of Azure Pipeline showing the variable group. The group contains one variable.](../media/3-library-variable-group.png)
...
1. Under **Pipelines**, select **Environments**.
    ...
    ![A screenshot of Azure Pipelines showing the Environments menu option.](../media/3-pipelines-environments.png)
...
1. Open the file at *manifests/deployment.yml* in edit mode.
    ...
    ![A screenshot of GitHub showing the location of the edit mode icon.](../media/3-github-edit-mode.png)
