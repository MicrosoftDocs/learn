In [Automate Docker container deployments with Azure Pipelines](/learn/modules/deploy-docker?azure-portal=true), you updated a release pipeline to build and publish an ASP.NET Core app as a Docker container and deployed to Azure App Service. The migration to a container-based project afforded the product team several key benefits. However, the adoption of container technologies can open new doors to future innovations.
