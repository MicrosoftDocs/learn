...
1. Next, each of the remaining observations (in this case flowers) are assigned to its closest centroid. 
1. Next, the new means of each cluster is computed and the centroid is moved to the mean. 
