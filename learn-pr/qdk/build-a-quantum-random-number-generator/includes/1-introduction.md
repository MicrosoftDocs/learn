In this module you are going to learn how to build a quantum random number
...
![Schrodinger's cat](../media/cat.png =250x250) 

In Schrödinger's cat thought experiment, if we open the box to check if the
cat is dead or alive, the quantum state of the cat randomly collapses into one 
of the two classical states. Since the state of the cat can be encoded with a
...
- Learn to build a quantum random number generator with the QDK.
- Learn to combine Q# programs with a classical host program in Python.
- Learn to put qubits in superposition with Q#.
- Learn to perform qubit measurements with the QDK.