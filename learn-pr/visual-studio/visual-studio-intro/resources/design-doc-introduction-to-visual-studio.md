...
| What's in Visual Studio? | Edit code and Debug, Customization, Extensions, and Connecting your IDE | Knowledge Check (at end) | 2-4 |Yes |
...
- Visual Studio is an integrated development environment (IDE) that’s popular for .NET and C++ workloads and it does support many languages and frameworks and has a massive ecosystem of extensions because Visual Studio has been around for over 20 years!
...
1. **What's in Visual Studio?**
    ...
    - Editor
        - It also has excellent code completion, syntax highlighting, quick info hints, errors/warnings that come with code fix suggestions. That helps you understand more about the code you are writing.
        - IntelliCode
        - Built-in code fixes and code style  
        - Navigation
        - snippets
    - Debugger
        - F5 debugging
    ...
    - Live Share
        ...
        - Useful for students and teachers, but also used everyday by professional developers
