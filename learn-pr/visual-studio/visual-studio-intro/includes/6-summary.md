You've now had a basic introduction to Visual Studio. As mentioned in the beginning, this IDE is over 20 years old so don't be surprised if you find yourself learning something new regularly!
...
Recall the example at the beginning of this module of learning to program your first website. Visual Studio can help you select website templates to help you get started, offer hints and warnings as you type in the Editor, and let you inspect your webapp as it runs locally with debugger tools.

## Next Steps

**[Download Visual Studio](https://visualstudio.microsoft.com/downloads/)** to try out what you have learned. Happy coding!
