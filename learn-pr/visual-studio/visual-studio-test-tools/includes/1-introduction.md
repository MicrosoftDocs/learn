...
:::image type="content" source="../media/introduction-collage.png" alt-text="Collage that shows screenshots of Visual Studio, including the new test project dialog, debugging a test, a test that uses Fluent Assertions, and Test Explorer.":::
