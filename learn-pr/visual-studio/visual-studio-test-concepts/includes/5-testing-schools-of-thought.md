There is much guidance out there when it comes to testing. We'll cover some of the common schools of thought that experienced developers often recommend.
...
1. Add the necessary product code to make that test pass or turn "green."
...
*Don't repeat yourself*, also known as *DRY*, is another practice in the field of testing. DRY posits that you should avoid repeating information and logic everywhere you can. You can do this by abstracting the information and honoring one "source of truth," rather than maintaining multiple copies of the same logic.
