...
![image](../media/test-pyramid-integration.png)
...
![image](../media/test-pyramid-performance.png)
...
![image](../media/test-pyramid-load.png)
...
![image](../media/test-pyramid-acceptance.png)
...
![image](../media/test-pyramid-ui.png)

UI tests can directly test the UI interactions of an app. This is meant to mimic an actual user clicking and interacting with your app and testing if the UI response is correct. UI tests are at the very top of the testing pyramid. There are many frameworks that can automate UI interactions. For example, [Playwright](https://playwright.dev/dotnet/docs/why-playwright) can automate the browser to mimic a user using your website.
