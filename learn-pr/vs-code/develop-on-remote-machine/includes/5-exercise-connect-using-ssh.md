Now that you have a remote host configured, you need to connect to it from Visual Studio Code. To connect to the remote machine, you need the Remote – SSH extension.
