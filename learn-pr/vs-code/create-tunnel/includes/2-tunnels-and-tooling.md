...
:::image type="content" source="../media/8. remoteChart.png" alt-text="Screenshot of VS Code & Remote OS chart.":::
...
4. Copy the file into both the TestUI and TestCLI folders. 
    ...
    :::image type="content" source="../media/18. PopulatedFolders.png" alt-text="Screenshot of TestUI and TestCLI Folders with index.html files.":::
