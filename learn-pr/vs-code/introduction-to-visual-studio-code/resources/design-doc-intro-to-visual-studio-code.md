...
| Factor | Description |
| ----| ---- |
| Is there an official IDE for the language or framework I’m using? | There may be many different editors available for the language you want to work in. For example, you can edit HTML in just about any IDE. However, for some specialized use cases such as MacOS and Android development, you may want to choose an official editor. |
