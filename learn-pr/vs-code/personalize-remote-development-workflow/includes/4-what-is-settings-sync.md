...
Settings Sync lets you share your VS Code configurations such as settings, keybindings, and installed extensions across your machines so you are always working with your favorite setup.
...
* Settings - Any settings in VS Code that you have configured, such as increasing the font size or having the editor format your code when you save a file. These settings can be found by selecting "Preferences: Open User Settings" from the Command Palette.

* Keyboard Shortcuts - Any custom keyboard shortcuts that you have configured in VS Code. These keyboard mappings can be found by choosing "Preferences: Open Keyboard Shortcuts" from the Command Palette. 
