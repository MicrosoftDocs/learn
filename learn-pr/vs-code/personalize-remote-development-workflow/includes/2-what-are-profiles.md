...
Keeping track of all of the info included in a profile can be beneficial. For example, when you start working on a new machine, you're immediately productive if your usual key bindings, snippets, and more are instantly available. You don't need to spend time re-creating them on the new machine.

## Creating and managing profiles

To create a profile, you can use the **Create Profile** command on the **File** > **Preferences** > **Profiles** menu. Or you can access the **Profile** menu by using the gear icon.
