...
For this module, we assume that you're comfortable with Python, and that you completed the first module of this learning path (or are already familiar with Keras). We don't assume any knowledge of TensorFlow.
