...
If after learning Keras you feel that you need more flexibility than it provides, then the fifth module of this learning path, Intro to Machine Learning with TensorFlow, shows how to re-implement a portion of the Keras code in this module using lower-level TensorFlow APIs. 
