...
The command downloads and runs a script that sends six sequential requests to the web API. The following headings appear according to the order in which the request was sent. See the Cloud Shell for the individual curl commands that were sent.
