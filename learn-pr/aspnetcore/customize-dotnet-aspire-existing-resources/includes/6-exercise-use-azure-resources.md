...
1. Notice that there's a container named **redis**. This container hosts the output cache for the **webapp** microservice.
...
1. You can explore other displays in Application Insights. When you're finished, you can clean up your Azure subscription by deleting the **rg-aspireeshop** resource group.
