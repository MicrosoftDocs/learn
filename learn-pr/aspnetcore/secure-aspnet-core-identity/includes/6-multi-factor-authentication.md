In the previous unit, you customized and extended ASP.NET Core Identity. In this unit, you learn about multifactor authentication and how it's implemented in Identity.
