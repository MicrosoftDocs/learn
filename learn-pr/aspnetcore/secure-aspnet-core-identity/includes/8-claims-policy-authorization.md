In the previous unit, you added QR code functionality to enable multifactor authentication. In this unit, you learn about authorization based on claims and policies. 
