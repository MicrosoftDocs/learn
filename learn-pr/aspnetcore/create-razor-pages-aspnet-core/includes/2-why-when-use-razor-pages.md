...
* Razor Pages makes it easy to get started building dynamic web apps when all you need is to define UI logic using a combination of HTML, CSS, and C#. Razor Pages provides a productivity advantage over the more complex **M**odel-**V**iew-**C**ontroller (MVC) app model.
* Razor Pages encourages organization of files by feature, therefore easing maintenance of your app.
* Razor Pages can be broadly described as an HTML file where you can work with markup as you're used to. You also have the advantage of adding server-side C# code by using Razor syntax. Razor pages have the extension *:::no-loc text=".cshtml":::*.
