...
The following markup uses the *:::no-loc text="Label Tag Helper":::* that contains an *:::no-loc text="asp-for":::* attribute, as do many Tag Helpers.
...
The *:::no-loc text="Create":::* Razor Page form has been created. Let's explore its *:::no-loc text="PageModel":::* class file and modify it to handle the *:::no-loc text="Create":::* page's *:::no-loc text="POST":::* event and data.
