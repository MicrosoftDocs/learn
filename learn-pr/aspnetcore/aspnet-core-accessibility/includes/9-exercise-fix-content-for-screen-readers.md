Before you try to move through the sample webpage by using a screen reader, you'll find and fix remaining accessibility issues.
...
1. Run the application and check FastPass one last time. You should see that all automated checks have now passed.

## Check tab stops

1. Now that you've cleared all automated checks, it's time to check tab stops. Select **Tab stops** on the left pane in FastPass.
...
1. Switch to the web application and begin using the Tab key to move through the page. You'll see that the navigation flows from the top of the page, through the form and page links, to the links in the footer.
...
1. Select the 1 key again. You'll hear "Join our mailing list." This isn't correct, because there should only be one `<h1>` element on a page.
...
1. Select the Tab key once more. You'll hear a link read aloud as "Link: click here." This is unclear. What is the link we're being told to click?
