...
1. In Visual Studio Code, in the **TERMINAL** pane at the bottom, go to the **Diagnostics** folder.
1. Run this command:
...
1. Open a browser and, in a new tab, go to the Prometheus app [http://localhost:9090/](http://localhost:9090/).
