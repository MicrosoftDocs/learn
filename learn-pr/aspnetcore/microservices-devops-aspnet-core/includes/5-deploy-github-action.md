...
1. Select the **:::no-loc text="deploy-to-aks":::** task:
    ...
    :::image type="content" source="../media/5-deploy-github-action/deploy-to-aks-task.png" alt-text="Screenshot shows deploy-to-aks job selected with all a list of all the steps completed." border="true" lightbox="../media/5-deploy-github-action/deploy-to-aks-task.png":::
...
1. Select the **:::no-loc text="Actions":::** tab again. You'll see a variation of the following screen when the deployment completes:
    ...
    :::image type="content" source="../media/5-deploy-github-action/deployment-action-completed.png" alt-text="Screenshot shows 'All workflows' selected and listing three workflows." border="true" lightbox="../media/5-deploy-github-action/deployment-action-completed.png":::
