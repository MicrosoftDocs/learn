...
1. Set up your database servers yourself using virtual machines or database clusters for high availability.
1. Configure a managed database service.

The approach used in *:::no-loc text="eShopOnContainers":::* is using in-cluster data services, deployed as containers/pods; however, that's a valid option just for a demo or dev/test environment.
