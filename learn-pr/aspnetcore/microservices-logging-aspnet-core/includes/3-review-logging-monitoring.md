...
In a microservices architecture, we need a solution that can:
...
In later units, you'll learn about using code instrumentation with Application Insights. We'll use Azure Monitor for near-real-time telemetry data monitoring.
...
You can parse Structured formats to search and filter the relevant data based on their correlation. For example, consider the following logging statement that uses the Serilog library:
...
:::image type="content" source="../media/3-logging-monitoring/structured-logging-visualization.png" alt-text="Screenshot of structured logging visualization." border="true" lightbox="../media/3-logging-monitoring/structured-logging-visualization.png":::
...
Serilog provides [sinks](https://github.com/serilog/serilog/wiki/Provided-Sinks) for writing log events to storage in various formats. In *:::no-loc text="eShopOnContainers":::*, Seq is configured as the centralized log monitoring system. We selected Seq for its free single-user license, which can be used in production and can be run locally.
...
:::image type="content" source="../media/3-logging-monitoring/azure-monitor.png" alt-text="Diagram of Azure Monitor." border="true" lightbox="../media/3-logging-monitoring/azure-monitor.png":::
...
:::image type="content" source="../media/3-logging-monitoring/ai-diagram.png" alt-text="Diagram of Application Insights." border="true" lightbox="../media/3-logging-monitoring/ai-diagram.png":::
