...
Which is the output of `Console.WriteLine($"Tax rate: {tax:P2}");`, where `tax` is defined by `decimal tax = .12051m;`?
( ) `Tax rate: 12.05 %` {{Incorrect. `tax:P1` rounds the percentage to a single decimal place.}}
( ) `Tax rate: 12.10 %` {{Incorrect. `tax:P1` rounds the percentage to a single decimal place.}}
(x) `Tax rate: 12.1 %` {{Correct. `tax:P1` rounds the percentage to a single decimal place.}}
