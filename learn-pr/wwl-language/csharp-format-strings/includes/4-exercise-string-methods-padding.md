...
When you run the code, you won't notice any characters added to the end of the string, but they're there.
...
We'll reuse the `formattedLine` variable to build our output string. When you run the code, you should get the following output:
...
When you run the application, you have the following output that you can send off to the maintainers of the legacy system to confirm our new integration will work correctly:
...
Here are a few important takeaways from this unit:
...
- You can use `PadLeft()` to right-align a string.
