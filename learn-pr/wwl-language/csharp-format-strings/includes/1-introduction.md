...
In this module, you focus on data output. You work with string data formatting it with alignment and spacing. You format data for presentation as currency and other numbers. By the end of this module, you have new tools you can use to output data to the users that conveys and clarifies its meaning.

In this module, you learn how to work with string and numeric data to solve real-world business problems in C#. You create a mockup of a receipt issued for products sold. And you merge data to send a personalized marketing message to customers.
