...
Which choice best represents how bits represent on and off?
( ) Bits are represented by "x" or "o" {{Incorrect. Bits are binary and represented by "1" or "0".}}
( ) Bits are represented by "+bit" or "-bit" {{Incorrect. Bits are binary and represented by "1" or "0".}}
(x) Bits are binary and represented by "1" or "0" {{Correct. Bits are represented by "1" or "0".}}
