Choosing the right data type for your application is a vital programming skill. Our goal was to understand the differences between each data type so that we could make an informed decision when it comes time to choose the data types on which we'll rely when writing code.
