...
1. To declare a new array of strings that can hold three elements, enter the following code:
   ```c#   string[] fraudulentOrderIDs = new string[3];   ```
...
1. To assign Order ID values to your `fraudulentOrderIDs` array, update your code as follows:
   ```c#   string[] fraudulentOrderIDs = new string[3];      fraudulentOrderIDs[0] = "A123";   fraudulentOrderIDs[1] = "B456";   fraudulentOrderIDs[2] = "C789";   ```
...
1. At the bottom of your code file, enter the following code line:
   ```c#   fraudulentOrderIDs[3] = "D000";   ```

1. Ensure that your code matches this example:
   ```c#   string[] fraudulentOrderIDs = new string[3];      fraudulentOrderIDs[0] = "A123";   fraudulentOrderIDs[1] = "B456";   fraudulentOrderIDs[2] = "C789";   fraudulentOrderIDs[3] = "D000";   ```
...
1. At the Terminal command prompt, to run your code, type `dotnet run` and then press Enter.
   ...
   ```Output   Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.           at Program.<Main>$(String[] args) in C:\Users\someuser\Desktop\CsharpProjects\TestProject\Program.cs:line 6   ```
   Notice the following parts of the error:
   - Error message: `System.IndexOutOfRangeException: Index was outside the bounds of the array.`   - Error location: `Program.cs:line 6`
...
1. To write the value of each fraudulent Order ID, update your code as follows:
   ```c#   string[] fraudulentOrderIDs = new string[3];      fraudulentOrderIDs[0] = "A123";   fraudulentOrderIDs[1] = "B456";   fraudulentOrderIDs[2] = "C789";   // fraudulentOrderIDs[3] = "D000";      Console.WriteLine($"First: {fraudulentOrderIDs[0]}");   Console.WriteLine($"Second: {fraudulentOrderIDs[1]}");   Console.WriteLine($"Third: {fraudulentOrderIDs[2]}");   ```
...
1. At the Terminal command prompt, type `dotnet run` and then press Enter.
   You should see the following message:
   ```Output   First: A123   Second: B456   Third: C789   ```
...
1. At the Terminal command prompt, type `dotnet run` and then press Enter.
   You should see the following message:
   ```Output   First: A123   Second: B456   Third: C789   Reassign First: F000   ```
...
1. To declare the array initialize values in a single statement, enter the following code:
   ```c#   string[] fraudulentOrderIDs = { "A123", "B456", "C789" };   ```
...
1. At the end of your code file, to report the number of fraudulent orders, enter the following code:
   ```c#   Console.WriteLine($"There are {fraudulentOrderIDs.Length} fraudulent orders to process.");   ```
...
1. Save the changes to your **Program.cs** file, and then run the application.
   ...
   ```Output   First: A123   Second: B456   Third: C789   Reassign First: F000   There are 3 fraudulent orders to process.   ```
