...
1. To create the initial code for this exercise, enter the following:
   ```c#   Random dice = new Random();      int roll1 = dice.Next(1, 7);   int roll2 = dice.Next(1, 7);   int roll3 = dice.Next(1, 7);      int total = roll1 + roll2 + roll3;      Console.WriteLine($"Dice roll: {roll1} + {roll2} + {roll3} = {total}");      ```
...
1. To create your first game feature, enter the following `if` statements.
   ```c#   if (total > 14)   {       Console.WriteLine("You win!");   }      if (total < 15)   {       Console.WriteLine("Sorry, you lose.");   }   ```
   ...
   - The `if` keyword   - A *Boolean expression* between parenthesis `()`   - A *code block* defined by curly braces `{ }`
...
1. To create your "doubles" game feature, enter the following `if` statement.
   ```c#   if ((roll1 == roll2) || (roll2 == roll3) || (roll1 == roll3))   {       Console.WriteLine("You rolled doubles! +2 bonus to total!");       total += 2;   }      ```
...
1. To create your "triples" game feature, enter the following `if` statement.
   ```c#   if ((roll1 == roll2) && (roll2 == roll3))    {       Console.WriteLine("You rolled triples! +6 bonus to total!");       total += 6;   }      ```
...
1. At the Terminal command prompt, to run your code, type **dotnet run** and then press Enter.
   ...
   ```Output   Dice roll: 3 + 6 + 1 = 10   Sorry, you lose.      ```
   Or, like this:
   ```Output   Dice roll: 1 + 4 + 4 = 9   You rolled doubles! +2 bonus to total!   Sorry, you lose.      ```
   Or, like this:
   ```Output   Dice roll: 5 + 6 + 4 = 15   You win!      ```
   Or, if you're lucky, you'll see this:
   ```Output   Dice roll: 6 + 6 + 6 = 18   You rolled doubles! +2 bonus to total!   You rolled triples! +6 bonus to total!   You win!      ```
