...
- **Game rules:**
    ...
    - This is a game for two players, so the computer play the role of your opponent and it will choose a random element from the list of elements
...
- **Interaction with the player:**
    ...
    - The player can also choose whether to play again or not, be warned if they enter an invalid option, and know their score at the end of the game.
