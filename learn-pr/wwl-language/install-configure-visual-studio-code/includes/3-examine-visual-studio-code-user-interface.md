...
**F** - The **Main Menu** is the menu interface at the top of the application window. Among other options, these menu options enable the developer to save, edit, and run their code.
