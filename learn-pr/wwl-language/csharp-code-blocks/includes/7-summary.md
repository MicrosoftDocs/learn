...
Code that uses improperly scoped or initialized variables will produced runtime errors. Your ability to scope and initialize varaibles correctly will ensure a better user experience with your applications.
