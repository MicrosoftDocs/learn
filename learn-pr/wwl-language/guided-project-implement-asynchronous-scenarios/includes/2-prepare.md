...
This module guides you through the steps required to continue building the LangtonsAnts demonstration. It teaches you how to use asynchronous programming to create a new thread so your program doesn't freeze.
...
1. Download the zip file containing the Starter project code by selecting the following link: [Starter Files](https://github.com/MicrosoftLearning/Guided-Project-asynchronous-programming/zipball/main).
...
1. Unzip the download files to your working directory.
    ...
    1. Right-click **MicrosoftLearning-Guided-Project-asynchronous-programming**, and then select **Extract all**.

    1. Select **Show extracted files when complete**, and then select **Extract**.

    1. Open the **MicrosoftLearning-Guided-Project-asynchronous-programming** folder.
