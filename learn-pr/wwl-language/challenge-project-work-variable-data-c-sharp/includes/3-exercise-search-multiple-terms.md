...
- Review the following animated image
  ...
  - Notice the messages for matches persist (example: "`Our dog lola is a chase match!`")
    ...
    :::image type="content" source="../media/pet-search-animation.gif" alt-text="Animated diagram showing an example of application searching dog descriptions with four user submitted terms":::
