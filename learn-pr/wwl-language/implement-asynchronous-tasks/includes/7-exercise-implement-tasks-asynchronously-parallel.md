This exercise guides you through the implementation of data parallelism using `Parallel.ForEachAsync` and `Task.WhenAll` in a C# application.
...
[![Button to launch exercise.](../media/launch-exercise.png)](https://go.microsoft.com/fwlink/?linkid=2312912&azure-portal=true)
