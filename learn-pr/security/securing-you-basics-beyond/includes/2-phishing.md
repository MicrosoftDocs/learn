...
- Select a link and go to a dangerous webpage.
...
Now that you can recognize phishing email and you know not to select any links or open any attachments, let's talk about what else you can do. Your email application or website probably has the *report phishing* feature. Using this feature will notify the email provider and help prevent similar email in the future. Of course, you can delete phishing email too.
