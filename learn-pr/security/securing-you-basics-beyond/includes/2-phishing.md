...
Another common phishing goal is to deliver *malware*, a type of malicious software. Often included as an attachment, opening one of these bad attachments could result in running a program that could harm your computer, or even lock you out from it permanently. Social engineering is leveraged again to make the attachment look harmless. You'll often see examples that are made to look like bank statements or pictures.
...
Similar to phishing, tech support scams use social engineering to get you to provide your personal information such as, username, password, and credit card details.
...
Attackers know what emotions get people to respond. For example, they will send an email to get you to select a link quickly by telling you something needs to happen urgently. One common example is an email indicating that your account has been closed. This seems like something that would be concerning and you'd need to address immediately, but most businesses won't send unsolicited emails indicating account closure.
...
You don’t have to be afraid of all your email, but you do need to pay close attention to anything that looks unusual or suspicious. If you notice any phishing characteristics, just remember to not do anything with that email, other than reporting it and deleting it.
