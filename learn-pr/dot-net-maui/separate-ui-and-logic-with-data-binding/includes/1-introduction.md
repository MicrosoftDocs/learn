...
Some time after your app is released, the weather service you use announces that they're going to be shutting down. Anticipating this, you start looking for a replacement service. Of the services you've evaluated, you notice that they all input and ouput data in different ways. Since your UI uses code-behind events for interaction with the service, your UI experience could be impacted by this change.

It would be nice to change how the UI synchronizes the weather updates, from code-behind events to data binding. This way, if a service change happens again, you'll minimize the impact to your code.

## What will you do

This module demonstrates the differences between a code-based UI to a data-bound UI and shows you how to add data binding to a UI. You'll then learn about the ways you can customize data bindings. With this information, you'll update a sample weather app to use data binding instead of code-behind.

## What do you learn

By the end of this module, you'll be able to use data binding to present data in the UI, and use converters to transform data when the UI types and data types don't match.
