...
The **SQLiteAsyncConnection** class exposes similar operations as the synchronous counterpart. However, the operations are all task-based for background usage.

The common asynchronous operations available include:
...
the code below shows an example of how to use the **ToListAsync** method to retrieve records asynchronously:
