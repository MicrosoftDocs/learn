...
The MVVM Toolkit also handles `async` methods, which are common in .NET programming. The library is distributed through the `CommunityToolkit.Mvvm` NuGet package.
