...
To create .NET MAUI apps with .NET 8, you need to install [Visual Studio version 17.7](https://visualstudio.microsoft.com/) or newer with the following workload installed:
