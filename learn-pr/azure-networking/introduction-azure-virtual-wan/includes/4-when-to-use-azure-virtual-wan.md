...
| Indirect Interconnect model | CPEs deployed in their VNet are indirectly connected to Virtual WAN hubs using IPsec. The virtual CPE serves as an SD-WAN gateway into Azure |
