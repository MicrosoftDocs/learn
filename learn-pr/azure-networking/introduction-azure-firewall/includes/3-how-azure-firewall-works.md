...
:::image type="content" source="../media/how-azure-firewall-works.png" alt-text="Network diagram showing an external computer requesting a remote desktop connection with a virtual machine and Azure Firewall translating its public IP address to the virtual machine's private IP address.":::
