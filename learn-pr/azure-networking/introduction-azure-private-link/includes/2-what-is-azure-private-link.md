...
:::image type="content" source="../media/2-private-link-description.png" alt-text="Network diagram showing an Azure virtual network, an Azure peered virtual network, and an on-premises network accessing an Azure SQL database via the internet.":::
