...
:::image type="content" source="../media/how-azure-private-link-works.png" alt-text="Network diagram showing an Azure virtual network, an Azure peered virtual network, and an on-premises network accessing Azures services via a private IP address mapped by Private Endpoint.":::