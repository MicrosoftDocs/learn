...
:::image type="content" source="../media/4-using-private-link.png" alt-text="Network diagram showing an Azure virtual network accessing a single instance of an Azure SQL database via a private IP address mapped by Private Endpoint and not allowing access to other instances of Azure SQL Database.":::
