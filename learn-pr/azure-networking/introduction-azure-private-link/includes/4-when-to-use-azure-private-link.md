...
![Network diagram showing an Azure virtual network accessing a single instance of an Azure SQL Database via a private IP address mapped by Private Endpoint and not allowing access to other instances of Azure SQL Database.](../media/when-to-use-azure-private-link.png)
