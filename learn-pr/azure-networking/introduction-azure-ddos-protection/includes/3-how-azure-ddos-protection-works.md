To better evaluate whether Contoso should upgrade to DDoS Protection, you need to understand how the service works. In this unit, you learn about the features of DDoS Protection and how it works.
