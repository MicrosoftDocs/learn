...
- An Azure account. You can [sign up for a free account](https://azure.microsoft.com/free/?azure-portal=true) if you don't already have one.
- Software:
...
- Coding skills:
  ...
  - Intermediate knowledge of Python, including these concepts:
