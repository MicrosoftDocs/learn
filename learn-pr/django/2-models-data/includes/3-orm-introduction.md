...
Object-relational mappers, or ORMs, solve this problem by acting as middleware between an application and the database. We can create objects that model the data, including adding constraints and other forms of metadata. The ORM then:

- Manages creating and updating the database as needed.
- Handles the queries.
- Converts (or maps) the requests that we make through our objects into the appropriate database calls.
