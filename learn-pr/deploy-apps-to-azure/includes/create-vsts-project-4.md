...
> [!NOTE]
> For this tutorial, you can use a free account to create a basic ASP.NET web app and CI/CD pipeline. If you don't already have a Visual Studio Team Services account, [create one](http://go.microsoft.com/fwlink/?LinkId=307137).

1. Open your Team Services dashboard in a web browser, and then select **New project**.
2. For the **Project name**, enter *myWebApp*. Leave all other default values, including the *Git* version control and the *Agile* work item process. Then, select **Create**.
