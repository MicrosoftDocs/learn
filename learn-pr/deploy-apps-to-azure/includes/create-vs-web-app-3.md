...
3. Select **Web** templates, and then select the **ASP.NET Web Application** template.
    ...
    2. If the option is available, clear the **Add Application Insights to project** check box. Azure Application Insights requires you to authorize your web application with Application Insights. For this tutorial, skip this process.
    3. Select **OK**.
