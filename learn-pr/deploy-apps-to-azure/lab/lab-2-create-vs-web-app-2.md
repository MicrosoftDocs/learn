To first show the manual process to right-click publish to Azure Web Apps, complete the following steps. This process is not recommended for production workloads where you should typically use a review control process or CI/CD pipeline. You continue to build this CI/CD pipeline in the rest of this tutorial.
