...
Deploying two or more instances of an Azure VM across to or more availability zones raises the VM SLA to 99.99%. Recalculating your composite SLA above with this VM SLA would give you an application SLA of 99.96%, which exceeds your target. To learn more about how the configuration of a VM impacts the SLA, visit [SLA for Virtual Machines](https://azure.microsoft.com/en-us/support/legal/sla/virtual-machines/v1_9/?azure-portal=true) 
