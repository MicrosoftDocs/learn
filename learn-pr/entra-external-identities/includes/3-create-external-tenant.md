...
1. You can scroll down to view a preview of your sign-in page. When you're done, select **Continue**.
    ...
    [ ![Screenshot of "Preview of your sign-in page" and a button labeled Continue highlighted.](../media/create-an-external-tenant/17_inline.png) ](../media/create-an-external-tenant/17_900.png#lightbox)
    [ ![Screenshot of "Preview of your sign-in page" and a button labeled Continue highlighted.](../media/create-an-external-tenant/17_inline.png) ](../media/create-an-external-tenant/17_1000.png#lightbox)
