...
|  |  |
| ------------ | -------------| 
|![Icon indicating play video](../media/video-icon.png)|Watch this video to learn how e-commerce retailer ASOS is using Cosmos DB to enable new cloud applications.|
