Welcome to the Azure demonstration module. This module allows you to *see* how Azure can be used to solve some of the most common challenges in moving to the cloud. You will see a series of two demos. Each demo has been broken into short segments that focus on specific capabilities of the products.
