...
Welcome to the solution demo covering Windows Server and SQL Server migration to Azure. Azure offers solutions that help organizations assess on-premises applications, allowing you to discover servers, visualize dependencies, and confidently plan and implement server and service migration to Azure.
...
- Use Azure Migrate to easily discover and assess your on-premises virtual machines, eliminating the need for your IT department to manually count servers and determine specs.
...
- The Azure Hybrid Benefit allows you to capitalize on your existing Windows licensing investments by providing discounts for VMs turned on in Azure.
...
- Azure Site Recovery offers a method for migrating your on-premises VMs to the cloud without taking the servers down. It replicates the VMs from a primary site (on-premises) to a secondary location (Azure).
