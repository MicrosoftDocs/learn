...
|Business Need | Azure Services | Description | Benefits |
|---------|---------|---------|---------|
|Ability to route data to multiple locations. A cold path for storage, a warm path for analytics.|Azure Hub Message Routing|Provides a sophisticated range of routing options, for masses of incoming data.|Manages multiple goals, such as a cold path for archiving data, a warm path for rapid analysis, and a cooler path for in-depth analysis.|
