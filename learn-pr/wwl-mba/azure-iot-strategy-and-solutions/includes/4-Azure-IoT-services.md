...
|The ability to build apps that interact with the hub.|Azure IoT Service SDKs|The Azure IoT service SDKs contain code to facilitate building applications that interact directly with IoT Hub to manage devices and security.|Enables you to build backend apps to manage your IoT hub. Optionally, send messages, schedule jobs, invoke direct methods, and send desired property updates to your IoT devices or modules.|
