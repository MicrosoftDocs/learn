...
Remember that the chief financial officer (CFO) can be a key player in creating and landing a cloud adoption plan and can drive the value of migration and innovation and create a financial plan for adoption.
...
> [!TIP]
> Links to the TCO Calculator, Azure Pricing Calculator, and Azure Cost Management tools are available in the “Summary and resources” unit at the end of this module.
