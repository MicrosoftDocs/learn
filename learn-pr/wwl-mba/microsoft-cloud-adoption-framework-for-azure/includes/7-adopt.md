...
Align execution to change management requirements to define the cadence and approval process.
...
Replicate on-premises functionality by using cloud native technology.
...
Prepare the migrated asset for ongoing operation.
...
- Cloud migration is the process of moving existing digital assets to a cloud platform. The Cloud Adoption Framework for Azure separates migration into two areas of focus:
...
You've learned how to plan, get ready, and start to deploy your first applications to the cloud. Now let’s talk about how to operate in the cloud.
