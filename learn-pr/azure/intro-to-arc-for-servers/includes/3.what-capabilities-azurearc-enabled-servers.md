...
| Insights | Allows you to use Azure Monitor to review host CPU, disks, and the operating system state of the Arc enabled server. |
...
> [!NOTE] The equivalent VM extensions are available for Arc enabled servers running Linux.
