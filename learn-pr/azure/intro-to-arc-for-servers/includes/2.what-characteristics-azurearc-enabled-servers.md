...
- Azure Arc enabled data services - Azure SQL Database and PostgreSQL Hyperscale services running on Azure Arc enabled Kubernetes or Azure Kubernetes Service on Azure Stack HCI.
...
- [Connect Azure Stack HCI to Azure](https://docs.microsoft.com/en-us/azure-stack/hci/deploy/register-with-azure)
- [Azure Arc enabled SQL Server (preview)](https://docs.microsoft.com/en-us/sql/sql-server/azure-arc/overview?view=sql-server-ver15)
- [What is Azure Arc enabled Kubernetes Preview?](https://docs.microsoft.com/en-us/azure/azure-arc/kubernetes/overview)
- [What is Azure Kubernetes Service on Azure Stack HCI?](https://docs.microsoft.com/en-us/azure-stack/aks-hci/overview)
- [What are Azure Arc enabled data services (preview)?](https://docs.microsoft.com/en-us/azure/azure-arc/data/overview)
