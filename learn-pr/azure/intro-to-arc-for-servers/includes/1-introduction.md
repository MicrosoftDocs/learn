Azure Arc promises to bridge the gap between on-premises and cloud environments by providing consistent operational approach, leveraging agility, automation, and hyperscale of the Azure platform and its services. In this module, you will learn how you can benefit from these capabilities when managing Windows and Linux servers residing on-premises or hosted by third party private and public cloud providers. 
...
<!-- Add "the" before "cloud". Sentence should be "In addition, the Contoso's IT team is exploring the option of migrating to the cloud some of its on-premises server workloads running on legacy infrastructure which is reaching end-of-life.". -->
