...
- It's difficult for some evaluation metrics to become cost functions
...
- Cost functions are ideally smooth. For example, accuracy is useful, but if we change our model slightly, it won’t notice it. Given that fitting is a procedure with lots of small changes, this gives the impression that alterations won't lead to improvement.
