Suppose you're a member of a car manufacturing R&D team that is tasked with designing and developing their new flagship sports car. This project will require running several tightly coupled, high-performance computing (HPC) applications. Each of these applications has different performance characteristics. Management wants your team to complete this project in a timely and cost-effective manner, so your job is to determine the most efficient and economical way of building and running your applications in Azure.

In this module, you'll learn some key optimization principles that will help you ensure that your HPC application runs efficiently from both a VM and HPC software perspective.
