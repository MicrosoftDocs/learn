...
Let's look briefly at the function's other file, the *function.json* config file (close the Test/Run box and click the drop down to view thee file. The configuration data from this file is shown in the following JSON listing.
