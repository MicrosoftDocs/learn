...
Each security group has a set of default security rules to apply the default network rules previously described. These default rules can't be modified but _can_ be overridden.
