...
Recall in the bus catching scenario you will build the foundation with your database. In the case that you want to update the database or deploy the same configurations automatically to a new database, you can use GitHub Actions.
