...
> [!NOTE]
> Depending on your local configuration (for example, if you're on a VPN), Azure Data Studio might prompt you to add your IP address to the server firewall. You can add your IP address to the server firewall in the Azure portal by following the steps [in this article](/azure/azure-sql/database/firewall-configure?view=azuresql#from-the-database-overview-page).
