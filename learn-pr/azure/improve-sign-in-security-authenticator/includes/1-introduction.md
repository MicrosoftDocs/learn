...
By the end of this module, you'll be able to explain why Microsoft Authenticator provides better security than authentication methods like SMS or voice call, enable users to register Microsoft Authenticator when they sign in, and confirm it's their default sign-in method.
