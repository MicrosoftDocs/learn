Fabrikam Residences is struggling to automate its deployment and management, response, and orchestration of servers and VMs across its hybrid and multicloud environment. Azure Automation delivers a cloud-based automation, operating system updates, and configuration service that supports consistent management across Azure and non-Azure environments. In this unit, you’ll learn about Azure Automation’s core capabilities.
...
![Update Management workflow](../media/update-management-flow.png)
