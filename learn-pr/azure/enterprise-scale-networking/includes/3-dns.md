...
-Use an Azure Private DNS zone in the global connectivity subscription. Additional zones might be needed for services such as Private Link. For detailed information on this DNS configuration see here: <https://docs.microsoft.com/azure/private-link/private-endpoint-dns>
