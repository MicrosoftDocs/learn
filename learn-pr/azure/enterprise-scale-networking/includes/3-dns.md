...
Fast and reliable DNS resolution is required for most applications to function well. Azure provides options for built-in name resolution or using your own DNS server, or both. Many customers will use a mix of built-in Azure DNS services and their own DNS servers.
