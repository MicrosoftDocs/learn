...
## Connectivity to PaaS services
        ...
        -Do not enable VNet service endpoints by default on all subnets. Private Link is preferred over service endpoints because PaaS behind private link can be accessed from on-prem and mitigates data exfiltration concerns with service endpoints. https://docs.microsoft.com/azure/private-link/ 
