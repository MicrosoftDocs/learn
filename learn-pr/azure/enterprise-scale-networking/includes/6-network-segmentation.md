...
The platform team can use Azure Policy to ensure that a network security group with specific rules is always associated with subnets that have deny-only policies. Examples of specific rules are denying inbound SSH or RDP from the internet, or allowing/blocking traffic across landing zones. 
