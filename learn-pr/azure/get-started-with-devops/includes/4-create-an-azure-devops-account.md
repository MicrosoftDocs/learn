...
Your new Azure DevOps organization should be created. 
...
In the list of organizations on the left side of the page, you should see the new organization name shown. If you refer to the address bar in your browser, the address for your Azure DevOps organization will be `https://dev.azure.com/<Orgname>`. If you do not see an organization name associated to your account, you will need to create a new organization.
...
This will create a new organization for your Azure DevOps projects, which can be accessed by navigating to a URL in the format `https://dev.azure.com/<Orgname>`.
...
After completing the steps above to create a new Azure DevOps organization, you should be presented with a screen titled "Create a project to get started". If you're using an existing Azure DevOps organization, navigate to `https://dev.azure.com/<Orgname>` to be presented with the same screen.
...
Congratulations! You have signed up for a new Azure DevOps organization and created a new project. You can use your account to start learning more about Azure DevOps, and you will need this account if you want to continue learning more about Azure DevOps in future modules.

This step is just the very beginning of our journey with DevOps using Azure DevOps.
