...
:::row:::
    ...
    **Resource panel**
    ...
    You can also collapse this pane; with the **<<** double-caret. This will minimize it to just icons which can be convenient if you are working with limited screen real-estate.
    :::column-end:::
:::row-end:::
