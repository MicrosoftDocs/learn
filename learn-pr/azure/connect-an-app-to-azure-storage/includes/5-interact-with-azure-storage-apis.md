...
- **Files** for traditional Server Message Block (SMB) file shares.
...
For example, if you want to list all the blobs in a container, you create a request something like:
...
However, this approach requires manual parsing and creating HTTP packets to work with each API. For this reason, Azure provides prebuilt *client libraries* that make working with the service easier for common languages and frameworks.

## Use a client library

Client libraries can save a significant amount of work for app developers because the API is tested, and often provides nicer wrappers around the data models sent and received by the REST API.
...
> [!NOTE]
> The client libraries are just thin *wrappers* around the REST API. They do exactly what you would do if you used the web services directly. These libraries are also open source, making them very transparent. For links to these libraries' source code on GitHub, see the **Additional Resources** section at the end of this module.
