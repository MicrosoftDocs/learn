...
In the Cloud Shell command prompt section of the window, add a reference to the  **Microsoft.Extensions.Configuration.Json** NuGet package.
...
1. In the command prompt section of the Cloud Shell add a dependency to the  **dotenv** package using `npm`.
