...
:::image type="content" source="../media/base-08-section1-step1-1.png" alt-text="Unity MRTK Project Configurator window" lightbox="base-08-section1-step1-1.png":::
...
:::image type="content" source="../media/base-08-section2-step1-1.png" alt-text="Unity MixedRealityToolkit component with newly created profiles applied and eye tracking enabled" lightbox="base-08-section2-step1-1.png":::
...
:::image type="content" source="../media/base-08-section3-step1-1.png" alt-text="Unity with TextMeshPro object selected" lightbox="base-08-section3-step1-1.png":::
...
:::image type="content" source="../media/base-08-section4-step1-1.png" alt-text="Unity with Button object selected" lightbox="base-08-section4-step1-1.png":::
...
:::image type="content" source="../media/base-08-section4-step1-2.png" alt-text="Unity with TextMeshPro object selected and components added" lightbox="base-08-section4-step1-2.png":::
...
:::image type="content" source="../media/base-08-section4-step1-3.png" alt-text="Unity with Hints TextMeshPro object selected and EyeTrackingTarget component configured" lightbox="base-08-section4-step1-3.png":::
