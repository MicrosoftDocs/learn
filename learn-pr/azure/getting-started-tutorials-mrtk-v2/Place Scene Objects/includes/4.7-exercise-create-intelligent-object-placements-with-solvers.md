...
:::image type="content" source="../media/base-05-section1-step1-1.png" alt-text="Unity Project window with Solvers folder selected" lightbox="base-05-section1-step1-1.png":::
...
:::image type="content" source="../media/base-05-section2-step1-1.png" alt-text="Unity with newly added Chevron prefab selected" lightbox="base-05-section2-step1-1.png":::
...
:::image type="content" source="../media/base-05-section2-step1-2.png" alt-text="Unity with DirectionalIndicator solver component added" lightbox="base-05-section2-step1-2.png":::
...
:::image type="content" source="../media/base-05-section2-step1-3.png" alt-text="Unity with DirectionalIndicator solver component configured" lightbox="base-05-section2-step1-3.png":::
...
:::image type="content" source="../media/base-05-section2-step1-4.png" alt-text="Unity Play mode split view with DirectionalIndicator solver in use" lightbox="base-05-section2-step1-4.png":::
...
:::image type="content" source="../media/base-05-section3-step1-1.png" alt-text="Unity with TapToPlace solver component added and configured" lightbox="base-05-section3-step1-1.png":::
...
:::image type="content" source="../media/base-05-section3-step1-2.png" alt-text="Unity with TapToPlace OnPlacingStarted event added" lightbox="base-05-section3-step1-2.png":::
...
:::image type="content" source="../media/base-05-section3-step1-3.png" alt-text="Unity with TapToPlace OnPlacingStarted event configured" lightbox="base-05-section3-step1-3.png":::
...
:::image type="content" source="../media/base-05-section3-step1-4.png" alt-text="Unity with temporary ground cube object added and positioned" lightbox="base-05-section3-step1-4.png":::
...
:::image type="content" source="../media/base-05-section3-step1-5.png" alt-text="Unity with temporary ground cube object Layer set to Spatial Awareness" lightbox="base-05-section3-step1-5.png":::
...
:::image type="content" source="../media/base-05-section3-step1-6.png" alt-text="Unity Play mode split view with gaze hitting RoverAssembly object" lightbox="base-05-section3-step1-6.png":::

7. Click the left mouse button to start the tap-to-place process:

:::image type="content" source="../media/base-05-section3-step1-7.png" alt-text="Unity Play mode split view with TapToPlace placing started" lightbox="base-05-section3-step1-7.png":::
...
:::image type="content" source="../media/base-05-section3-step1-8.png" alt-text="Unity Play mode split view with TapToPlace placing ended" lightbox="base-05-section3-step1-8.png":::
...
:::image type="content" source="../media/base-05-section3-step1-9.png" alt-text="Unity with temporary ground cube selected and Delete contextual popup menu" lightbox="base-05-section3-step1-9.png":::
