...
![Unity Project window with Solvers folder selected](../media/base-05-section1-step1-1.png)
...
![Unity with newly added Chevron prefab selected](../media/base-05-section2-step1-1.png)
...
![Unity with DirectionalIndicator solver component added](../media/base-05-section2-step1-2.png)
...
![Unity with DirectionalIndicator solver component configured](../media/base-05-section2-step1-3.png)
...
![Unity Play mode split view with DirectionalIndicator solver in use](../media/base-05-section2-step1-4.png)
...
![Unity with TapToPlace solver component added and configured](../media/base-05-section3-step1-1.png)
...
![Unity with TapToPlace OnPlacingStarted event added](../media/base-05-section3-step1-2.png)
...
![Unity with TapToPlace OnPlacingStarted event configured](../media/base-05-section3-step1-3.png)
...
![Unity with temporary ground cube object added and positioned](../media/base-05-section3-step1-4.png)
...
![Unity with temporary ground cube object Layer set to Spatial Awareness](../media/base-05-section3-step1-5.png)
...
![Unity Play mode split view with gaze hitting RoverAssembly object](../media/base-05-section3-step1-6.png)

7. Click the left mouse button to start the tap-to-place process:

![Unity Play mode split view with TapToPlace placing started](../media/base-05-section3-step1-7.png)
...
![Unity Play mode split view with TapToPlace placing ended](../media/base-05-section3-step1-8.png)
...
![Unity with temporary ground cube selected and Delete contextual popup menu](../media/base-05-section3-step1-9.png)
