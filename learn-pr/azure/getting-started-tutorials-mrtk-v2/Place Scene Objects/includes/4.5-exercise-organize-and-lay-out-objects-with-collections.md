...
:::image type="content" source="../media/base-04-section3-step1-1.png" alt-text="Unity with newly created RoverParts object selected and positioned" lightbox="base-04-section3-step1-1.png":::
...
:::image type="content" source="../media/base-04-section3-step1-2.png" alt-text="Unity with all Parts selected and Duplicate contextual popup menu" lightbox="base-04-section3-step1-2.png":::
...
:::image type="content" source="../media/base-04-section3-step1-3.png" alt-text="Unity with newly duplicated parts as children of RoverParts object" lightbox="base-04-section3-step1-3.png":::
...
:::image type="content" source="../media/base-04-section3-step1-4.png" alt-text="Unity with RoverAssembly scene visibility off" lightbox="base-04-section3-step1-4.png":::

5. In the Hierarchy window, clean up the RoverParts child objects' names by replacing the appended **(1)** with **_Part**:

:::image type="content" source="../media/base-04-section3-step1-5.png" alt-text="Unity with duplicated parts name cleaned up" lightbox="base-04-section3-step1-5.png":::
...
:::image type="content" source="../media/base-04-section3-step1-6.png" alt-text="Unity RoverParts object with Add Component Grid Object Collection in progress" lightbox="base-04-section3-step1-6.png":::
...
:::image type="content" source="../media/base-04-section3-step1-7.png" alt-text="Unity with GridObjectCollection component configured" lightbox="base-04-section3-step1-7.png":::
