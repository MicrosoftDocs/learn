...
:::image type="content" source="../media/base-02-section7-step1-1.png" alt-text="Import custom package" lightbox="base-02-section7-step1-1.png":::
...
:::image type="content" source="../media/base-02-section7-step1-2.png" alt-text="Import tutorial package" lightbox="base-02-section7-step1-2.png":::
...
:::image type="content" source="../media/base-02-section7-step1-3.png" alt-text="Click the all button to ensure all the assets are selected" lightbox="base-02-section7-step1-3.png":::

## Create the parent object

1. In the Hierarchy window, right-click on an empty spot, and select **Create Empty** to add an empty object to your scene:

:::image type="content" source="../media/base-04-section1-step1-1.png" alt-text="Unity Create Empty contextual popup menu" lightbox="base-04-section1-step1-1.png":::

2. Right-click on the newly created object, select **Rename**, and change the name to **RoverExplorer**:

:::image type="content" source="../media/base-04-section1-step1-2.png" alt-text="Unity Rename contextual popup menu" lightbox="base-04-section1-step1-2.png":::
...
:::image type="content" source="../media/base-04-section1-step1-3.png" alt-text="Unity with RoverExplorer object selected and positioned" lightbox="base-04-section1-step1-3.png":::

## Add the tutorial prefabs

1. In the Project window, navigate to the **Assets** > **MRTK.Tutorials.GettingStarted** > **Prefabs** folder:

:::image type="content" source="../media/base-04-section2-step1-1.png" alt-text="Unity Project window with Prefabs folder selected" lightbox="base-04-section2-step1-1.png":::
...
:::image type="content" source="../media/base-04-section2-step1-2.png" alt-text="Unity with newly added Table prefab selected and positioned" lightbox="base-04-section2-step1-2.png":::
...
:::image type="content" source="../media/base-04-section2-step1-3.png" alt-text="Unity with newly added RoverAssembly prefab selected and positioned" lightbox="base-04-section2-step1-3.png":::
