...
![Import custom package](../media/base-02-section7-step1-1.png)
...
![Import tutorial package](../media/base-02-section7-step1-2.png)
...
![Click the all button to ensure all the assets are selected](../media/base-02-section7-step1-3.png)
