...
:::image type="content" source="../media/base-06-section3-step1-1.png" alt-text="Unity with newly created TextMeshPro object selected" lightbox="base-06-section3-step1-1.png":::
...
:::image type="content" source="../media/base-06-section3-step1-2.png" alt-text="Unity with TextMeshPro component configured" lightbox="base-06-section3-step1-2.png":::
...
:::image type="content" source="../media/base-06-section4-step1-1.png" alt-text="Unity Project window with ToolTips folder selected" lightbox="base-06-section4-step1-1.png":::
...
:::image type="content" source="../media/base-06-section4-step1-2.png" alt-text="Unity with all rover part objects selected and ToolTipSpawner component added and configured" lightbox="base-06-section4-step1-2.png":::
...
:::image type="content" source="../media/base-06-section4-step1-3.png" alt-text="Unity with Camera ToolTipText configured" lightbox="base-06-section4-step1-3.png":::
...
:::image type="content" source="../media/base-06-section4-step1-4.png" alt-text="Unity Play mode split view with tooltip triggered by gaze" lightbox="base-06-section4-step1-4.png":::
