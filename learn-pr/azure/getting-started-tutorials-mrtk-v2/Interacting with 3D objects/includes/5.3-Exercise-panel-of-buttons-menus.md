# Exercise - Include Panel of Buttons and Dynamic Menu
...
:::image type="content" source="../media/base-06-section1-step1-1.png" alt-text="Unity with newly created Buttons object selected and positioned" lightbox="base-06-section1-step1-1.png":::
...
:::image type="content" source="../media/base-06-section1-step1-2.png" alt-text="Unity with newly added PressableRoundButton prefabs" lightbox="base-06-section1-step1-2.png":::
...
:::image type="content" source="../media/base-06-section1-step1-3.png" alt-text="Unity Buttons object with GridObjectCollection component added, configured, and applied" lightbox="base-06-section1-step1-3.png":::
...
:::image type="content" source="../media/base-06-section1-step1-4.png" alt-text="Unity with button text labels configured" lightbox="base-06-section1-step1-4.png":::
...
:::image type="content" source="../media/base-06-section1-step1-5.png" alt-text="Unity with Hints button object OnClick event configured" lightbox="base-06-section1-step1-5.png":::
...
:::image type="content" source="../media/base-06-section1-step1-6.png" alt-text="Unity with Explode button object OnClick event configured" lightbox="base-06-section1-step1-6.png":::
...
:::image type="content" source="../media/base-06-section1-step1-7.png" alt-text="Unity Play mode split view with Hints button being pressed" lightbox="base-06-section1-step1-7.png":::

8. **Explode button** will toggle the exploded view on and off:

:::image type="content" source="../media/base-06-section1-step1-8.png" alt-text="Unity Play mode split view with Explode button being pressed" lightbox="base-06-section1-step1-8.png":::
...
:::image type="content" source="../media/base-06-section2-step1-1.png" alt-text="Unity with newly added near menu prefab selected" lightbox="base-06-section2-step1-1.png":::
...
:::image type="content" source="../media/base-06-section2-step1-2.png" alt-text="Unity with Menu object selected and ButtonCollection object expanded" lightbox="base-06-section2-step1-2.png":::
...
:::image type="content" source="../media/base-06-section2-step1-3.png" alt-text="Unity with Indicator button object Button Config Helper configured" lightbox="base-06-section2-step1-3.png":::
...
:::image type="content" source="../media/base-06-section2-step1-4.png" alt-text="Unity with Indicator object selected, disabled, and DirectionalIndicatorController component added" lightbox="base-06-section2-step1-4.png":::
...
:::image type="content" source="../media/base-06-section2-step1-5.png" alt-text="Unity with TapToPlace button object Button Config Helper configured" lightbox="base-06-section2-step1-5.png":::
...
:::image type="content" source="../media/base-06-section2-step1-6.png" alt-text="Unity with TapToPlace component reconfigured" lightbox="base-06-section2-step1-6.png":::
