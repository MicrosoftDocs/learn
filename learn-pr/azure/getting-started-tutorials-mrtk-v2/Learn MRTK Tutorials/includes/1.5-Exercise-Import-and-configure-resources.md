...
:::image type="content" source="../media/base-02-section4-step1-1.png" alt-text="Opening MixedRealityFeatureTool" lightbox="base-02-section4-step1-1.png":::
...
2. In the **New Scene** window select **Basic (Built-in)** and click on create to **create** a new
scene:
