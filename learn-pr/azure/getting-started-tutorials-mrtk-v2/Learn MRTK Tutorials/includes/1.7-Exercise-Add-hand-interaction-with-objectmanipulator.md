# Exercise - Add hand interaction with objectmanipulator and deploy your application to HoloLens 2
...
:::image type="content" source="../media/base-02-section8-step1-1.png" alt-text="Adding the cube" lightbox="base-02-section8-step1-1.png":::
...
:::image type="content" source="../media/base-02-section8-step1-1b.png" alt-text="Adding the cube" lightbox="base-02-section8-step1-1b.png":::
...
3. To focus in on the objects in the scene, you can double-click on the **Cube** object, and then zoom slightly in again. Or you can use F key to zoom and focus on the object.

4. To interact and grab an object with tracked hands, the object must have:
* Collider component such as **Box Collider** (Unity's cube already has a Box Collider
by default)
...
:::image type="content" source="../media/base-02-section8-step1-2.png" alt-text="Adding the object manipulator" lightbox="base-02-section8-step1-2.png":::

6. Repeat the same to add **Near Interaction Grabbable script** to the cube.

:::image type="content" source="../media/base-02-section8-step1-3.png" alt-text="Adding the Near Interaction Grabbable" lightbox="base-02-section8-step1-3.png":::

[!NOTE]
> When you add a Object Manipulator (Script), in this case, the Constraint Manager
(Script) is automatically added because Object Manipulator (Script) depends on it.
...
:::image type="content" source="../media/base-02-section8-step1-4.gif" alt-text="Move the cube" lightbox="base-02-section8-step1-4.gif":::
...
:::image type="content" source="../media/base-02-section9-step1-1.png" alt-text="Adding Scenes in build" lightbox="base-02-section2-step1-1.png":::
...
:::image type="content" source="../media/base-02-section9-step1-2.png" alt-text="Select a Build folder" lightbox="base-02-section2-step1-2.png":::

3. Wait for Unity to finish the build process: 

:::image type="content" source="../media/base-02-section9-step1-3.png" alt-text="Wait for the build process to finish" lightbox="base-02-section2-step1-3.png":::
...
:::image type="content" source="../media/base-02-section10-step1-1.png" alt-text="File Explorer" lightbox="base-02-section10-step1-1.png":::
...
:::image type="content" source="../media/base-02-section10-step1-2.png" alt-text="Visual Studio window 1" lightbox="base-02-section10-step1-2.png":::

[!TIP]
> If you're deploying to HoloLens (1st generation), select the **x86** architecture.

[!NOTE]
> For HoloLens, you will typically build for the ARM architecture. However, there is a [known issue](https://github.com/microsoft/MixedRealityToolkit-Unity) in Unity 2019.3 that causes errors when selecting ARM as the build architecture in Visual Studio. The recommended workaround is to build for ARM64. If that is not an option, go to **Edit** > **Project Settings** > **Player** > **Other Settings** and disable **Graphics Jobs**.
...
:::image type="content" source="../media/base-02-section10-step1-3.png" alt-text="Visual Studio Window 2" lightbox="base-02-section10-step1-3.png":::

[!IMPORTANT]
> Before building to your device, the device must be in Developer Mode and paired with your development computer. Both of these steps can be completed by following [these instructions](https://docs.microsoft.com/en-us/windows/mixed-reality/develop/platform-capabilities-and-apis/using-visual-studio).

[!TIP]
> You can also deploy to the [HoloLens Emulator](https://docs.microsoft.com/en-us/windows/mixed-reality/develop/platform-capabilities-and-apis/using-the-hololens-emulator) or create an [App Package](https://docs.microsoft.com/en-us/windows/uwp/packaging/packaging-uwp-apps) for sideloading.
