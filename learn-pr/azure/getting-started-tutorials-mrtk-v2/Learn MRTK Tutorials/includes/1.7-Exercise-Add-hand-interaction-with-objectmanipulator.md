...
![Adding the cube](../media/base-02-section8-step1-1.PNG)
...
![Adding the cube](../media/base-02-section8-step1-1b.PNG)
...
![Adding the object manipulator](../media/base-02-section8-step1-2.PNG)

6. Repeat the same to add **Near Interaction Grabbable script** to the cube.

![Adding the Near Interaction Grabbable](../media/base-02-section8-step1-3.PNG)
...
![Adding Scenes in build](../media/base-02-section9-step1-1.png)
...
![Select a Build folder](../media/base-02-section9-step1-2.png)
...
![File Explorer](../media/base-02-section10-step1-1.png)
...
![Visual Studio window 1](../media/base-02-section10-step1-2.png)
...
![Visual Studio Window 2](../media/base-02-section10-step1-3.png)
