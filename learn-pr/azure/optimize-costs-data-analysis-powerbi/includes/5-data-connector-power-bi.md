...
Select a table to see a preview dialog. You can select one or more tables by selecting the boxes beside their name and then select **Load**.

When the data you selected is loaded, the data tables and fields are shown in the **Fields** list.

To create a report:

 1. For this example, select **Usage details** and then select **Load**.  
