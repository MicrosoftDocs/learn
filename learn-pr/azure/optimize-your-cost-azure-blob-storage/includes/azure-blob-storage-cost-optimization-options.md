...
If you expect to use Azure Blob Storage for an extended amount of time, you can further reduce your costs by purchasing a reserved capacity in 100 terabyte (TB) and 1 petabyte (PB) units per month for the period of either one year or three years. This arrangement offers a discounted price for storage (per gigabyte) charges of data residing in Azure Blob Storage and Azure Data Lake Storage Gen2 storage accounts. A reservation can be purchased for any access tier and type of redundancy but is applicable to a specific combination of the Azure region, access tier, and redundancy option.
