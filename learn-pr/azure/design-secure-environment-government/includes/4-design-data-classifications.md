...
* All recommended technologies used for unclassified data, especially services such as [Virtual Network](/azure/virtual-network/virtual-networks-overview), [Azure Security Center](/azure/security-center/), and [Azure Monitor](/azure/azure-monitor/).
