...
1. Find the resource group **ship-manager**, or the resource group name that you used, and select it.
...
1. Repeat the preceding steps for the resource group named **MC_ship-manager_ship-manager_eastus** to delete all created resources.
