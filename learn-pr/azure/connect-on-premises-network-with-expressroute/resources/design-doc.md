...
1. **What is the Azure ExpressRoute service**
   ...
   - Describe the Azure ExpressRoute service
       ...
       - What can the service be used for?  
        ...
        - Call out that ExpressRoute needs to be implemented through a Provider. See [Azure Expressroute providers and locations](/azure/expressroute/expressroute-locations))
