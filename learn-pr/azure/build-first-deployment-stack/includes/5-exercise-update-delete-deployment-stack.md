...
1. You're prompted to enter a value for `sqlServerAdminUserName`. Create a name for the SQL server administrator, followed by 'Enter.'
    ...
    :::image type="content" source="../media/sql-admin-cli.png" alt-text="{A graphic representing the Azure CLI command line prompting you to enter an SQL server administrator user name.}":::
...
1. You're prompted to enter a value for `sqlServerAdminPassword`. Create a complex password for the SQL server administrator, followed by 'Enter.'
    ...
    :::image type="content" source="../media/sql-password-cli.png" alt-text="{A graphic representing the Azure CLI command line prompting you to enter an SQL server administrator password.}":::
...
2. You're prompted to enter a value for `sqlServerAdminUserName`. Create a name for the SQL server administrator, followed by 'Enter.'
    ...
    :::image type="content" source="../media/sql-admin-powershell.png" alt-text="{A graphic representing the Azure PowerShell command line prompting you to enter an SQL server administrator user name.}":::
...
3. You're prompted to enter a value for `sqlServerAdminPassword`. Create a complex password for the SQL server administrator, followed by 'Enter.'
    ...
    :::image type="content" source="../media/sql-password-powershell.png" alt-text="{A graphic representing the Azure PowerShell command line prompting you to enter an SQL server administrator password.}":::
...
1. You're asked to confirm if you would like to remove the resource group. Press 'Y', followed by 'Enter.'
    ...
    :::image type="content" source="../media/confirm-resource-group-cli.png" alt-text="{A graphic representing a command line confirmation to delete the resource group using Azure CLI.}":::
...
2. You're asked to confirm if you would like to delete the stack and the specified resources.
    ...
    :::image type="content" source="../media/confirm-powershell.png" alt-text="{A graphic representing a command line confirmation to delete the deployment stack using Azure PowerShell.}":::
...
5. You're asked to confirm if you would like to remove the resource group. Press 'Y', followed by 'Enter.'
    ...
    :::image type="content" source="../media/confirm-resource-group-powershell.png" alt-text="{A graphic representing a command line confirmation to delete the resource group using Azure PowerShell.}":::
