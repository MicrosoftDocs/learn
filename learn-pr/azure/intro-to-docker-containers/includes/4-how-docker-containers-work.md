...
:::image type="content" source="../media/4-docker-container-lifecycle.svg" alt-text="Diagram that shows the lifecycle of a container and the transition between the lifecycle phases.":::
