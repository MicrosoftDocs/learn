...
![An illustration showing a Docker image with an Ubuntu base OS and the dependency on the host OS Kernel.](../media/3-container-ubuntu-host-os.png)
...
![An illustration showing the stacking of layers in a Docker image.](../media/3-unionfs-diagram.png)
