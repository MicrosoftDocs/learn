...
For more information about Intune supported devices, platforms, and operating systems, see [Supported operating systems and browsers in Intune](https://docs.microsoft.com/mem/intune/fundamentals/supported-devices-browsers).
