...
| `Version` | The version number of the agent monitoring the virtual machine. | Identify the agent version oon each machine. | Rename the column to `AgentVersion` (`AgentVersion=Version`). |
