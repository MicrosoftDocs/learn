...
| `ObjectName` | Holds the names of all of the objects for which the table holds performance data.  | Analyze the performance of the processor. | `ObjectName == "Processor"` <br/>For more information, see [== (equals) operator](/azure/data-explorer/kusto/query/equals-cs-operator).|
