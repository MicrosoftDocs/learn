...
You've recently acquired a branch whose employees will need access to your accounting applications. This branch is managed in a separate Azure AD tenant. You don't want these users to have to complete multi-factor authentication (MFA) repeatedly during sign-in, so you want to streamline their experience by trusting multi-factor authentication from the branch tenant.
