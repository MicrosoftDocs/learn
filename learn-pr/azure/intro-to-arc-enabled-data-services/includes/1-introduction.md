...
In this module you will learn the fundamenatls of hybrid computing, Azure Arc, and Azure Arc-enabled data services. You will learn the architecture of Azure Arc-enabled data services and how various components and tools interact with Azure and Kuberentes. You will also learn the capabilites, features, and interfaces of Azure Arc-enabled SQL Managed Instance and Azure Arc-enabled PostgreSQL Hyperscale.
