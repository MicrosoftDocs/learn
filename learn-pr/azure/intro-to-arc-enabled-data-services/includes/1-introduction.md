...
Azure Arc-enabled data services are designed to make it possible to run Azure-managed data services in the infrastructure of your choice using the power of Kubernetes. Azure Arc-enabled data services include Azure Arc-enabled SQL Managed Instance and Azure Arc-enabled PostgreSQL server (preview).

In this module, you learn the fundamentals of hybrid computing, Azure Arc, and Azure Arc-enabled data services. You learn the architecture of Azure Arc-enabled data services and how various components and tools interact with Azure and Kubernetes. You also learn the capabilities, features, and interfaces of Azure Arc-enabled SQL Managed Instance.
