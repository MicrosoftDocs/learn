...
Hybrid computing connects on-premises systems to one or more public-cloud systems. It provides a single application experience along with simple provisioning, governance, and management. Hybrid computing gives you the ability to use current on-premises investments. It places data close to the compute environment for the best performance. Another advatnage is selecting the proper security for applications, all while using a unified billing, management, and data collection and reporting for the governance of the entire system.
