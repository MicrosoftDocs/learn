You've been able to build and test an Azure Function using Maven, which resolves part of the scenario that you're researching for your company. Your next task is to investigate how to deploy your function to Azure Functions.
