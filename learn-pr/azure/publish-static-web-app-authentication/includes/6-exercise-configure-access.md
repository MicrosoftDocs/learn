...
1. Open the file `angular-app/staticwebapp.config.json`

::: zone-end

::: zone pivot="react"

1. Open the file `react-app/staticwebapp.config.json`

::: zone-end

::: zone pivot="svelte"

1. Open the file `svelte-app/staticwebapp.config.json`

::: zone-end

::: zone pivot="vue"

1. Open the file `vue-app/staticwebapp.config.json`
...
1. You should see a 404 error page like this:
    ...
    :::image type="content" source="../media/swa-404-error-page.png" alt-text="Screenshot of the Static Web Apps 404 error page":::
