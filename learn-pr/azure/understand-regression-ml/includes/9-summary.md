...
We also covered R2 values, which we use to assess how well our model fits the data, with the number 0 meaning the model is completely ineffective, and 1 meaning it fits perfectly.
