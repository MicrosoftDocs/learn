...
To troubleshoot an NSG flow issue, use the Network Watcher IP flow verify tool and NSG flow logging to determine whether there's an NSG or UDR that's interfering with traffic flow.
