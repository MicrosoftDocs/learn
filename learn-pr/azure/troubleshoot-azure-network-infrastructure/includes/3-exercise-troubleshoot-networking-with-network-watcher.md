...
The results should show that traffic flows from the back-end VM to the front-end VM.
...
The results should show that no traffic flows from the front-end VM to the back-end VM.
