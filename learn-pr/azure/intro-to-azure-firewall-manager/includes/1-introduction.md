...
:::image type="content" source="../media/firewall-manager-overview.png" alt-text="Diagram showing the hierarchy of Firewall Manager. A firewall administrator uses Firewall Manager, which centralizes management of firewall policies.":::
