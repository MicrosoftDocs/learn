...
In this unit, you'll determine whether using Azure Firewall Manage will benefit your organization. 
...
- Implement Azure Firewall Manager to centralize configuration

The choice you make is determined largely by the complexity of your Azure infrastructure. 
