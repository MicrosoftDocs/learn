You've deployed Azure File Sync and configured both the Azure and on-premises environments. In this exercise, you map a drive to the Azure file share and check that the file sync works.
...
1. Under **key1**, copy the **Key** value. You use this key to set up the mapped drive.
