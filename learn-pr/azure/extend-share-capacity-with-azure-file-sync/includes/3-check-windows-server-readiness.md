...
After learning about Azure File Sync, you want to assess your servers to check whether they can take part in the sync process. You investigate the tools offered by Microsoft to help you do this task.

In this unit, you learn the system requirements for servers that you want to use with Azure File Sync. You find out how to run system checks by using PowerShell.
...
There are many different file types on a Windows Server computer. Some files are important to the OS but have no place in a sync operation. If these files are synced, they would take up unnecessary space. So the following files are ignored:
