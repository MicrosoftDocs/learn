...
1. In the left Activity Bar, open the Remote Explorer.
...
1. Stop forwarding port 5000 (right-click -> Stop Forwarding Port, or select the X next to the globe icon).
