...
:::image type="content" source="../media/add-container.png" alt-text="How to create a container configuration file using Remote - Containers extension.":::
...
:::image type="content" source="../media/docker-file.png" alt-text="Docker container configuration created by Remote - Containers extension.":::
...
:::image type="content" source="../media/devcontainer-files.png" alt-text="Devcontainer configuration file created by Remote - Containers extension.":::