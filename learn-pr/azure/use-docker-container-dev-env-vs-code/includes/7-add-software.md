...
When you ran **Dev Containers: Add Development Container Configuration Files**, a '.devcontainer' folder was added to your app. It included a devcontainer.json file and a Dockerfile. These files came from the [Visual Studio Code dev containers](https://github.com/microsoft/vscode-dev-containers) repo. Although this repo gives us many options for our team, we might want to iterate on them by installing more software.
