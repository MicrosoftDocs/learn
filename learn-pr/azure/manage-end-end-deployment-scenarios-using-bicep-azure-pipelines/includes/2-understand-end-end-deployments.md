...
>
> If you're in this position, you can consider disabling the infrastructure deployment for your development environment. You can use pipeline templates and conditions to achieve this. However, you should leave the full deployment sequence intact for your other environments.
