...
Pipeline tasks and scripts provide you with flexibility and control. They also enable you to access *pipeline artifacts*, which you'll learn about soon. In this module, we focus on pipeline scripts and tasks. We link to more information about Resource Manager deployment scripts in the summary.
