...
By the end of this session, you'll be able to add sign in support to a Python Flask web app using the Microsoft identity platform. The app you build can log in users and allow them access protected data based on their roles. 