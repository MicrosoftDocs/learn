...
1. **Exercise - deploy a Low Priority Scale Set in Azure Portal**
...
1. **Exercise - Installing and Updating Applications in Scale Sets**
    ...
    You need to deploy Proxy software to your Azuze Virtual Machine Scale Set. In this unit, you will use the Azure Shell and CLI to create a Scale set, use a Custom Script Extension to deploy the Proxy and then roll out an update
      ...
      1. Create the Custom Script Extension definition by running `sensible-editor customConfig.json` and entering the below code block
      ...
      1. Create a virtual machine set. This will take a few minutes.
      ...
      1. Apply the custom script agent
      ...
      1. To test your WebServer, collect the Public IP of your Load Balancer. Enter the output of this into a web browser. Leave this page open.
      ...
      1. To update your App Deployment update the Custom Script Extension.  Create the following file using `sensible-editor customConfigv2.json`
