In this module, you use Azure Container Instances to launch APIs in single containers, inside of virtual networks to increase security. You then learn to use advanced tools like sidecar containers, initialization containers, and Azure Private Link to address sophisticated networking and security requirements.
...
You need to implement several improvements in a customer API to better meet their requirements.
