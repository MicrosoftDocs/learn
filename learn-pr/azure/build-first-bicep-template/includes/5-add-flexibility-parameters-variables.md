...
The resource group ID includes the Azure subscription ID (`1a12b123-123c-123a-1a2b-1ab23cd45e67`) and the resource group name (`MyResourceGroup`). The resource group ID is often a good candidate for a seed value for resource names, because:
