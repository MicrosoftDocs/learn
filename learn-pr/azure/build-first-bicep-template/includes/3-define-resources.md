...
* `Microsoft.Storage/storageAccounts@2021-08-01` is the _resource type_ and _API version_ of the resource. `Microsoft.Storage/storageAccounts` tells Bicep that you're declaring an Azure storage account. `2021-08-01` is the version of the Azure Storage API that Bicep will use when it creates the resource.
  > [!TIP]
