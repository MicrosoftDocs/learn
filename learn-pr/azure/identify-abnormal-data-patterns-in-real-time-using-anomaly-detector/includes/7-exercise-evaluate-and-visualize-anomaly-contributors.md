...
![Diagram displaying graph showing anomalies from the mutivariant anomaly detector](..\media\7-exercise-evaluate-and-visualize-anomaly-contributors-1.png)
...
```
![Diagram displaying contributors of an anomaly](..\media\7-exercise-evaluate-and-visualize-anomaly-contributors-2.png)
