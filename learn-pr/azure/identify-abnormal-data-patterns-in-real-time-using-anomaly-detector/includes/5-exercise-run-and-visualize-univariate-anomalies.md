...
```
![Diagram displaying anomaly sensitivity level at 95](..\media\5-exercise-run-and-visualize-univariate-anomalies-1.png)
...
build_figure(result, BLOB_DATASET, sensitivity)
```
![Diagram displaying anomaly sensitivity level at 70](..\media\5-exercise-run-and-visualize-univariate-anomalies-2.png)