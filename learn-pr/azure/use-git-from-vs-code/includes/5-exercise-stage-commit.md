...
:::image type="content" source="../media/5-visual-studio-code-source-control.png" alt-text="Screenshot of the Visual Studio Code Source Control view with the file containing changes shown in the working tree." light="../media/5-visual-studio-code-source-control.png":::
