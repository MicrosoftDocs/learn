...
1. **Overview of a geographically distributed networking architecture**
    ...
    - The core component of the networking architecture is Traffic Manager:
        ...
        - Illustrate this priority routing mode with a simplified diagram based on https://docs.microsoft.com/en-gb/azure/traffic-manager/traffic-manager-routing-methods#priority-traffic-routing-method with just a single failover but clearly shown in a separate region
