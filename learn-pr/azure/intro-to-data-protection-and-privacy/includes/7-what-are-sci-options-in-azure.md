As you move more data to the cloud, it's important to feel confident that you're not opening yourself up to security or compliance risks. You need a partner that can meet you where you are today and provide what’s needed as both your environment and business change. To help ensure meeting all security and compliance advancements and requirements, Microsoft is regularly audited and submits self-assessments to third-party auditors. Microsoft proactively collaborates with industry leaders and government bodies around the world to anticipate future compliance requirements. As a result, Microsoft is often the first global cloud service provider to adopt new frameworks and standards.
...
The Service Trust Portal contains additional guidance and tools to help meet your security, compliance, and privacy needs when using Azure and other Microsoft Cloud services. These audit reports, Azure Security Blueprints, and trust documents to help you understand cloud features, and to verify technical compliance and control requirements.
...
You can use the built-in blueprints or create your own custom blueprints. Blueprints can be created in the Azure portal or using the REST API with tools such as PowerShell or Azure Portal. If the latter method is used, you can define blueprint parameters to prevent conflicts when reusing certain blueprints. 
...
**Data encryption**. Data in Azure is always encrypted. You can encrypt data in storage (at rest) and in transit to align with best practices for protecting the confidentiality and integrity of your data. For some Azure services you can control if Microsoft-managed or customer-managed keys are used for encryption. Azure supports various encryption models, including both client-side and server-side encryption. 
