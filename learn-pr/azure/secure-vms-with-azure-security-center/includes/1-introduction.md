...
These servers and personal devices are common targets for attack. Once a hacker gets access to a single computer on your network, they can begin to infiltrate all of your data. Your job is to lock down these local and cloud servers. You ensure that the surface area is minimized, and that common attack vectors are closed. You've explored the features of **Microsoft Defender for Cloud** to analyze your network and cloud resources and have decided to use some of its built-in features to protect your VM and computing hardware.
