Server administrators understand that it's efficient to remotely administer and maintain servers in an on-premises datacenter. With Windows IaaS VMs being deployed in Azure, administrators must rely solely on remote management to be able to administer and maintain cloud-based resources. But how can administrators connect securely to remote cloud-based VMs without exposing the management interfaces of those VMs to the internet? Azure Bastion is a service that you can use to securely connect to your Azure virtual machines (VMs) remotely, without needing to expose remote administrative ports to the internet.
