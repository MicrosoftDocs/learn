...
Server administrators understand that it's more efficient to remotely administer and maintain servers in an on-premises datacenter than it is to interactively administer them using locally installed tools. Of course, with Windows IaaS VMs being deployed in Azure, admins must rely solely on remote management to be able to administer and maintain cloud-based resources. But how can admins connect securely to remote cloud-based VMs without exposing the management interfaces of those VMs to the internet? 
...
In this module, you'll learn about how Azure Bastion can help protect your hosted VMs. This is because Azure Bastion avoids the need to expose RDP and SSH ports to the internet. However, it still provides the convenience of securely using both RDP and SSH.
