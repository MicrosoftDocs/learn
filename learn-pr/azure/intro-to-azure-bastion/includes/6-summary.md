...
We applied these criteria to the scenario and decided that Azure Bastion is the preferred choice for remote management of the LOB app. The criteria helped you evaluate whether your business requirements are a good match for Azure Bastion. First, they let you assess how well Azure Bastion will solve your problem. Second, they give you an idea of the amount of management effort that's involved in using Azure Bastion for your task. The analysis made it clear that Azure Bastion provides a more secure option than jump servers and takes less of your time with management and update tasks.  
