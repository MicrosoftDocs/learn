...
Suppose that you work at a financial-services company that uses Azure services extensively. Your chief technology officer (CTO) wants to migrate several applications, databases, and support files to the cloud. Most of these applications are running in your on-premises system area network (SAN), which requires shared block storage. This migration will reduce the number of physical servers you must maintain in your datacenter. 
