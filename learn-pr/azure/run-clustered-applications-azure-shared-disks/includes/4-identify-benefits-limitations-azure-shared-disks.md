...
- **High availability**. Using HA configurations provide better control on application uptime for planned and unplanned failovers. If there's a failure in one VM, the other VMs can maintain full access to the disk.
