With deadlines approaching, you needed to render video scenes in a few hours so that reviews could complete within the same day.

Azure HPC Cache let you remove the bottleneck from storage and allowed your HPC clients to access the data faster. After connecting the cache to the NAS and pointing your HPC clients to the cache, the cloud clients ran more efficiently and created more video content in less time.
