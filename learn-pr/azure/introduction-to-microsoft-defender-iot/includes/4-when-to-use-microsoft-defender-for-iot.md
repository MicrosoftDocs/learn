This unit dives deeper into the features provided by Microsoft Defender for IoT.

Use this unit to further evaluate whether Defender for IoT is the right solution for your organization, and whether Defender for IoT can help your team meet its goals for OT/IoT security and operations.


The following table lists several business needs your organization might encounter, and how Defender for IoT can answer those needs.
...
|**Automate remediation actions**     |    Use the Microsoft Sentienl playbooks provided with the **IoT OT Threat Monitoring with Defender for IoT** solution to run automated remediation actions as a routine.   |
