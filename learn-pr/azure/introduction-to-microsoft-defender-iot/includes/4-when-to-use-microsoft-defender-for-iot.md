...
|---------|---------|
|Device discovery     | The Defender for IoT sensor console provides a **Device inventory** page and a **Device map** page. The pages provide drill-down data on each of the OT/IoT devices in your network and the connections between them.      |
