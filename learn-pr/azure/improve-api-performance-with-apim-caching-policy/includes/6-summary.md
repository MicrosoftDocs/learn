In this module you have how you can use Azure API Management to modify the behavoir of an API without re-writing any code. As the developer at the Board gaming company you were able to apply a caching policy to a GET operation to enable a more speedy response to identical queries.
