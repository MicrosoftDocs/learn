...
- Use zipdeploy to quickly deploy to app service instead of doing the git dance. See https://docs.microsoft.com/training/modules/instrument-web-app-code-with-application-insights/5-instrument-the-application for an example.
