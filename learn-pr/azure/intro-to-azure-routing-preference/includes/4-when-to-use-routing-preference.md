...
Here, we'll discuss how you can decide whether changing the routing preference of the application in Azure fulfills the goal of the traffic cost savings project. We list some criteria that indicate whether routing preference meets your cost savings goal.
