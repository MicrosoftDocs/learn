Azure VMware Solution (AVS) provides you with a dedicated, private cloud in Azure. Built by Microsoft and VMware. AVS deploys on dedicated bare-metal infrastructure in Azure. 
...
- Benefits of the service on existing licensing when using the Azure Hybrid Benefits
