...
* Download finger-painting sample application requirement from the provided GitHub link [maluoi/ StereoKit-PaintTutorial](https://github.com/maluoi/StereoKit-PaintTutorial) & select [StereoKitPaintTutorial_UWP](https://github.com/maluoi/StereoKit-PaintTutorial).
...
Look for the Assets folder in the solution explorer. This folder contains paint .glb and palette .glb model files which will be used later in the application.
