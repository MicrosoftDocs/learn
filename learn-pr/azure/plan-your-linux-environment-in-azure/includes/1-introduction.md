...
To optimize the VMs' performance, functionality, and pricing, you must properly plan their configuration and deployment. This learning module reviews how to plan for a deployment of Azure VMs that run Linux operating systems (OSs). The planning process involves:
