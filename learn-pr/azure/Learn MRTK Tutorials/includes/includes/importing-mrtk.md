...
![opening MRTK configurator tool](../../media/base-02-section5-step1-1xrsdk.PNG)
...
> [!IMPORTANT]
> The Mixed Reality Feature Tool performs validation to ensure that it has been
directed to a Unity project folder. The folder must contain Assets, Packages
and Project Settings folders.
...
![MixedRealityFeatureTool Discover Features](../../media/base-02-section4-step1-4-openxr.png)
...
![MRTK Project Configurator](../../media/base-02-section5-step1-9-openxr.PNG)
...
![MRTK Project Configurator 2](../../media/base-02-section5-step1-10-openxr.PNG)
