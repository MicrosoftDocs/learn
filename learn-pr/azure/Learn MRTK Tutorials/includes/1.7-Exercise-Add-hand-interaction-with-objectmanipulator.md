## Exercise - Add hand interaction with object manipulator and deploy your application to HoloLens 2
...
![Changing the transform values of the cube](../media/base-02-section8-step1-1b.png)
...
2. If you use the default scale (1,1,1), the cube will be too big. If you use the default position (0,0,0), the cube will be placed at the same position as your headset and you won't be able to see it until you move backward.
