In this unit, you've seen how managed disks provide storage that is easy to set up, scalable, and highly available without incurring much administrative effort. You've also learnt about these disk types and can choose the best type for a set of virtual machine requirements:
