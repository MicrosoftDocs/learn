...
To meet your goals, you need to ensure that the functionality provided by the special hardware device is replicated by the Azure service that you're replacing it with. Important functionality that must be present in the replacement service includes:
