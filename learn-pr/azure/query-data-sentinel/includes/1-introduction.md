Microsoft Microsoft Sentinel Workbooks provide interactive reports that help you visualize important signals by combining text, table, charts, and tiles.
...
In this module, you'll learn how to create and use Microsoft Sentinel Workbooks to visualize security data, use queries to generate reports, and explore the functionalities of a workbook.

By the end of this module, you'll be able to create Microsoft Sentinel Workbooks to take advantage of the reporting and monitoring features in Microsoft Sentinel.
...
> [!NOTE]
> If you choose to perform the exercise in this module, be aware that you could incur costs in your Azure Subscription. To estimate the cost refer to [Microsoft Sentinel Pricing](https://azure.microsoft.com/en-us/pricing/details/azure-sentinel/).
