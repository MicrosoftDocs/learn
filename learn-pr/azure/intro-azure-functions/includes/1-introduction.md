...
You own a business, and you want to send a holiday greeting email to your customers. Instead of building a website and deploying and hosting it, just for one feature, you can use an Azure function, add your email login details in the function and then deploy it to Azure. The functions connect to the data source, get customers emails, and send them an email on a scheduled date and time.
