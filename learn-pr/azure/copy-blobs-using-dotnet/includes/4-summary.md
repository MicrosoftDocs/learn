In this module, you learned that if you require complete flexibility, you can write your own custom data-transfer code using the .NET Storage Client library.
