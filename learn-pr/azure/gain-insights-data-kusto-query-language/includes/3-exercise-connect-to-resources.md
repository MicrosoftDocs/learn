...
1. If you expand the **Samples** database, **Tables**, and the **Storm_Events** folder, you'll have a list of tables below the database; we'll be using the *StormEvents* table.
