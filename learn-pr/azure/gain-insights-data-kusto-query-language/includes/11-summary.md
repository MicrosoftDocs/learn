...
* You then visualized the results using the `render`, `bin`, and `sum` operators, which can be a helpful aid in comparing activity across location.
* You used the `avg`, `min`, `max`, and `percentiles` operators to gain further insights into your data.
