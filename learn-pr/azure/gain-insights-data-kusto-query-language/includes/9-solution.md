...
1. Create a column that sums damage from *DamageProperty* and *DamageCrops* to give a value of damage in USD. Divide this value column by the conversion rate set in Step 1 to obtain damage in Euros.
