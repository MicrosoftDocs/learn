...
:::image type="content" source="../media/backup-vaults.png" alt-text="Diagram of recovery service vault graphics showing option for backup policies and management with the portal, SDKs, or the Command-line interface (CLI).":::
