...
1. On the resource menu, select **All Services**, in the **All services** menu, select **Integration** category. In the results that appear, select **Logic apps**. The **Logic apps** pane appears.
