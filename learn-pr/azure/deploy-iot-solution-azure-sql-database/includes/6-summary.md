...
The solution you've now learned how to deploy and monitor isn't just applicable to the distributor scenario. You can modify the solution to fit the needs of any IoT scenario you want to tackle. In the references section, there are several customer stories at which you can take a closer look. These customers were able to use Azure SQL Database to meet their IoT needs for industries including real estate, health, electricity, workspace management, manufacturing,
