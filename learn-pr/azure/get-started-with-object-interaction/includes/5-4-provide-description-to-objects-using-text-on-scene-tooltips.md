...
A tooltip is a brief description that is related to some other manipulate or object. They're used to deliver a hint or extra data upon closer inspection. Tooltips assist users recognize strange items in the physical surroundings that aren't defined directly.
