...
Buttons help the user to trigger an immediate action. It's one of the foundational components provided by MRTK. Various kinds of button prefabs can be used, depending on your situation. The Button is based on the Interactable script component to offer smooth UI controls on different interactive surfaces. The Interactable module is an all-in-one box to make any item interactable and conscious. Interactable acts as a catch-all, considering all forms of entering consisting of touch, hand rays, speech, and so on, and funnels those interactions into activities and visible subject responses.
