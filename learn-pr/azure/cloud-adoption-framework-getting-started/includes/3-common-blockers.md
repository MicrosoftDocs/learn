...
This is a common experience for customers who are new to cloud migration. Engaging an experience partner can help with these concerns, as can proper planning and data-driven decisions. The getting started guide for [accelerating migration](https://docs.microsoft.com/azure/cloud-adoption-framework/get-started/migrate?azure-portal=true) will help the Tailwind Traders team address this concern. In particular, that guide will help the team create a data-driven dialog with leadership around stakeholder expectations and the general strategy. It will also help the team collect data on the overall portfolio and map that data to actionable cloud adoption plans.
