...
Those guides categorize blockers into the following areas on the [getting started help page](/azure/cloud-adoption-framework/get-started/help?azure-portal=true?azure-portal=true):
