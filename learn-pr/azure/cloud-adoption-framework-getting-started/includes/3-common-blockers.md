...
Those guides organize blockers into the following categories on the [getting started page](/azure/cloud-adoption-framework/get-started/?azure-portal=true):
