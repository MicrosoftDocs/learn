...
These guides also categorize blockers into the following areas on the [getting started page](/azure/cloud-adoption-framework/get-started/?azure-portal=true):
