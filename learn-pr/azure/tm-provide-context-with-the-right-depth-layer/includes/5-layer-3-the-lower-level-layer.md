The lower-level layer is the last layer and should be used whenever you create a kernel-level or critical level system. Data-flow diagrams at this layer contain separate data-flow diagrams detailing each **low-level** system subpart. 
