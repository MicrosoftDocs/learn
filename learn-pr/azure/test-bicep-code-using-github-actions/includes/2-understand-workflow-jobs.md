...
*Jobs* help you to divide your workflow into multiple logical blocks. Each job can contain one or more steps.
...
:::image type="content" source="../../includes/media/shift-left-3.png" alt-text="Chart with a timeline on the horizontal axis, cost on the vertical axis, and a line showing that the cost increases the later an error is identified." border="false":::
