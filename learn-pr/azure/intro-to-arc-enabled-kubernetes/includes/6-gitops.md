...
GitOps simplifies standardizing Kubernetes configuration across your organization. You can define a a baseline configuration that you want to apply to every cluster and its components, including, for example, the delegation model, monitoring and logging settings, as well as characteristics of cluster-wide services.
