...
Azure Monitor uses a consistent configuration and monitoring interface regardless of the resource it monitors. The Monitor interface includes the following features:
