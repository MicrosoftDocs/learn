...
Many vendors support Kubernetes as a standard for containerized deployments. Azure Arc provides a consistent, scalable management model for Kubernetes clusters and their workloads across hybrid and multicloud deployments.
...
Your engineering team is tasked with exploring and evaluating Azure Arc capabilities for Kubernetes-based workloads. You must determine how Contoso can benefit from its hybrid management model by pursuing a multivendor strategy and maintaining some on-premises containerized workloads.

In this module, you learn how Azure Arc helps with Kubernetes cluster management and monitoring. You can then demonstrate to Contoso how these capabilities can help optimize and simplify their operations.
...
Some procedures in later units list more specific prerequisites.
