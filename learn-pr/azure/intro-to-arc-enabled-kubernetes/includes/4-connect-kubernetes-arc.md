...
- Outbound connectivity from the cluster to Azure and to the Microsoft container registry that hosts the container images required for installation. For details regarding target URLs and ports, refer to your Kubernetes product documentation.
...
- The latest version of the Azure CLI or Azure PowerShell installed on your management computer. This example uses Azure CLI.

### Connection steps

1. Start an Azure CLI session on a computer with connectivity to the Kubernetes cluster and to Azure.
1. Sign in to the Azure AD account you identified in the prerequisites.
