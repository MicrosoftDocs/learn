...
4. Use the following code to mount a container using a NFS 3.0 client. Replace the values for *<nameofthestoraggeaccount>* and *<nameofthecontainer>* with names that correspond to your environment.
