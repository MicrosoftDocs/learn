...
- [Network File System (NFS) 3.0 protocol support in Azure Blob Storage](https://docs.microsoft.com/azure/storage/blobs/network-file-system-protocol-support)
...
- [Using the HDFS CLI with Data Lake Storage Gen2](https://docs.microsoft.com/azure/storage/blobs/data-lake-storage-use-hdfs-data-lake-storage)
