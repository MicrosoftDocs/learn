...
:::image type="content" source="../media/3-azure-blob-storage-architecture.png" alt-text="Illustration depicting Azure Blob Storage and the supported protocols used to access data stored in a hierarchical file system." lightbox="../media/3-azure-blob-storage-architecture.png":::
