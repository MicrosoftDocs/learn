...
1. **Data at rest Encryption on Azure**

    List the content that will enable the learner to *Identify the encryption capabilities for services on Azure*:
...
1. **Knowledge check**
    ...
    What types of questions will test *Data at rest Encryption on Azure*?
