Your company's Intellectual Property (IP) is its application source code.  IP is classified as confidential, and you need to ensure no credentials or certificates are hard-coded or shared into source code management products. By the end of this unit, you'll:
