...
In this module, you'll learn how to classify your data, and then identify the security requirements that are relevant to each type of data. Finally, you'll look at the Azure tools and encryption options that you can use to help protect your stored "at rest" data.
