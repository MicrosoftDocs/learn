...
You've been hired as a lead cloud architect for a manufacturing organization. The organization is moving several systems to Azure. Different kinds of data are stored in these systems – such as customer details, financial information, and intellectual property.  You need to correctly identify and classify this data, to secure it to meet business and regulatory requirements. After this data is classified, you need to select the proper encryption method and/or service to protect it.
