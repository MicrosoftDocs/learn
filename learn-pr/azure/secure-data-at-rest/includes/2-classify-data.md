...
Here, you'll learn the different states of data. You'll learn about the classifications of confidential, internal, or public data. And you'll learn how to differentiate structured data from unstructured data.
...
Data states and classifications are linked. You won't be able to meet classification requirements for your data if you don't understand what its states are, and plan accordingly. 
...
Customer data can be leaked, or a company's internal data might have been distributed online for all to access. The impact on the organization and its customers can be devastating. That's why data is classified by its expected impact on the business and stakeholders.
...
- **Confidential (high level)**: If this data is exposed or lost, it will substantially affect the organization or the individual, whether they're a customer or an employee. Examples are:
...
Unstructured data might include images, videos, and files such as word processor documents. This type of data is not captured in conventional, predefined fixed fields. For example, the source data for a PDF document is in an unstructured format. The application for that document presents the data in a meaningful way. In another example, streaming video data of live streamers is unstructured in its raw form, but it's presented in a meaningful way for viewers.
