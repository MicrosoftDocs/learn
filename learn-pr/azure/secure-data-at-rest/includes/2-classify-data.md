...
Generally, you can categorize data into either structured or unstructured. Structured data can be data that resides in a spreadsheet or a relational database. This type of data is in a fixed field that is part of a larger record. Think about a spreadsheet showing employee details. You'd have columns for details about each employee – for example, employee ID, their role, and their salary. Here's an example showing what that type of structured data could look like:
