...
Your application's performance is a key consideration for customer satisfaction. Your application might experience peaks and troughs in a demand cycle. Holiday shopping or marketing campaigns can contribute to increased demand on your application and the servers hosting them.
...
- **Scale up**: Get more CPU, memory, disk space, and extra features such as dedicated VMs, custom domains and certificates, staging slots, and autoscaling. You can scale up by changing the pricing tier of the App Service plan that your app belongs to.
