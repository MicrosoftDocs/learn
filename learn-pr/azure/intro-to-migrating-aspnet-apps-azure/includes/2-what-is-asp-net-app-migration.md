...
- Policies - your company may have other policies that restrict hosting options or you have vendor or other technology "lock-in" objections.  With a VM, you can move your VM disk (.vhd) over to another cloud provider or back to on-premises if the need arises.
