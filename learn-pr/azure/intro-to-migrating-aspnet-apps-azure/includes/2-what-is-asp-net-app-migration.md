...
As you might expect, the on-premises model places all the responsibility of management on the organization. You are responsible for acquiring and installing all hardware and software. You setup and control the networking and security for the servers and hosted applications, and you are responsible for updates, patches, and licensing.
