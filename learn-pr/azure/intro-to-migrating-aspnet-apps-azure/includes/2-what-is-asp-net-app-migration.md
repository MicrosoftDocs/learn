...
<!-- Update the sentence to the following "Once the configuration is complete and the VM has been deployed and started" -->
...
<!-- Update the sentence to the following (the idea here is to mention that the vhd can be moved to on-premises). "With a VM, you can move your VM disk (.vhd) over to another cloud provider or back to on-premises if the need arises." -->
