...
Here, you use a condition to control when a storage account is provisioned. Doing so enables you to support each of your infrastructure environments from the same Azure Resource Manager (ARM) template.
