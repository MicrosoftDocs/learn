...
Here, you create an ARM template that defines a storage account resource. The template uses _copy_ to create similar versions of the same resource a given number of times.
