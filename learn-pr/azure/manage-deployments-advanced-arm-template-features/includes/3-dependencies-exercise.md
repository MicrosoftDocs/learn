...
Then, you run a basic Azure Resource Manager template that provisions a Linux virtual machine (VM). After the deployment completes, you verify that the VM is running and connectable.
