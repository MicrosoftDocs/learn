...
A Service is a Kubernetes object that provides stable networking for Pods. A Kubernetes Service enable communication between nodes, pods, and users of your application, both internal and external, to the cluster.
