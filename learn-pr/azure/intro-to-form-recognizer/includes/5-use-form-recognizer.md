...
The code deployed is open source (though not production ready). You can view the code, clone or fork the GitHub repository at [https://github.com/MicrosoftDocs/mslearn-intro-to-form-recognizer](https://github.com/MicrosoftDocs/mslearn-intro-to-form-recognizer)
...
The command will take several minutes to run. When it's complete, it will provide you with a link to your web app.
