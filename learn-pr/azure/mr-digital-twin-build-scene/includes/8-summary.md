...
Experiencing Digital Twins inside the Unity editor can be useful, but a more immersive experience can be realized when you deploy your app to the HoloLens 2 and interact with it in a Mixed Reality.

## References

* [Mixed reality core concepts - Mixed Reality](https://docs.microsoft.com/windows/mixed-reality/design/core-concepts-landingpage)
...
* [Creating a Bing Maps Account - Bing Maps | Microsoft Docs](https://docs.microsoft.com/bingmaps/getting-started/bing-maps-dev-center-help/creating-a-bing-maps-account)
* [Getting a Bing Maps Key - Bing Maps | Microsoft Docs](https://docs.microsoft.com/bingmaps/getting-started/bing-maps-dev-center-help/getting-a-bing-maps-key)
...
* [Use the Start menu and mixed reality home](https://docs.microsoft.com/hololens/holographic-home#close-apps)