Unity is a robust 3D development engine with many features, and as a result, it has a large number of Editor windows. To help make the work environment more approachable, the Default Layout features only major windows used during typical development. Additional Windows can be found under the Windows menu item at the top of the work area.
...
Please refer to [Unity’s Interface documentation](https://docs.unity3d.com/Manual/UsingTheEditor.html) for more detailed information.
