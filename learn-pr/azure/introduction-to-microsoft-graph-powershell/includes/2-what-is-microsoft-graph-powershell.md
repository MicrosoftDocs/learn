...
Microsoft Graph PowerShell wouldn't exist without Microsoft Graph. Microsoft Graph offers is a gateway to data and intelligence in Microsoft 365. It offers a single endpoint, https://graph.microsoft.com, to access rich, people-centric data and insights in the Microsoft cloud, including Microsoft 365, Windows, and Enterprise Mobility + Security through REST APIs.
...
Commands are named like **{Verb}**-Mg **{Resource}** (A Graph API resource) for example, user,group, and application. These cmdlets return a .NET object.
