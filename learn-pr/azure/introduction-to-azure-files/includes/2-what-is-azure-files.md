...
Azure file shares can be mounted concurrently on cloud or on-premises deployments. SMB Azure file shares can also be cached on Windows servers with Azure File Sync to provide fast access near where the data is being used.
