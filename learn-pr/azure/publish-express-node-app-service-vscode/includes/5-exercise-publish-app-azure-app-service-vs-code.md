...
1. Select the **Central US** region. VS Code creates a resource group, App Service plan, and webapp in your Azure subscription.
...
1. If you are asked if you are sure, click **Deploy**. If you are asked if you always want to deploy this workspace to the App Service, click **Yes**.
