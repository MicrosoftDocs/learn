...
The [Azure App Service](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azureappservice) extension is not installed by default in VS Code. Let's start by installing it:
