<!-- Compliant with: https://review.docs.microsoft.com/en-us/learn-docs/docs/id-guidance-introductions?branch=master -->

Express.js is a popular framework that you can use to create websites with server-side code in JavaScript. It's easy to host Express.js websites in the Azure App Service.
...
In this module, you'll install the Express.js framework and use it to build a website with a countdown on it. Then, you'll publish it to Azure. You'll also examine how new versions of the website are managed.

By the end of this module, you'll be able to publish and update websites built in Express.js in the Azure App Service.
