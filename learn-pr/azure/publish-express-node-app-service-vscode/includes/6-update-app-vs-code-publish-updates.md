...
:::image type="content" source="../media/6-update-web-app.png" alt-text="Deploy updated code from VS Code." loc-scope="vs-code":::
...
:::image type="content" source="../media/6-vs-code-azure-deployments.png" alt-text="View a deployment in Azure from VS Code." loc-scope="vs-code":::
