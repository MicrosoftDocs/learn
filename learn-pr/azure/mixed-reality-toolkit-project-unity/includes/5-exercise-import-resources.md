...
3. Under Project Settings, Select MRTK3, check if there is a valid Profile. If there is none, search for MRTKProfile in Packages (Packages/org.mixedrealitytoolkit.core/Configuration/Default Profiles/MRTKProfile.asset) of the project, and assign it to the Profile.
