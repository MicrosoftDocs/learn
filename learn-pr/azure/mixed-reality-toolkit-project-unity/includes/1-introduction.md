...
In this module, you'll configure Unity for Windows Mixed Reality development and import the Mixed Reality Toolkit (MRTK) into your project. The Mixed Reality Toolkit includes a ObjectManipulator script, which will be applied to a cube for direct manipulation with hands.
...
- Unity Hub with Unity 2019.2.X installed
