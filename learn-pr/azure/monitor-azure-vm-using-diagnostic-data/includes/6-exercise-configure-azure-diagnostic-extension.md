...
1. Select **Create** to create a new data collection rule.
   ...
   :::image type="content" source="../media/dcr-create.png" alt-text="Screenshot of the Data Collection Rules screen with Create highlighted.":::
...
1. Select **Next: Resources** or the **Resources** tab.
   ...
   :::image type="content" source="../media/create-dcr-basics.png" alt-text="Screenshot of the Basics tab of the Create Data Collection Rule screen.":::
...
1. In the empty query window, type *Syslog*, and then select **Run**. The events the DCR collected within the **Time range** are displayed.
   ...
   :::image type="content" source="../media/dcr-log.png" alt-text="Screenshot that shows the events returned from the Syslog by the DCR.":::
