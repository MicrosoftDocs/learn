Azure Monitor includes VM Insights, curated workbooks of useful VM metrics visualizations for managing your VM health and performance. VM Insights also collects client and workload metrics. In this unit, you enable VM Insights and use it to monitor host performance and guest OS metrics.
