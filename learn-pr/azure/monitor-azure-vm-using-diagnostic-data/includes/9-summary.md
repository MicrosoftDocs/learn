When you host your virtual machines on Azure, you're given basic metrics without having to install any other software. You've also seen the monitoring options available to you after you enable boot diagnostics and install the Azure Monitor Agent.
