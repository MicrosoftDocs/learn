...
Azure Monitor Metrics Explorer is an Azure portal component that you can use to plot metrics charts, visually correlate trends, and investigate changes in metrics for your VM. By using Metrics Explorer, you can:
