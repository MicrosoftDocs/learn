This unit combines the last two exercises in your evaluation of Azure App Service on Azure Arc. In these two exercises, you will perform the following tasks:
