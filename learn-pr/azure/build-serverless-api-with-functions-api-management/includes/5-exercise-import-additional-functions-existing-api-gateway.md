...
1. In the list of Function Apps, select the **OrderFunction** and then choose **Select**.
1. Ensure that **OrderDetails** is checked, and then choose **Select**.
...
1. In the **value** textbox, enter *Chiba*, and then select **Send**.
...
1. Back in the Cloud Shell, enter the following command, paste the **Gateway URL** value that you copied in place of the token, and then press Enter:
...
1. Back in the Cloud Shell, enter the following command, paste the **PRIMARY KEY** value that you copied in place of the token, and then press Enter:
