...
1. In the **Name** field, enter *id*, and in the **Value** field, enter *3*.
...
1. Select **Create new** under the **API Management** field.

    ![Screenshot illustrating how to create a new API.](../media/3-create-api.png)

    The **API Management service** page appears.

1. Enter the following API Management values as specified in the following table.
...
1. Select **Create** to create the API Management instance, which may take several minutes, and then select **Link API**.

    ![Screenshot showing the Link API button.](../media/3-link-api.png)

1. The **Import Azure Functions** page opens with the **ProductDetails** function highlighted. Select **Select** to continue.
...
1. In the **value** field, enter *1*, and then select **Send**.
