...
![Example web app with an SLA value of 99.95 percent connected to a SQL database with an SLA value of 99.99 percent.](../media/7-sla-compositesla1.png)
...
![Example Web app with an SLA uptime value of 99.95 percent connected in parallel to a SQL database with an SLA value of 99.99 percent  and a queue with an SLA value of 99.9 percent.](../media/7-sla-compositesla2.png)
