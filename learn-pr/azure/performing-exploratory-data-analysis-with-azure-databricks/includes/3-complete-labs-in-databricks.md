...
Now it's time to use Azure Databricks notebooks to performa basic and advanced EDA on a sample data set.
...
1. **02 Loading data with Azure Databricks** - This notebook contains an introduction to data loading with Azure Data bricks. You will learn how to prepare your data environment to start performing EDA.
1. **03 Basic EDA with Azure Databricks** - This notebook contains a basic EDA techniques such as data cleaning, handling missing values, and correlation analysis.
1. **04 Advanced EDA with Azure Databricks** - This notebook contains advanced topics like linear regression analysis, one hot encoding, feature scaling, dimensionality reduction, and feature importance estimation.