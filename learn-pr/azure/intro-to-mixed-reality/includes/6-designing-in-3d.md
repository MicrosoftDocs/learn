...
Bodystorming is the process of prototyping interactions, digital objects, and UI, and animations using crafting materials. This allows anyone involved in the design process to try out the proposed interactions, features, and mechanics without having to fully prototype them. The goal of all bodystorming sessions is to get actionable input, testing feedback, and most importantly to think spatially about the app content.

![Example of people bodystorming](../media/academyWork1000.png)

## Acting and feedback

After you’ve been through a bodystorming session or two, the next step is to stage how a user would move through your Mixed Reality experience. This phase, which is called acting, is all about testing ideas in three-dimensional space, but also about allowing others to watch the interactions and events from the outside and provide feedback. This is especially important when you have non-technical team members or stakeholders. For example, if you are exploring a mixed reality experience designed for hospitals, acting out your thinking to a medical professional can provide invaluable feedback.

![Example of an action and feedback design session](../media/academyCollab1000.png)
