...
:::image type="content" source="../media/6-update-web-app.png" alt-text="Deploy updated code from Visual Studio Code." loc-scope="vs-code":::
...
:::image type="content" source="../media/6-vs-code-azure-deployments.png" alt-text="View a deployment in Azure from Visual Studio Code." loc-scope="vs-code":::
