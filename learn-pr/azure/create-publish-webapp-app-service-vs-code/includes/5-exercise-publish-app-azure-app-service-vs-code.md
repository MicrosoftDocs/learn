...
In this unit, you'll use VS Code to deploy the Python site, which you created in the last exercise, to Azure.
...
1. When the deployment is complete, select **Browse Website**, and then select **Open Link**. Then Azure website is displayed in your browser. Notice that the website is hosted in the **azurewebsites.net** domain.
    ...
    :::image type="content" source="../media/5-deployed-webapp.png" alt-text="Python website hosted in Azure." loc-scope="other":::
