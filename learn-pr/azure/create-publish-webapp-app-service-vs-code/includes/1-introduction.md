...
In this module, you'll use your choice of JavaScript / Node.js / Express.js or Python / Flask to build a website with a countdown on it. Then, you'll use Visual Studio Code to publish it to Azure App Service. You'll also examine how new versions of the website are managed.

By the end of this module, you'll be able to publish and update websites to Azure App Service using popular languages and web frameworks.
