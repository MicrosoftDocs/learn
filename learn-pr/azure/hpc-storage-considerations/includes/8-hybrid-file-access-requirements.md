The previous units were largely focused on *what* your storage solution is doing. This unit focuses on *where* your data is located. We'll discuss hybrid file access considerations and how to approach them.
...
The buildout of your HPC cluster and its management plane are outside the scope of this module. We assume you've determined which virtual machine types and quantities your cluster will run.
...
Let's discuss the general approaches you can use to add data to Azure. The focus of this transfer is on active data. We won't discuss data archive and backup.
