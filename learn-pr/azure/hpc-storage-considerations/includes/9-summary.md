...
We'll create a checklist that encapsulates the major storage considerations. You might wonder why a checklist is necessary, particularly if you've overseen your current storage environment for a long time. The goal is to consolidate information for other stakeholders, including Azure team members and partners you might be working with. The checklist will help to streamline the decision process and minimize any misunderstandings around a particular storage solution's capabilities (or lack of capabilities).

You'll create your checklist based on the following list of considerations.

## Distribution of workload traffic ##

Account for the types of traffic your HPC environment will generate and process. This step is especially important if you plan to run multiple types of workloads and plan to use the storage for other purposes.
...
You'll want to record the following traffic types in your checklist:
