...
Azure offers several roll-your-own parallel file system offerings. You can go to the Azure Marketplace to see the options, which include BeeGFS and Lustre. (Search for *Whamcloud*.) You can also install Lustre on standard Linux virtual machines, or you can use the ARM templates found on the [Azure Quickstart](https://azure.microsoft.com/en-us/resources/templates/?term=lustre) site. 
