...
## Task 1: Create an analytics rule using the Analytics rule wizard
...
4. On the **General** page, provide the inputs in the following table, and then select  **Next:Set rule logic**.
  ...
  | Tactics | From the **Tactics** drop-down menu, choose **Initial Access**. |
  | Severity | Select the **Severity** drop-down menu and then select **Medium**. |
  | Status | Set the status of the rule to **Enable.**|
...
After completing this exercise, you will have created an incident rule using the Analytics rule wizard and investigated an incident in Azure Sentinel.
