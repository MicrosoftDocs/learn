...
1. Select the **Deploy to Azure** link.
...
2. In the **Azure Sentinel** page, in the **Configuration** section, select **Data connectors**.
...
> [!Note]
> The connector for Azure Activity could take 15 minutes until it data is available in Azure Sentinel.
