...
You’ve must evaluate Microsoft Azure Disk Storage types and capabilities and propose a storage solution that optimizes performance and costs for applications that require high storage.
<!-- Replace "You've" with "You". -->
## Learning objectives
