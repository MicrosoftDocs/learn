Now it's time to run your app in Azure. You'll need to create an Azure App Service app, set it up with a managed identity and your vault configuration, and deploy your code.
...
1. All your configuration is set, and you're ready to deploy! The following commands will publish the site to the `pub` folder, zip it up into `site.zip`, and deploy the zip to App Service. Make sure to replace `<your-unique-app-name>` with your app's name in the `--name` parameter.
