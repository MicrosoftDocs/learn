...
> [!NOTE]
> If your organization uses Kubernetes or another containerization technology, you might already be familiar with registries. However, you don't need to use containers or Kubernetes to work with Bicep - they simply provide a generic and convenient way to store and share artifacts.
...
> [!NOTE]
> It's generally easiest to include the registry name in the module path, like in the example above. However, you sometimes 
