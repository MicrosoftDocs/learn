...
For Automation, it's recommended to use the core Terraform workflow, which focuses on the plan/apply cycle.
This workflow runs all of Terraform's CI/CD actions on new and updated pull requests.
