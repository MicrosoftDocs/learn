...
## Modify the .NET Core application to return detailed results
...
## Run detailed queries with your .NET Core app

Now that your .NET Core app has been updated to display detailed information, try out the following queries to retrieve detailed results from your graph.
