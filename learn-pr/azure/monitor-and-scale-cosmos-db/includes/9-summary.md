...
- [Azure Cosmos DB documentation](https://docs.microsoft.com/en-us/azure/cosmos-db/): This is the official Microsoft documentation for Azure Cosmos DB.
- [Azure Cosmos DB calculator](https://www.documentdb.com/capacityplanner#): This tool calculates request units for different workloads, which is useful for estimating the volume of your JSON payload.
