...
- The number of fields in your Azure Cosmos DB that are indexed, and the indexing mode
...
When you create an Azure Cosmos DB collection, you configure a fixed maximum number of RUs. The sum of RUs consumed by all of the operations on the collection must be less than this value. If this value is exceeded, then requests to the database are throttled.

To operate an Azure Cosmos DB efficiently, you need to:
