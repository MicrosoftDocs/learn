...
In this module, you'll use a console application to populate the database and simulate a set of queries. Then you'll use monitoring tools to observe and understand the following key metrics of Azure Cosmos DB:
