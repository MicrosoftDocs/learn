...
1.	In the Azure portal search bar, type “HDInsight on AKS clusters” and select “Azure HDInsight on AKS clusters” from the drop-down list.
    ...
    :::image type="content" source="../media/picture-6.png" alt-text="Screenshot shows Azure portal search bar." lightbox="../media/picture-6.png":::
...
:::image type="content" source="../media/picture-8.png" alt-text="Screenshot shows view the cluster details." lightbox="../media/picture-8.png":::
...
:::image type="content" source="../media/picture-9.png" alt-text="Screenshot shows check and modify the number of worker nodes." lightbox="../media/picture-9.png":::
...
:::image type="content" source="../media/picture-11.png" alt-text="Screenshot shows configuration properties." lightbox="../media/picture-11.png":::
...
:::image type="content" source="../media/picture-12.png" alt-text="Screenshot shows health of the services running in your cluster." lightbox="../media/picture-12.png":::
