...
:::image type="content" source="./media/Picture1.png" alt-text="Screenshot showing the stages during cluster creation for script action." lightbox="./media/Picture1.png":::
...
:::image type="content" source="./media/Picture2.png" alt-text="Screenshot showing the stages during cluster creation for script action." lightbox="./media/Picture2.png":::
 

**Option 3**: Create cluster by selecting New in the Overview page of an existing cluster pool.  
 
:::image type="content" source="./media/Picture3.png" alt-text="Screenshot showing the stages during cluster creation for script action." lightbox="./media/Picture3.png":::
...
:::image type="content" source="./media/Picture4.png" alt-text="Screenshot showing the stages during cluster creation for script action." lightbox="./media/Picture4.png":::
...
:::image type="content" source="./media/Picture5.png" alt-text="Screenshot showing the stages during cluster creation for script action." lightbox="./media/Picture5.png":::
