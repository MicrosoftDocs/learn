...
2. Right-click any item in the grid to perform actions on the backup instance. For example, to go to the resource, to trigger on-demand backups and restores, or to stop backup.

:::image type="content" source="../media/backup-center-instances.png" alt-text="Screenshot shows Backup center instances.":::
