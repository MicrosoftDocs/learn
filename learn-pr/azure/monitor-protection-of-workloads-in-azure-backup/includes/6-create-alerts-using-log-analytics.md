...
:::image type="content" source="../media/inked-log-analytics-azure-backup-create-alert.png" alt-text="Screenshot shows the Log Analytics alert-creation page.":::
...
:::image type="content" source="../media/log-analytics-azure-backup-alert-logic.png" alt-text="Screenshot shows how to set up an alert condition.":::
...
:::image type="content" source="../media/log-analytics-azure-backup-action-group.png" alt-text="Screenshot shows the available notification mechanisms in the Add action group window.":::
