...
Areas with changing trust zones are the most targeted by attackers and should be carefully designed. Microsoft has predefined trust zone requirements for engineers to use internally, which takes the guesswork out of the design. If you work at Microsoft, contact your security team to learn more.
