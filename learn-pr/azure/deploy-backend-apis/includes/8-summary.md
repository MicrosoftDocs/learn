...
If you continue in the learning path, the next module covers creating a web application to serve the data on an interactive map, allowing users to see their geofences and the buses on monitored routes nearby. The module uses Azure Static Web Apps, which combines the power of Azure App Service with Azure Functions.
