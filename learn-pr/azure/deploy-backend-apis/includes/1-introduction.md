...
By the end of the module, you'll be able to deploy Azure Function Apps in any language and integrate them with Azure SQL Database and Azure Logic Apps. You'll learn how to build backend APIs with Azure Function, and how services like Azure SQL Database and Azure Logic Apps can help in easing development.
