# Deploy backend APIs with Azure Functions, Logic Apps, and Azure SQL Database
...
1. **Build a solution to get bus data and monitor routes**
    ...
    - Get Real-time feed and explain JSON
        - Information needed to accomplish the enabling objective
        - Information needed to accomplish the enabling objective
    - Get monitored routes
        - Information needed to accomplish the enabling objective
        - Information needed to accomplish the enabling objective
    - Process geofences and explain geospatial support
        - Information needed to accomplish the enabling objective
        - Information needed to accomplish the enabling objective
...
Note any additional information that may be beneficial to this content such as links, reference material, and more.