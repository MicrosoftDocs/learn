Now you're ready to start managing Azure resources for your customers, using your Contoso credentials. 
...
Here is an example of the Azure portal All Resources blade showing network security groups from different customer subscriptions that have been onboarded with Azure Lighthouse:
