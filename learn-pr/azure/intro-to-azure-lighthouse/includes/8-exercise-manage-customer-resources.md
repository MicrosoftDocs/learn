...
You've detected that a customer's virtual machine isn't being backed up. As a Contoso staff member using your own credentials, you can enable Azure Backup for that virtual machine.
