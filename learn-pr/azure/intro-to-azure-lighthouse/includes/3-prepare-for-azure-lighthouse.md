...
- Apply the **principle of least privilege** when allocating permissions to your users;  Contoso users should have enough permissions to do their job and no more
