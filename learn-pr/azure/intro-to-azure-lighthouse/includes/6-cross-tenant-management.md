...
:::image type="content" source="../media/6-my-customers.png" alt-text="Depiction of the service provider view of their Customers in Azure Lighthouse.":::
...
:::image type="content" source="../media/6-my-service-providers.png" alt-text="Depiction of the customer view of their Service Providers in Azure Lighthouse.":::
