...
![Unity with newly created TextMeshPro object selected](../media/base-06-section3-step1-1.png)
...
![Unity with TextMeshPro component configured](../media/base-06-section3-step1-2.png)
...
![Unity Project window with ToolTips folder selected](../media/base-06-section4-step1-1.png)
...
![Unity with all rover part objects selected and ToolTipSpawner component added and configured](../media/base-06-section4-step1-2.png)
...
![Unity with Camera ToolTipText configured](../media/base-06-section4-step1-3.png)
...
![Unity Play mode split view with tooltip triggered by gaze](../media/base-06-section4-step1-4.png)
