This module has walked you through the principles for a management baseline.
...
The end of the module covered how to handle critical workflows and platforms that require a specific management baseline. The module also covered the different tools and services that can be used for workflow-specific and platform-specific management baselines.
