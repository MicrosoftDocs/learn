...
Later, we demonstrate how Tailwind Traders can add cost controls to its governance foundation.
...
Later, we apply this discipline to the early needs of our customer narrative for Tailwind Traders.
...
In the next units, we'll explore technical solutions to help you get started with a cloud-governance foundation to support each discipline. We also look at some technical solutions that address risks related to managing costs.
