...
The Cloud Adoption Framework is proven guidance that's designed to help you create and implement the business and technology strategies necessary for your organization to succeed in the cloud. It provides best practices, documentation, and tools that cloud architects, IT professionals, and business decision-makers need to achieve short-term and long-term objectives successfully.
...
Bring your web apps to the cloud with minimal or no code changes by using the [Azure App Service Migration Assistant](https://azure.microsoft.com/services/app-service/migration-assistant/?azure-portal=true). The Assistant is a free and simple tool to migrate .NET web applications from on-premises to the cloud automatically.
