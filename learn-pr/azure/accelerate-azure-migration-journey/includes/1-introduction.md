Microsoft Azure provides access to a comprehensive set of cloud services that developers and IT professionals can use to build, deploy, and manage applications, through a global network of data centers. 
