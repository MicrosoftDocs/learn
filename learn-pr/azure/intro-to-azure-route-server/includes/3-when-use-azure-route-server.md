...
:::image type="content" source="../media/3-network-infrastructure.png" alt-text="A network infrastructure layout with Azure Route Server deployed in RouteServerSubnet /27." border="false":::

One more scenario when Azure Route Server usage is appropriate is when you have your NVAs and Azure Route Server in hub and spoke topology. This means that Azure Route Server is deployed in spoke virtual network that peers with virtual networks where NVAs are deployed as depicted in the following diagram:
