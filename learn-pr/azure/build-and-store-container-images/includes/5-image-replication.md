...
[![Screenshot of Azure portal showing the container replication world map with many circles marked across several countries.](../media/replication-map.png "Azure Container Registry replication map")](../media/replication-map-expanded.png#lightbox)
