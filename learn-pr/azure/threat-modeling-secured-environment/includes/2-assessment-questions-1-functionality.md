...
|**Is the proposed version the most current?**|<ul><li>Issues with the proposed version</li><li>If it's a past version, then why?</li><li>Patches and updates required for the version</li><li>Secure configuration for the proposed version</li></ul>|
|**Is the application in the productivity category?**|<ul><li>Call out email clients, document editors, and so on.</li></ul>|
...
|**How are users authenticated to use the application? Examples include AAD, ACL, and MFA**|<ul><li>External identity providers vs. local authentication</li><li>Current state of security for identity provider</li><li>Enabled security controls</li></ul>|
...
|**What are the security controls available for use in the application?**|<ul><li>2FA availability</li><li>Security logging and monitoring</li><li>Encryption</li><li>Tampering controls</li></ul>|
...
|**What happens if there's an incident with the application?**|<ul><li>Service level agreements with the application owner</li><li>Automatic or manual patches and security updates</li><li>Notification workflows</li></ul>|
|**Does the application owner have a set of security policies or risk program?**|<ul><li>Established risk program observed by the application owner</li><li>Set of security policies followed by the application owner</li></ul>|
