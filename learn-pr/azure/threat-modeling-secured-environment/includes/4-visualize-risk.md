...
- **Context level** - data-flow diagram begins with a high-level context diagram, followed by more in-depth diagrams as needed. Check out the [Provide context with the right depth layer](/learn/modules/tm-provide-context-with-the-right-depth-layer/) module from the [Threat Modeling Security Fundamentals](/learn/paths/tm-threat-modeling-fundamentals/) learning path to learn more.
