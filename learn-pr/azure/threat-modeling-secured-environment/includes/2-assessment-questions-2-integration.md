...
- Investigate if the application requires services from trusted cloud providers to authenticate users, provide backups, and so forth.
...
|**How does the application handle sensitive data?**|<ul><li>Data encryption and storage process</li><li>Use of cache or cloud services to accomplish task</li><li>Data access</li><li>Privacy implications</li></ul>|
|**Are any cloud providers or services they provide required by the application?**|<ul><li>Cloud provider used</li></ul>|
