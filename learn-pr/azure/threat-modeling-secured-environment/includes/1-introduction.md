...
- Using alternate credentials and associated smart cards exclusively in the environment.
- Enforcing password policies that are more restrictive.
- Prohibiting the use of local administrative accounts.
- Restricting changes to device configurations.
- Blocking the use of applications not previously approved by the security team.
...
|------|----------------|-----------------|
|![Spoofing.](../media/threats/spoofing-50.png)</br>**Spoofing** is when you pretend to be a person or process to gain access to the secured environment.|![Authentication](../media/threats/authentication-50.png)</br>**Authenticate** everyone using multifactor authentication, and use only alternate accounts for administrative tasks.|![Process](../media/elements/process-25.png)</br>Process</br></br>![External entity](../media/elements/external-entity-25.png)</br>External entity|
...
Give priority to IT security professionals or the security team directly involved with managing the secured environment, as they might already be familiar with common security risks.
