...
## Gaze and commit
 ...
 It's best to use gaze and commit when interacting with holographic content that's out of reach. The user  gazes at an object or UI element, and then clicks on it ("commits" to it) using a secondary input. Commit methods include voice commands, a button press, or a hand gesture.

There are two types of gaze input (head- and eye-gaze) and they have different commit actions.
