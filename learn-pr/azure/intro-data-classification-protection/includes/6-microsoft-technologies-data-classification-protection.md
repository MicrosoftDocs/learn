...
- The ability to share protected content with users in the same organization or those who are outside your organization but who also use Office 365 or Azure Information Protection.
...
- Support for the Rights Management sharing app or Azure Information Protection client app on mobile devices and desktops. This enables file sharing with people in other organizations, document tracking, and email notifications.
- Support for Cryptographic Mode 2 without requiring additional configuration. This provides stronger security enhancements for key lengths and encryption algorithms.
...
Azure Information Protection enables data classification and protection because it's mostly based on classification and rights-management technologies. It also is part of the Microsoft Information Protection platform. This platform provides additional technologies for implementing more controls and using existing encryption and DLP technologies.
...
End users who read encrypted or rights-protected mail on non-Outlook clients also use the OME Portal to open encrypted and rights-protected messages.
