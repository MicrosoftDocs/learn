...
Because of classification importance on several different levels, as you just learned, it's important that people who manage data understand what data classification really means and how it differs from data protection. Each organization must work on raising awareness on data classification in the context of data governance, and not only technical data protection. Usually, data protection comes because of data classification. However, even protected data is sometimes accessed by the people who need it. People who access protected data need to know how to manage the data, not based on how data is protected, but how it's classified.
