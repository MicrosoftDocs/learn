...
Because of this, it is important that people who handle data understand what data classification really means and how it differs from data protection. It’s important that each organization works on raising awareness on data classification in the context of data governance, and not only technical data protection. Usually, data protection comes as a result of data classification. However, even protected data is sometimes accessed by the people who need it. People who access protected data need to know how to handle the data, not based on how data is protected, but how it is classified.
 
