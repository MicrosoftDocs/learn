...
If you are already working with a CSP, this channel may minimize the need for a net new procurement process. In addition, many of the CSPs in the list above offer customized support options for government customers. You can find a current list of available services through the CSP program at [Introduction: Azure plan lets partners buy Azure at pay-as-you-go-rates for customers](/azure/cloud-solution-provider/overview/azure-csp-available-services).
