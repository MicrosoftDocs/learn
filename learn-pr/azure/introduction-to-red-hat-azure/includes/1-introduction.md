...
You recommend migrating the system to the cloud, running the core application on Red Hat Enterprise Linux (RHEL) on Azure, modernizing the Java with JBoss Enterprise Application Platform (JBoss EAP), and containerizing components of the application using Azure Red Hat OpenShift (ARO).

## Learning objectives

By the end of this module, you'll be able to:

- Discuss how Red Hat Enterprise Linux (RHEL), Azure Red Hat OpenShift (ARO), and JBoss EAP in Azure work.
