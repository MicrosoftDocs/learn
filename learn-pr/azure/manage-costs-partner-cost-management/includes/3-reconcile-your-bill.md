...
1. To [analyze costs](/azure/cost-management-billing/costs/quick-acm-cost-analysis) on your invoice, select **Cost Management + Billing**, and then **Cost Mangaement**. Under **Reporting + analytics** select **Cost analysis**.
