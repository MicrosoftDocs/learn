...
:::image type="content" source="../media/06-customer-list.png" alt-text="Example that shows the list of customers." lightbox="../media/06-customer-list.png" :::
...
:::image type="content" source="../media/06-create-budget-wizard.png" alt-text="Example that shows creating a budget and setting its evaluation period." lightbox="../media/06-create-budget-wizard.png" :::
...
In the following example, an email alert gets generated and sent to admin@fabrikam.com when 90 percent of the budget is reached.

:::image type="content" source="../media/06-create-budget-alert.png" alt-text="Example that shows creating a budget with alert conditions." lightbox="../media/06-create-budget-alert.png" :::
