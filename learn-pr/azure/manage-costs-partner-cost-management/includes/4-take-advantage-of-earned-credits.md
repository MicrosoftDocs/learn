...
In Azure Cost Management, Fabrikam can use cost analysis to view costs that received the PEC benefits. Take the following steps:
...
3. In a donut chart, select the drop-down list and select  **PartnerEarnedCreditApplied**  to drill into PEC costs.  
    :::image type="content" source="../media/04-partner-earned-credit-applied.png" alt-text="Example that shows partner earned credits." lightbox="../media/04-partner-earned-credit-applied.png" :::
...
You can also group and filter by the **PartnerEarnedCreditApplied** property by using the **Group by** options. Use the options to examine costs that do and don't have PEC.

:::image type="content" source="../media/04-partner-earned-credit-grouped.png" alt-text="Example that shows partner earned credit filter and group options." lightbox="../media/04-partner-earned-credit-grouped.png" :::
