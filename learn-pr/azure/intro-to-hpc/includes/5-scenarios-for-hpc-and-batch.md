...
This diagram shows a possible architecture that you could use to publish a CAD software as a service (SaaS) product, based on N- and H-series VMs in Azure. 
