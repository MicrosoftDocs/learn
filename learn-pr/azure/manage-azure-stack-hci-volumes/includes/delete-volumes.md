...
:::image type="content" source="../media/6-delete-volume-windows-admin-center.png" alt-text="Screenshot depicting deletion of volumes in Windows Admin Center." border="true"6-delete-volume-windows-admin-center.png lightbox="../media/6-delete-volume-windows-admin-center.png":::
