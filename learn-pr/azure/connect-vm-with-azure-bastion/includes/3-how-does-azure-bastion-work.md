...
The following two sections show you the steps involved for each of the Azure Bastion deployment options in the Azure portal. You don't need to complete any of these steps yet; you'll do that in the next exercise.
...
1. Add a subnet address with a subnet mask of /26 or larger.
...
To provision Azure Bastion, in the portal on the VM, select **Connect** > **Bastion** > **Configre manually**. Enter a name for the Azure Bastion resource, select the subnet, create a public IP, and so on. After Azure Bastion deploys, you can connect to the VM.
