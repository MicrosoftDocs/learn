...
Intelligent Performance for Azure SQL includes Intelligent Query Processing. Automatic Plan Correction, and Automatic Tuning for Azure SQL Database.
...
> [!NOTE]
> You can at a later date use the AdventureWorksLT sample with your own Azure SQL Database deployment and use the scripts in the 04-Performance/tuning_recommendations folder to see this example. It is important to note that when you run these scripts it can take 24 hours to see results in DMVs and Azure Portal.
...
![Query_Performance_Overview](../media/9-query-performance-overview.png)
...
![Query_Performance_Insights](../media/9-query-performance-insights.png)

The Azure Portal also provides a way to directly see any performance recommendations.

![Performance_Recommendations](../media/9-performance-recommendations.png)
...
![Automatic_Tuning_Options](../media/9-automatic-tuning-options.png)
...
![create_index_recommendation](../media/9-create-index-recommendation.png)
