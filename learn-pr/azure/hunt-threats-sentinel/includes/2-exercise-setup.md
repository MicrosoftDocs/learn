...
4. The resource group should contain the resources displayed in this table:
    ...
    | **SecurityInsights(*yourname*-Sentinel)** | Solution | Security insights for Microsoft Sentinel, where *yourname* represents the workspace name that you chose in the previous task. |
