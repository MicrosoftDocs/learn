...
What if your development tool, Visual Studio, can do everything for you in one place? It saves a lot of time and increases productivity. Visual Studio offers features to publish your app to Azure App Service.
...
In the next couple of exercises, you will explore how to publish your web API application to Azure App Service and integrate it using Azure API Management.
