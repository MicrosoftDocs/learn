...
1. A web browser window will open. At the **Enter code** prompt, paste the device code you copied to the clipboard, and then click **Next**
    ...
    :::image type="content" source="../media/5-enter-code.png" alt-text="Screenshot of a browser window, prompting the user to Ender code from the Azure Device Login window.":::
