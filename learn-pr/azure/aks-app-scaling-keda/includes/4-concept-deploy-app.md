...
Without any HPA or KEDA Scaler Object, an engineer would manually adjust the number of replicas available to process sufficiently the number of events. They would also have to _scale down_ the `Deployment` when the load returns to normal.
