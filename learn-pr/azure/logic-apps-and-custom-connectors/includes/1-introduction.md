...
Imagine you're the lead developer at a picture framing company. You and other developers can access some of your company's picture frame data, but only through an in-house, custom-built REST API. You have plans to build many automated workflows in Azure Logic Apps and need access to this data For example, you want to create a workflow that automatically quotes a price for a frame, based on the dimensions.
