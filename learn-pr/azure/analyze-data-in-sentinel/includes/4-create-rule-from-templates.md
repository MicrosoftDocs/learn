...
By default Azure Sentinel Analytics creates an alert rule using the Fusion rule template. For Machine Learning Behavior Analytics, you can only create a rule as enabled or disabled, and you do not have the option to further customize the rule.
