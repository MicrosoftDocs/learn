...
1. In the list Sentinel workspace names, select the Azure Sentinel workspace you created in Task 2.
1. On the **Azure Sentinel** pane, on the left menu under **Configuration**SS, select **Data connectors**.
