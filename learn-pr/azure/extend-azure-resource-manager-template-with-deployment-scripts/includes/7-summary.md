In this module, you were introduced to the  `deploymentScripts` resource as a way to add custom behavior to your Azure Resource Manager template deployments. You learned how the `deploymentScripts` resource works and the resources it depends upon.  Finally, you learned how to make those `deploymentScripts` more flexible by parameterizing them.
