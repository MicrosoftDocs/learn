...
```Greenbox- Note:  Backed by Azure infrastructure, the Speech service offers enterprise-grade security for all data stored on the cloud. Your data remains yours. Your audio input and transcription data aren’t logged during audio-to-text processing.