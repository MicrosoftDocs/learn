...
**Microsoft Defender for Cloud** is a primary tool in that response plan, and learning how to use all its features can help you quickly identify real threats from false positives. Defender for Cloud enables you to find & fix vulnerabilities, aids in blocking malicious access, and alerts you when your resources are under attack.
