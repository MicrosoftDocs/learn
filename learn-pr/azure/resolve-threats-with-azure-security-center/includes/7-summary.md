...
Having a security response plan in place helps the team respond to active threats with defined procedures. Azure Security Center can help detect real threats to your workloads - and provide guidance and automated responses so you can repel and quickly recover from an attack.
