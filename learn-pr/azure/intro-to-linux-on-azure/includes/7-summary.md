...
- [Choose an Azure compute service - Azure Architecture Center | Microsoft Learn](/azure/architecture/guide/technology-choices/compute-decision-tree)
- [Use platform as a service (PaaS) options - Azure Architecture Center | Microsoft Learn](/azure/architecture/guide/design-principles/managed-services?source=recommendations)
