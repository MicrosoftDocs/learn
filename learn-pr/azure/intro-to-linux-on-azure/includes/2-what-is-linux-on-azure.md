...
As you think about designing a computing environment on Azure, distinguish between four general usage models available: infrastructure as a service (IaaS), platform as a service (PaaS), database as a service, and software as a service (SaaS). 

**IaaS** &mdash; Azure maintains the physical hardware and provisions additional computing resources as needed. You, the customer, are responsible for managing the operating system, configuring addition services for security, web applications, as well as your development environment, application deployment, and monitoring. 
