...
We’ve seen that classification has a lot in common with classic regression. For both we can use supervised learning, a cost function, and use test and train datasets to estimate real-world performance. We focussed here on logistic regression, which is almost a hybrid between these two types of model, and shoed how thresholding the output gives us a categorical label, like ‘avalanche’/’no-avalanche’.
