...
You can more quickly add workloads, assets, and tasks by using the Teams add-in for Microsoft Excel. The *Next steps* section in the next unit provides an article series that will teach you how to load a large number of workloads and assets by using the workload template provided in the initial cloud-adoption plan.
