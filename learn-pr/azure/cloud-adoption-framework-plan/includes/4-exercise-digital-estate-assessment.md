...
- **Azure Hybrid Benefit**: With [Azure Hybrid Benefit](https://azure.microsoft.com/en-us/pricing/hybrid-benefit/), you can bring on-premises Windows Server licenses with active Software Assurance or Linux subscriptions to Azure. You can combine this with Reserved Instances options.
