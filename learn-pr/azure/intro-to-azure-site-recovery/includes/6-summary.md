In this module, you learned how Azure Site Recovery can orchestrate and automate the replication of Azure VMs between regions, on-premises virtual machines and physical servers to Azure, Azure VMs to on-premises VMs, and on-premises machines to a secondary datacenter. You learned about the type of scenarios where Azure Site Recovery is an appropriate solution for your organization, and how Azure Site Recovery is likely able to meet Adatum's needs.
