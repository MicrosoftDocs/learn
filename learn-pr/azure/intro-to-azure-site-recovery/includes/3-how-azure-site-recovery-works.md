...
You can increase the retention history of recovery points to 14 days. App-consistent recovery points can be configured to be taken as frequently as once an hour.
...
> [!NOTE]
> You cannot perform an offline replication using Azure Data Box or other storage technologies for the initial replication to Azure.
