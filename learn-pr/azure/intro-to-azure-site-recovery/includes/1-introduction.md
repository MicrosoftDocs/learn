...
You have investigated Azure Site Recovery and believe that this Azure service can achieve these goals. This module explains what Azure Site Recovery does, how it works, and when you should choose to use Azure Site Recovery as a solution to meet your organization's needs. 
