...
- You can configure Azure Site Recovery to store recovery points for two weeks. This meets Adatum's goals for recovering from data corruption problems.
