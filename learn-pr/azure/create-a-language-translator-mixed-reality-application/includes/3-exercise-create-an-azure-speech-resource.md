...
1. Fill out the wizard with the following values:
    ...
    |Field  |Value  |Details  |
    |---------|---------|---------|
    |**Name**     |    Enter a unique name     |   Choose a globally unique name for the resource. For example, you could name the resource mr-speech-xxx, where the x's could be replaced with your initials. If the name isn't globally unique, you could try any other combination. Valid characters are a-z, 0-9 and -.      |
