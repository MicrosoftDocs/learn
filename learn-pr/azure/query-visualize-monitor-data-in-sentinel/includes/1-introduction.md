Microsoft Azure Sentinel Workbook provides an interactive report that helps you visualize important signals by combining text, table, charts, and tiles.
...
Contoso provides threat protection for its Azure-based and on-premises resources by using the paid version of Azure Defender. The company also monitors and protects other non-Microsoft assets.
...
In this module, you'll learn how to create and use Azure Sentinel workbooks to visualize security data, use queries to generate reports, and explore the functionalities of a workbook.

By the end of this module, you'll be able to create Azure Sentinel workbooks to take advantage of the reporting and monitoring features in Azure Sentinel.
