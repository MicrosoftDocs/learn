...
You want to analyze the logs in Azure Sentinel from Azure Activity connector. You want to then further implement visualization of this data and save it in a customized workbook.
...
:::image type="content" source="../media/07-Default-workbook.png" alt-text="Screenshot that present interaction with the workbook." border="true":::
...
:::image type="content" source="../media/07-Add-parameter.png" alt-text="Screenshot of adding a new parameter." border="true":::
