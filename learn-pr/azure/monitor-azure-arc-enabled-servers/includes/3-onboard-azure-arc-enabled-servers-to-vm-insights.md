...
You can apply VM extensions to your Arc-enabled server via the Azure portal:
...
With VM insights enabled, you'll get a message that the machine has been successfully onboarded to VM insights. This process takes a few minutes while extensions are installed on your connected machine.
