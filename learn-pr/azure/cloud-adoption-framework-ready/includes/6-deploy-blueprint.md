The first step towards an Azure landing zone deployment is the implementation of a Cloud Adoption Framework landing zone template. When following the _start small and expand_ approach, you would start with the CAF Migration landing zone blueprint.
