The first step towards an Azure Landing Zone deployment is the implementation of a Cloud Adoption Framework landing zone template. When following the *Start small & expand* approach, you would start with the CAF migration landing zone blueprint.
