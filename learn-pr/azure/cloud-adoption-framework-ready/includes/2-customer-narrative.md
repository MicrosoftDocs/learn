...
- **Policy-driven governance**: Tailwind Traders hasn't historically automated its corporate policies. Because of the pressure to migrate the datacenter quickly, the company chose to minimize the amount of governance—including in its initial landing zone deployment. 
  ...
  The company has also committed to completing the [Learn module about the Govern methodology of the Cloud Adoption Framework](learn/modules/cloud-adoption-framework-govern/) after it configures the initial environment. Limitations in IT staff dedicated to the cloud migration are a big driver for this deviation. This deviation is further enforced by business and IT resistance to full cloud governance or "Azure Ops."
