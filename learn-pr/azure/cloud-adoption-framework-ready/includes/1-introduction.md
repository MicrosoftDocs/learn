Cloud adoption and operations depend on your early platform decisions. Compare Azure landing zones to develop the right cloud platform to support your adoption plans and ongoing needs for operations management.

In this module, you'll compare common operating models and options for implementing Azure landing zones. The goal is to find the best path to a fully configured cloud platform.
...
- Review of the getting-started Learn module about the Cloud Adoption Framework.
