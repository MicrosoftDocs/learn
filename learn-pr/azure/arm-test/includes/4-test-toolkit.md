You've learned so far how *what-if* can be used to preview changes that you are about to apply to your deployments. There's another aspect that is important to test for as well, namely *best practices*. So what are these *best practices* and why are they important for your templates?
