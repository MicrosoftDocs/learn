 In this exercise, we are going to create a query that uses data from Azure resource health. Azure resource health helps detect service problems that affect your Azure resources. We are going to create a report that shows:
