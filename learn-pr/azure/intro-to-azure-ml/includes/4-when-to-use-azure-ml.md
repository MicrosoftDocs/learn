Azure ML’s versatility and ease of use mean that new applications are always being discovered by users. Here we'll explore some of the strengths of Azure ML in practice, so you can utilize these functions in your next application or scenario.

## Working in a team

Collaborative work within Azure ML is possible by adding multiple users to a Workspace. If you require more precise control, you can use _Azure Role Based Access Control (RBAC)_ to equip team members with roles to define their access and control of resources within the Workspace. Once team members have access, they may contribute to data labeling projects or work jointly to add and clean data, or train and deploy models.
