...
1. On the **Register sources** pane, select the **Azure SQL Database** source tile, and then select **Continue.**
    ...
    :::image type="content" source="..media/2-register-azure-sql-database.png" alt-text="Screenshot that describes the process of registering an Azure SQL Database data source in Microsoft Purview" lightbox="../media/2-register-azure-sql-database.png":::
...
1. On the **Register sources (Azure SQL Database)** pane, provide a **Name** for the data source, select the relevant **Azure subscription**, select the **Server name** for the SQL server, enter the public **endpoint**, select the **collection**, and then select **Register.**
    ...
    :::image type="content" source="..media/2-provide-name-sql.png" alt-text="Screenshot that depicts the Register sources (Azure SQL Database) pane" lightbox="../media/2-provide-name-sql.png":::
...
- Grant the Microsoft Purview account managed identity the **Reader** role at the **Subscription** or **Resource group** where your Azure SQL Database is created.
    ...
    :::image type="content" source="..media/2-managed-identities.png" alt-text="Screenshot depicting how to scan an Azure SQL Database with system-managed or user-managed identities." lightbox="../media/2-managed-identities.png":::
...
1. Under the **Azure SQL DB** you registered earlier, select the **New Scan** icon.
    ...
    :::image type="content" source="..media/2-scan-azuresqldatabase.png" alt-text="Screenshot depicting the steps to scan an Azure SQL Database that's been configured using managed identities." lightbox="../media/2-scan-azuresqldatabase.png":::
...
:::image type="content" source="..media/image5.png" alt-text="Screenshot depicting the steps to scan an Azure SQL Database configured with SQL authentication by connecting your Microsoft Purview Account with the Azure Key Vault service." lightbox="../media/":::
...
:::image type="content" source="..media/2-register-key-vault-connection.png" alt-text="Screenshot depicting how to configure the access policy for Azure Key Vault to grant Get and List secret permission for Microsoft Purview." lightbox="../media/2-register-key-vault-connection.png":::
...
:::image type="content" source="..media/2-view-the-scan.png" alt-text="Screenshot depicting the status of the scan." lightbox="../media/2-view-the-scan.png":::
