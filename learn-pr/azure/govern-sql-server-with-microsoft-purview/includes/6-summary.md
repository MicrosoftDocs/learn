...
- Amazon RDS Multi-Cloud Scanning Connector for Microsoft Purview (Public preview) <https://docs.microsoft.com/azure/purview/register-scan-amazon-rds>
...
- Connect to Azure SQL Database in Microsoft Purview <https://docs.microsoft.com/azure/purview/register-scan-azure-sql-database?tabs=sql-authentication>

- Create an Azure AD user in SQL Database using an Azure AD service principal <https://docs.microsoft.com/azure/azure-sql/database/authentication-aad-service-principal-tutorial#create-an-azure-ad-user-in-sql-database-using-an-azure-ad-service-principal>
