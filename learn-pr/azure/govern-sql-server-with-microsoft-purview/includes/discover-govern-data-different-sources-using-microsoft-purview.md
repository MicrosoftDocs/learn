...
:::image type="content" source="../media/2-data-map-collections.png" alt-text="The Data map Collections pane" border="true" lightbox="../media/2-data-map-collections.png":::
