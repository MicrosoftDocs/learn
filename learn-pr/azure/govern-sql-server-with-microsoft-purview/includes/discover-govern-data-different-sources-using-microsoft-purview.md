...
:::image type="content" source="../media/2-data-catalog.png" alt-text="Screenshot showing the Data Catalog section in Microsoft Purview Studio." border="true" lightbox="../media/2-data-catalog.png":::
...
:::image type="content" source="../media/2-scan-insights.png" alt-text="Screenshot showing the Microsoft Purview Scan insights pane displaying statistics for successful, failed, and cancelled scans." border="true" lightbox="../media/2-scan-insights.png":::
