...
<!-- Consider replacing "Contoso uses the paid version of Azure Security Center as threat protection for resources that run on Azure and on-premises." with " Contoso uses Azure Security Center with Azure Defender as threat protection for resources that run on Azure and on-premises." -->
