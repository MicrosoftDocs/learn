...
In this module, you learn how Azure Migrate App Containerization can help you containerize and migrate your Java web applications running on Linux machines to Azure Kubernetes Service (AKS) by using a templatized process.
