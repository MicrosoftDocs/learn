...
- High availability to help ensure that your application remains available if there are server or datacenter failures or downtime. Azure makes use of zones, regions, and availability sets to help achieve this.
...
The tool provides an option to select an existing App Service plan but for this exercise we'll create a new App Service plan.
...
Now that your application container is deployed, use the following steps to browse the migrated application:
