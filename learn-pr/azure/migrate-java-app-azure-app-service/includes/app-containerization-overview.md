...
App Containerization helps you to -
...
In the next sections of this module, you set up a sample two-tier Java web application and use Azure Migrate App Containerization to containerize and migrate the application to Azure App Service.