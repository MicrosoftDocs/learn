...
> ### Safe and sound
>
> Backed by Azure infrastructure, the Translator service offers enterprise-grade security, availability, compliance, and manageability. **No data sent for translation through the Translator Text API is kept**, and no record of the submitted text will be saved in persistent storage in any Microsoft data center.
