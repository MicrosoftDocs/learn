...
| Staging | The final non-production environment where changes are deployed before production, with production-like configuration. | Operations team | Long lived | Controlled |
