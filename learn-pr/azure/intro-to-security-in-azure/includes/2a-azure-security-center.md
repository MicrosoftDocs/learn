...
1. Use Security Center for incident response.
    ...
    Many organizations learn how to respond to security incidents only after suffering an attack. It's essential to reduce costs and damage and have incident response plan before an attack occurs. You can use Azure Security Center in different stages of incident response.
