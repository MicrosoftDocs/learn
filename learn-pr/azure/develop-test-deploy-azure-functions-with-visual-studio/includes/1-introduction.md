...
Let's say you're a senior web developer in a research role for an online luxury watch dealer. You're building a website based on Azure Web Apps. You're asked to provide new functionality, which involves creating individual methods that can be deployed, manually executed, scheduled, or even triggered by other Azure services.
