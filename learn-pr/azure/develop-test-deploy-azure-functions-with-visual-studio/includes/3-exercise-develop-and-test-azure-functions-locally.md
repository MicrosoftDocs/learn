...
1. In Visual Studio, on the **File** menu, select **New**, and then select **Project**. The **Create a new project** page appears. Scroll down, and select **Azure Functions**.
...
Select **Next**. The **Configure your new project** page appears.
...
In the **Configure your new project** page, in the **Project name** field, enter **WatchPortalFunction**. For the **Location** field, select a convenient location on your computer to store the project. The **Solution name** field should default to **WatchPortalFunction**. Select the checkbox **Place solution and project in the same directory**, and then select **Create.** The **Create a new Azure Functions application** page appears.
...
1. In the **Create a new Azure Functions application** page, select **Azure Functions v2 (.NET Core)**, and then select **Http Trigger**. Leave the **Storage Account** set to **Storage Emulator** because you'll be running the Azure Functions app locally to start with. Under **Authorization level**, select **Anonymous**, and then select **Create**.
