...
## Specifying a size during VM creation
...
> [!NOTE]
> The Azure sandbox is limited to a few VM sizes. Most of the possibilities are not allowed in the free Microsoft Learn subscription.
