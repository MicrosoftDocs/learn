...
In the list of alerts, select either a specific alert or a group of alerts, and the details will appear in the alert pane, including the alert description, traffic source and destination and more.
...
Triage the alert to check, update or confirm the status of the alert. Alerts can have 5<!--4? --> different statuses.
