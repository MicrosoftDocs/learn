...
You have an activated OT sensor and data is now being mirrored to the sensor. You're tasked with fine-tuning the OT sensor. You now need to check and fine-tune your sensor settings to ensure that it detects the interfaces and traffic that you want to monitor and alerts you correctly for risky activity. When your sensor has identified a baseline of network traffic, you’re ready to switch out of learning mode into operation mode.
...
By the end of this session, you'll be able to fine tune and calibrate your OT sensor, ensuring it sends more accurate and filtered data, to complete your deployment of Defender for IoT. <!-- are we deploying a sensor or D4IoT? deployment of the sensor to Defender for IoT-->
