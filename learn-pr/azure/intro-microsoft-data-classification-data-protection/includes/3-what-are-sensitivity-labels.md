...
When you assign a sensitivity label to a document or email, it's like a stamp that's applied to content that's:
...
- The current price list that's sent to business partners cannot be opened after a specified date.
