Before starting to use labels for protection, you need to create and configure the sensitivity labels that you want to make available for apps and other services, such as the labels you want users to see and apply from Office apps. Also, you need to create one or more label policies that contain the labels and policy settings that you configure. It's the label policy that publishes the labels and settings for your chosen users and locations.
