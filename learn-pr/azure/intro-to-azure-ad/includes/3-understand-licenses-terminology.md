...
|Azure AD tenant|An instance of an Azure AD directory. This directory is created for you automatically when you first sign up for Azure or other services like Office 365. A tenant, which represents an organization, holds your users, their groups, and applications.|
