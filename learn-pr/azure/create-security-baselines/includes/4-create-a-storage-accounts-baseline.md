...
1. Sign in to the Azure portal.
1. Go to **Storage Accounts**.
1. For each storage account, go to **Encryption** under **BLOB Service**.
1. Set **Storage service encryption** to **Enabled**.
...
1. Enter **RegenerateKey** in the **Search** text box.
1. CLick **Apply**.
...
1. Sign in to the Azure portal.
1. Go to **Storage Accounts**.
1. For each storage account, go to **Encryption** under **File Service**.
1. Ensure that **Storage service encryption** to **Enable**.
