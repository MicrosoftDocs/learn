...
1. Set **Secure Transfer required** to **Enabled**.
    ...
    ![Screenshot the storage setting blade](../media/4-storage-secure-transfer.png)
...
![Screenshot the storage setting blade](../media/4-storage-encryption.png)
...
1. Click **Apply**.
![Screenshot the storage setting blade](../media/4-storage-timespan.png)
...
![Screenshot the storage setting blade](../media/4-storage-SAS.png)
...
![Screenshot the storage setting blade](../media/4-storage-blob.png)
