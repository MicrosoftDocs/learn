...
1. Go to the **Key vaults** pane, if not listed on the left menu, search for **Key vaults**.
1. Select **Key Vaults**.
...
1. Sign in to the Azure portal.
1. In the Settings pane for the resource, resource group, or subscription that you wish to lock, select **Locks**.
