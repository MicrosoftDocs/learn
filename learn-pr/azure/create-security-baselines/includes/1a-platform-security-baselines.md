Microsoft's cybersecurity group and the Center for Internet Security ([CIS](https://www.cisecurity.org/)) have developed best practices to help establish security baselines for the Azure platform.
