...
We looked at how tags enable you to add custom contextual information to your resources, for use in areas such as billing and filtering.
...
1. In the **Overview** pane, select **Delete resource group**. Enter the `msftlearn-core-infrastructure-rg` resource group name to confirm, and select **Delete**.
...
1. Select **Definitions**, then select the **...** for your definition, and then select **Delete definition**.
