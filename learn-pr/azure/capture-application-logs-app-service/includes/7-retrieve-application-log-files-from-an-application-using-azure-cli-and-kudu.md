...
1. Click in the Azure Cloud Shell, and to close the editor, press Ctrl + Q.
...
1. In the **App Services** list, select **contosofashions\<_your-number_\>**; and in the **Development Tools** section, select **Advanced Tools**; and then on the Advanced Tools pane, select **Go**.
...
1. In the Storage Explorer (preview) pane, expand **BLOB CONTAINERS**, and then select **asp logs**.
