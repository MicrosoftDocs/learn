...
1. In the **App Services** list, select **contosofashions\<_your-number_\>**. The **contosofashions\<_your-number_\>** Web App menu appears.

1. On the Web App menu, in the **Essentials** section, copy the **default domain** and paste it in a new browser tab (For example, `contosofashionsNNNNN.azurewebsites.net`). The home page for *Contoso Fashions* should appear.

   Let's set up app logging.

1. On the left-hand menu for your Web App, scroll down to the **Monitoring** section and expand it if necessary. Select **App Service logs**. The **App Service logs** pane appears.
