In this unit, you'll deploy a sample ASP.NET Core Web app from GitHub, which has the code required to generate trace output messages. You'll then use the Azure portal to enable app logging for this app.
