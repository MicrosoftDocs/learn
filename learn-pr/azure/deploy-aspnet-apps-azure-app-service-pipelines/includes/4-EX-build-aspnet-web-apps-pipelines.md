<!--  Marcin, please check this edit below. -->
As your company considers migrating their ASP.NET applications to the Azure App Service, you decide to prepare through hand’s-on practice. 
In this exercise, you'll build artifacts necessary to deploy a sample ASP.NET web app to an Azure App Service web app. 
...
<!--  Marcin, in the note below, will learners know how to add this step? Do they need a little more guidance?  -->
...
## Results
In this exercise you built artifacts necessary to deploy a sample ASP.NET web app to an Azure App Service web app.
