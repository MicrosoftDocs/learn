...
For older versions of vSphere (5.0+), HCX Connector needs to be deployed and downgraded. VMware will then support the migration for a limited period of time.
...
Next, you need to factor in the following network segments in the on-premises HCX environment:
