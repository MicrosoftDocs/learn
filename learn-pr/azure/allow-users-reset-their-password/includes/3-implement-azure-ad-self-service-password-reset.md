...
- An Azure AD tenant. This tenant must have at least a trial license enabled. 
...
1. Enable SSPR. You can either enable it for all users in the Azure AD organization, or for selected users. To enable for selected users, you must specify the security group. Members of this group can use SSPR.
