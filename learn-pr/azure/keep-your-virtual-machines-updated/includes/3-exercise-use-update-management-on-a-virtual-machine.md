...
1. The **Create a virtual machine** pane appears.
1. On the **Basics** tab, enter the following values for each setting.
    ...
    | Resource group       | Select **Create new**, then create a new resource group named *mslearn-vmupdate*     |
    | **Instance details** |
...
1. When update management deployment is complete, the Update Management page shows the status of the VM updates. You might need to refresh the page and select **Go to Update management** to get to this view.
...
1. When Update Management configuration is complete, notice that **Compliance** is complete and the **Failed update deployments** counter is configured.
   ...
   Also, in this example, Update Management identified that there are updates for Windows Server available. In the **Information link** column, there's a link to the knowledge base article for update.
...
1. Notice that the virtual machine you created is listed as a system hybrid worker group.
