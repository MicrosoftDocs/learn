You can add custom domain names to Microsoft Entra ID. After you add the domain names, your employees can use memorable and branded usernames to access your company's resources.
