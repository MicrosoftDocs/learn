...
- Read [an overview of Azure Dedicated Hosts](/azure/dedicated-hosts/overview.md).
 
- Learn how to [deploy VMs and Scale Sets to dedicated hosts](azure/virtual-machines/dedicated-hosts-how-to.md)

- Explore more Azure features (many with ADH compatibility) using the [compute decision chart](/azure/architecture/guide/technology-choices/compute-decision-tree.md)
