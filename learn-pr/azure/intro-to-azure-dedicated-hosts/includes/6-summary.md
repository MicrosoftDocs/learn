...
- Read [an overview of Azure Dedicated Hosts](https://learn.microsoft.com/en-us/azure/virtual-machines/dedicated-hosts).
 
- Learn how to [deploy VMs and Scale Sets to dedicated hosts](https://learn.microsoft.com/en-us/azure/virtual-machines/dedicated-hosts-how-to)

- Explore more Azure features (many with ADH compatibility) using the [compute decision chart](https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/compute-decision-tree)
