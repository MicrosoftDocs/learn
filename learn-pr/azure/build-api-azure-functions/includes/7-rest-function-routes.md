...
By default, any HTTP trigger function responds to GET and POST requests. It also sets the URL of your function to the name of that function prefixed by "/api." Both of these things are configurable.
