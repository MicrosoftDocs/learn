...
You `function.json` file for CreateProducts should now look like this...
...
You `function.json` file for UpdateProduct should now look like this...
...
You `function.json` file for DeleteProduct should now look like this...
...
Each one is shown with the new route that you specified, as well as the HTTP request method that it responds to. Your API is now a RESTful one!
