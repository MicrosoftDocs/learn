...
Look at that stunning API. It's simply gorgeous. Notice how you specified the same exact same route for the CreateProduct, UpdateProduct and DeleteProduct functions? Only the HTTP request method is different. You've turned three URL's into one while still having three endpoints. You're a magician.
