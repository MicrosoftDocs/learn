...
In this exercise, you setup the project enviornment in VS Code. You also connected VS Code to the sandbox concierge subscription. Next, you'll create the Azure Functions project which will serve as the API for the Product Manager application.
