...
Tailwind is exhibiting a number of common business values and expected benefits including: innovation and growth, improvements to operations and security, & technical capabilities and agility. Use this module to understand how they balanced those expectations.

## Guiding the conversation

Digital transformation is a large bet for many organizations and the technology teams leading the effort. Success will produce returns for all involved. Succeed or fail, digital transformation programs can define careers and the future of the business. Strategic clarity and executive buy-in are imperative to the success of digital transformation. Clear commitments to strategic motivations will drive investment allocations & aid in making difficult technical decisions.
...
## Tailwind Trader's horizon plan
...
- **Datacenter exit** The datacenter exit will require significant focus from the Central IT and Retail Innovation teams. The 12-18 month time-frame is aggressive but realistic, if there are few distractions.
- **Operational improvements** Accelerating innovation will require modernization of existing operational systems. It will also require modernization of the processes dedicated to operating the production environments.
...
|---------|---------|---------|---------|
|1) Migration & modernization|Prioritize the datacenter exit with a focus on modern PaaS solutions over a basic shift & lift migration|Months 0 - 18|The migration is priority should minimize conflicts with existing innovation commitments|
|2) Operation modernization|Prioritize operational improvements built on cloud-native governance, ops management, security, and compliance capabilities|Months 6 - 18|This effort will compliment and support the primary migration effort.|
...
|4) Innovation & growth|Redirect capital reduction from datacenter exits and new skills in Central IT to focus on accelerating continued innovation|Month 24+|All prior horizons will produce a long list of new innovations, as the Central It and Retail innovations team create tighter collaborations and build out automation assets|

## Record your observations

If you haven't already, download the [Cloud Adoption Framework Strategy and Plan template](https://raw.githubusercontent.com/microsoft/CloudAdoptionFramework/master/plan/cloud-adoption-framework-strategy-and-plan-template.docx). Fill in the box found under the "Motivations and Drivers" header. Use the motivations discussed in this unit to describe your motivations.
