...
Azure Database for PostgreSQL is a service that provides a fully managed instance of PostgreSQL in the Azure cloud - at any scale. It’s the same open-source software that is used in on-premises servers, with Azure taking care of maintenance and security obligations.
...
As you’re considering cloud-hosted database offerings, consider usability, scalability, and security. In this module, we'll refer back to the payment app scenario to evaluate the qualities of Azure Database for PostgreSQL and assess use cases.
