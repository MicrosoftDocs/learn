...
In this module, you'll create an Azure AD B2C tenant and use it to register an application. You'll use the user flows in Azure AD B2C to help manage patient access to the application. You'll also use multifactor authentication with Azure AD B2C to add a second layer of protection for users.

## Learning objectives

After completing this module, you'll be able to:

- Secure access to an application by using Azure AD B2C.
- Enable multifactor authentication for Azure AD B2C.
