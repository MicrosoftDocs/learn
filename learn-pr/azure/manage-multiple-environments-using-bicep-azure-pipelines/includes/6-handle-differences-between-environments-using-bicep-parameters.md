...
There are special rules about how service connection names can be specified. These rules can affect how you use them in pipelines that deploy to multiple environments. For example, you can't use a variable defined within a variable group to specify a service connection name. You can use pipeline template parameters to specify the name of the service connection to use.
