...
1. The Microsoft Purview Governance Portal opens automatically to the home page of the Microsoft Purview Data Catalog.
    ...
    This text will also be in line with the point above it. See how there's a line trailing from the number in the list to the next number, past these tabbed-over things?
