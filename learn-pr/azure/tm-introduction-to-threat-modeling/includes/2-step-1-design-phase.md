...
Use that information to create a data-flow diagram. It is a graphical representation of your system that shows data across each stage in the data lifecycle, especially as it crosses different trust-zones. Examples include:
...
Microsoft engineering teams are required to submit data-flow diagrams as part of their security compliance requirements.