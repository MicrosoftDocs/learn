...
## I Answered All My Questions, Now What?
...
## What Does the Data-Flow Diagram Look Like?
...
|-----------|-----|-----------|
|0|System|Starting ground for any system. Data-flow diagram contains major system parts with enough context to help you understand how they work and interact with each other|
...
|2|Subprocess|Focus on data-flow diagrams for each subpart of a system part. Used for systems considered critical. Examples include systems for secured environments, handling highly sensitive data or containing a high risk rating|
