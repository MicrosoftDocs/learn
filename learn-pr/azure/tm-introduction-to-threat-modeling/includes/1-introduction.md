...
- Software delivery approaches, like Agile or Waterfall
- Deployment cadences, like hourly, monthly, or yearly

In this module, you'll explore the four high-level steps of threat modeling.

> [!NOTE]
> This training path will refer to systems, applications, and services as "systems."

![Threat Modeling Steps](../media/threat-modeling-steps.png)
