...
### 2. Features of Azure Virtual Hard Disks (VHD)
...
### 2. How to Generalize a Windows Server or Linux VM and create an image of a VM
...
### 3. Exercise - Create an image of an Azure VM from the Azure CLI and provision a new VM.
...
### 4. Exercise - Create an image from a Snapshot.
