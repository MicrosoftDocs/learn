...
In this module, you will build a Java console application in Visual Studio Code to create, update, and delete user records, query your data, and perform stored procedures using Java.
...
- Must have [Apache Maven](https://maven.apache.org/) extension
