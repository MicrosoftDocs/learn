Imagine that you're a software developer for a multimedia company with hundreds of thousands of videos. Video quality has a direct effect on customer retention, so you want to transcode content for optimal resolution and delivery across different platforms.
...
In this module, you learn about common batch-processing workloads. You learn how to create application packages and containerized applications with Azure Batch accounts, pools, jobs, and tasks. You also learn how to enhance security for your Batch account by using virtual networks and private endpoints.
