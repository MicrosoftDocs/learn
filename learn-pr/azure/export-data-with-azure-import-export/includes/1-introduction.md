Imagine you're an Azure administrator for a film production company that has 200 terabytes (TB) of footage archived in Azure Blob Storage. The company plans to rerelease the film with some new footage that's in the archive. You've been asked to get a copy of the new material so that the producers can work on the film locally. You decide to evaluate Azure Import/Export to export the film footage from Azure Blob Storage.
