...
1. Above the code is the path with a dropdown list showing the file name. In the dropdown list, select **function.json**. The JSON file that was created by the template appears. It should look like the following code.
