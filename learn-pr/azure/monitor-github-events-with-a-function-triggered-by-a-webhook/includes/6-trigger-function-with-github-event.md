The GitHub *Gollum* event enables you to listen for wiki updates. When this event occurs, and your Azure HttpTrigger function is triggered, you can parse the payload to retrieve and process the data that was sent.

You've shown the IT department that you can listen for *Gollum* events on your company's GitHub repository by setting up a webhook in GitHub. You've also demonstrated how Azure Function apps enable you to run code when a function receives a webhook request. 
