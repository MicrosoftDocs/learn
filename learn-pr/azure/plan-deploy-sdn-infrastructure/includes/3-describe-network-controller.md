Now that you have a basic understanding of the core SDN concepts, you want to explore the architecture and characteristics of Network Controller. You’re aware of its significance as the foundational component of the Azure Stack HCI SDN control plane, but you’re interested in technologies that serve as the basis of its resiliency. You also want more information regarding its management capabilities.
