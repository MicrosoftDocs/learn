Azure Stack HCI is a hyperconverged infrastructure (HCI) solution that facilitates the design and deployment of Software Defined Networking (SDN) infrastructure.
