...
:::image type="content" source="../media/physical-partitions.png" alt-text="Diagram that illustrates the physical partitions in Cosmos DB." border="false":::
...
:::image type="content" source="../media/logical-partitions.png" alt-text="Diagram that shows different examples of logical partitions." border="false":::
...
:::image type="content" source="../media/hot-partition-storage.png" alt-text="Diagram that shows a hot partition with a highly asymmetric storage pattern." border="false":::
...
:::image type="content" source="../media/hot-partition-throughput.png" alt-text="Diagram that shows a throughput hot partition." border="false":::
...
:::image type="content" source="../media/partitions-even.png" alt-text="Diagram that shows the data and requests spread evenly across partitions." border="false":::
...
:::image type="content" source="../media/in-partition-query.png" alt-text="Diagram that shows a partition query for username." border="false":::
...
:::image type="content" source="../media/customer-partition-key.png" alt-text="Diagram that shows the customer partition key as id." border="false":::
...
:::image type="content" source="../media/single-document-per-partition.png" alt-text="Diagram that shows a single document per partition for the partition key id." border="false":::
