...
:::image type="content" source="../media/product-category-model.png" alt-text="product category model" border="false":::
...
:::image type="content" source="../media/product-category-model-type.png" alt-text="product category model type" border="false":::
...
:::image type="content" source="../media/product-tag-model.png" alt-text="product tag model" border="false":::
