1. To install PowerShell Core, follow the instructions in [Installing PowerShell on Linux](/powershell/scripting/install/installing-powershell-core-on-linux?azure-portal=true&view=powershell-7). 
