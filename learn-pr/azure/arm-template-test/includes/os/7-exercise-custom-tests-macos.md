...
The preceding command is run with the parameter named `-Test`, which takes a test name as input. You've provided `Custom-ParameterNaming` as an argument, which means only your newly developed test will be run.
