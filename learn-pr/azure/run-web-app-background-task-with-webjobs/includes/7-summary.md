...
- [Develop and deploy WebJobs using Visual Studio - Azure App Service](/azure/app-service/webjobs-dotnet-deploy-vs)
- [Get started with the Azure WebJobs SDK for event-driven background processing](/azure/app-service/webjobs-sdk-get-started)
...
- [How to use the Azure WebJobs SDK for event-driven background processing](/azure/app-service/webjobs-sdk-how-to)
- [What are Microsoft Flow, Logic Apps, Functions, and WebJobs?](/azure/azure-functions/functions-compare-logic-apps-ms-flow-webjobs)