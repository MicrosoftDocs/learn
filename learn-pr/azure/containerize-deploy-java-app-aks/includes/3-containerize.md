...
| Docker command | Description |
|-|-|
| FROM   | FROM maven will be the base layer that this TurkishAirlines-0.0.1-SNAPSHOT.war is built from, a specific version of Maven and specific version of JDK to ensure the some compilation of byte code occurs on all machines running this build. |
