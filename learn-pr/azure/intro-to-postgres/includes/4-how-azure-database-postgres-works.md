...
![Azure portal showing the Azure Database for PostgreSQL deployment options, with the create button for Flexible server server highlighted.](../media/4b-portal.png)

![Form for creating flexible server, where you can input the server name, username, and password.](../media/4c-form.png)
