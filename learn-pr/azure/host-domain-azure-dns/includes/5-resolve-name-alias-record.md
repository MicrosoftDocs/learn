...
CNAME records that you may need for a Traffic Manager profile or Azure CDN endpoints aren't supported at the zone apex level. Alias records are supported at zone apex level.
...
The Azure alias record are useful for several scenarios.
...
- **Points zone apex to Azure Content Delivery Network (CDN) endpoints**: With alias records, you can now directly reference your Azure Content Network.
