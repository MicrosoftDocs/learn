...
If you add metadata as files are uploaded to blob storage, they can be automatically indexed by Azure Cognitive earch using the metadata to build the index. This can be useful for image files, where conventional content indexing can be difficult.
