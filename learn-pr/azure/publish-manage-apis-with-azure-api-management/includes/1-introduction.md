...
In this module, you'll create an API gateway to securely publish an API. You'll also use an API Management subscription key to call the API in the same manner as an authorized application. At the end of this module, you'll be able to use API Management to publish any API.
