...
Partners are given their key as part of an onboarding process. In this exercise, you'll use the administrator key, but once you've got a key, its the same process for using the key in API calls.
