Deployment scripts in Azure Resource Manager (ARM) templates enable custom automation to your environment management.

Suppose you are a member of a cross-functional team that supports an application. Your team has adopted ARM templates for creating and managing the environments for your application.  Part of the application environment includes staging some assets into a storage account. You've decided to use a deployment script to ensure that the storage account has the required assets.

In this module, you'll learn how the deployment scripts resource enables you to add custom behavior to your ARM templates.
