To get started with the Azure Developer CLI (`azd`), you can install the tool locally or use it from a cloud environment such as GitHub Codespaces. You can install the Azure Developer CLI with a single command, and it supports a variety of platforms and environments. This module assumes a local installation of `azd`, but you can read more about the pros and cons of the different development-environment choices on the [supported environments](/azure/developer/azure-developer-cli/supported-languages-environments#supported-development-environments) page.
