To get started with the Azure Developer CLI, you can install the tool locally or use it from a cloud environment such as GitHub Codespaces. The Azure Developer CLI can be installed with a single command and supports a variety of platforms and environments. This module assumes a local installation of `azd`, but you can read more about the pros and cons of the different development environment choice on [Azure Developer CLI supported environments](/azure/developer/azure-developer-cli/supported-languages-environments#supported-development-environments) age.
...
Install the Azure Developer CLI on your preferred environment using one of the following commands:
