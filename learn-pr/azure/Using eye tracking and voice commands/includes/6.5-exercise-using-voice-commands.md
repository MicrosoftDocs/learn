...
:::image type="content" source="../media/base-09-section1-step1-1.png" alt-text="Enable microphone capability" lightbox="base-09-section4-step1-1.png":::
...
:::image type="content" source="../media/base-09-section2-step1-1.png" alt-text="Configure DefaultMixedRealitySpeechCommandsProfile" lightbox="base-09-section2-step1-1.png":::
...
:::image type="content" source="../media/base-09-section2-step1-2.png" alt-text="Add speech commands" lightbox="base-09-section2-step1-2.png":::
...
:::image type="content" source="../media/base-09-section3-step1-1.png" alt-text="Opening tooltip folder" lightbox="base-09-section3-step1-1.png":::
...
:::image type="content" source="../media/base-09-section3-step1-2.png" alt-text="Configuring speech input handler component" lightbox="base-09-section3-step1-2.png":::

3. On the SpeechInputHandler component, click the small + icon three times to add three keyword elements:

:::image type="content" source="../media/base-09-section3-step1-3.png" alt-text="Adding keyword elements to speech input handler" lightbox="base-09-section3-step1-3.png":::
...
:::image type="content" source="../media/base-09-section3-step1-4.png" alt-text="Configure keyword element 0" lightbox="base-09-section3-step1-4.png":::
...
:::image type="content" source="../media/base-09-section3-step1-5.png" alt-text="Configure keyword element 1" lightbox="base-09-section3-step1-5.png":::
...
:::image type="content" source="../media/base-09-section3-step1-6.png" alt-text="Configure keyword element 2" lightbox="base-09-section3-step1-6.png":::
...
:::image type="content" source="../media/base-09-section3-step1-7.png" alt-text="Add speech input handler to Rover Assembly" lightbox="base-09-section3-step1-7.png":::
...
:::image type="content" source="../media/base-09-section3-step1-8.png" alt-text="Configure speech input handler on Rover Assembly" lightbox="base-09-section3-step1-8.png":::