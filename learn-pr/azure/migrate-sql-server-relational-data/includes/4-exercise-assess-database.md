...
Look more closely at the first row, though, and you'll see the issue **Service Broker feature is not supported in Azure SQL Database. Azure SQL Database does not support trace flags.** The information for that issue includes instructions on how to solve it. The database that you're migrating doesn't need this feature, so you can disable it without any problems.
