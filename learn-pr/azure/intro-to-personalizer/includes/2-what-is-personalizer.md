Personalizer is an API in the Decision category of Azure Cognitive Services. It allows your applications to select appropriate content to show to users of the application. 
