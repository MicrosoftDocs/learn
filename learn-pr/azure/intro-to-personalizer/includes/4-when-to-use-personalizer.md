...
- Follow proper ethics to ensure any learning from the model follows [responsible user guidelines](/azure/cognitive-services/personalizer/ethics-responsible-use?azure-portal=true).
