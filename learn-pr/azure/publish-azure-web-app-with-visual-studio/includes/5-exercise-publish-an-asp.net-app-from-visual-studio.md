...
1. In the dialog box that appears, select **Azure** as your publish target, and then select **Next** to continue.
...
1. After several seconds, the **App Service (Windows)** dialog window will disappear. Your new App Service displays in the list of App Service resources on the **Publish** dialog. Select **Finish** to finish the creation of the publishing profile. The **Publish** dialog disappears.
