...
1. You should now see a geofence and several bus points. You may need to use the **+** or **-** buttons create a zoom fit. If you don't see any buses, change the URL from `gid=1` to `gid=2`.
