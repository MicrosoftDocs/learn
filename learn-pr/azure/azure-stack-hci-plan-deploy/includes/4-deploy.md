...
:::image type="content" source="../media/4-azs-hci-wac2.png" alt-text="The image illustrating the Windows Admin Center Cluster Creation wizard page containing the listing of the main installation steps." border="false":::
...
1. Integrate with Azure services. Use Windows Admin Center to implement integration betweeen Azure Stack HCI VM-based workloads and Azure.
