Azure Storage Blobs give you binary storage in the cloud and an API that lets you build applications to access the data.
...
You need a storage solution that can handle thousands of simultaneous uploads, massive amounts of video data, and constantly growing log files. You also need to add the viewing functionality to all your mobile applications and your website, so you want API access from multiple platforms and languages.
