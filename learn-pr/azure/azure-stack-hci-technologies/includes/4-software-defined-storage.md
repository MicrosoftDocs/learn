...
A storage space is a storage-virtualization capability built into Azure Stack HCI, Windows Server, and Windows 10. The Storage Spaces feature consists of two components:
...
To provide additional resiliency for your Hyper-V worklods, you can use Storage Replica.
