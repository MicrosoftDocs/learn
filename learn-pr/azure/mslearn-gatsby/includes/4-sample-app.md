Most apps have *so-called* master-detail views. What that means is that we have the following views:

- `list view`, this view contains a list of items
- `detail view`, this view shows a specific item from a list

Master-detail views can come with a different set of functionalities though. Some versions just contains a list view and a detail view whereas some gives the user the capability to add, remove, update and even delete items.

## Our Sample app

Our Sample app is of type master-detail. It is limited though in what it can do. It will contain the following:

- list view, this view will display a list of dream vacations
- detail view, this will display a detailed view over one specific vacation
