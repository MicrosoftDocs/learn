...
Taking the data sorting one step further, you can group, or aggregate, results by common fields. You may recall that the sorted list above gave several entries for various states.
...
1. Right-click on a selected field, and select **Add selection as filters**. The query above changes to add filtered fields.
