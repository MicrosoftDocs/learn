*Azure Bot Service* is a collection of tools that you can use to create enterprise-grade conversational AI experiences. You can use Azure Bot Service components, including the Bot Framework Composer and the Bot Framework SDK, to design, build, test, and deploy bot functionality.
...
- The components and capabilities of the Azure Bot Service.
- How the Azure Bot Service components work together on Azure.
