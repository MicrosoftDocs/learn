...
:::image type="content" source="../media/2-docker-hub-search.png" alt-text="Screenshot of the Docker Hub search page that lists various container images.":::
...
:::image type="content" source="../media/2-sample-web-app.png" alt-text="Screenshot of the sample web app running in a browser.":::
