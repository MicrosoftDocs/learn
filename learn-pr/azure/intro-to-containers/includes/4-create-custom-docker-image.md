...
| EXPOSE | Creates a configuration in the new image that specifies which ports to open when the container is run. If the container is running a web app, it's common to EXPOSE port 80. |
