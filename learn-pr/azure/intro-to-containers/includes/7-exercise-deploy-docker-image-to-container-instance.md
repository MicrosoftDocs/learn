...
1. Select **Containers**, and select **Container Registry**. The **Create container registry** pane appears.
...
1. On the **Summary** pane, wait for validation to complete, and correct any errors, if necessary. Select **Create**.
