In this module you used some the buil-in functions of Azure Databricks to perform basic data transformation. You applied schema to structure your data and used built-in functions to handle corrupt records. 
