...
:::image type="content" source="../media/3-industrial-network-diagram-knowledge-check.png" alt-text="aaaaDiagram of a sample network diagram. Figure one for the knowledge check question." border="false":::
