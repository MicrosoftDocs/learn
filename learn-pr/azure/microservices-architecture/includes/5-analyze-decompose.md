...
For Fabrikam's application, all of these services reside in their existing monolithic application. Now that they've identified where they decompose their application into microservices, they're going to start with the package service.
