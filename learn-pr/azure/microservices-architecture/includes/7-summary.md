...
To learn more about microservices, check out the following docs on the Azure Architecture Center.

- [Introduction to microservices](https://docs.microsoft.com/azure/architecture/microservices/introduction)
- [Designing a microservices architecture](https://docs.microsoft.com/azure/architecture/microservices/design/)
