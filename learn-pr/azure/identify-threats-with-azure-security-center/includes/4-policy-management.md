...
You can view the active security policies through the workload protection dashboard and the Security policy view.

![Screenshot of the Security policy pane in the Microsoft Defender for Cloud product.](../media/3-security-center-policy-mgt.png)
