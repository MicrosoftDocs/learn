...
1. Add the query string value `&name=Azure` to the end of this URL, and then press <kbd>Enter</kbd> to execute the request. You should see a response similar to the following response returned by the function appear in your browser.
...
1. Return to the portal, and in the left menu pane, under **Developer**, select **Code + Test** to view the code. The **Code + Test** pane appears for your function.
...
1. Return to the portal, and in the left menu pane, under **Developer**, select **Code + Test** to view the code. The **Code + Test** pane for your function appears.
...
1. We'll get back to adding input bindings later in this module but for now, select **Cancel** to dismiss this pane.

1. Select **Add output** in the **Outputs** box. The **Create Output** pane appears showing a list of all possible output **Binding Types** when selecting its dropdown list.

1. As you can see, there are several output binding types. We'll get back to adding output bindings later in this module but, for now, select **Cancel** to dismiss this pane.
