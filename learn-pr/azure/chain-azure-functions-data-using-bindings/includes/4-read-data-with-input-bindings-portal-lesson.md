...
A full listing of supported bindings is avalable: <a href="https://docs.microsoft.com/en-us/azure/azure-functions/functions-triggers-bindings?tabs=csharp#supported-bindings" data-linktype="external" target="az-portal">Here<span class="docon docon-navigate-external" aria-hidden="true"></span></a>
