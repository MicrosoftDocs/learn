Azure Load Balancer allows you to distribute incoming network traffic across a group of backend resources or services such as virtual machines (VM). Load Balancer helps you scale your applications while maintaining throughput, and keeping response times low.
