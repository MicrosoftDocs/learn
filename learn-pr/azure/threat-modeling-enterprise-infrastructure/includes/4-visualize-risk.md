...
|Element A|Data-flow|Element B|Crosses boundary|Details|
|---------|---------|---------|----------------|-------|
|![Azure IaaS process.](../media/elements/process-25.png)</br>Azure IaaS|![Bi-directional flow between Azure IaaS process and firewall service process](../media/elements/data-flow-25.png)</br>Bi-directional|![Firewall service process](../media/elements/process-25.png)</br>Firewall service|![Crosses trust boundary](../media/supporting-icons/check-25.png)</br>Yes|<ul><li>IPSec tunnel</li><li>Microsoft Entra authentication</li><li>User credentials</li><li>Session tokens</li><li>Requests and responses</li></ul>|
