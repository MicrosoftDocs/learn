As we learned in the [Threat Modeling Security Fundamentals Learning Path](/learn/modules/tm-introduction-to-threat-modeling), threat modeling is an effective technique to help secure your systems, applications, networks, and services. It can also help secure your company infrastructure.
...
The threat modeling framework is flexible, and can be easily used for your infrastructure. Let's revisit the framework, which is primarily found in our [Threat Modeling Security Fundamentals Learning Path](/learn/modules/tm-introduction-to-threat-modeling):
