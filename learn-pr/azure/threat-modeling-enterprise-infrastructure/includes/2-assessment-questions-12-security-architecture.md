...
![Security architecture category.](../media/policies/security-architecture.png)
...
|--------|--------------|
|**Describe your infrastructure.**|<ul><li>Learn if the infrastructure is on-premises, cloud-based, or a hybrid of both.</li><li>Software usage restrictions.</li><li>Baselines used to provide acceptable levels of security across different platforms and operating systems.</li></ul>|
|**Describe your infrastructure for containers and IoT devices.**|<ul><li>Use of IoT and containers.</li><li>Security controls used for network access, device configuration, and data handling.</li><li>Security requirements for containers as they relate to containerization and orchestrators.</li></ul>|
