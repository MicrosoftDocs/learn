We've looked at the number of pods that our application will require. Now, we need to decide what kind of virtual machine nodes we need. We'll also need to know how many nodes to run.
