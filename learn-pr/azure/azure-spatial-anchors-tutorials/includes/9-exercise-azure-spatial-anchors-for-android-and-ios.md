...
:::image type="content" source="../media/asa-05-section2-step1-1.png" alt-text="Configure MRTK for AR camera" lightbox="asa-05-section2-step1-1.png":::
...
:::image type="content" source="../media/asa-05-section2-step1-2.png" alt-text="Camera settings" lightbox="asa-05-section2-step1-2.png":::

3. Click the + **Add Camera Setting Provider** button, then expand the newly added **New data provider**:

:::image type="content" source="../media/asa-05-section2-step1-3.png" alt-text="Add camera setting provider" lightbox="asa-05-section2-step1-3.png":::
...
:::image type="content" source="../media/asa-05-section3-step1-1.png" alt-text="Change build settings" lightbox="asa-05-section3-step1-1.png":::
...
:::image type="content" source="../media/asa-05-section3-step1-2-1.png" alt-text="Project settings" lightbox="asa-05-section3-step1-2-1.png":::
...
:::image type="content" source="../media/asa-05-section3-step1-4.png" alt-text="Run device dropdown" lightbox="asa-05-section3-step1-4.png":::
...
:::image type="content" source="../media/asa-05-section3-step1-5.png" alt-text="Build to android" lightbox="asa-05-section3-step1-5.png":::
...
:::image type="content" source="../media/asa-05-section4-step1-1.png" alt-text="Build settings" lightbox="asa-05-section4-step1-1.png":::
...
:::image type="content" source="../media/asa-05-section4-step1-2.png" alt-text="MRTK project configurator" lightbox="asa-05-section4-step1-2.png":::
...
:::image type="content" source="../media/asa-05-section4-step1-3.png" alt-text="Strip Engine Code" lightbox="asa-05-section4-step1-3.png":::
...
:::image type="content" source="../media/asa-05-section4-step1-4.png" alt-text="Build the scenes" lightbox="asa-05-section4-step1-4.png":::
