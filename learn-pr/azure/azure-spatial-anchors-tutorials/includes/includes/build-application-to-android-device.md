...
:::image type="content" source="../../media/ar-core-checkbox.png" alt-text="Screenshot of Check ARcore checkbox" lightbox="../../media/ar-core-checkbox.png":::
...
:::image type="content" source="../../media/build-settings-window.png" alt-text="Screenshot of Close the Player Settings window and open Build Settings window" lightbox="../../media/build-settings-window.png":::
