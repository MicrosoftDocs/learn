...
Users can scan their phones to see where they are in the real world depends on what the camera sees. The application displays arrows over the environment to make navigation easier for the user.

**Internet of Things**

Another area where the usage of spatial anchors will be extremely beneficial is the Internet of Things. For example, assume you're standing in front of a piece of factory equipment which is equipped with several sensors. If a part has a problem, an arrow can be used to point straight to the problem part. You can see every piece of important information quickly and just by gazing at the piece of equipment with your device on.
...
The script will help to change the icon, text, and label of the button. Each button has a Button Config Helper script that allows you to choose an icon for your button from a set of icons.
