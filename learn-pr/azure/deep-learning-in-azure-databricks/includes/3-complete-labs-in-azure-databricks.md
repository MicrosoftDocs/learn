...
Now that you have learned about various deep learning techniques supported by Azure Databricks, it's time to use some of those. We will use Databricks notebooks for further exploring some of the deep learning tool.
...
1. **01 Deep Learning** - This notebooks gives a brief about the other notebooks in this lab.
