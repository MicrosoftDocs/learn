...
![Diagram of the App Containerization process overview.](../media/process-overview.png)

In the next sections of this module, you'll set up a sample two-tier ASP.NET web application and use Azure Migrate: App Containerization to containerize and migrate the application to AKS.
