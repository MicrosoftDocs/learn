Great work! In this module, you learned about accelerating your application modernization journey using Azure Migrate: App Containerization by containerizing and migrating an ASP.NET application to AKS. You containerized and migrated the ASP.NET application, Parts Unlimited, that was running on Windows machines to AKS using the Azure Migrate: App Containerization tool.  
