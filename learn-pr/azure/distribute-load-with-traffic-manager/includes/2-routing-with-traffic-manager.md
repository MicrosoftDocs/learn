...
- **Azure endpoints** are used for services hosted in Azure. These can be services like Web App, as well as public IP resources that are associated with load blancers or virtual machines.
