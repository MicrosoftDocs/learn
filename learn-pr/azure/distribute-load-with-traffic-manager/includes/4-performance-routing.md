...
:::image type="content" source="../media/4-performance-example.png" alt-text="S[Diagram of an example showing Traffic Manager routing traffic to the best performing endpoint." loc-scope="other":::
