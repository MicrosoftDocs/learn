...
The .NET CLI creates and manages .NET projects within a specified directory. Here, you'll use the CLI to create a new console application and add a package reference to the SDK.
