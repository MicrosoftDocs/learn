...
- guide: https://learn.microsoft.com/java/azure/eclipse/azure-toolkit-for-eclipse-create-hello-world-web-app
- guide: https://learn.microsoft.com/azure/app-service/app-service-web-get-started-java 
- Create a directory
