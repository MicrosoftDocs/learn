...
Files and folders are available for recovery from Azure virtual machines if the backup has been done with the **Microsoft Azure Recovery Services (MARS)** agent. You can restore data to the same machine that it was originally backed up from, or to a different machine in your subscription.
