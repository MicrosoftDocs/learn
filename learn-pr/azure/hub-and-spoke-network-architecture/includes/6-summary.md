In this module, you explored migrating your on-premises infrastructure to Azure by using the hub and spoke model. You know the components you need to create hub-spoke networks and how to secure them in Azure.
