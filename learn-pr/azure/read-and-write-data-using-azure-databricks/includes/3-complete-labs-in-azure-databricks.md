...
4. On the Import Notebooks dialog, select URL and paste in the following URL:
    ```
    https://github.com/solliancenet/proj-learning-paths-public/blob/master/modern-data-warehouse/04-Reading-Writing-Data.dbc?raw=true
    ```
5. Select Import.
...
To complete the labs, continue working within your Azure Databricks workspace and open the new **04-Reading-Writing-Data** folder. Within the folder, you will find _Python_, _Scala_, and _Spark_ sub-folders. Choose the folder for the language you prefer to use, open the corresponding folder and then the  notebook. Follow the instructions within the notebook, until you have completed the entire notebook. Then continue with the remaining notebooks in order.

- **01-Getting-Started** -  This notebook gets you started with your Databricks workspace.
- **02-Querying-Files** - This notebooks contains exercises to help you query, large data files and visualize your results.
...
- **06-Data-Lakes** - This notebooks lists the exercises that helps you understand how to create ADLS and use Databricks DataFrames to query and analyze this data.
- **07-Azure-Data-Lake-Gen2** - Here you use Databricks to query and analyze data stores in Azure Data Lake Storage Gen2.
- **08-Key-Vault-backed-secret-scopes** - This notebooks lists the steps for configuring a Key Vault-backed secret scope. You will create a Key Vault-backed secret scope  and securely store in it usernames and passwords for a sample SQL Database and Cosmos DB to be used in the following notebooks.
- **09-SQL-Database-Connect-Using-Key-Vault** - Here you will connect to a SQL Database using your Azure SQL username and password that you created and securely stored in the Key Vault-backed secret scope in the previous notebook.
- **10-Cosmos-DB-Connect-Using-Key-Vault** - Here you will connect to a Cosmos DB using your Azure Cosmos DB username and password that you previously created and securely stored in the Key Vault-backed secret scope.
