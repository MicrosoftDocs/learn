...
1. Click **New Project** to create a new project.
    ...
    :::image type="content" source="../media/1-portal-click-new-project.png" alt-text="Screenshot of the Custom Vision Service portal with the New Project option highlighted." loc-scope="other"::: <!-- no-loc -->
...
1. Select **Create project** to create our project.
    ...
    :::image type="content" source="../media/1-portal-create-project.png" alt-text="Screenshot of the Create new project dialog box with the Name field, Domains list, and Create project button highlighted." loc-scope="other"::: <!-- no-loc -->
