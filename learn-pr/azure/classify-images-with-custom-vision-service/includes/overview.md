...
In order to complete this lab you will need a Microsoft account. If you don't have one, [sign up for free](https://account.microsoft.com/account). You will also need Visual Studio Code and Node.js.