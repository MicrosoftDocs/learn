...
1. Select **Select Existing** to select the resource group that has been created for you in the Azure sandbox.

    :::image type="content" source="../media/extension-no-permissions.png" alt-text="Select existing resource group":::

1. Select the resource group named <rgn>[Sandbox resource group]</rgn>.
...
1. In the Visual Studio Code Explorer window, return to the _Static Web Apps_ section, right-click on **my-first-static-web-app**, and select **Open in Portal** to view app in the Azure portal.
