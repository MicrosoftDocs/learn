...
1. In the **Development Tools** section, select **App Service Editor (Preview)**, and then on the App Service Editor (Preview) pane, select **Go**. 
...
## Change website and rerun the performance test
