You need an Azure Remote Rendering account to access the Remote Rendering service. In this exercise, you create a Remote Rendering account and copy its account ID, account domain, and primary access key. You use the Remote Rendering credentials later in this module to load and render a model.
