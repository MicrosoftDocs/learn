...
- Design review for assets like truck engines.
- Preoperative surgery planning.

Bringing detail to life with 3D visualization helps designers, engineers, doctors, and students better understand complex information and make right calls.

## Decimation

Unfortunately, tethered virtual and mixed reality devices have limited computational power for rendering complex models. A traditional approach to viewing 3D content on untethered devices is *decimation*, which compresses the models and removes some polygons. Decimation simplifies the model enough so it can run on slower GPU hardware.
