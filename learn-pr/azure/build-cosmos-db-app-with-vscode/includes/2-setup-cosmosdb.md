...
1. Click the **Database** > right click **Concierge Subscription** and select **Create Server** to start creating an Azure Cosmos DB account. You will be asked to select the subscription if you have more than one.
