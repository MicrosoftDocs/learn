...
<!--ID/SME: Please review the alt text for graphics in this unit and that they correctly describe the screenshots.-->
...
<!--ID/SME: This alt text didn't seem to describe it's respective graphic. Please use or edit suggested changes.-->
   > [!NOTE]
...
<!--ID/SME: The following image isn't available so I couldn't check the corresponding alt text.-->
...
<!--ID/SME: I suggest rewording thd alt text to "Screenshot of the Items tab in the Data Explorer window displaying telemetry data generated..."-->
## Results
