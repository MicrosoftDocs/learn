...
In this module, you will extend your cloud-native application to provide IoT functionality by integrating its components with an Azure IoT service and leveraging Cosmos DB to provide a persistent data store.
