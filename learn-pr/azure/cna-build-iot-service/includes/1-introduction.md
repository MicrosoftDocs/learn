...
In this module, you'll extend your cloud-native application to provide IoT functionality by integrating its components with an Azure IoT service and by using Cosmos DB to provide a persistent data store.
...
Your team has also designed and implemented the prototype of a solution that uses Azure IoT Central for IoT telemetry collection and processing. This prototype serves as the basis for extending the IoT data pipeline that you'll focus on in this module.
