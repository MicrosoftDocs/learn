...
The installation instructions are platform-specific. Follow the instructions for your platform at  [Work with Azure Functions Core Tools](/azure/azure-functions/functions-run-local?WT.mc_id=learnlive-video-learn)
