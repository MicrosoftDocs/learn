...
The Azure Monitor agent has replaced the Log Analytics agent, the diagnostic extension, and the Telegraf agent. By using the Azure Monitor Agent, you can realize the following benefits:
