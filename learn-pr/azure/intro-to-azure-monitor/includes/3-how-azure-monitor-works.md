...
You can enable additional Azure Monitor features for your resources at-scale programmatically with Azure CLI, ARM templates and PowerShell. You can ingest and export data via APIs and you can use Azure Event Hubs to stream data out in near real time.
