...
During this module you'll be able learn about how to use Azure DNS Private Resolver to resolve DNS queries from on-premises to cloud.


## What is the main goal?
By the end of this session, you'll be able understand details about what is the Azure DNS Private Resolver, how it works and when to use.
