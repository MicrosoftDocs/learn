...
> [!TIP]
> We recommend that you review [Test your Bicep code by using Azure Pipelines](xref:learn.azure.test-bicep-code-using-azure-pipelines) for more information on how to test your Bicep files in an automated workflow.
