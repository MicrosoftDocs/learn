Imagine that you're an Azure subscription owner or billing admin for an organization called Contoso. Your team has been using Azure for several years and has consistent base virtual machine (VM) usage. Currently, you're paying for the VMs on a monthly pay-as-you-go basis, and are interested in lowering the overall annual cost of your environment. Lower Azure costs would free up additional funds for future development work.
