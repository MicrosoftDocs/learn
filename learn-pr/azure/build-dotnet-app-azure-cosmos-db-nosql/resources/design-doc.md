...
01. Create Azure Cosmos DB for NoSQL database, container, and item resources
01. Execute multiple Azure Cosmos DB for NoSQL .NET SDK operations either as a transaction
01. Query Azure Cosmos DB for NoSQL items and iterate through the result set
