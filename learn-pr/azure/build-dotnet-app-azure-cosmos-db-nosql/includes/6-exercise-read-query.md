...
:::image type="content" source="../media/project-visual-query.svg" alt-text="Illustration of icons indicating data being queried using a query." lightbox="../media/project-visual-query.svg" border="false":::
