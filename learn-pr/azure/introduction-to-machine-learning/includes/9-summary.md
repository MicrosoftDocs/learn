We covered a lot of new jargon in this module. Let’s recap what we have learned:

* The goal of machine learning is to find patterns in data and use this to make estimates
...
* An **optimizer**, which is the additional code that changes the model depending on its performance.
...
* Pandas and Plotly are powerful tools explore datasets in Python
