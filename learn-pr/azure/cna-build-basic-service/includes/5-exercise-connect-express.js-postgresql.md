...
1. Next, use the code editor to create a file named **index.js** in the root of the project and add to it the following content:

    > [!NOTE]
    > To save a file in code editor, use the **ctrl+s** key combination. To close the editor pane, use the menu on right side of the pane.
...
1. From your computer, in the web browser window displaying the Azure portal, within the Bash session on the **Cloud Shell** pane, use the code editor to add the following content to the **index.js** file:
