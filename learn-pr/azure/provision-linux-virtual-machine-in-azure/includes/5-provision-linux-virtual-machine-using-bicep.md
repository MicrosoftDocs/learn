...
> [!NOTE]
> This command includes the **--parameters** switch, which in this case sets the name of the local administrator for the Azure VM that you're deploying. Azure CLI will prompt you to provide the corresponding password because the default value of the **adminPasswordOrKey** parameter is not set.
