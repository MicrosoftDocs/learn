...
- The customer can't connect their network to the public internet for compliance reasons.
- Microsoft can't offer connectivity to other Microsoft clouds for geo-political or security reasons.
- The host organization might require cloud management by non-Microsoft entities, or in-country/region by security-cleared personnel for geo-political or security reasons.
- Cloud management would pose significant risk to the physical well-being of Microsoft resources operating the environment.

For most of these customers, Microsoft and its partners offer a customer-managed, Azure Stack Hub-based private cloud appliance on field-deployable hardware from [major vendors](https://azure.microsoft.com/products/azure-stack/hub/#partners) such as Avanade, Cisco, Dell EMC, Hewlett Packard Enterprise, and Lenovo. The hardware vendor manufactures, configures, and deploys Azure Stack Hub. It can be ruggedized and security-hardened to meet many different environmental and compliance standards. Including, the ability to withstand transport by aircraft, ship, or truck, and deployment into colocation, mobile, or modular datacenters. Azure Stack Hub can be used in the most extreme conditions and remote locations. Such as, exploration, construction, agriculture, oil and gas, manufacturing, disaster response, government efforts, and military efforts. Azure Stack Hub allows customers the full autonomy to monitor, manage, and provision their own private cloud resources while meeting their connectivity, compliance, and ruggedization requirements.

## Machine learning model training

[AI](/training/modules/azure-artificial-intelligence/1-introduction-to-azure-artificial-intelligence) holds tremendous potential for governments. [Machine learning](/training/modules/azure-artificial-intelligence/3-machine-learning) is a data science technique that allows computers to learn to use existing data to forecast future behaviors, outcomes, and trends, without being explicitly programmed. [Machine learning technologies](/azure/architecture/data-guide/technology-choices/data-science-and-machine-learning) can also discover patterns, anomalies, and predictions that can help governments in their missions. As technical barriers continue to fall, decision-makers face the opportunity to develop and explore transformative AI applications. There are five main vectors that can make it easier, faster, and cheaper to adopt machine learning:
...
What we mean by data-driven farming is the ability to map every farm and overlay it with data. For example, what is the soil moisture level 15 cm under the soil, what is the soil temperature 15 cm under the soil, and so on. These maps can then enable techniques, such as precision agriculture, which is shown to improve yield, reduce costs, and benefit the environment.

Although precision agriculture as a technique was proposed more than 30 years ago, it still isn't widely used. The biggest reason is the inability to capture large amounts of data from farms to accurately represent the conditions in the farm. Our goal as part of the Farm Beats project is to be able to accurately construct precision maps at a fraction of the cost.

## Unleashing the power of analytics with synthetic data

Synthetic data is data that is artificially created rather than generated by actual events. Computer algorithms are often used to create synthetic data, and it's used for a wide range of activities. Including, usage as test data for new products and tools, as well as for the validation and improvement of machine learning models. Synthetic data can meet specific needs or conditions that aren't available in existing real data. For governments, the nature of synthetic data removes many barriers and helps data scientists with privacy concerns, accelerated learning, and data volume reduction needed for the same outcome. The main benefits of synthetic data are:

- Overcoming restrictions: Real data might have usage constraints from privacy rules or other regulations. Synthetic data can replicate all important statistical properties of real data without exposing real data.
...
Now, let's review what you learned with a knowledge check.
