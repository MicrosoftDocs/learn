...
![Note]
In this module, we'll merely create a file as a means of triggering the Python extension for Visual Studio Code to display a pop up message to initiate the installation of pylint.  We will not use the file in this module, but will learn how to write and execute a code file in the next module titled "Write your first Python code".
