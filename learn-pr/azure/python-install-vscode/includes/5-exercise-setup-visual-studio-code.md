We've already seen how we can execute Python code line by line using Python's Interactive Mode.  Like we said at that time, that is useful when you want to experiment with a few lines of code.  The downside is that once you leave Interactive Mode, any code you wrote is gone forever.
