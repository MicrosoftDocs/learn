Azure Files provides a cloud-based file share for storing and sharing files. You can then access these files from applications hosted in Azure App Service, an Azure VM, or an on-premises machine. Azure Files can store and share file access between applications and systems in a secure and failure resilient manner.

A financial company is moving an application to Azure that generates reports and data exports for users and other systems to consume. The company stores these reports and data exports on both NAS devices and Windows file shares. The files are stored this way so they can easily share them between systems. They would like to consolidate the storage of these files to a native cloud service, as the company wants to continue to use Server Message Block (SMB) to access the files securely.
