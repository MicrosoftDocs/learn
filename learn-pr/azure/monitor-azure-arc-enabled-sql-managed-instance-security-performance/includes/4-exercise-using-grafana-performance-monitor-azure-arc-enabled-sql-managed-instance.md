An Azure Arc-enabled SQL Managed Instance deployment out of the box provides the ability to monitor the environment locally using Azure Data Studio and Grafana. In this exercise, we look at how to access Grafana and what metrics are captured and provided by default. 
...
[![Screenshot of Grafana Pods and Container Metrics.](../media/azure-data-studio-grafana-pods-container-metrics-11.png)](../media/azure-data-studio-grafana-pods-container-metrics-11.png#lightbox)
