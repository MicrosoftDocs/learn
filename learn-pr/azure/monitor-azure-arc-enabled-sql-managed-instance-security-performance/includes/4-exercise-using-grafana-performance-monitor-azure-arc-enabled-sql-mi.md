...
![Screenshot of Azure Monitor – Arc-enabled SQL MI Manage - Grafana endpoint.](../media/azure-data-studio-grafana-endpoint-1.png)
...
![Screenshot of Grafana Arc-enabled SQL MI - Batch Requests/sec.](../media/azure-data-studio-grafana-batch-requests-3.png)

    - Wait Statistics

![Screenshot of Grafana Arc-enabled SQL MI - Wait Stats.](../media/azure-data-studio-grafana-wait-stats-4.png)

    - Memory Broker Clerks

![Screenshot of Grafana Arc-enabled SQL MI - Memory Broker Clerks.](../media/azure-data-studio-grafana-memory-clerks-5.png)

    - Database Activity

![Screenshot of Grafana Arc-enabled SQL MI - Database Activity.](../media/azure-data-studio-grafana-database-activity-6.png)

    - SQL Server Activity

![Screenshot of Grafana Arc-enabled SQL MI - SQL Server Activity.](../media/azure-data-studio-grafana-sql-server-activity-7.png)

    - Buffer Cache - Memory

![Screenshot of Grafana Arc-enabled SQL MI - Buffer Cache Memory.](../media/azure-data-studio-grafana-buffer-cache-7.png)

    - Memory Manager

![Screenshot of Grafana Arc-enabled SQL MI - Memory Manager.](../media/azure-data-studio-grafana-memory-manager-8.png)

9. Swap to another deployed Arc-enabled SQL MI. Select the drop-down for Host.

![Screenshot of Grafana monitored Arc-enabled SQL MI.](../media/azure-data-studio-grafana-monitored-sqlmi-9.png)
