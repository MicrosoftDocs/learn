Your CRM application is a complex system that stores data in Azure Storage, and in Azure Data Lake Storage Gen1. You wanted an easy-to-use tool that helps your engineers to administer the data in the different Azure locations.

You can use Azure Storage Explorer to give your developers a tool that manages and controls data stored in Azure, including Azure Data Lake Gen1 and Gen2.
...
In this module, you've explored different ways to use Storage Explorer to connect to your storage accounts. You've used the Azure CLI to create Data Lake Gen2 enabled storage accounts. Finally, you've connected Storage Explorer to Data Lake Storage. Then you uploaded and viewed the data that's stored there.
