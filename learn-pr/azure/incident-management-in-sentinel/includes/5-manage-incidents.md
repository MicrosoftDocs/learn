...
Once you start using Azure Sentinel to generate incidents, you and the IT team at Contoso will want to investigate those incidents. You can use the advanced investigation and analysis tools to gather information and determine remediation steps.
...
:::image type="content" source="../media/5-investigation-graph.png" alt-text="The screenshot shows the **Investigation graph** page.":::
