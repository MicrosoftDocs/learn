...
If you prefer, Sang has another format for a conclusion that she just added to the dev guide. Hers is: restate scenario problem and show how you solved the problem (paragraph 1), and then describe the experience without the product and describe the business impact of using the product (paragraph 2). 
