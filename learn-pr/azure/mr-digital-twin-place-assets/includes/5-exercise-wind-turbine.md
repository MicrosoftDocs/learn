...
2. Browse to the folder where you saved your Scene.  Typically, this is the **Assets > Scenes** folder in the root project folder structure.  If you followed the guidance in the previous module, your Scene will be called **MainScene**.
...
- Select **Gizmos** dropdown and adjust the size via the slider.  
- Toggle Gizmos on and off by selecting the Gizmos button at the top of your Scene.
...
5. Make the **Wind Turbine Design** a child of the **Bing Maps Design** by nesting it under the **Bing Maps Design** Asset in the Hierarchy window.  Be sure to drag it to the bottom of the list of children or you'll receive a message “Cannot restructure Prefab instance”.  If you receive this, select **Cancel**, and place the Prefab at the bottom of the list of children directly under the **Bing Maps Design**.
