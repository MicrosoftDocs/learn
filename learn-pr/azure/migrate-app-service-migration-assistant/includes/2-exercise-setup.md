In this unit, open a sandbox environment. The exercises in this module use a virtual machine to simulate an on-premises Windows Server installation running Internet Information Services (IIS) and an ASP.NET web app. The VM has the Azure App Service Migration Assistant pre-installed.
...
After you see the message *Provisioning started! Continue to the next unit*, select **Continue** at the bottom of this page.
