...
It will take several moments for the script to run.  The script provisions a new Virtual Machine and installs all the resources to complete the exercise in this module.  In the mean time, you'll learn about the Migration Assistant.

After you see the script output the message "Provisioning started! Continue to the next unit" on the right, choose Continue at the bottom of this page.