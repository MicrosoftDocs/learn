You have registered your web application with Azure AD. You are now ready to add the authentication code to sign in users in your application. You see that there are many authentication flows supported by Azure AD and you are unsure which flow and how to implement it. You want a Java SDK that will handle the authentication for your web application. In this unit, you will learn about the official Microsoft Authentication Library for Java (MSAL4J).
