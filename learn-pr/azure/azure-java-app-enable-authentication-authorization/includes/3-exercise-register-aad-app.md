...
1. In the **Client secrets** section, click on **New client secret**:
   ...
   :::image type="content" source="../media/app-reg-credentials.png" alt-text="Screenshot highlighting the certificates & secrets blade of an app registered with Azure Active Directory on Azure Portal":::
