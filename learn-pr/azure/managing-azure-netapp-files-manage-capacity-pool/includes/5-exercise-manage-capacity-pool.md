...
1. In the Azure portal, go to your NetApp account. From the navigation pane, select **Capacity pools**.
    ...
    ![Screenshot of the Azure portal left-hand navigation menu for an Azure NetApp Files account, with Capacity pools highlighted.](../media/ex-capacity-pools.png)

1. Select **+ Add pools** to create a new capacity pool. The New Capacity Pool window appears.

    ![Screenshot of the toolbar showing the Add pool option highlighted.](../media/ex-add-pool.png)
...
1. Provide the following information for the new capacity pool:
    ...
    ![Screenshot of the Azure portal dialog for creating a new capacity pool, with the fields filled in for NetAppLearnCP2.](../media/ex-new-capacity-pool.png)

1. Select **Create**.

    The Capacity pools page shows the newly created capacity pool and configurations for the capacity pool.

   [![Screenshot of the Azure NetApp Files capacity pools list view showing the newly created NetAppLearnCP2 pool highlighted.](../media/ex-capacity-pool-list.png)](../media/ex-capacity-pool-list.png#lightbox)
...
3. Select **Change QoS type**. Then set **New QoS Type** to **Manual.** Select **OK**.
    ...
    [![Screenshot of the Azure portal displaying the NetAppLearnCP2 capacity pool with the Change QoS type panel open, showing Manual and Auto options.](../media/change-qos-type.png)](../media/change-qos-type.png#lightbox)
...
1. Select **Change throughput**. Specify the **Throughput (MiB/S)** that you want. Select **OK**.
    ...
    ![Screenshot of the Azure portal Change throughput dialog box, showing available throughput and an editable throughput field.](../media/ex-change-throughput.png)
...
2. Fill in the **Name** and **Value** pair. Click **Apply**.
    ...
    [![Screenshot of the Azure portal Tags blade for a capacity pool resource, showing an existing tag and a new billing tag being added.](../media/ex-add-billing-tag.png)](../media/ex-add-billing-tag.png#lightbox)
...
3. You can display and download information about tagged resources by using the Microsoft Cost Management portal:
    ...
    - Click **Cost Analysis** and select the **Cost by resource** view.
        ...
        [![Screenshot of the Microsoft Cost Management Cost Analysis page showing resources with associated tags.](../media/cost-analysis.png)](../media/cost-analysis.png#lightbox)
    ...
    - In the Download window that appears, download usage details. The downloaded csv file includes capacity pool billing tags for the corresponding resources.
        ...
        ![Screenshot of the Azure portal Download dialog for a billing period, with the Usage Details Download button highlighted.](../media/ex-download-usage-details.png)

        [![Screenshot of an usage billing export spreadsheet showing resource tags in JSON format, including billing tags for HR/Legal and Sales.](../media/ex-usage-billing-export.png)](../media/ex-usage-billing-export.png#lightbox)
