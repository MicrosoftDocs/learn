...
![Deployment Opportunities on Azure for different types of Java Applications](../media/javaee.gif)
...
is by far the most used framework as an alternative to application servers. It is running on top of the Spring Framework and simplifies the life of developers. Not without success - at least every second web project is using Spring boot. It has become the most popular Java web framework. And it's getting more and more momentum over the last years. Its opinionated auto-configuration makes it easy to use. Spring boot applications are running stand-alone. Therefore they can be a perfect fit for Microservices.
...
- **Redhat JBoss Enterprise Application Plattform** delivers enterprise-grade security, performance, and scalability in any environment. Whether on-premise; virtual; or in private, public, or hybrid clouds, JBoss EAP can help you deliver apps faster, everywhere.
