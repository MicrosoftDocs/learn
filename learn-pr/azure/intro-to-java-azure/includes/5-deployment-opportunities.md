Azure offers different deployment solutions for Java applications. In this unit, we'll discuss at a few of them.

![Deployment Opportunities on Azure for different types of Java Applications](../media/5-java-on-azure-info-graphic.jpg)

## Virtual machines  

Azure Virtual Machines (VMs) is available for Windows and Linux. Linux also allows you to choose between different distributions like Ubuntu, Red Hat, or Suse.
...
- **Azure Kubernetes Service** AKS is the managed Kubernetes Service. Kubernetes is the de-facto standard to orchestrate your containerized applications. It's perfect for Microservices and mid-sized applications. AKS comes with service discovery, autoscaling, and monitoring. Microsoft is a collaborator in Kubernetes projects, such as Virtual Kubelet, Dapr, or OAM.

- **Azure RedHat OpenShift** ARO is the RedHat managed flavor of Kubernetes.

- **Azure Container Instances** ACI is a great solution for quick tests and proof of concepts and sidecar containers.
