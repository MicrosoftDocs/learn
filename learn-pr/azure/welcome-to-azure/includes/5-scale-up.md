...
Scaling out, or horizontal scaling, means to add virtual machines to power your application. For example, you might create many virtual machines configured in exactly the same way and use a load balancer to distribute work across them.
...
Nice job! With just one command, your VM is now twice as powerful.
