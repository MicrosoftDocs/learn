...
In this module, you'll choose descriptive names for your variables that describe their purpose and intent.  You'll learn how to add code comments, both to temporarily instruct the compile to ignore lines of code, and to document higher-level requirements and your approach in code.  Finally, you'll learn how white space can be used to help convey the relationship of individual lines of code.
