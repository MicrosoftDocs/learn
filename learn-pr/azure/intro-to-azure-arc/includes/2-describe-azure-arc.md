...
:::image type="content" source="../media/2-arc-management.png" alt-text="Azure management tools being used to manage both Azure hosted resources, and through Azure Arc, resources located elsewhere." border="false" lightbox="../media/2-arc-management.png":::
