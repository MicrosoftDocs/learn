Because Contoso needs to continue to operate an on-premises environment for some time after it begins migrating workloads to Azure IaaS VMs, it's important to be able to apply Azure policies to on-premises Windows Server workloads. Additionally, administrators need to be able to review on-premises Windows Server instances and Kubernetes clusters in the Azure portal.
...
- [Azure Policy built-in definitions for Azure Arc-enabled servers](/azure/azure-arc/servers/policy-samples?azure-portal=true)
