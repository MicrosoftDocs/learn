...
Develop and configure an app that queries an Azure SQL Database
...
Create a database on Azure SQL to store data for an application, and create a .NET Core console application to query data from the database.

## Learning objectives

1. Create, configure, and populate an Azure SQL Database
1. Develop a .NET Core console application that queries an Azure SQL Database

## Chunk your content into subtasks

Identify the subtasks of *Develop and configure an app that queries an Azure SQL Database*
...
| Connect a .NET Core application to query data from Azure SQL | ...connect a .NET Core application to query data... | Exercise | 2 | Yes |

## Outline the units

1. **Introduction**

    An educational institution is creating an application that academic advisors can use to discuss courses and plans of study with students. The development team would like to use Azure SQL Database to store their data, which is currently stored as comma delimited data in text files. They are planning to create a .NET Core app for the advisors to use initially. They need to know how to create and manipulate an Azure SQL Database, and how to connect a .NET Core application to an Azure SQL Database to query data.
...
1. **Connect a .NET Core application to Azure SQL Database**

    List the content that will enable the learner to *Connect a .NET Core application to query data from Azure SQL*:
...
1. **Exercise - Connect a .NET Core application to Azure SQL Database**

    1. Get SQL connection string
    1. Create new .NET Core app
    1. Insert application code and code to connect to Azqure SQL
    1. Build and run application

1. **Summary**

    You now know how to create, manipulate, and load an Azure SQL database, and can create a .NET Core application to query the database.
...
Then go through this one with a .NET Core console app. Will need to modify it to query data from the student info.
