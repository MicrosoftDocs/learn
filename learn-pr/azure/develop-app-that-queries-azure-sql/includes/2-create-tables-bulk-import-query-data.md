...
For full syntax and command-line parameters for the utility, see the [help documentation for bcp](https://docs.microsoft.com/sql/tools/bcp-utility?azure-portal=true).
