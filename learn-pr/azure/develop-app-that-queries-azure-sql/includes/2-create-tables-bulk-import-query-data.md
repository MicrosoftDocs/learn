...
The important line is *five rows copied*. This was the number of lines in the source file that contain data that was imported. If this number is different (or zero), then your format file is incorrect.
