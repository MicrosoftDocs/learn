...
For example, suppose you want to find an example template that builds an App Service Plan and an App Service. In the repository, you'll notice each quickstart template gives you the option to deploy the template directly to Azure, or browse the template on GitHub.
