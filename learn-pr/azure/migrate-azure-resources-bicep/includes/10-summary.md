Your company recently acquired a smaller competitor that has created a toy truck. This company uses Azure to host its application infrastructure, but their resources were deployed using the Azure portal and JSON ARM templates. Your company standardized on Bicep for infrastructure as code, and you need to migrate all Azure resources to use Bicep for deployments.
