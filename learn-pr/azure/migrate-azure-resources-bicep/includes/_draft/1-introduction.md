...
In this module, you'll learn about the ways you can migrate your Azure resources to Bicep, including JSON ARM templates and Azure portal resources. You'll also learn how you can verify your resource template migrations. You'll find answers to these questions:
...
- How can you verify your template migrations using available tools and documentation?

## What is the main goal?

After completing this module, you'll be able to migrate your JSON ARM templates to Bicep and verify the migration using available tools.
