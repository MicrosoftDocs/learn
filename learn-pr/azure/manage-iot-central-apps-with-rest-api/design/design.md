...
1. Create an IoT Central application and device templates
2. Generate an API token to use to authorize REST API calls
3. Manage devices using the REST API
...
| Create and publish a device template | Add device templates | Exercise | 1 | No, "Create an IoT Central application" |
| Generate SAS key | Manage an IoT Central application programatically using the REST API  | Exercise & Knowledge Check | 2 | Yes |
| Add real and simulated devices | Add devices  | Exercise & Knowledge Check | 3 | Yes |
...
1. **Authorize REST API calls to access your IoT Central application**
    ...
    - How to authorize
        - How to use the SAS in a REST API call
...
1. **Knowledge check**
    ...
    What types of questions will test *Manage devices using the REST API*?
