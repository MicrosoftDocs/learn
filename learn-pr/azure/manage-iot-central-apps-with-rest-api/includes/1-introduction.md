...
The IoT Central REST API is now generally available, but some specific APIs are still in public preview. This module only uses generally available APIs unless explicitly called out.
