...
You use the *control plane* to manage resources in your Azure subscription. For example, you can use the Azure CLI with the [azure-iot extension](https://docs.microsoft.com/cli/azure/ext/azure-iot/?view=azure-cli-latest&preserve-view=true) for control plane operations such as creating an IoT Central application.
