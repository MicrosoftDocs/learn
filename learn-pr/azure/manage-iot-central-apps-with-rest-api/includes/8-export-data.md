...
To simplify the job of a fleet manager, you've been asked to integrate IoT Central data export definition management capabilities into the existing fleet management application. Fleet managers want to use the existing fleet management application to manage data export definitions.
