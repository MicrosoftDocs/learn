...
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/deviceTemplates/dtmi:contoso:refrigerated_truck \
...
az rest -m get -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/deviceTemplates \
...
```azurecli
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/sim-truck-001 \
...
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/sim-truck-002 \
--headers Authorization="$OPERATOR_TOKEN" --body \
'{
  "template": "dtmi:contoso:refrigerated_truck",
  "simulated": true,
...
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/sim-truck-003 \
--headers Authorization="$OPERATOR_TOKEN" --body \
'{
  "template": "dtmi:contoso:refrigerated_truck",
  "simulated": true,
...
az rest -m get -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices \
...
```azurecli
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/real-truck-001 \
--headers Authorization="$OPERATOR_TOKEN" --body \
'{
  "template": "dtmi:contoso:refrigerated_truck",
  "simulated": false,
...
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/real-truck-002 \
--headers Authorization="$OPERATOR_TOKEN" --body \
'{
  "template": "dtmi:contoso:refrigerated_truck",
  "simulated": false,
...
az rest -m put -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/real-truck-003 \
--headers Authorization="$OPERATOR_TOKEN" --body \
'{
  "template": "dtmi:contoso:refrigerated_truck",
  "simulated": false,
...
```azurecli
az rest -m get -u https://$APP_NAME.azureiotcentral-ppe.com/api/v1/devices/real-truck-003/credentials \
--headers Authorization="$OPERATOR_TOKEN"
```
