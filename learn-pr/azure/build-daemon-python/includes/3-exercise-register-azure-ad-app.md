Now that you've understood why you need to register an application with Microsoft Entra ID, you need to configure Microsoft Entra ID to support a Python daemon application.

In this exercise, you complete the following tasks:

- Register a daemon application in your Microsoft Entra tenant.
...
You've now successfully registered and configured your app with Microsoft Entra ID.
