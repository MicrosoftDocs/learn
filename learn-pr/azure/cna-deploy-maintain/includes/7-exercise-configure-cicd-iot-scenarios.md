...
1. In the **cna-devops-07-iothub - CI** pane, in the **Tasks** pane<!-- ID/SME: Is there a pane in a pane, or should one of these be a blade? -->, in the list of tasks, select both **Azure CLI: Get AR credentials**, and the **+** sign next to the **Agent job 1** entry.
...
1. In the **cna-devops-07-iothub - CI** pane, in the **Tasks** pane, select the **+** icon next to the **Agent job 1** entry<!-- ID/SME: We can't use just a descriptor of the sign/symbol, because someone who can't see won't be able to find it. We have to use the name of the icon as well. Is this an Add icon? If you're not sure, hover over it and text should display. -->.
...
1. In the **cna-devops-07-iothub - CI** pane, in the **Tasks** pane<!-- ID/SME: Verifying we have another pane w/in a pane. -->, select **Save & queue**. From the drop-down menu, select **Save**, and then in the **Save build pipeline** pane, select **Save**.
1. In the vertical menu<!-- ID/SME: Again, this is a sight term. We need the name of the menu. --> next to the **cna-devops-07-iothub - CI** pane, in the **Pipelines** section, select **Releases**. Ensure that the **cna-devops-07 - CD** release pipeline is selected, and then select **Edit**.
...
1. In the **All pipelines > cna-devops-07-iothub - CD** pane, on the **Pipeline** tab, on the edge of the rectangle representing the **qa** stage, select the oval shape representing the pre-deployment conditions applicable to this stage.<!-- ID/SME: Same comment about visual queues - rectangle, oval shape. -->
...
1. From the list of tasks, select the **Azure Deployment: Create Azure IoT Hub** task, and then select the **+** sign<!-- ID/SME: Another sight word. --> next to the **Create Device and Deploy** entry.
...
1. From the list of tasks, select **Azure CLI: Get ACR credentials**, and then select the **+** sign<!-- ID/SME: Sight word. Please search and fix "+". I'll stop calling these out.--> next to the **Create Device and Deploy** job entry.
...
1. In the vertical menu<!-- ID/SME: Same comment about this being a sight descriptor, and s/r'ing it. I'll stop mentioning this. --> next to the **All pipelines > cna-devops-07-iothub - CD** pane, select **Repos**, and then in the repository's folder hierarchy, select **edgeSmokeTest.sh**.
...
1. Replace both occurrences of `azure-cli-iot-ext` with `azure-iot`. Add the `# ` string to the front of the line **91**<!-- ID/SME: Do we want line 91 bolded? Is it the actual line 91 (like this is line 197), or "the line 91?" --> `validateDevicesModulesRunning`, and then select **Commit**.
...
1. In the **cna-devops-07-iothub - CD > Release-1** pane, select the **Logs** button directly following release pipeline **dev** stage's rectangle icon<!-- ID/SME: Please verify. -->.
