...
1. On the **Additional settings** blade, specify the following configuration, leaving all other settings with their default values:
    ...
    > [!NOTE]
    > The check mark next to the Container Registry name indicates its global uniqueness.
...
1. In the **cna-devops-07-iothub - CI** pane, in the **Tasks** pane, in the list of tasks, select both **Azure CLI: Get AR credentials**, and the **+** sign (**Add** sign) next to the **Agent job 1** entry.
...
1. In the **cna-devops-07-iothub - CI** pane, in the **Tasks** pane, select the **+** icon (**Add** icon) next to the **Agent job 1** entry.
...
1. In the **All pipelines > cna-devops-07-iothub - CD** pane, on the **Pipeline** tab, on the edge of the rectangle representing the **qa** stage, select the oval shape that represents the pre-deployment conditions applicable to this stage.
...
1. From the list of tasks, select the **Azure Deployment: Create Azure IoT Hub** task, and then select the **+** sign (**Add** sign) next to the **Create Device and Deploy** entry.
...
1. From the list of tasks, select **Azure CLI: Get ACR credentials**, and then select the **+** sign (**Add** sign) next to the **Create Device and Deploy** job entry.
...
1. Once again, select the **+** sign (**Add** sign) next to the **Create Device and Deploy** job entry.
