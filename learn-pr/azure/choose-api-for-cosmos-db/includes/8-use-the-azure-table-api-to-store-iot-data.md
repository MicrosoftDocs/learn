...
The best practice is to use Core (SQL) for new projects, as it has more features that the Azure Table API. However, to reduce downtime during your migration to Cosmos DB, you might want to consider using the Table API for now, and switch to Core (SQL) sometime in the near future.
