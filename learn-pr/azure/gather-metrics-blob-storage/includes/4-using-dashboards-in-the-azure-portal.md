...
In addition to the tile gallery, you can add Azure Monitor charts to a dashboard from the associated resources in the Azure portal. When you're viewing resource information and viewing metrics, the chart toolbar has the option to add the chart to a dashboard directly.
