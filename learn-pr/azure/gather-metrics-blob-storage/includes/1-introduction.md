...
Note that this module deals with Azure Storage Analytics and its use in the portal. This module doesn't include any developer subjects. A separate module covers how to use the Azure SDK and the Azure Monitor REST API to access Storage Analytics data. 
...
- Use the portal to enable logging and to download the logs
