Regualations exist that provide rights to people (data subjects and consumers) to manage personal data that has been collected from them by organziations or employers (data controller or controller). In the European Union (EU) the General Data Protection Reguatlation (GDPR) provides these righgts. In the United States, the California Consumer Privace Act (CCPA) provides California consumers with these rights. 
