...
The process for executing a DSR in Office 365 is broken into four parts. The high-level exectuion tasks differ based on the data type,  application, and the request type:
