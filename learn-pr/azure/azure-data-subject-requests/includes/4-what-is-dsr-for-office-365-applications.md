...
#### Using the Content Search eDiscovery tool to access data for DSRs

The applications in Microsoft 365 and Office 365 that support this tool are:
...
#### Using in-app functionality to access data for DSRs

You can use in-app functionality in these applications to find customer data:
...
1. Access and export
1. Notify about DSR response issues
1. Delete
...
- Office 365 operated by 21Vianet (China):
    ...
    1. Select **Commerce**, select **Subscription**, then select **Privacy**.
    1. Select **GDPR**, then enter the required information.

### Part 4: Responding to DSRs for other Microsoft services
