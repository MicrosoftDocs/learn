...
1. **Validate:** Check that the Bicep file is well-formed and doesn't contain any obvious errors.
1. **What-if:** Validate the list of changes that will be applied against your production environment, and have a manual approval by a human to proceed.
1. **Deploy.**
