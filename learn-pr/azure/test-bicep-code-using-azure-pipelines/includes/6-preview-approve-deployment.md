...
If a human reviewer decides that the changes are reasonable, you can use Azure Pipeline's environments feature to provide manual approval to proceed with the deployment.
