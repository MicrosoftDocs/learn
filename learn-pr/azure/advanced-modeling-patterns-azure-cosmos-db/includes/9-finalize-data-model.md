...
:::image type="content" source="../media/9-product-meta.png" alt-text="Diagram that shows product category and product tag containers combined into a single container called product meta." border="false":::
