Great work! In this module, you learned about accelerating your application modernization journey using Azure Migrate: App Containerization by containerizing and migrating an Java web application to AKS. You containerized and migrated the Java web application, Airsonic, that was running on a Linux machine to AKS using the Azure Migrate: App Containerization tool.  
