...
In this module, you'll learn how Azure Migrate App Containerization can help accelerate your application modernization journey by helping you containerize and migrate your Java web applications running on Linux machines to Azure Kubernetes Service (AKS) using a templatized process. 
