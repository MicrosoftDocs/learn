...
> [!NOTE]
> You might incur some costs when running this exercise.
...
​:::image type="content" source="../media/4-deploy-mysql-basics_1.png" alt-text="The Flexible server tab of the Azure portal Flexible server deployment page displaying the project and server details of a new Azure Database for MySQL server." border="false":::
