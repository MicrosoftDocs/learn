...
> [!NOTE] 
> Any set of number will work for a shareed key in this example.  SHAREDKEY=123456789  It is recoemnded in production to use string of printable ASCII characters no longer than 128 characters.
