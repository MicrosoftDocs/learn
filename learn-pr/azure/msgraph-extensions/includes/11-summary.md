...
Apart from the **user** resource, other Microsoft Graph resource types may support some of the extensions. For example, the **device** resource type supports all the extension options while the **group** resource type supports schema, directory, and open extensions. To learn more, including considerations and limitations for each extension type, visit the links below.
