...
|Packet Core Control/Data Plane |The control/data plane of a packet core instance |Use this resource to manage a packet core instance. You can open it from a **Mobile Network Site**. |
