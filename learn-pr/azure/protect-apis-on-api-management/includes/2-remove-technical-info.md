...
In the census example, it is important that you remove the following header:
...
- **Remove headers from the response**. In this step, you will apply a policy that removes an insecure header from all responses.
