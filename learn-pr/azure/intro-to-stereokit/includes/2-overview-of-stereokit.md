...
StereoKit focuses on getting you up and running with as little code as possible. Most activities, including UI, can be accomplished with just one line of code. Here's an example of a code showing how easy loading a 3D asset into your application is.
