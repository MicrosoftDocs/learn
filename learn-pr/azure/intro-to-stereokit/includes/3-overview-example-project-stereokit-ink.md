...
**Pinching** and **gripping** are two easily accessible functions, which you can use in your StereoKit Ink application where to pinch the frame, use the **JustPinched** function, and to unpinch the frame use the **JustUnpinched** function. The below code snippet explains the pinching and gripping functionalities.
