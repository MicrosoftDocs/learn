StereoKit is an easy-to-use open source Mixed Reality engine for building AR and VR applications using C# and OpenXR. Inspired by libraries like XNA and Processing, StereoKit is meant to be fun to use and easy to develop with, yet still quite capable of creating professional and business ready software.
...
For native developers, StereoKit even provides a C API. This can streamline development of applications that rely heavily on native dependencies.

In this module, you'll get an introduction to StereoKit's features, and learn how easy they are to use! We'll also take a look at the sample project, StereoKit Ink, as an example to illustrate many of these features.
