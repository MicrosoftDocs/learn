...
You've learned that the computing resource necessary in your on-premises datacenter is sometimes insufficient to render 3D models to the desired detail quickly enough. You learned that you must choose between scaling down the detail, or increasing the available compute resources. These criteria helped you decide that by using Azure Remote Rendering, you can render complex 3D models to any desired detail level. 
