Azure Arc provides customers with consistent operational experiences across their hybrid, multi-cloud, and edge infrastructure. In this module, you'll learn about Azure Arc-enabled servers' capabilities to develop a robust inventory of your servers and virtual machines.

Tailwind Manufacturing is a small industrial firm. As the company continues to expand its multi-cloud investments while running workloads on their private datacenter and factory sites, the need to effectively organize their IT resources is increasingly challenging. By onboarding their non-Azure machines across both industrial floor and business offices to Azure Arc-enabled servers, Tailwind Manufacturing brings together unified resources for their Azure and off-Azure estate.
