...
Azure Static Web Apps supports custom routing rules defined in an optional _staticwebapp.config.json_ file located in the app's source folder. You can define a navigation fallback route in the **navigationFallback** object. A common fallback route configuration looks like this example.
