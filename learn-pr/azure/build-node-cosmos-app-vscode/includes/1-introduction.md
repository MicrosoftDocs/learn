...
In this module, you'll learn about how to build databases and collections with Cosmos DB. You'll use Visual Studio Code, as a tool for managing Cosmos DB, and as a development environment for building the course grades application. Finally, you'll learn how to insert, update, delete, and query documents in a Cosmos DB collection.
