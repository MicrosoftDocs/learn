...
![Screenshot of the Cosmos DB extension in VS Code as user right-clicks on the Documents node for a contextual menu to create a new document.](../media/2-cosmosdb-extension.png)
