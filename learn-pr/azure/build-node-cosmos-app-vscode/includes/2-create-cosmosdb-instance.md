...
You create and manage Cosmos DB databases using the Azure portal from a web browser, by writing your applications, and from within tools like Visual Studio Code.
