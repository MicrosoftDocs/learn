...
- Create a Azure Databases extension instance for a Node.js app
- Build a new Node.js app in Visual Studio Code
- Add JavaScript code to work with Azure Databases extension

You can now use Node.js to build applications that create, query, and maintain data in a Azure Databases extension.
