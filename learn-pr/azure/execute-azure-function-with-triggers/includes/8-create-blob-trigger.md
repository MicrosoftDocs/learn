...
1. Select the _New_ link underneath the **Storage account connection** dropdown list. In the **New Storage Account connection** dialog box that appears, select the storage account for this function app, and then select **OK**.

1. After you have returned to the *Add function* pane, select **Add** to create the function.
...
1. In the Azure portal, under **Azure services**, select **All resources**, search for and select **Storage accounts**, and then filter by the storage name you created. The *Storage account* pane appears.
