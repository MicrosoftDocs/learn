...
When failover is complete, your geo-replication map only shows one region. This region is your new primary. You'll need to reconfigure your account to use geo-redundant storage.
