...
:::image type="content" source="../media/4-new-credential.png" alt-text="The New credential pane displaying authentication method, Microsoft account ID, and external ID." border="false":::
...
1. From the available sources, select either **Amazon RDS (SQL)** or **Amazon RDS (PostgreSQL)**, and then select **Continue**.
    ...
    :::image type="content" source="../media/4-register-sources" alt-text="Register sources Amazon RDS (SQL) pane" border="false":::
