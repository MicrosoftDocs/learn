...
:::image type="content" source="../media/c.png" alt-text="Adding prefabs 1." lightbox="c.png":::

2. Drag-and-drop these models from the prefabs folder into the **Hierarchy** window.

:::image type="content" source="../media/d.png" alt-text="Adding prefabs 2." lightbox="d.png":::
...
:::image type="content" source="../media/f.png" alt-text="Interactable script 1." lightbox="f.png":::
...
:::image type="content" source="../media/g.png" alt-text="Interactable script 2." lightbox="g.png":::
...
:::image type="content" source="../media/h.png" alt-text="Interactable script." lightbox="h.png":::
...
:::image type="content" source="../media/m.png" alt-text="Target Objects." lightbox="m.png":::
