...
The Eye Tracking Interaction extension provided by Khronos is supported by Unity OpenXR. To get the pose data that the extension returns, use this layout.
