...
The Network Client-server manager is used to manage connections in many multiuser applications, but you can also use the lower-level NetworkServer and NetworkClient classes directly.
...
Hand mesh or hand rig data are not included in this interaction profile. 
