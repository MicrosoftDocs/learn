...
> [!NOTE]
> The screenshot above is from **Unity 2020** If you're using **Unity 2019**, there will be two tabs: one for Legacy XR and one for XRSDK. Ensure that you're in the XRSDK tab and then clone **XR SDK Windows Mixed Reality Spatial Mesh Observer**.
