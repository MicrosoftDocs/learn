...
We covered how the Microsoft Purview governance portal is used to register data sources and create a data map. Setting up scanning caused Microsoft Purview to scan through the selected data types in the sources, and list metadata associated with those sources.  This metadata helps data consumers discover what is contained in the data sources, documenting the expected usage. We also showed how the metadata includes classification information to help identify sensitive data.
