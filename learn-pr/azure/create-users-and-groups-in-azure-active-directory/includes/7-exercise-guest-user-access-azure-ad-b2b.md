...
1. Sign in to the [Azure portal](<https://portal.azure.com/learn.learn.microsoft.com?azure-portal=true>), and under **Azure services**, select **Azure Active Directory**. The **Overview** pane for your Azure AD appears.
