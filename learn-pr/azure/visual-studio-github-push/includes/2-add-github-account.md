...
:::image type="content" source="../media/2-sign-in.png" alt-text="Screenshot of Visual Studio default sign in dialog":::
...
:::image type="content" source="../media/2-signed-in.png" alt-text="Screenshot of Visual Studio Account Settings dialog signed in":::
