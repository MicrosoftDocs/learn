...
All GitHub repositories created through Visual Studio are set to private by default. This means only you can view the repository and commit to it. To change this setting, add contributors to private repositories and manage access via the repository's **Settings** page on GitHub.com. Clearing the checkbox switches the repository to public, which allows anyone on the internet to view your repository and its contents on GitHub.com. But you can still choose who can contribute to it directly. 
