...
In this module, you'll use the GitHub integration inside Visual Studio 2019 to sign in to GitHub, create a new repository, and push commits - all without leaving the IDE.

By the end of this module, you'll know how to use GitHub and source control features inside Visual Studio 2019. It is worthwhile to first be familiar with the [GitHub flow](https://guides.github.com/introduction/flow/) so you can hit the ground running.
