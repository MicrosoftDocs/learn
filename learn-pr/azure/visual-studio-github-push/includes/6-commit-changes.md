...
:::image type="content" source="../media/6-status-section.png" alt-text="Screenshot of Git Changes window status section":::
...
:::image type="content" source="../media/6-changes-section.png" alt-text="Screenshot of Git Changes window changes section":::
...
:::image type="content" source="../media/6-staged-changes-section.png" alt-text="Screenshot of Git Changes window staged changes section":::
...
:::image type="content" source="../media/6-committing.png" alt-text="Screenshot of making a commit":::
...
:::image type="content" source="../media/6-amending.png" alt-text="Screenshot of amending a commit":::
...
:::image type="content" source="../media/6-resetting.png" alt-text="Screenshot of resetting a commit":::
...
:::image type="content" source="../media/6-reverting.png" alt-text="Screenshot of reverting a commit":::
...
:::image type="content" source="../media/6-stashes-section.png" alt-text="Screenshot of Git Changes window stashes section":::
