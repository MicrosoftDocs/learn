...
1. Select **multifactor authentication** under the **Manage** heading in the left-hand menu. Here, you find options for multifactor authentication.

    ![Screenshot showing MFA options in the dashboard.](../media/4-mfa-options.png)

1. Select the **Additional cloud-based multifactor authentication settings** link under **Configure**. A new browser page opens, where you can see all the MFA options for Azure.
...
1. Under **Users**, select the **0 users and groups selected**.
...
MFA is now enabled for your selected applications. The next time a user or guest tries to sign into that app, they'll be prompted to register for MFA.
