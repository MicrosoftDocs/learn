...
1. If the correct credentials were entered and validated, the service sends the request to **Azure Multi-Factor Authentication Server**.

1. The Azure Multi-Factor Authentication Server sends an additional verification challenge to the user. The methods you can easily configure are:
...
1. Azure Multi-Factor Authentication Server sends an additional verification challenge to the user, as just described.
