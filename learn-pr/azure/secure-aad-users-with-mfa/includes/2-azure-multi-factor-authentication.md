...
Using Microsoft Entra multifactor authentication improves identity security by limiting the impact of password exposure. To fully authenticate, a malicious hacker also needs a second factor such as the user’s phone, fingerprint, or face. Multifactor authentication should always be enabled because it is the most effective way to prevent unauthorized sign-in.
