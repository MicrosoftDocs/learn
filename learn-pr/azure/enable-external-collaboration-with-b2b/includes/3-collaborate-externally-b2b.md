...
![External user using their identity](../media/3-user-added-using-their-identity.png)
 ...
 <!--Feel free to style according to Learn standards. Original image: https://docs.microsoft.com/en-us/azure/active-directory/b2b/what-is-b2b -->
...
<!-- Feel free to style according to Learn standards. Original image: https://docs.microsoft.com/en-us/azure/active-directory/b2b/media/quickstart-add-users-portal/quickstart-users-portal-email-small.png -->
...
<!--Feel free to style according to Learn standards. Original image https://docs.microsoft.com/en-us/azure/active-directory/b2b/media/what-is-b2b/add-member.png -->
