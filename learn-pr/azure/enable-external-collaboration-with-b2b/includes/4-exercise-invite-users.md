...
1. Use your guest user's email address for the **Email address** field. For this exercise, enter an email address that you can access, but don't use the same one as for your Azure account.

1. For the personal message text area, write your own customized invitation message.
...
1. In the search box, look for Twitter, select **Twitter** in the returned list, then select **Add**.
...
1. Select your user from the list, then select **Select**.
...
1. This panel lists the applications the guest user has been allowed to access. To access an application, select the one you want.
