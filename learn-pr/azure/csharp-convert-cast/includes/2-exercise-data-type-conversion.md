...
[Type Conversion Tables in .NET](https://docs.microsoft.com/en-us/dotnet/standard/base-types/conversion-tables?azure-portal=true)
...
[Built-in types table](https://docs.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/built-in-types-table?azure-portal=true)
