...
Next, you learned how activity log alerts enable notifications when a named Azure resource meets the specified conditions.
...
- [Smart groups](/azure/azure-monitor/platform/alerts-types#smart-detection-alerts)
