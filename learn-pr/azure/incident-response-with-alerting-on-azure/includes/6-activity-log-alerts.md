...
You can also reuse action groups on multiple alerts, once you've created them. For example, after you've created an action to email your company's Ops team, you can add that action group to all the service health events.

You can add, or create, action groups at the same time your create your alert. Or you can edit an existing alert to add an action group after you've created it.