...
- Learn how to [Implement scale and high availability with Windows Server VM](/learn/modules/implement-scale-high-availability-windows-server-virtual-machine).
- Review how you can [Build a scalable application with virtual machine scale sets](/learn/modules/build-app-with-scale-sets).
