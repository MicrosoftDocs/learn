...
1. Paste the following code into the *bicepconfig.json* file. Replace `YOUR_CONTAINER_REGISTRY_NAME` with the name of your private registry.
...
1. On the left menu, select **Deployments**.
   ...
   - **cdn** and **website**, which represent the modules that you included in your *main.bicep* file
