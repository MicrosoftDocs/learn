...
Recall that you've looked at arbitrary rows of data to get a sense of the data structure. In this unit, you'll learn how to choose specific data columns that relate to storm types, locations, and damaging effects.
