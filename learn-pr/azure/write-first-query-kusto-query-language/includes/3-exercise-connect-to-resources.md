...
1. If you expand the **Samples** database, **Tables**, and the **Storm_Events** folder, you'll see a list of tables underneath the database; we'll be using the *StormEvents* table.
