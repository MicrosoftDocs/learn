...
Azure NetApp Files supports application volume groups, which are designed to facilitate SAP HANA workloads on Azure NetApp Files. Application volumes groups enable you to simplify the deployment process for SAP HANA while also benefitting from increased storage performance. Application volume groups on Azure NetApp Files allow you to focus on your application demands instead of managing technical settings such as individual QoS or sizes for volumes.
