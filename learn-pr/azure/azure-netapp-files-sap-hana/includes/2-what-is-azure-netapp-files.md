Azure NetApp Files is an enterprise-class, high-performance, fully managed, and first-party NAS service for shared file storage. It's deployed and managed through the Azure portal.
