Your company is launching a shopping list website that helps customers add, edit, view, and remove items from their personal shopping list. Your app and an API must be hosted securely, globally available, and automatically redeploy with continuous deployment.
