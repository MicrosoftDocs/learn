Azure Policy is a service that you use to create, assign, and manage policy definitions. Those policy definitions are mainly used to implement governance for resource consistency, regulatory compliance, security, cost, and management. You can specify configuration requirements for any resources that are created and take one of these actions:
