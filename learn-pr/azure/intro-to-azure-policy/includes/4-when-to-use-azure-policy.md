...
* **Backup**
  * Make sure all your virtual machines are with Azure Backup enabled
  * Ensure that geo-redundant backup is enabled on Azure Database for MySQL or PosgreSQL
  * Ensure that long-term geo-redundant backup is enabled on Azure SQL Database
  
* **Governance**
  * Ensure the properly tag usage as well tag enforcement on resources
