As you think through your options, your top considerations include:
...
- [Azure SQL](/azure/azure-sql/azure-sql-iaas-vs-paas-what-is-overview?view=azuresql&preserve-view=true) is a family of database services, and its two prominent options are [Azure SQL Database](/azure/azure-sql/database/sql-database-paas-overview?view=azuresql&preserve-view=true) and [Azure SQL Managed Instance](/azure/azure-sql/managed-instance/sql-managed-instance-paas-overview?view=azuresql&preserve-view=true). Both options are based on the SQL Server engine—SQL Database is optimized for cloud-native applications, and SQL Managed Instance has superior compatibility with existing SQL Server databases. Generally, SQL Managed Instance is favored over SQL Database for the type of migration you're considering.
...
- [Microsoft SQL Server Migration Assistant (SSMA) for Oracle](/sql/ssma/oracle/sql-server-migration-assistant-for-oracle-oracletosql?view=sql-server-ver16&preserve-view=true) is a tool that helps automate migration tasks, such as migration assessment, schema and SQL syntax conversion, data migration, and migration testing, optimized for Azure SQL.
...
- [Ora2Pg](https://ora2pg.darold.net/documentation.html#Ora2Pg-usage) is a Perl-based utility that assists in the migration of Oracle databases to PostgreSQL.
...
- [Newt Global](https://newtglobal.com/) has extensive experience with moving Oracle databases to cloud-based PostgreSQL environments, targeting Azure in particular.
