...
Based on the implementation and functional requirements, identify the application components that participate in the user flow. The components are described in [Example architecture components](./3-exercise-identify-layered-model#components).
