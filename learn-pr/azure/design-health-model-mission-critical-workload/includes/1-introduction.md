...
As Contoso Shoes prepares for its next high-profile product launch, the company has identified a gap in awareness of the health and availability of its web application. Employees use this application to update the product catalog. Their customers interact with the catalog through the store website. Traffic is expected to increase during the launch and insufficient monitoring and knowledge about application health, is a potential risk.

In this module, you'll use the web application as the core example. The exercises will cover these tasks: 
