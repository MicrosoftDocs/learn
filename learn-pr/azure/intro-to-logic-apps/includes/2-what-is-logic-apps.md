...
![Diagram of the steps to define and run a logic app: select the components, use the Logic Apps Designer tool to arrange them, then save your work.](../media/app-design-process.png)
