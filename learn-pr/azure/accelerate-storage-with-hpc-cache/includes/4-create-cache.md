...
:::image type="content" source="../media/4-create-the-cache-02-basics-tab.png" alt-text="Diagram showing the Basics tab of the Azure H P C Cache creation wizard.":::
...
:::image type="content" source="../media/4-create-the-cache-03-cache-tab.png" alt-text="Diagram showing the Cache tab of the Azure H P C Cache creation wizard.":::
...
The create process takes more than 20 minutes. When you're ready to create the cache and its corresponding resources, select **Create**.
...
We then chose the smallest cache size that would hold our HPC working set. If we have our own encryption keys or tags, we added them to the cache's configuration.
