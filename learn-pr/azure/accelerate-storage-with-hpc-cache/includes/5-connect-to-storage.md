...
From the Azure portal, select the HPC Cache resource. On the left menu, choose **Storage Targets**.
...
:::image type="content" source="../media/5-connect-to-storage-01-add-storage-target.png" alt-text="Screenshot showing the Add Storage Target pane for Azure H P C Cache.":::
