...
In this module, you'll learn how to create an Azure HPC Cache, configure the cache to accelerate a Linux-based file system, and attach clients to access the cache's storage.
...
By the end of this module, you'll be able to create and configure an Azure HPC Cache so that HPC clients can access its storage.
