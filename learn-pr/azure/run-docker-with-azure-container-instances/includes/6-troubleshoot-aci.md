...
:::image type="content" source="../media/6-cpu-memory.png" alt-text="Screenshot that show the Azure portal view of Azure Container Instances CPU and memory usage information.":::
