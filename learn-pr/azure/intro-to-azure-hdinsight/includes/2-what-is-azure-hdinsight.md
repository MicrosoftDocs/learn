Let's review the features and uses of HDInsight. This overview will help you evaluate the suitability of HDInsight for your organization's requirements.

## What is big data?

The term *big data* is used to describe the vast volumes of both structured and unstructured data that organizations are able to collect. This data can be extremely useful for organizations. Specifically, if an organization is able to analyze the data for insights, then it is better able to make decisions. These decisions can help the organization become more successful. For example, the analysis of big data might enable a commercial organization to recognize customer habits, which in turn could lead to increased sales.
...
HDInsight provides several benefits to organizations working with big data. It is:

- Open-source. Enables you to create optimized clusters for a variety of open-source frameworks.
...
- Monitored. Integrates with Azure Monitor logs to provide a single interface through which you can monitor all your clusters.

## How HDInsight can help you work with big data

You can use HDInsight for a variety of scenarios in big data processing. Your data can be:
...
- Provide the prepared data in a structured format that can be queried by using analytical tools
...
:::image type="content" source="../media/architecture-data-warehouse.png" alt-text="A graphic that depicts the data warehousing scenario.":::
...
:::image type="content" source="../media/architecture-iot.png" alt-text="A diagram that depicts the Internet of things scenario, which is described in the preceding text.":::
...
3. Azure Spark on HDInsight processes the data in readiness for Azure Machine Learning. Data is also visualized by using Power BI.

:::image type="content" source="../media/architecture-data-science.png" alt-text="A diagram that displays the data science scenario, which is described in the preceding text.":::

### Hybrid

For organizations with on-premises big data infrastructure, you can use HDInsight to extend into Azure. This enables you to get the benefits of the advanced analytics capabilities of the Azure cloud. The following diagram depicts the hybrid scenario, in which:
...
:::image type="content" source="../media/architecture-hybrid.png" alt-text="A diagram that depicts the hybrid scenario, which is described in the preceding text.":::
