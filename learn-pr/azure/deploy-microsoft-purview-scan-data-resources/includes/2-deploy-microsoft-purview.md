...
You can connect to your Microsoft Purview account either publically, via public IP addresses or service endpoints, or privately, using a private endpoint. [Learn more about private endpoints for your Microsoft Purview account](https://docs.microsoft.com/en-us/azure/purview/catalog-private-link).
