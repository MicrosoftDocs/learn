...
- **Create Subscription**: The customers or partners must follow the standard Azure procedure to create a subscription: [https://learn.microsoft.com/en-us/azure/cost-management-billing/manage/create-subscription](https://learn.microsoft.com/en-us/azure/cost-management-billing/manage/create-subscription). Customers or partners should have owner or contributor access to Azure subscription. In the **Azure portal**, go to **Home > Subscriptions > Your-subscription > Resource providers**.
