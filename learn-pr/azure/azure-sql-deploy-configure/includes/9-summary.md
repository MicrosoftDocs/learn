...
- [Deploy Azure SQL Managed Instance to an instance pool](/azure/sql-database/sql-database-instance-pools-how-to#create-an-instance-pool?azure-portal=true)
