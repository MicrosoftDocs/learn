...
Also keep in mind that minimal logging isn't supported, so you're always running in full recovery mode. Because of full recovery mode and limits around log throughput, log governance might have an effect as you load data. Techniques like using batches and appropriately sizing them become important during a bulk load. There are more tips in the next exercise. Loading into a clustered columnstore index might help in avoiding transaction log limits, depending on your scenario.
