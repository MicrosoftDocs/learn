Your organization has successfully migrated several applications from on-premises to Azure virtual machines (VMs) and Azure Kubernetes Service (AKS), and now has hundreds of resources deployed across several Azure subscriptions. You must track resource usage to ensure that cloud resources are adequately provisioned and their performance meets business requirements.

You need a monitoring approach that provides broad visibility and the capability to triage and isolate problems when they arise. In this unit, you learn how to use Azure Monitor insights and other tools for an at-scale monitoring view across all your resources, and how to drill into specific nodes and containers for troubleshooting.
...
- Investigate an over-utilized node.
