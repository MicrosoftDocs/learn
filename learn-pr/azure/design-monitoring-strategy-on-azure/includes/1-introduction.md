You can use tools in Azure to perform full stack monitoring of your applications and infrastructure.
...
The organization wants to design a monitoring strategy that performs full-stack monitoring across all solutions that it uses. There should also be insights and alerting into the collected data. The organization wants to quickly identify and minimize the impact of poor application performance and system failures the future.

In this module, you'll explore the monitoring solutions available in Azure. You'll assess Azure Monitor and its features such as Application Insights, Azure Monitor for VMs and Azure Monitor Logs to analyze infrastructure and application performance and availability. You'll also explore how Azure Security Center, and Azure Sentinel are used for security monitoring.
