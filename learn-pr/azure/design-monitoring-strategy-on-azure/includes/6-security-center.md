...
- You want to understand the security posture of your architecture.
...
![Screenshot of Azure Security Center Overview](../media/6-security-center-01.png)
...
![Screenshot of recommendation in Azure Security Center](../media/6-security-center-02.png)
...
You enable JIT through the **Just in time VM access** option in the **Azure Defender, Advanced protection** section of Security Center in the Azure portal. You'll see all virtual machines that already have JIT configured, and a list of virtual machines where JIT is not configured. Choose a virtual machine in the not configured list, and then use the **Enable JIT on (number) VM** option to configure JIT for the virtual machine.
...
![Screenshot of JIT configuration](../media/6-security-center-03.png)
...
![Screenshot of Adaptive application controls](../media/6-security-center-04.png)
...
![Screenshot of Security alerts overview](../media/6-security-center-05.png)

You drill down into specific security incidents by selecting an incident.

![Screenshot of incident details](../media/6-security-center-06.png)

From here, you can see the list of alerts that the incident holds.

![Screenshot of incident with alert list](../media/6-security-center-07.png)

You request more information about a specific alert by selecting one.

![Screenshot of alert details](../media/6-security-center-08.png)
...
![Screenshot of alert status](../media/6-security-center-09.png)
...
![Screenshot of alert action options](../media/6-security-center-10.png)