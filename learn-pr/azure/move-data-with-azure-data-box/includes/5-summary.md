...
You've considered the overall workflow for ordering and using an Azure Data Box device. You've also seen how orders can be cloned to facilitate regular data imports to Azure.
