...
Once high availability is enabled, there are essentially two servers for every one - a primary server and a standby server. For this part, y ou will disable high availability. This process can take some time, as the standby servers are torn down.
