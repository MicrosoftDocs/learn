...
![Azure SQL deployment options in portal](../media/5-azure-sql-portal.png)
...
![SSMS](../media/5-sql-server-management-studio.png)
...
![Azure Data Studio](../media/5-azure-data-studio.png)
...
![Azure Cloud Shell](../media/5-cloud-shell.png)
