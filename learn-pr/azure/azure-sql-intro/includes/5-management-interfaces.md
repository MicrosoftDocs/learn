...
:::image type="content" source="../media/5-azure-sql-portal.png" alt-text="Azure SQL deployment options in portal":::
...
:::image type="content" source="../media/5-sql-server-management-studio.png" alt-text="SSMS":::
...
:::image type="content" source="../media/5-azure-data-studio.png" alt-text="Azure Data Studio":::
...
:::image type="content" source="../media/5-cloud-shell.png" alt-text="Azure Cloud Shell":::
