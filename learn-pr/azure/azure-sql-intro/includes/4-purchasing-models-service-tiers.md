...
Note that if you choose General Purpose within Azure SQL DB and want to use the serverless compute tier, Gen5 hardware is currently the only option and it currently can scale up to 16 vCores.  

What purchasing model, service tier, and hardware selections you make will have a big impact on the performance, availability and cost of your deployment. If you continue on the learning path, you'll learn more how service tiers can affect performance and availability.  
