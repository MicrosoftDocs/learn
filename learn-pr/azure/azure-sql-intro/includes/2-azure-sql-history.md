Software and services for relational databases have been a large part of Microsoft's product offering over the years. Before you learn about Azure SQL and where it's going, let's briefly consider where it started.
...
Since 2008, SQL Server and Azure SQL have both evolved to become more available, scalable, and performance to meet the demands of any application. The database services offered have expanded from SQL, and now include open source databases such as Azure Database for PostgreSQL and Azure Database for MariaDB.
