...
1. Follow the steps to connect your machine with ssh. If you are using a local Windows machine, you will need putty, Windows sub-system for Linux (WSL), or another software that provdes ssh under Windows. If you are using a local Linux machine, open a terminal. 
