...
- Familiar with [Azure fundamentals](https://docs.microsoft.com/learn/paths/azure-fundamentals?azure-portal=true) (Link to learning path)
...
- [Azure Resource Manager Tools for Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=msazurermtools.azurerm-vscode-tools&azure-portal=true) installed locally
