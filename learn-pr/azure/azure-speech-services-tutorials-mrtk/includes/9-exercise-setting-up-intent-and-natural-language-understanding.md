...
:::image type="content" source="../media/tutorial4-section1-step1-1.png" alt-text="Add the Lunarcom Intent Recognizer (Script) component" lightbox="tutorial4-section1-step1-1.png":::
...
:::image type="content" source="../media/tutorial4-section1-step1-2.png" alt-text="Add the RocketLauncher_Complete prefab" lightbox="tutorial4-section1-step1-2.png":::
...
:::image type="content" source="../media/tutorial4-section1-step1-3.png" alt-text="Assign each of the buttons" lightbox="tutorial4-section1-step1-3.png":::
...
:::image type="content" source="../media/tutorial4-section2-step1-1.png" alt-text="Azure prediction resource" lightbox="tutorial4-section2-step1-1.png":::

2. Click the **Create** button to create an instance of this service:

:::image type="content" source="../media/tutorial4-section2-step1-2.png" alt-text="create an instance of this service" lightbox="tutorial4-section2-step1-2.png":::
...
:::image type="content" source="../media/tutorial4-section2-step1-3.png" alt-text="Configure the prediction option" lightbox="tutorial4-section2-step1-3.png":::
...
:::image type="content" source="../media/tutorial4-section2-step1-4.png" alt-text="Configure the create page" lightbox="tutorial4-section2-step1-4.png":::
...
:::image type="content" source="../media/tutorial4-section2-step1-5.png" alt-text="Review the details" lightbox="tutorial4-section2-step1-5.png":::
...
:::image type="content" source="../media/tutorial4-section2-step1-6.png" alt-text="Message display" lightbox="tutorial4-section2-step1-6.png":::
...
:::image type="content" source="../media/tutorial4-section3-step1-1.png" alt-text="Click on the done button" lightbox="tutorial4-section3-step1-1.png":::

3. When the new app has been created, you will be taken to that app's **Dashboard** page:

:::image type="content" source="../media/tutorial4-section3-step1-2.png" alt-text="App's dashboard page" lightbox="tutorial4-section3-step1-2.png":::
...
:::image type="content" source="../media/tutorial4-section3-step2-1.png" alt-text="Create a new intent" lightbox="tutorial4-section3-step2-1.png":::
...
:::image type="content" source="../media/tutorial4-section3-step2-2.png" alt-text="Intent's page" lightbox="tutorial4-section3-step2-2.png":::
...
:::image type="content" source="../media/tutorial4-section3-step3-1.png" alt-text="PressButton intent page" lightbox="tutorial4-section3-step3-1.png":::
...
:::image type="content" source="../media/tutorial4-section3-step4-1.png" alt-text="Create a new entity" lightbox="tutorial4-section3-step4-1.png":::

3. **Repeat** the previous step to create another entity named **Target**, so you have two entities named Action and Target:

:::image type="content" source="../media/tutorial4-section3-step4-2.png" alt-text="Create a target entity" lightbox="tutorial4-section3-step4-2.png":::
...
:::image type="content" source="../media/tutorial4-section3-step5-1.png" alt-text="Label go ahead as an action entity value" lightbox="tutorial4-section3-step5-1.png":::
...
:::image type="content" source="../media/tutorial4-section3-step5-2.png" alt-text="Notice the action entity value" lightbox="tutorial4-section3-step5-2.png":::
...
:::image type="content" source="../media/tutorial4-section3-step5-3.png" alt-text="Click on the word launch" lightbox="tutorial4-section3-step5-3.png":::
...
:::image type="content" source="../media/tutorial4-section3-step5-4.png" alt-text="Notice the Target entity value under the word launch" lightbox="tutorial4-section3-step5-4.png":::
...
:::image type="content" source="../media/tutorial4-section3-step5-5.png" alt-text="All the example utterances have been labeled" lightbox="tutorial4-section3-step5-5.png":::

## 6. Train, test, and publish the app

1. To train the app, click the **Train** button and wait for the training process to complete:

:::image type="content" source="../media/tutorial4-section3-step6-1.png" alt-text="Train the app" lightbox="tutorial4-section3-step6-1.png":::
...
:::image type="content" source="../media/tutorial4-section3-step6-2.png" alt-text="Click the test button" lightbox="tutorial4-section3-step6-2.png":::
...
:::image type="content" source="../media/tutorial4-section3-step6-3.png" alt-text="Click inspect to see the test results" lightbox="tutorial4-section3-step6-3.png":::
...
:::image type="content" source="../media/tutorial4-section3-step6-4.png" alt-text="Publish the app" lightbox="tutorial4-section3-step6-4.png":::

5. Wait for the publishing process to complete:

:::image type="content" source="../media/tutorial4-section3-step6-5.png" alt-text="Wait for the publishing process to complete" lightbox="tutorial4-section3-step6-5.png":::

6. Navigate to the Manage > Application Settings > **Azure Resources** page, your Azure Resources page should look similar to this:

:::image type="content" source="../media/tutorial4-section3-step6-6.png" alt-text="Azure resources page" lightbox="tutorial4-section3-step6-6.png":::
...
:::image type="content" source="../media/tutorial4-section4-step1-1.png" alt-text="Connecting the unity project" lightbox="tutorial4-section4-step1-1.png":::
...
:::image type="content" source="../media/tutorial4-section4-step1-2.png" alt-text="Pass the example query you copied" lightbox="tutorial4-section4-step1-2.png":::
...
:::image type="content" source="../media/tutorial4-section5-step1-1.png" alt-text="Testing the intent recognition" lightbox="tutorial4-section5-step1-1.png":::
...
:::image type="content" source="../media/tutorial4-section5-step1-2.png" alt-text="Enter the game mode" lightbox="tutorial4-section5-step1-2.png":::
...
:::image type="content" source="../media/tutorial4-section5-step1-3.png" alt-text="Retrain the model" lightbox="tutorial4-section5-step1-3.png":::
