As part of implementing your security strategy, you want to control how network traffic is routed across your Azure infrastructure. In the following exercise, you'll use a network virtual appliance to help secure and monitor traffic. You'll want to ensure communication between front-end public servers and internal private servers is always routed through the appliance.

You'll configure the network so that all traffic flowing from a public subnet to a private subnet is routed through a network virtual appliance. To make this flow happen, you'll create a custom route for the public subnet to route this traffic to a perimeter-network subnet. Later, you'll deploy a network virtual appliance to the perimeter-network subnet.

![Virtual network, subnets, and routing table](../media/3-virtual-network-subnets-route-table.svg)
