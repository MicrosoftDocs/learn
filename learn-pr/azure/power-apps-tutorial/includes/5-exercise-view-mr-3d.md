...
3. Select an item in the list and then select **Add Attachments**. Select your **3D model** (.glb file) or **Image** (.jpg file) in the **Power Apps custom folder**. Follow the same procedure for all the items on the list.
...
4. Select the dropdown next to the **Attachments** column and then select **Show attachments first**. We want that to be placed first for easy access.
...
The details page includes all the details and information concerning the selected product. It gives you an understanding of certain features of the product. You must connect the product page designed in the previous section and the details page created in this section. Here, you'll also be using the **View in 3D** component of Power Apps to add 3D content to your canvas app. You'll be able to rotate and zoom in on 3D objects for a better view.
...
5. Select the **Media** dropdown and then select **Image** to insert an image in the **Product_details** screen. Configure the **Image** property in the following way:
