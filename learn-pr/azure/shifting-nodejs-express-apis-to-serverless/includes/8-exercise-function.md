...
1. Enter **heroes-get** as the name of the function
...
The other important file here in the _functions/heroes-get_ folder is _index.ts_. This file contains the logic that runs when the route is invoked. We already have all this logic from our Express app. We'll go get that next.