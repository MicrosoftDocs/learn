...
- Learn module: [Organize Azure Storage blobs with properties and metadata](/training/modules/organize-blobs-properties-metadata/6-add-blob-metadata-using-application-code)
