...
- Learn module: [Secure your Azure Storage Account](/learn/modules/secure-azure-storage-account/)
- Learn module: [Connect an app to Azure Storage](/learn/modules/connect-an-app-to-azure-storage/)
