Azure ExpressRoute meets Adatum’s needs for the following reasons: 
...
An organization with remote individual users, such as those working from home or those that regularly travel with a laptop computer can leverage Azure point-to-site VPNs to connect to Azure resources. A point to site VPN is a VPN connection that is established from an individual computer to Azure.  
