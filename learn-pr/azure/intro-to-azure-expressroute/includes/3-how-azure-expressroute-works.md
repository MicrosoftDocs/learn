Azure ExpressRoute allows you to extend your on-premises networks into Microsoft’s cloud through a private connection. To implement ExpressRoute, you need to work with an ExpressRoute partner who'll provide an edge service. This edge service is an authorized and authenticated connection to Microsoft’s clouds that functions through a partner-controlled router.
