...
- Infrastructure as a service (IaaS), a type of cloud computing service that offers compute, storage, and networking resources on demand. IaaS offerings enable organizations to remove the cost and complexity of buying and managing physical servers and datacenter infrastructure. Organizations pay for each resource for as long as it's needed, on a pay-as-you-go basis. A [cloud computing service provider](https://azure.microsoft.com/resources/cloud-computing-dictionary/choosing-a-cloud-service-provider/) like [Azure](https://azure.microsoft.com/resources/cloud-computing-dictionary/what-is-azure/azure-iaas/) manages the infrastructure, while you purchase, install, configure, and manage your own software - including operating systems, middleware, and applications.
