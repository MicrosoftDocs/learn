...
- Software as a service (SaaS), which allows users to connect to and use cloud-based applications over the internet. These are also known as _hosted applications_. In general, users install no software; they simply sign in via a browser and use the hosted software. 
