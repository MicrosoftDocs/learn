...
The web app still works in the sense that it's running but it doesn't display data from the database yet because the web app doesn't have the connection string in the app settings.
