...
* **2 Developers**: One form of these secrets is 2 secrets, which you would hand out to 2 separate developers or connecting resources. Each secret can be cycled for a new secret.  Cosmos DB provides 2 connection strings for your resource.
...
:::image type="content" source="../media/app-service-connect-app-identity-credentials.png" alt-text="Diagram that shows identity used to access an Azure resource from App Service.":::
