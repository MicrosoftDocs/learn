...
1. In the **Resources** section, expand the **Concierge Subscription** subscription and right-click the database and select **Copy Connection String**.
...
1. In the **Resources** section, expand the **Concierge Subscription** subscription, the **App Services** node and right-click your web app resource and select **Browse Website**.
