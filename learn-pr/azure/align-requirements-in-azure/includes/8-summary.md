...
1. Platform as a service (PaaS) provides ready-made development and deployment environments that you can use to deliver your own cloud services.

1. Software as a service (SaaS) delivers applications over the internet as a web-based service.
