...
- Microsoft Endpoint Manager allows you to configure device security and to manage security tasks for devices when those devices are at risk.
- Intune and Configuration Manager provide a number of tools you can use to resolve compliance issues for end user's devices and apps, as well as your tenant.
