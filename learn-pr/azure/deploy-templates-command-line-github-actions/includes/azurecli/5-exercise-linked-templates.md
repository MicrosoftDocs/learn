...
1. After you save that file locally, deploy it at the resource group level by using the following Azure CLI command. Namely, use [az deployment group create](/cli/azure/deployment/group?azure-portal=true&view=azure-cli-latest#az-deployment-group-create).
