...
Proper CI/CD pipelines also allow you to include in your deployment tasks a testing step by using tools such as the Azure Resource Manager (ARM) template test toolkit (*arm-ttk* for short). For more information about this toolkit, see [Validate your deployments by using what-if and the test toolkit](/learn/modules/arm-template-test/). 
