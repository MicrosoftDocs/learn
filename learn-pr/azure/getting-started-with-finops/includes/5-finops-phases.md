The FinOps phases are designed as an iterative loop to support the customer journey in adopting and improving practices continuously. It consists of three phases - Inform, Optimize, and Operate, which do not need to follow a strict sequence. This flexibility allows organizations to customize it for their specific needs. Additionally, it is important to note that different teams might be in different stages based on various factors and objectives.

![Diagram showing the phases of the FinOps lifecycle.](../media/5-finops-lifecycle.png)
