At the time of this writing, MRTK3 does not yet have the *Object Collection* components that were available in MRTK2 (i.e. *Grid Object Collection*, *Scatter Object Collection* and *Tile Grid Object Collection*). Therefore they are not covered in this tutorial. In the meantime, *Object Bar* can be used to help lay out an array of objects.
