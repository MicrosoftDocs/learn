...
1. Click the left mouse button to start the tap-to-place process.
...
1. Press and hold the right mouse button while moving your mouse to the left or right to rotate your gaze direction. When you're happy with the placement, click the left mouse button.
