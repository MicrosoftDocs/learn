There are numerous situations when you want to position your game objects in an appropriate place or order. Unity helps you in moving, rotating, and scaling the game object.
