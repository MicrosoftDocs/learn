...
The first set of policies works against the Azure API itself. The second set of policies interacts with the Kubernetes API. To achieve this, you will need to setup the [Azure Policy add-on for AKS](/azure/aks/use-azure-policy) on your AKS clusters.
