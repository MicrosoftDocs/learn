...
Azure App Service supports various pricing models, including a serverless option called [Azure Functions](https://docs.microsoft.com/azure/azure-functions/functions-overview?azure-portal=true). In Azure Functions, only application usage is charged. There are no fixed costs. 
