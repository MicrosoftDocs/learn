...
- Data Processing: Azure includes services to analyze and transform data streams with [Azure Stream Analytics](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-introduction), and to execute ETL (Extract-Transform-Load) processes at large scale with [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/).
