In this unit, you'll learn how to apply the results of the measure step in the innovation lifecycle. You'll also learn about the importance of data democratization.
...
The main problem of data centralization is scale at different levels. At the risk of oversimplifying, we can reduce it to the three "V's" of big data:
