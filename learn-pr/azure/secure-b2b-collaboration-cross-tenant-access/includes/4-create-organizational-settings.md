...
Here, you'll learn the cross-tenant access settings you can use to create B2B collaboration settings that are specific to an organization. You'll also learn about trusting multi-factor authentication from another organization so users don't have to complete the multi-factor authentication process multiple times when signing in.
