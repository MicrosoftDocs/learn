The Azure managed identity is a free feature included with Azure Active Directory that offers the functionality to authenticate an identity to any Azure service that supports Azure AD.
