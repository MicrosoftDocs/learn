...
- <https://learn.microsoft.com/azure/active-directory/manage-apps/application-proxy-add-on-premises-application>
- <https://learn.microsoft.com/azure/active-directory/manage-apps/plan-an-application-integration>
- <https://learn.microsoft.com/azure/active-directory/manage-apps/application-proxy>
- <https://learn.microsoft.com/azure/azure-resource-manager/resource-manager-api-authentication>
- <https://learn.microsoft.com/powershell/azure/create-azure-service-principal-azureps?view=azps-1.6.0>
- <https://azure.microsoft.com/resources/samples/aad-dotnet-manage-service-principals/>
- <https://learn.microsoft.com/cli/azure/create-an-azure-service-principal-azure-cli>
- <https://learn.microsoft.com/azure/active-directory/develop/app-objects-and-service-principals#overview>
- <https://learn.microsoft.com/azure/data-lake-store/data-lake-store-service-to-service-authenticate-net-sdk>
- <https://learn.microsoft.com/azure/key-vault/service-to-service-authentication#running-the-application-using-managed-identity-or-user-assigned-identity>
