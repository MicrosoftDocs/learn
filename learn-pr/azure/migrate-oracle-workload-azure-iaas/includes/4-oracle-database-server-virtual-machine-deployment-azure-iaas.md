...
To configure the machines after deployment, the scripts make use of [Ansible](/azure/developer/ansible/overview). You modify the sample Ansible configuration files to automate the any post-deployment VM setup, including configuring the Oracle database software and creating your databases.
