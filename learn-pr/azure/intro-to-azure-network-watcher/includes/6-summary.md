...
- [What is Azure Network Watcher?](/azure/network-watcher/network-watcher-monitoring-overview?azure-portal=true)
- [Monitor network connectivity by using Connection Monitor](/azure/network-watcher/connection-monitor-overview?azure-portal=true)
- [Create an Azure Network Watcher instance](/azure/network-watcher/network-watcher-create?azure-portal=true)
...
- [Configure Network Watcher](/training/modules/configure-network-watcher/)
- [Design and implement network monitoring](/training/modules/design-implement-network-monitoring/)
