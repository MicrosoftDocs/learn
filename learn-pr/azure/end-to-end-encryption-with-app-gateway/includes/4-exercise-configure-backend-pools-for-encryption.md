...
3. Upload the authorization certificate for the VM in the backend pool to Application Gateway. THis certificate was generated by the setup script and is stored in the *shipping-ssl-crt* file:
