...
:::image type="content" source="../media/4-distinct-operator.png" alt-text="Screenshot showcasing the Heartbeat query with a pipe and distinct Computer listed." lightbox="../media/4-distinct-operator.png":::
