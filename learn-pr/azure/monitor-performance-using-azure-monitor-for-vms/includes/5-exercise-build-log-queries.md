...
1. In the [Azure portal](https://portal.azure.com/learn.learn.microsoft.com?azure-portal=true), search for and select **Log Analytics Workspace**. Select the workspace you created earlier.
