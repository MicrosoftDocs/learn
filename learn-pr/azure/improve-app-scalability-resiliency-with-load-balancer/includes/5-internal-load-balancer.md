In addition to balancing requests from users to front-end servers, you can use Azure Load Balancer to distribute traffic from fron-tend servers evenly among back-end servers.
...
:::image type="content" source="../media/5-internal-load-balancer.svg" alt-text="Screenshot showing internal load balancer." border="false":::
