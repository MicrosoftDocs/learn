In addition to balancing requests from users to frontend servers, you can use Azure Load Balancer to distribute traffic from frontend servers evenly among backend servers.
