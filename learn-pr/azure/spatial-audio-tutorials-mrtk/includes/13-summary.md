In this module, you've learned to import and enable the Microsoft Spatializer plugin and enable the spatial audio on your workstation. Also, to spatialize the button's interaction sounds and use an audio clip to test button interaction. In addition, To enable and disable spatialization at run time, test out the app on a HoloLens 2 or in the Unity editor. In the app, you can now click the button to activate and deactivate the spatialization of the audio.
