## 8. Enable and disable spatialization at run time

## Spatialization

An essential element of VR audio is spatialization: the ability to play a sound as if it's positioned at a specific point in three-dimensional space. Spatial audio is essential to deliver an immersive experience because it provides powerful cues that make the user feel they are actually in the 3D environment. The two major components to spatialization are direction and distance
...
Apart from determining if this AudioSource is heard as a 2D or 3D source, this property is useful to morph between the two modes.
