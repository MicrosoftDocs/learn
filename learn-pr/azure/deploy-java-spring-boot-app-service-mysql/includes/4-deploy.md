Azure gives developers the option to deploy to Azure directly from Eclipse, IntelliJ, and Maven. In the previous exercise, you created a quick "Todo" example Java web app and tested it locally. Adding the Maven Plugin for Azure App Service to your project allows you to deploy your app to Azure App Service.
