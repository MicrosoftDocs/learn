...
For more information about using Azure with Java, see [Azure for Java developers](../index.yml/?WT.mc_id=java-10785-ropreddy) and [Working with Azure DevOps and Java](/azure/devops/?WT.mc_id=java-10785-ropreddy).
