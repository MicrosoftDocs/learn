...
- ***Simulation friendly***: Bonsai provides accelerated simulation integration capabilities that simplify scaled training. You can easily integrate any simulation with Bonsai. Today, Bonsai offers seamless integrations for Anylogic, Simulink, VP-Link, and FMU simulations. Additionally, Bonsai has a Python integration accelerator for Python sims, which can also be used for ad-hoc instancing of non-python sims.
