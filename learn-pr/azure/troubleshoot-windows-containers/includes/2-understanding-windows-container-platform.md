...
:::image type="content" source="../media/1-windows-container-architecture.png" alt-text="Diagram showing Windows container architecture.":::
...
- Kubelet (Kubernetes agent running on all nodes) will see the pending container and will call the runtime to create the container.
