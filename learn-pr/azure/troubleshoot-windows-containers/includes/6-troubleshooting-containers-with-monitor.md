...
Below are some of the components of a Azure Monitor solution that help you troubleshoot your environment.
...
Log Analytics workspace is a unique environment for log data from Azure Monitor and other Azure services, has its own data repository and configuration but might combine data from multiple services including AKS. You can either create your own, or let Azure create a default one for you. It is used to store all logs generated by your AKS cluster.
...
Azure Monitor can easily identify issues at all levels inside your AKS cluster. We will go through them below.
...
:::image type="content" source="../media/6-application-container-insights.png" alt-text="NA" lightbox="../media/6-application-container-insights.png":::
...
:::image type="content" source="../media/6-enable-diagnostic-settings.png" alt-text="NA" lightbox="../media/6-enable-diagnostic-settings.png":::

:::image type="content" source="../media/6-control-plane-diagnostic-settings.png" alt-text="NA"  lightbox="../media/6-control-plane-diagnostic-settings.png":::
...
:::image type="content" source="../media/6-container-logs-query.png" alt-text="NA" lightbox="../media/6-container-logs-query.png":::
...
:::image type="content" source="../media/6-grafana-dashboard.png" alt-text="NA" lightbox="../media/6-grafana-dashboard.png":::