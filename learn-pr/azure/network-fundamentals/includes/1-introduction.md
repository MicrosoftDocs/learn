...
In this module, you'll explore how networks communicate with each other. You'll also learn about network protocols and standards and the difference between a WAN and a LAN. Finally, you'll get to know more about the Transmission Control Protocol and Internet Protocol (TCP/IP), IP addresses, and ports.

While the content of this module applies to any network, you'll see where and how the concepts apply to networks managed by using Azure.
