...
1. Run the `Set-AzStorageServiceMetricsProperty` command to configure minute-level storage metrics, with a retention period of seven days:
...
1. In the Azure portal, on the page for your storage account, in the menu pane, under **Blob service**, click **Containers**.
...
1. In the toolbar, click **Column Options**, and select the following columns:
    ...
    Use the **Move Up** and **Move Down** buttons to arrange the columns in the order shown above, and then click **OK**.
