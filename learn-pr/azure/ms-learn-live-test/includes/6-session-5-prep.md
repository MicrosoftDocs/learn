In session four, we added a centralized, cloud-based storage to VanArsdel's solution. Now the project is fully running in the cloud, we want to make sure things are going well.
...
- Set up scaling rules for your application
...
You're now ready to join session five! :-)
