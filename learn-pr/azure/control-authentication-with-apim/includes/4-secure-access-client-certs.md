...
These properties are not mutually exclusive and they can be combined to form your own policy requirements. For example, you can specify that the certificate passed in the request be signed by a certain certificate authority and hasn't expired.
