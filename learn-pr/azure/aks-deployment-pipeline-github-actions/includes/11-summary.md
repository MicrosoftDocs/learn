...
- [Automating tasks by using GitHub Actions](https://docs.microsoft.com/learn/modules/github-actions-automate-tasks/)
- [CI with GitHub Actions](https://docs.microsoft.com/learn/modules/github-actions-ci/)
...
- [Azure Helm docs](https://docs.microsoft.com/azure/aks/kubernetes-helm)
