Imagine you work for a video company. After a few months of planning, your team successfully migrated its technology stack to use Azure Kubernetes Service (AKS).

The current solution is running without any problems. However, you've noticed that the team spends a lot of time building container images and deploying applications. To reduce the team's time spent on these tasks, you decide to investigate using pipelines to deploy to AKS. When you approached management with this idea, they asked you to create a proof of concept by using the company's new website.
