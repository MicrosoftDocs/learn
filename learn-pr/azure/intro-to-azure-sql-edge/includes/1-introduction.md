...
You don't want to create new apps on a proprietary system, solely for vehicle-sensor data that arrives at the edge. Another important requirement is the ability to develop the app by using the SQL Server skills your development team already possesses. Here, you'll decide how you can achieve your company's goals for this app by implementing Azure SQL Edge.
