...
To create and use Azure services (including Azure Digital Twin), you need an Azure subscription. For more information on how to create an Azure account, see [Create Azure free account](https://azure.microsoft.com/free/).
