...
:::image type="content" source="../media/4-trust-relationship-diagram.png" alt-text="Diagram showing on-premises AD DS configured in a trust relationship with an AD DS deployment hosted on an Azure subnet." border="false" lightbox="../media/4-trust-relationship-diagram.png":::
...
:::image type="content" source="../media/4-identity-synchronization-diagram.png" alt-text="Diagram showing identity synchronization between on-premises Active Directory Domain Services instances and an Azure Active Directory tenant." border="false" lightbox="../media/4-identity-synchronization-diagram.png":::
...
:::image type="content" source="../media/4-azure-active-directory-domain-services-architecture.png" alt-text="Diagram showing how on-premises AD DS synchronizes with an Azure AD tenant that populates an Azure AD DS managed domain." border="false" lightbox="../media/4-azure-active-directory-domain-services-architecture.png":::
