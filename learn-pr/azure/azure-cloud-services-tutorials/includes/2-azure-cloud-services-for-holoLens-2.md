...
With Azure Custom Vision (part of the Azure Cognitive Services) you can associate a set of images to Tracked Objects , train a machine learning model on the set, and detect the Tracked Object.
