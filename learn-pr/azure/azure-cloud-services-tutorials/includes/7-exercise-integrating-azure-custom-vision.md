...
![Unity with Project window showing path to ObjectDetectionManager prefab](../media/tutorial3-section4-step1-1.png)
...
![Unity with SceneController script component configuration fields shown in Inspector](../media/tutorial3-section4-step1-3.png)
...
![Unity with SceneController script component configured](../media/tutorial3-section4-step1-4.png)
