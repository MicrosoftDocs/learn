...
The application is composed of an App Service app, Cosmos DB account, and an Azure Front Door endpoint, route, and origin group. The Front Door resources are child resources of the Front Door profile.
...
The deployment stack is created or modified with deny settings that prevent any unauthorized changes to the managed resources in the stack.
