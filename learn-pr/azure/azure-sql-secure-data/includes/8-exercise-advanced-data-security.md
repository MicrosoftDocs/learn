...
1. On the left pane, under **Security**, select **Defender for Cloud**. Microsoft Defender for Cloud should already be enabled. Select **Configure**.
...
1. Select the **Defender for Cloud** tab under Security to view the **Defender for Cloud** dashboard for your SQL Database. 
...
1. In the Azure portal, go to your AdventureWorks database. On the left pane, under **Security**, select **Defender for Cloud**. 

    Under **Security incidents and alerts**, select **Check security alerts on this resource in Defender for Cloud**.  
