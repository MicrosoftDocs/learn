...
* [Data exfiltration prevention](/azure/azure-sql/database/private-endpoint-overview?view=azuresql#data-exfiltration-prevention)  
* [Virtual network endpoints and rules](/azure/azure-sql/database/vnet-service-endpoint-rule-overview?view=azuresql)  
