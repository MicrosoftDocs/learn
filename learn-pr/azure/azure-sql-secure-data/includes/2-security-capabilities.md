...
![Enterprise-class security](../media/2-enterprise-security.png)
...
![Allow access to Azure services](../media/2-allow-access.png)
...
![Firewall rules](../media/2-firewall-rules.png)
...
![VNet Rules](../media/2-vnet-rules.png)
...
![Private endpoint connection](../media/2-private-endpoint.png)
...
![SQL Managed Instance Network](../media/2-sql-managed-instance-network.png)
...
![Set the AD admin](../media/2-azure-ad-admin.png)  
