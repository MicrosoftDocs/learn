The goal of this module was to help you evaluate whether the Azure Developer CLI can improve the cloud journey for your app. We discussed the following features and benefits provided by `azd`:
...
Consider these factors when deciding if `azd` is a great fit for your project or team. `azd` can provide value to most apps that require streamlined provisioning and deployment to Azure in a repeatable, distributable format.
