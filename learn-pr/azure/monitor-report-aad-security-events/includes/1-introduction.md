...
In this module, you'll learn how to set up Azure Monitor to process your Azure Active Directory activity and sign-in logs. You'll use Azure Monitor to set up security event alerts. Then, you'll see how to create a dashboard that helps improve your ability to respond to incidents.
