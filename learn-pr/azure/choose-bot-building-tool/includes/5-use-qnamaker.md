...
You can download a QnA Maker bot's source code and modify it using an IDE. Create QnA Maker bots by using C# source code to enable your development team to extend bot functionality in many ways. They can incorporate the C# libraries that the criteria require. The bot's code-based design also enables your developers to integrate your bot with the REST-enabled FAQ application. This fulfills another criteria.
