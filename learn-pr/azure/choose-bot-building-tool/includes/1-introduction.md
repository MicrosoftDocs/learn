A bot provides a conversational interface in websites and applications. To determine which bot-creation method to use in specific scenarios, examine the fundamental differences between the different bot-building tools that Microsoft provides. THIS IS A TEST.
