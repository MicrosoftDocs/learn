...
:::row:::
  ...
  :::column-end:::
  :::column:::
    :::image type="content" source="../media/icon-service-managed-sql-instance-417013a9.png":::
...
:::image type="content" source="../media/migration-process-flow-small-a899c59c.png" alt-text="The process flow for data migration to Azure SQL Managed Instance.":::
