...
6. Select **Next : Security**, and next to **Enable Azure Defender for SQL**, choose **Not now**.
   ...
   :::image type="content" source="../media/security-tab.png" alt-text="Screenshot of the Security tab of the Create SQL Database pane with settings selected.":::
...
9. After validation success, on the **Create SQL Database** window, select **Create** to deploy the server and database.
...
6. In the **Client IP address** section, your IP will be shown (verify that it is the same client IP address from the error above). Click on **+ Add client IP**, which will add a **Rule name** and put your IP in both the **Start IP** and **End IP** fields, and then select **Save**.
