...
:::image type="content" source="../media/8-vm-tags-7c63fa8a.png" alt-text="A screenshot that shows virtual machine tags. The tag names are AppName, CostCenter, Owner, Environment, and Impact.":::
