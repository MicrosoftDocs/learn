After you have created a subscription for Tailwind Traders, you're ready to start creating resources and storing those in resource groups. With that in mind, it's important to define those terms:
...
[![Resource Manager request model.](../media/consistent-management-layer.png)](../media/consistent-management-layer-expanded.png#lightbox)
...
- Manage your infrastructure through declarative templates rather than scripts. An Azure Resource Manager template is a JSON file that define what you want to deploy to Azure.
