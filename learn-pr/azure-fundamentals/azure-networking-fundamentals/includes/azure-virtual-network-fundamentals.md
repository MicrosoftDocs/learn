...
The good news is, Azure virtual networking can help you reach your goals.

## What is Azure virtual networking?

**Azure virtual networks** enable Azure resources - such as virtual machines, web apps, and databases - to communicate with each other, with users on the Internet, and with your on-premises client computers. You can think of an Azure network as a set of resources that links other Azure resources.
