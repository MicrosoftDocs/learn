In your research for Tailwind Traders so far, you've looked at two different ways that you can virtualize your application. However, another alternative is to deploy your application's front-end websites to Azure App Service, which makes it easy to respond to application demand.
