...
A stolen password might allow unauthorized access to company and customer data. Tailwind Traders wants to extend their investments in Active Directory to secure all of their applications, both when accessed from their intranet and from public networks.
