...
:::image type="content" source="../media/4-key-vault-certificates-b32bfbfe.png" alt-text="A screenshot of the Azure portal showing a test certificate in Azure Key Vault.":::
