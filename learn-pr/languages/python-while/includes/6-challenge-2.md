...
- If the user types in a non-numeric value, tell the user "Numbers only, please!"
...
If the user types in a value that is not numeric, display an error message.  In the following example output, the end user enters a few strings and is reminded to only enter numbers:
