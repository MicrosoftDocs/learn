...
You've just taken your first steps toward learning how to use Python to build programs and write scripts to automate tasks, analyze data, and build entire web-based applications, games, and more.