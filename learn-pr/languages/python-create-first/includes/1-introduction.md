A common goal of many programs is to take input, process it, format it, then output it in some way.  In this module, you'll write Python code to perform each of these tasks.  Along the way, you'll learn many foundational ideas, such as working with data, performing operations on data, retrieving input, generating output, and more.
