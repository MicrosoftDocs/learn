...
A Jupyter notebook is a document that contains both explanatory text and code. You can go through each individual cell, run the code and interprete the output. 
