One of the services that Azure Quantum offers is a solution to quantum computing on real or simulated quantum devices.
...
In an unstructured problem, such as a list of $n$ random numbers as the input of the algorithm, a quantum computer can achieve polynomial to a quadratic speedup. In Grover's algorithm, for example, a quantum computer gives a quadratic speedup. 
