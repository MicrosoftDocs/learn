...
If you took some of the earlier modules in the [learning path](https://docs.microsoft.com/en-us/learn/paths/quantum-computing-fundamentals/), you might have focused on the theoretical aspect of quantum computing. In the learning path, you were a member of a space mission in a spaceship with access to Azure Quantum servers. At this point you're ready to connect to Earth and start using real quantum computers to implement your Q# quantum programs.
