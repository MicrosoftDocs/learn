...
[Azure Quantum](https://azure.microsoft.com/en-us/products/quantum/) is an open ecosystem to build quantum computing solutions and it offers flexibility to use your preferred development tools with support for Qiskit, and Q#. Learn how you can use the familiar and trusted Azure platform to develop quantum algorithms and run them on real hardware from multiple providers.

In this module, you'll learn about the history of quantum computing and the requirements to build a quantum computer. You'll also learn about the Azure Quantum service and its components.
