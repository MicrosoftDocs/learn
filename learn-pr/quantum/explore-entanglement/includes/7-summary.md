Congratulations! In this module, you learned about the concept of quantum entanglement, and you used entanglement to help Alice and Bob to send quantum information through the teleportation protocol with Q#.
...
- Learn more about quantum computing and Q# in the [Microsoft Quantum documentation](https://learn.microsoft.com/azure/quantum/).
- Go to the [Microsoft Quantum website](https://quantum.microsoft.com/tools/quantum-coding) for the latest news and developments from Microsoft Quantum.
