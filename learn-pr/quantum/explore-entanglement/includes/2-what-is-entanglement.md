...
> [!NOTE]
> In Dirac notation, $\ket{0_A 0_B}= |0\rangle_A |0\rangle_B$. The first position corresponds to the first qubit, and the second position corresponds to the second qubit.
