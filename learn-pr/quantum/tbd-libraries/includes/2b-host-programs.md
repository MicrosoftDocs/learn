...
In the [Create your first Q# program by using the Quantum Development Kit](https://docs.microsoft.com/learn/modules/qsharp-create-first-quantum-development-kit?azure-portal=true) module, you built a basic quantum random number generator. In this part, you TODO.
...
1. Install [Miniconda](https://docs.conda.io/en/latest/miniconda.html) or [Anaconda](https://www.anaconda.com/products/individual#Downloads).
    ...
    > [!NOTE]
    > 64-bit installation is required.

1. Open an Anaconda Prompt.

   Or, if you prefer to use PowerShell or pwsh: open a shell, run `conda init powershell`, then close and reopen the shell.
...
In your Q# project, create a Q# file with the following contents. It is the familiar `GenerateRandomBit` operation.
...
## Call the quantum operation from your host program

Here, you write the quantum dice rolling simulation for each host program.
...
TODO: Tell the learner how to run it!
