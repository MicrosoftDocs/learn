...
* [Learn to solve Boolean satisfiability problems using the search algorithm](https://github.com/microsoft/QuantumKatas/blob/master/SolveSATWithGrover).
* [Deep dive into solving graph coloring problems using the search algorithm](https://github.com/microsoft/QuantumKatas/blob/master/GraphColoring).
