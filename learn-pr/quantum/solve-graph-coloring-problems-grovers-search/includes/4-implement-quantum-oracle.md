For the moment, forget spacecraft traveling between stations and consider only colors and vertices. You have a picture of dots connected by edges and you wonder about the ways to color the dots. 
...
Congrats space explorer! Now you know how to build a complete quantum oracle for a graph coloring problem! In the next unit, you finally put into practice your skills as we need you to implement Grover’s search algorithm to determine our delivery routes. 
