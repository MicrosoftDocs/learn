...
In this module, you write your first quantum program by using the Quantum Development Kit (QDK). You write a quantum program to generate random numbers. A quantum random number generator is a perfect introduction to quantum computing because it illustrates quantum behavior and requires only a few lines of code. You also review the basic structure of a Q# program.
...
- Install the latest version of the [Quantum Development Kit](https://marketplace.visualstudio.com/items?itemName=quantum.qsharp-lang-vscode) extension.
