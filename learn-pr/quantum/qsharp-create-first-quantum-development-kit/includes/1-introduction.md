...
Imagine you are the new member of a space crew. The spaceship is equipped with a computer that has access to the Azure Quantum servers on Earth and you can use the power of quantum computing to complete the different tasks. During your training as a new crew member, you will learn about quantum computing and how to use the Microsoft Azure Quantum service.

Welcome aboard!

![alt_text = Figure of the crew spaceship. ](../media/spaceship-core.svg)
