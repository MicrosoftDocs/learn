...
If you're interested in learning more, the [Solve optimization problems by using quantum-inspired optimization](/learn/modules/solve-quantum-inspired-optimization-problems/?azure-portal=true) module is a great next step. There you'll see how you can apply algorithms inspired by quantum physics to solve difficult optimization problems.
...
Once you're ready to dive deeper, you can [browse code samples](/samples/browse/?languages=qsharp&azure-portal=true) or [learn quantum computing with the Quantum Katas](/azure/quantum/tutorial-qdk-intro-to-katas).
