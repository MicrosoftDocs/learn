...
The job shop scheduling problem is defined as follows: we have a set of jobs $J_0, J_1, J_2, \dots, J_{n-1}$ which have various processing times and need to be processed using a set of machines $m_0, m_1, m_2, \dots, m_{n-1}$. The goal is to complete all jobs in the shortest time possible. This is called minimizing the **makespan**.
