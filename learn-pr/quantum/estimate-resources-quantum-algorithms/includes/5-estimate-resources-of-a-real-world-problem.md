...
Shor's factoring algorithm studies a quantum algorithm with superquadratic speedup and the cost of error correction. 
...
You can also construct a list of estimation parameters using the `EstimatorParams` object.
    ...
    params.items[3].error_budget = 0.333
    params.items[4].qubit_params.name = QubitParams.MAJ_NS_E4
    params.items[4].qec_scheme.name = QECScheme.FLOQUET_CODE
    params.items[4].error_budget = 0.333
    params.items[5].qubit_params.name = QubitParams.MAJ_NS_E6
    params.items[5].qec_scheme.name = QECScheme.FLOQUET_CODE
    params.items[5].error_budget = 0.333
    ```
