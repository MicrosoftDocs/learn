...
Understanding the power of quantum-inspired optimization, you will work with your crew in module [Solve QIO problems](https://docs.microsoft.com/learn-pr/quantum/solve-quantum-inspired-optimization-problems) to help the logistics division efficiently load cargo vessels, and in module [Solve the job shop scheduling problem](https://docs.microsoft.com/learn-pr/quantum/solve-job-shop-scheduling-optimization-problem) with the maintenance division to prioritize different kinds of jobs on the spaceship. 
