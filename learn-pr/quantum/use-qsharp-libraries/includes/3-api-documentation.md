...
API documentation is essentially the reference manual for the libraries of a language. It contains the specifics about how all the puzzle pieces fit together. For example, it contains all types and functions along with any required/optional inputs.
...
- *Python libraries* contain details regarding integration with Python as a host program.
