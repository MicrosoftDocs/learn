...
Physicists often use "wave function" as a synonym for the quantum state of a system. Don't get confused by this term, they use it because the Schrödinger equation that we introduced at the beginning of this module. The Schrödinger equation has the same mathematical structure as classical wave equations. 
