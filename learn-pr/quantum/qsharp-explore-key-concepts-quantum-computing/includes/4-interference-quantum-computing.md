...
Physicists often use "wave function" as a synonym for the quantum state of a system. They use it because of the Schrödinger equation we introduced at the beginning of this module. The Schrödinger equation has the same mathematical structure as classical wave equations. 
