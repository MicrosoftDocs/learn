...
There are many models of quantum computing. If you have viewed the [*Write your first quantum program with the Quantum Development Kit* module](https://docs.microsoft.com/learn/modules/get-started-qdk), you'll have gained familiarity with the Gate Model, in which we define quantum programs by writing operations that make use of quantum gates. 
