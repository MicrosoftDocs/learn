...
QIO works best with problems where the landscape is rugged, with many hills and valleys. Here's an example:

![A plot of an optimization landscape that shows many peaks and valleys](../media/plot_rugged.png)

**TODO:** Just to double-check, our container scenario has this topology, correct? If so, can we mention that in the lead-in to the diagram?
