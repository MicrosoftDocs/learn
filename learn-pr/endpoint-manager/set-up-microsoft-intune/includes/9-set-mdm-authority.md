...
- **Intune co-management** - This configuration integrates Microsoft Intune with Microsoft Endpoint Configuration Manager. Configuration Manager allows you to manage on-premises Windows 10 devices. For more information, see [Enable co-management in Configuration Manager](https://docs.microsoft.com/mem/configmgr/comanage/tutorial-co-manage-clients?azure-portal=true#enable-co-management-in-configuration-manager).
...
For more information, see [Set the mobile device management authority](https://docs.microsoft.com/mem/intune/fundamentals/mdm-authority-set?azure-portal=true).
