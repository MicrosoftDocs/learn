...
1. In **Group type**, choose one of the following options:
...
1. Choose whether you want to add owners and members at this time.
1. Select **Create** to add the new group. Your group is shown in the list.
...
The users and groups that you create control access to your organization's resources.

When you create groups, consider how to apply [compliance policies](/mem/intune/protect/device-compliance-get-started?azure-portal=true) and [configuration profiles](/mem/intune/configuration/device-profiles?azure-portal=true). For example, you might have:
