...
> [!IMPORTANT]
> If you're currently using Microsoft Endpoint Configuration Manager to manage computers and servers, you can [cloud-attach Configuration Manager with co-management](https://docs.microsoft.com/configmgr/comanage/overview?azure-portal=true). Cloud attach lets you to leverage both Configuration Manager and Microsoft Intune from Microsoft Endpoint Manager.
...
## Prerequisites
  ...
  - Basic knowledge of Microsoft Endpoint Manager and endpoint management concepts, see [Microsoft Endpoint Manager fundamentals](https://docs.microsoft.com/learn/paths/endpoint-manager-fundamentals?azure-portal=true).
  - Understand your endpoint management objectives, device inventory considerations, licensing needs, infrastructure objectives, and rollout plans, see [Determine your endpoint management implementation](https://docs.microsoft.com/learn/modules/determine-endpoint-implementation?azure-portal=true).
