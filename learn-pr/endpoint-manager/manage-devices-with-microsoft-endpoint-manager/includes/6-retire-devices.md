...
In Intune, for devices that don't meet your organization's compliance policies or rules, you can add actions for noncompliance. This feature configures a time-ordered sequence of actions, such as emailing the end user, and more. One of the available actions for noncompliance is to retire the noncompliant device. 
