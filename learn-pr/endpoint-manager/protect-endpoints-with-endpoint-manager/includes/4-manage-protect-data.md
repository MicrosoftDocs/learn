...
App-protection policies set up with Intune also work on devices managed with a non-Microsoft device-management solution. The personal data on the devices isn't touched; the IT department only manages company data.
