...
Co-management lets you concurrently manage Windows 10/11 devices with both Configuration Manager and Intune. Co-management combines your existing on-premises Configuration Manager and Active Directory investment with the cloud, by using Intune, Microsoft Entra ID, and other Microsoft 365 cloud services. You choose whether to make Configuration Manager or Intune the management authority. You can keep some tasks on-premises while running other tasks in the cloud with Intune.

There are two main paths to co-management:

- **Existing clients**: For existing Windows 10/11 Configuration Manager clients, you set up hybrid Microsoft Entra ID and enroll the devices into Intune.
- **New cloud-based devices**: New cloud-based Windows 10/11 devices join Microsoft Entra ID and automatically enroll to Intune. You install the Configuration Manager client to enable co-management.
