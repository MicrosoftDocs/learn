...
To quickly step through the areas of Microsoft Intune, see [Tutorial: Walkthrough Intune in Microsoft Intune](/mem/intune/fundamentals/tutorial-walkthrough-endpoint-manager?azure-portal=true).