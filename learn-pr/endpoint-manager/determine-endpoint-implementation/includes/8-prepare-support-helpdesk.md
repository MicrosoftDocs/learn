...
Determine who will support end users. Organizations may have different tiers or levels (1-3) of support. For example, tier 1 and 2 may be part of the support team, and tier 3 includes members of the MDM team responsible for the deployment of Endpoint Manager.

Tier 1 is normally the first level of support and typically the first tier the user contacts for support requests. If tier 1 is unable to resolve the end user's issue, they escalate it to tier 2. Tier 2 escalates it to tier 3 if needed. In addition, Microsoft support may be considered as tier 4.
...
For more information about determining and creating a rollout plan, see the following resource:
