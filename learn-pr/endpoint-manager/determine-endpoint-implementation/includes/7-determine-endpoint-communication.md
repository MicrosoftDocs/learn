...
- Organization web sites: used for all phases
- Yammer, posters, and flyers: used for kickoff and pre-enrollment phases

## Communications timeline

After determining what you need to communicate and the methods you will use, determine the timeline for your communications that includes who'd receive the communications and when they'd receive them.

For example, the initial Endpoint Manager project kickoff communications can target the entire organization or just a subset, and take place over several weeks before the Endpoint Manager rollout begins. After that, information could be communicated in phases to organizational groups and users, aligned with their Endpoint Manager rollout schedule. The following example is a sample high-level Endpoint Manager rollout communications plan:
...
For more information about determining and creating a rollout plan, reference the [Microsoft Intune planning guide - Communicate changes](/mem/intune/fundamentals/intune-planning-guide?azure-portal=true#task-6-communicate-changes).
