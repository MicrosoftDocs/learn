...
Now that you have determined the targeted groups and time frames for your Endpoint Manager rollout, the next step is to choose the most appropriate Endpoint Manager enrollment approach for each group. There are different enrollment approaches you can use including:
* User self-service
