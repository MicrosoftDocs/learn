...
- **mnistOutput** initializes the types that the model will output. In this case, the output is a list called `Plus214_Output_0` of type [TensorFloat](/uwp/api/windows.ai.machinelearning.tensorfloat).
