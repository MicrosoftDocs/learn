...
MVVM is the most widely used architecture pattern for UI frameworks that support data binding. There are many MVVM toolkits and frameworks available that can jumpstart your development in UWP and WPF, or even Xamarin Forms. Some of the most popular are:

- <a href="http://www.mvvmlight.net/" target="_blank">MVVM Light Toolkit</a>
