...
1. Now, complete the `CreateMainCard` method so that it contains the code to create three image columns, and add an action to each.
    ...
    ```cs
        private void CreateMainCard()
        {
            ...
            AddImageColumn(mainColumnSet, "https://learn.microsoft.com/learn/media/tanager.jpg", "Open URL action");
            ...
            AddImageColumn(mainColumnSet, "https://learn.microsoft.com/learn/media/songbird-pair.jpg", "Submit action");
            ...
            AddImageColumn(mainColumnSet, "https://learn.microsoft.com/learn/media/eagle-in-tree.jpg", "Show Card action");
...
1. Now complete the `CreateMainCard` method so that it contains the code to create three image columns, and add an action to each.
    ...
    ```cs
        private void CreateMainCard()
        {
            ...
            // Add the second image, with a Submit action.
            AddImageColumn(mainColumnSet, "https://learn.microsoft.com/learn/media/hawk.jpg", "Submit action");
            mainColumnSet.Columns[2].SelectAction = new AdaptiveSubmitAction
            {
                Id = "SubmitAction1",
            };
            ...
            // Add the third image, with a Show Card action.
            AddImageColumn(mainColumnSet, "https://learn.microsoft.com/learn/media/visitor.jpg", "Show Card action");
            mainColumnSet.Columns[3].SelectAction = new AdaptiveShowCardAction
            {
                Id = "ShowCardAction",
                Card = showCard
