...
9) In Visual Studio Code, change the `index.pug` file to make it look like this code:
   ...
   > [!NOTE]
   > *Optional:* Try adding another image by starting to type **img**. The Visual Studio Code *IntelliSense* feature will provide autocomplete options, including **img:srcset**. Select that option and enter **https://docs.microsoft.com/training/media/Moon-full-minus1.png** as the source.
