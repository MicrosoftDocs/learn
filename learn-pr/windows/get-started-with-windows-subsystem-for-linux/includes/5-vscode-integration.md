...
In VS Code, open the Extensions view (select **View** > **Extensions** or Ctrl+Shift+X) and search for "wsl". Choose the **Remote – WSL** extension as seen below (it should be at the top of the list) and press **Install**.
