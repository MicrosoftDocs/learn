...
:::image type="content" source="../media/2-dev-set-up/lang-version.png" alt-text="Screenshot of file with added LangVersion element":::
...
:::image type="content" source="../media/2-dev-set-up/start-debug.png" alt-text="Screenshot visual studio's Debug":::
...
:::image type="content" source="../media/2-dev-set-up/blank-project-structure.png" alt-text="Displays that the MainWindow files are part of the View":::
...
:::image type="content" source="../media/2-dev-set-up/add-new-folder.png" alt-text="Screenshot visual studio's add new folder":::
