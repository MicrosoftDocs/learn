...
Together, WinUI, the Windows App SDK, and WPF represent the best path forward for developers creating modern native desktop applications on Windows. Use WinUI when the feature set meets the needs of the application, especially for graphics, media and consumer scenarios. Use WPF to leverage the large ecosystem of third-party controls and libraries available, especially those for line-of-business applications.
