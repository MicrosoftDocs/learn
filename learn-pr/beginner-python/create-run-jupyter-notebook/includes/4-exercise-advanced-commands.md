...
First, create a Markdown block to notate what you will display:
...
Create a new code block and import two libraries, using them to build a bar chart:
...
Then, add a code block for the equation:
...
Run the code block to determine how long it will take to reach your desired velocity. Tweak the start and end velocity values or the acceleration to determine how your spaceship will perform.
