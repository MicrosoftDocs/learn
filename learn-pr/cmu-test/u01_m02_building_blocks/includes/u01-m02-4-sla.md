...
1. _Thomas Trappler  (). If It's in the Cloud, Get It on Paper: Cloud Computing Contract Issues  http://www.educause.edu/ero/article/if-its-cloud-get-it-paper-cloud-computing-contract-issues_