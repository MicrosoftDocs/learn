<!-- Original file: C:\Users\Mark\Desktop\CMU-source\v_5_3\content\_u04_cloud_storage\_u04_m01_cloud_storage\x-oli-workbook_page\_u04_m01_3_2_databases2.xml -->
...
![Figure 4.17: Relational database tables](../media/relational_database_tables.png)

_Figure 4.17: Relational database tables_


The concepts of relational databases were combined with SQL and used by IBM, which designed the System R and the DB2 _relational database management systems_ (RDBMS), which were the precursors to all modern RDBMSs. 

The typical features of modern RDBMSs include the following:

- <!-- A relational database model in which data -->Data is modeled as records in tables, and related records across tables are expressed as relations.
...
Traditional RDBMSs have been designed to run on a single machine, but as the amount of data or the number of concurrent users increase, the database must be scaled. Recall that databases can be scaled either _vertically_ or _horizontally_.
