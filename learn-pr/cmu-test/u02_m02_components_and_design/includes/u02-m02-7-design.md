...
<!-- TODO fix
<formula><m:math display="block" xmlns:m="m"><m:mrow><m:mfrac><m:mn>1</m:mn><m:mrow><m:mi>MTBF</m:mi><m:mi mathsize="small">system</m:mi></m:mrow></m:mfrac><m:mo>=</m:mo><m:mfenced open="(" close=")"><m:mrow><m:mfrac><m:mn>1</m:mn><m:mrow><m:mi>MTBF</m:mi><m:mi mathsize="small">c</m:mi><m:mn mathsize="6pt">1</m:mn></m:mrow></m:mfrac><m:mo>+</m:mo><m:mfrac><m:mn>1</m:mn><m:mrow><m:mi>MTBF</m:mi><m:mi mathsize="small">c</m:mi><m:mi mathvariant="italic" fontfamily="Times New Roman" mathsize="6pt">2</m:mi></m:mrow></m:mfrac><m:mo lspace="2px" rspace="2px">+</m:mo><m:mo lspace="2px" form="infix"> . . . </m:mo><m:mo lspace="2px" rspace="3px">+</m:mo><m:mfrac><m:mn>1</m:mn><m:mrow><m:mi>MTBF</m:mi><m:mi mathsize="small">c</m:mi><m:mi mathsize="6pt">n</m:mi></m:mrow></m:mfrac></m:mrow></m:mfenced></m:mrow></m:math></formula>
-->


On the other hand, when a system consists of redundant components, required in both components simultaneously to have an overall system failure. The overall MTBF of the system is thus the product of the MTBFs of each individual redundant component of the system. Formally,
<!-- TODO fix
<formula><m:math display="block" xmlns:m="m"><m:mrow><m:mi>MTBF</m:mi><m:mi mathsize="small">system</m:mi><m:mo>=</m:mo><m:mi>MTBF</m:mi><m:mi mathsize="small">rc</m:mi><m:mn mathsize="6pt">1</m:mn><m:mo lspace="3px" rspace="2px">times</m:mo><m:mi>MTBF</m:mi><m:mi mathsize="small">rc</m:mi><m:mi mathvariant="italic" fontfamily="Times New Roman" mathsize="6pt">2</m:mi><m:mo lspace="4px" rspace="2px">×</m:mo><m:mo lspace="2px" form="infix"> . . . </m:mo><m:mo lspace="1px" rspace="3px">×</m:mo><m:mi>MTBF</m:mi><m:mi mathsize="small">rc</m:mi><m:mi mathsize="6pt">n</m:mi></m:mrow></m:math></formula>
-->
...
1. _Schroeder, Bianca, and Gibson, Garth A.  (2007). Disk Failures in the Real World: What Does an MTTF of 1,000,000 Hours Mean to You? In Proceedings of the 5th USENIX Conference on File and Storage Technologies_
2. _Eduardo Pinheiro, Weber, Wolf-Dietrich, and Barroso, Luiz André.  (2007). Failure Trends in a Large Disk Drive Population In Proceedings of the 5th USENIX Conference on File and Storage Technologies_