<!-- Original file: C:\Users\Mark\Desktop\CMU\v_5_3\content\_u04_cloud_storage\_u04_m01_cloud_storage\x-oli-workbook_page\_u04_m01_5_summary.xml -->
...
- When the data is amenable to structuring, it is typical to organize it using a well-defined model (also known as a _schema_). Semi-strctured or unstructured data are typically stored in schema-less systems such as key-value stores.
