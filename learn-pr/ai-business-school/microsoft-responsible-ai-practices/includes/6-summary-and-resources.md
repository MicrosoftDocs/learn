...
|Resource type|Details|
|---|---|
|Guidance|&bull; Read this paper from the ACM Conference on Fairness, Accountability, and Transparency: [Fairness and Abstraction in Sociotechnical Systems](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3265913) that explains five key “traps” of fair-ML work and how to avoid them.</br>&bull; Read this paper from Cornell University: [Counterfactual Fairness](https://arxiv.org/abs/1703.06856) for an example of a framework for modeling fairness using tools from causal interference, and how it applies to the fair prediction of student success in law school.|
