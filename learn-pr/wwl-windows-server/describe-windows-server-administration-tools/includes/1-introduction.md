...
Contoso IT staff are migrating Contoso on-premises servers to Windows Server 2019. As a Windows Server 2019 administrator, you are responsible for managing and maintaining the server infrastructure that will help Contoso achieve its business goals. You decide to investigate the available Windows Server administration tools, including Windows Admin Center, Remote Server Administration Tools, Server Manager, and Windows PowerShell.
