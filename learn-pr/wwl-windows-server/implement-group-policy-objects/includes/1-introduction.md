...
Contoso IT staff are migrating Contoso on-premises servers to Windows Server 2019. As a Windows Server administrator at Contoso, you're responsible for configuring user and computer settings. These settings will be applied by using GPOs.

After completing this module, you’ll understand how group policies work in a Windows Server 2019 Active Directory environment.
