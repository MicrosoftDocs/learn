...
:::image type="content" source="../media/m19-iscsi-multiple-connections-per-session.png" alt-text="The architecture of MCS, with a single iSCSI session over multiple redundant network paths." border="false":::
...
:::image type="content" source="../media/m19-iscsi-multipath-input-output.png" alt-text="The architecture of MCS, with multiple, individual iSCSI sessions over different redundant network paths." border="false":::
