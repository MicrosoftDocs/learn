...
Before the Contoso infrastructure team starts deploying Windows Server, it's important that you verify that the target computers meet the minimum hardware requirements for Windows Server 2019. This applies whether you intend to run Windows Server on physical hosts, or you intend to virtualize Windows Server.
...
In addition to the previously listed requirements, there are a variety of other hardware requirements to consider, depending on your specific organizational needs and installation scenarios:
...
- A Trusted Platform Module (TPM) is needed to implement a number of security features.
