...
Contoso IT staff are migrating Contoso on-premises servers to Windows Server 2019. As a Windows Server administrator, you are responsible for managing and maintaining the server infrastructure that will help Contoso achieve its business goals. As part of this role, you must deploy and maintain DHCP servers to automate the allocation of IP configurations within your organization.

After completing this module, you’ll know how to install, configure, and manage the DHCP server role on computers running Windows Server 2019. You'll also know how to deploy and configure DHCP high availability options.
