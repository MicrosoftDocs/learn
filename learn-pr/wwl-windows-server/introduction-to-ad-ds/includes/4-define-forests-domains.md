...
:::image type="content" source="../media/m6-forest.png" alt-text="A graphic that displays a hierarchy of domains as described in the preceding text." border="false":::
...
:::image type="content" source="../media/m6-domain.png" alt-text="A graphic that displays a AD DS domain containing users, computers, and groups." border="false":::
