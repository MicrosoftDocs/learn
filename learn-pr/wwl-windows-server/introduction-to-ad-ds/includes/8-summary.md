...
You can learn more by reviewing the following documents.
 ...
 -  [Create an outbound forest trust to an on-premises domain in Azure Active Directory Domain Services](/azure/active-directory-domain-services/tutorial-create-forest-trust?azure-portal=true).
