...
:::image type="content" source="../media/m6-physical.png" alt-text="A screenshot of Active Directory Sites and Services. The administrator has selected the Sites node. Displayed are two sites, Seattle and Vancouver. Also displayed are two subnets.":::
