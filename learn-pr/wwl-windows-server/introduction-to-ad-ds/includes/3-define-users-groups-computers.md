...
:::image type="content" source="../media/m6-user.png" alt-text="A screenshot of the Jane Dow user account in Active Directory Administrative Center.":::
...
You create group managed service accounts by using `New-ADServiceAccount` Windows PowerShell  cmdlet with the `–PrincipalsAllowedToRetrieveManagedPassword` parameter.
...
:::image type="content" source="../media/m6-group.png" alt-text="A screenshot of Create Group: Sales Managers dialog box in Windows Administrative Center.":::
...
:::image type="content" source="../media/m6-computer.png" alt-text="A screenshot of the Create Computer: SEA-CL5 dialog box in Active Directory Administrative Center.":::
