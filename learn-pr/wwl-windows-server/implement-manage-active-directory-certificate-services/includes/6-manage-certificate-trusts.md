...
|Store|Description|
|-------|--------|
|Personal|Contains certificates issued to the local user, the local computer, or its service, depending on the store you selected.|
|Trusted Root Certification Authorities|Contains certificates of trusted root CAs.|
|Enterprise Trust|Contains certificate trust lists to implement trusts of self-signed certificates from other organizations.|
