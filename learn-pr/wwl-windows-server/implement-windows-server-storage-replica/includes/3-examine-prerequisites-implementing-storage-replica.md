...
- Each server should be running Windows Server 2019 Datacenter or Windows Server 2016 Datacenter edition.
    ...
    >[!Note] It's possible to use Windows Server 2019 Standard edition, but this configuration supports replication of only a single volume of up to 2 terabytes (TB) in size.
