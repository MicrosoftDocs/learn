Learn about Windows Server and Hyper-V containers, associated isolation modes, running containers, and preparing the Windows Server host for running containerized workloads. Learn about Docker, container runtimes, preparing Windows Server for running container workloads, and managing containers.
...
- Describe Docker, container runtimes, and how they're used to manage Windows containers.
...
- Explain basic concepts of security, storage, and networking around Windows containers.
