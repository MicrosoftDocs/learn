...
<!-- TODO: reference code to connectCallback method -->

### Telemetry

The function `sendTelemetry` sends telemetry in the format that the device model specifies.

<!-- TODO: reference code to sendTelemetry function -->
...
<!-- TODO: reference code to onCommandMaintenance and onCommandStartBrewing functions -->
...
## Coffee Maker Node.js application
<!-- TODO: I can remove this section if the code can be downloaded  -->
