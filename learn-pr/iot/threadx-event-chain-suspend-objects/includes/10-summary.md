Event-chaining is a technique that enables the linking of several objects based on the occurrence of independent events. This is particularly useful in activating a thread that is suspended on two or more resources. Implementing this technique is a three-step process: 
