...
Building block 1, part 2, is shown in the code below:
...
Building block 3, part 2, is shown in the code below:
...
Building block 4 contains the functions. The `dispatcher thread entry` function is shown in the code below:
...
The `urgent thread entry` function is shown in the code below:

:::code language="c" source="../code/project-message-queues.c" range="133-146":::

<a name="building-block-4-routine-thread-entry"></a>

Building block 4 also contains the `routine thread entry` function, shown in the code below:
...
Building block 4 also contains the `print_stats` application timer function, shown in the code below:
