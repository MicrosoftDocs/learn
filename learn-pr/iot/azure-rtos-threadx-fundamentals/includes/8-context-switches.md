...
:::image type="content" source="../media/thread-context-example-sm.png" alt-text="Figure showing a thread context example.":::
...
When a thread's context is restored, then the thread resumes execution at the point where it was stopped. The kernel performs the context switch operation, and the actual code required to perform context switches is necessarily processor-specific.
