...
Codespaces is the preferred environment because you won't need to install the toolchain on your PC. Here's how you get started with Codespaces:
...
1. The VS Code web opens and you can see the projects in the Explorer view under `courses/netx`. We'll give you additional instructions in the module where you'll build and run your first NetX project.
   ...
   ![Screenshot of the Codespace window.](../media/codespace.png)
