...
In the **Params** tab, set the **api-version** to *2023-10-31*, the **id** value to *sub_farmcluster_2*, and the **relationshipId** value to *57becd45-1391-45e8-b127-ff3fdc5d0175*. This value was the ID value given for this relationship when the graph was imported, and together with the source twin ID it identifies this specific relationship in the graph.
