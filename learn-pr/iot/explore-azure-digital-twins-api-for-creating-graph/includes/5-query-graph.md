In this unit, you'll use the [Query API](/rest/api/digital-twins/dataplane/query) to gather more information about the state of the sample graph that you've worked on in previous units.
