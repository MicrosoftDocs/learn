...
:::image type="content" alt-text="Diagram that lists ThreadX services and components in a table." source="../media/services-components.png" border="false" loc-scope="Azure":::
...
:::image type="content" alt-text="Diagram that lists the ThreadX service call data types and their associated meanings in a table." source="../media/primitive-data-types.png" border="false" loc-scope="Azure":::
...
:::image type="content" alt-text="Diagram that lists the ThreadX system data types and their associated meanings in a table." source="../media/system-data-types.png" border="false" loc-scope="Azure":::
