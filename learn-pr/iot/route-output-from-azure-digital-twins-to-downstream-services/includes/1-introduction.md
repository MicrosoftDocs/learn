...
There are many services to which you might ultimately want to direct your data, like [Azure Storage](/azure/storage/common/storage-introduction), [Azure Maps](/azure/azure-maps/about-azure-maps), and [Azure Time Series Insights](/azure/time-series-insights/time-series-insights-update-overview). To send your data to services like these, you first need to attach the destination service to an endpoint.

## How do event routes work?

You attach endpoints to Azure Digital Twins by using management APIs or the Azure portal. For more information on how to attach an endpoint to Azure Digital Twins, see the [guide for managing endpoints and routes](/azure/digital-twins/how-to-manage-routes-apis-cli).

- Event routes use [Azure Event Hubs](/azure/event-hubs/event-hubs-about), [Azure Event Grid](/azure/event-grid/overview), or [Azure Service Bus](/azure/service-bus-messaging/service-bus-messaging-overview) to drive your data flows.
...
- [Time Series Insights documentation](/azure/time-series-insights/time-series-insights-overview)
- [Learn module: Explore and analyze time-stamped data with Time Series Insights](/learn/modules/explore-analyze-time-series-insights/)
...
For more information about the notification types in this table, see [the Azure Digital Twins event data article](/azure/digital-twins/how-to-interpret-event-data).
...
- Store Azure Digital Twins data in [Azure Data Lake](/azure/storage/blobs/data-lake-storage-introduction).
- Analyze Azure Digital Twins data with [Azure Synapse Analytics](/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is) or other Microsoft data analytics tools.
...
- (Recommended.) Introductory knowledge of Azure IoT. You can learn more by completing the [Introduction to Azure IoT](../../../paths/introduction-to-azure-iot/index.yml) learning path.
- A basic understanding of the Azure CLI. We recommend that you complete the [Control Azure services with the CLI](/learn/modules/control-azure-services-with-cli/) module. 
...
- PowerShell. 
  ...
  - On macOS, you need to install [PowerShell for Mac](/powershell/scripting/install/installing-powershell-core-on-macos?view=powershell-6).
...
- (Recommended.) Some experience working with Time Series Insights. You can learn more by completing the [Explore and analyze time-stamped data with Time Series Insights](/learn/modules/explore-analyze-time-series-insights/) module.
