...
1. Youwon'tice that the car route in purple, and the truck route, in blue, are nearly identical, but diverge by 55.3 km. So where are the extra N km? 

1. Start at Seattle, and youwon'tice straightaway a divergence in routes, our hazardous materials are not allowed to cross the I-90 bridge. Follow the route along, zooming out a bit on the long cross-country sections, and try to locate the three areas where the routes diverge.
