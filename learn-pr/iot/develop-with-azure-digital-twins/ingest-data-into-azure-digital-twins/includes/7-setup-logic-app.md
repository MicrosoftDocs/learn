...
In this unit a custom Logic App connector will be created and used within a Logic App. The Logic App will periodically update the LOGICAPP property of the model / Digital Twin.
...
1. Navigate to the [Logic Apps Custom Connector](https://portal.azure.com/#blade/HubsExtension/BrowseResourceBlade/resourceType/Microsoft.Web%2FcustomApis) page in the Azure portal (you can use this link or search for it in the portal search bar). Hit + Add.
 ![Add new connector](..\media\logic-apps-custom-connector.png)
...
![Create new connector](..\media\create-logic-apps-custom-connector.png)
1. This will take you to the Review + create tab, where you can hit Create at the bottom to create your resource.
![Review new connector](..\media\review-logic-apps-custom-connector.png)
...
1. Click on **Security**
![Configure Security](..\media\configure-next.png)
...
1. Do this now by hitting Update connector across the top of the pane to confirm your connector settings.
    ![Update connector](..\media\update-connector.png)
...
1. Run the following command to update the reply URL of the Azure AD application created in the first unit.
...
1. In the Logic Apps Designer, under Start with a common trigger, select **Recurrence**.
    ![Configure connector](..\media\logic-apps-designer-recurrence.png)
