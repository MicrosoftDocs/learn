...
These objectives are the ultimate goals for digital twins. To take it one step at a time, in this module the goals are to explain by example the creation and purpose of digital models, and their representation and visualization in a connected graph. For this scenario, you're going to use the production line in a chocolate factory.
