...
In this final exercise, you'll create custom queries for your digital twins graph. Before creating the custom queries, you'll enter a range of property values into the digital twins. Entering these values gives you a bit more data to query.
...
1. Select one or more properties and enter values using the keyboard.
