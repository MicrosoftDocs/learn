Suppose you work at a chocolate manufacturing factory as a technical specialist to support the factory line operators. You're commisioned to launch a new, near real-time dashboard to monitor the running operations for the ***roasting***, ***grinding*** and ***molding*** processes, which will enable line operators to answer questions such as:
