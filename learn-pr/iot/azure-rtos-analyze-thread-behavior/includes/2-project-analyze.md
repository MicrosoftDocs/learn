...
>
> We will also introduce the concept of an application timer and the `thread_performance_info_get` service so that we can display summary statistics at periodic intervals.
