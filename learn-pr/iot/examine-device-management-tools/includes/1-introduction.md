Azure IoT device management tools provide interactive user interfaces that can be used to perform IoT device management tasks such as starting or stopping a device, reading or writing device state information, and firmware updates.
