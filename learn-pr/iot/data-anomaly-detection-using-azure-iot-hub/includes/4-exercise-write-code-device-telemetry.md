...
1. To verify that your IoT Hub is receiving the telemetry, open the **Overview** page for the hub. Scroll down to the bottom of the page. Change the time range to **1 Hour**. The **Device to cloud messages** plot should show some activity.
