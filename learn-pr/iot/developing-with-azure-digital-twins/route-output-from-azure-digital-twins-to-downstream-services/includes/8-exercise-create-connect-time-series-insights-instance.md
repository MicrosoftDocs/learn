...
1. Select **Next: Event Source** and select your Event Hubs information from above. You will also need to create a new Event Hubs consumer group.
    ...
    [![Screenshot showing the first steps in creating time series insights](../media/adt-create-time-series-insights-2.png)](../media/adt-create-time-series-insights-2.png#lightbox)
