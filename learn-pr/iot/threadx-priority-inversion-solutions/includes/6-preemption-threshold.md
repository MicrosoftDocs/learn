...
The next image contains an illustration of how preemption-threshold  works. Following is the sequence of numbered events that demonstrates how preemption threshold can prevent priority inversion:
