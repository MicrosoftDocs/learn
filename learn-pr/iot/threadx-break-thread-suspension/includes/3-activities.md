...
:::image type="content" alt-text="Diagram that illustrates how the monitor thread interacts with urgent and routine threads." source="../media/monitor-thread.svg" loc-scope="Azure":::
...
:::image type="content" alt-text="Diagram that illustrates how the monitor thread aborts the suspension of an urgent thread." source="../media/monitor-urgent-thread.svg" loc-scope="Azure":::
