...
To perform Log Analytics, navigate to the Azure portal and open your Azure IoT hub, then select **Logs** from the menu **Monitoring** section. These Log Analytics queries are scoped, by default, to the logs and metrics collected in Azure Monitor Logs for your Azure IoT hub.
