...
Review [building block 1](/training/modules/threadx-event-notification/6-building-blocks#building-block-1) and observe that you'll need to add several items to this building block, including defining another thread, counter, and prototype.

Review [building block 3 part 2](/training/modules/threadx-event-notification/6-building-blocks#building-block-3-part-2) to create an entry function for the second consumer.
