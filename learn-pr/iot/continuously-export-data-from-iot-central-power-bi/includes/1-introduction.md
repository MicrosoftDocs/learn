...
1. Right-click [Azure IoT Central](https://apps.azureiotcentral.com/?azure-portal=true), and select **Open link in new window**. It's a good idea to bookmark this URL, because it's the home for all your Azure IoT Central apps.
