...
Now we have a better understanding of what Event Grid is and how IoT Hub and Event Grid can be integrated, the next unit will walkthough connect the dots between the IoT Hub, Event Grid and the email-sending Logic App.
