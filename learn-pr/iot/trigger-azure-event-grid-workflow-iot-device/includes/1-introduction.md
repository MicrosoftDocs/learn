...
* Create new devices triggering a Logic App, which sends an email to an operator when a new device is added to the solution
...
Tracking details about thermostats installation is key to ensuring security and quality for your application. Each time a new thermostat is installed, you want your records to be updated, as well as the right people to be notified.
