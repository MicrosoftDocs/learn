...
Completing this data flow setup has enabled you as the sample scenario developer to have a fully-connected, digital representation of your smart building. The properties of the digital representation are synchronized with the state of your real building, enabling you to answer questions about your environment quickly and efficiently through queries. These queries can also be used to enable alerts and build dashboards that building managers can use to monitor temperatures across the building at a glance.

[!INCLUDE [Instructions to clean up Azure Digital Twins resources](../../includes/clean-up-azure-digital-twins.md)]

You might also want to delete the sample project you downloaded to your machine, as well as the following installations, if you downloaded them specifically for this module:
* Visual Studio
* .NET
