...
Although we are only printing out each rock that we see in a file at this stage, this will set us up perfectly to call a function. This function will look at each rock and add to the corresponding variable if it sees a rock of the correct type.
