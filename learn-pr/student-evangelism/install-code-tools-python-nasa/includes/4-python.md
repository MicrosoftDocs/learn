[Python](https://www.python.org/?azure-portal=true) is the programming language you'll be using throughout this learning path. Although it may seem that you're learning about only one programming language, the concepts learned here can be applied to many others.
