...
Microsoft Azure gives you the opportunity to run Visual Studio Code in your browser using [Visual Studio Codespaces](https://visualstudio.microsoft.com/services/visual-studio-codespaces/?azure-portal=true). By using a browser you can begin your Python coding journey without having to download any software.
