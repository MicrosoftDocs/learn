...
1. Open [Visual Studio Codespace.](https://online.visualstudio.com/environments) in a new browser tab; and if prompted, sign in using the Microsoft account associated with your Azure subscription.
