...
**Manage devices on the edge:** IoT Edge provides a cloud interface and a runtime module, which enables you to manage remotely and deploy workloads to edge devices through the IoT Hub.
...
**Ensure privacy for IoT deployments:** IoT Edge can protect personally identifiable information. Personally identifiable information can be cleansed before it is sent to the cloud, in that way providing better privacy protection. By storing data on-premises, you can comply better with security, confidentiality, and privacy regulations.  
