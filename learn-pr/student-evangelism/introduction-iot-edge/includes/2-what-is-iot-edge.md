...
**Manage edge devices:** IoT Edge provides a cloud interface and a runtime module, which enables you to remotely manage and deploy workloads to edge devices through the IoT Hub.
