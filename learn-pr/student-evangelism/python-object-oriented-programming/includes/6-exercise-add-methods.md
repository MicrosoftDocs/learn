...
1. To demonstrate, return to the `Person` class and add the following method to it, ensuring indentation is correct:
...
How do the outputs from the three `print()` statements differ, or do they differ at all? What does this tell you about how Python's `str()` function is implemented inside of Python?
