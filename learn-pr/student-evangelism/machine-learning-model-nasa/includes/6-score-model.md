...
As with an exam, learning can be measured with a score. There's a one-line function you can call to see how correct the model was at predicting whether a launch would happen.
