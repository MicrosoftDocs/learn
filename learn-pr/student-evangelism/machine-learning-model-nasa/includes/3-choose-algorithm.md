...
:::image type="content" source="../media/algorithm-cheat-sheet-inline.png" alt-text="Algorithm Cheatsheet." lightbox="../media/algorithm-cheat-sheet-expanded.png" loc-scope="azure":::
