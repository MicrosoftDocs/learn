...
Traditionally, enterprise applications are network agnostic, i.e., they do not consider the unique capabilities of the underlying network. For example, the network may be fixed or wi-fi, but the application itself functions seamlessly over a variety of network types. 
