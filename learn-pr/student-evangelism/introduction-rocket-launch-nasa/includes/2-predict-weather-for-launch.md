...
NASA partners closely with [NOAA - the National Oceanic and Atmospheric Administration](https://www.noaa.gov/?azure-portal=true) - to predict and analyze weather data. Luckily, NOAA also shares data with the public, so you can start to analyze similar patterns and make similar predictions using their data too.
