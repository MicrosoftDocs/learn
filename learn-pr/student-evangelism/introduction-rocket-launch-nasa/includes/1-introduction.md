Specifically for launches, NASA collects data from a lot of different sources to help determine if the conditions are safe for a launch. Whether crewed or uncrewed, it's important that the weather conditions are such that the trajectory and speed of the rocket are not disrupted as it attempts to enter and pass through the atmosphere.
