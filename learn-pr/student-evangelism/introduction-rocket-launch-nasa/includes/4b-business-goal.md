Step 1 in the data science lifecycle is to set a clear goal. In the garden example, the goal is to produce as much lettuce as quickly as possible. However, growing conditions aren't absolute. If your baseline production is 1 pound of lettuce in 14 days, you need a way to speed up production. You have found that if you play classical music at 50 decibels for 30 minutes every 3 hours, you get the same 1 pound of lettuce in 13.5 days. But such a complex solution probably is not worth the hassle.
