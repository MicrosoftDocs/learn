Congratulations! In this module, you learned how to fix common git mistakes.
...
At this point, you know enough about Git to use to fix common mistakes in a project. Collaboration with other developers is where version control shines. Check out the other modules in this learning path for more about using Git with others!
