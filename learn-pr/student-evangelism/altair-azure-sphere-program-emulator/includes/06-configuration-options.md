...
The original Altair 8800 was programmed directly via the front panel. It was a painstaking, error-prone process to load and execute a program. But you too can become a pioneer and learn how to load Intel 8080 instructions directly into memory and execute the program.
...
1. The virtual front panel, the advantage is that no additional hardware is required and works with either the Avnet or Seeed Studio Azure Sphere developer kits.
...
3. The Altair front panel is the most authentic experience, you will need to build the panel, but it operates just like the original Altair. You can find the hardware design in the [MT3620 Azure Sphere Based Altair 8800 Hardware](https://github.com/AzureSphereCloudEnabledAltair8800/AzureSphereAltair8800.Hardware?azure-portal=true)) repo.
