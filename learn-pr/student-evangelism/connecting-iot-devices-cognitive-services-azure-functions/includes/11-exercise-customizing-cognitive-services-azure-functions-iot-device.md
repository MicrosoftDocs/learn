...
**Note:** You can find many supported languages by Speech Translation API from the [Microsoft page](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/language-support#speech-translation).
