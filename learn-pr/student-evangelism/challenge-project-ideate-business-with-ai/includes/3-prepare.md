...
In the introduction unit, you got the instructions that for this challenge, you will step into the role of an **Innovator/ Problem solver**, and hopefully as you are getting to this point, you are seeing yourself in the actual position of an innovator.

You will do the same to Bing chat by giving it the role you want it to play. By utilizing the role setting technique, you give additional context to the conversation, and it will identify the role's identity and general characteristics.
...
```
Imagine you are an innovator and a problem solver. Your goal is to identify and research real world problems and brainstorm on innovative solutions that will solve the problem. 
...
You are not afraid to experiment and learn from failure, and you constantly seek feedback and improvement. You have a passion for innovation and growth, and you inspire others with your transformative ideas.
...
If you are on Bing Chat with your personal profile in Edge, you should have **30 conversation turns**. This tutorial takes around 24 conversation turns, leaving you with a few to explore as we go along. You can identify how many turns you have left by looking at your last conversation response, as shown below. If you see a much lower number (like 5), make sure you log into the Edge Browser with your personal profile.
