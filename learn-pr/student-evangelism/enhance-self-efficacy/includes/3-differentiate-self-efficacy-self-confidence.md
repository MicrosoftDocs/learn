...
As a confident person, you could have low self-efficacy in certain tasks such as debugging code, creating documentation, or interacting with team members on a virtual call. You could also have varying degrees of self-efficacy with the same task. For example, when you’re preparing for the coding competition, you have several meetings to discuss and fine-tune your code. You might have high self-efficacy when you’re sharing your code and explaining its logic to your teammates. However, if you were asked to present your code to a supervisor, you’d become anxious and question your abilities. You’d fear that your supervisor, who’s much more experienced, might find many flaws in your and code and stop respecting you.

> [!IMPORTANT]
> Your opinion of yourself and your abilities can have a profound impact on your progress and success.

:::image type="content" source="../media/3-mirror.png" alt-text="A person thinking positively and planning to develop their skills." border="false":::

## Self-efficacy and being a leader

Many people struggle to even think of themselves as leaders because they might still be learning so much themselves. As a leader or manager, you’ll be challenged to learn and grow as you support others. The skills you’ll learn will help you during future interviews and roles. Being confident in your ability to guide others in their computer programming is a different skillset than learning programming yourself.

When you work on improving your self-efficacy, you can be a better leader. You can improve your self-efficacy by gaining practice and feedback on your progress. You might still be developing your self-efficacy in a particular programming area. Use your own learnings to engage with your learners, students, or peers, so that you can overcome obstacles together. Work on your own self-efficacy and that of the group, and remember that you’re all learning.

> [!TIP]
> Remember that you might not always have all of the answers. With honesty, bravery, and a growth mindset you can help someone else shift from thinking “I don’t know if I can succeed in computer science” to “I can do this!”
...
:::image type="content" source="../media/3-challenges.png" alt-text="A person in computer science working through challenges such as deadlines, frustration, panic and anxiety." border="false":::

When you have low self-efficacy in computer science, pause and remember that great programmers are made, not born. They work their way through many trials, learn from their mistakes, and persevere. Exploring and learning how to mitigate discomfort is important for learning computer science, succeeding in a career choice, navigating life challenges, and reaching your full potential.
