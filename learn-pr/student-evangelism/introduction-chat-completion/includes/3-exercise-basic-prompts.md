In this exercise, you use basic prompts to interact with an Azure OpenAI deployment in the chat playground.

Prompts are inputs or queries that you can write to get a specific response from a large language model (LLM).
...
1. Select the paper plane icon to send your message. You should see an output like this text, which is shortened for brevity:
...
1. Select the paper plane icon to send your message. You should see an output similar to this text, which is shortened for brevity:
...
## Vary the response predictability using the temperature

In this exercise, you use the temperature parameter to vary the output of the model.

1. Select **Clear chat** and copy the following text and paste it into the **Chat session** text box.
...
## Simulate short term memory using the chat history
