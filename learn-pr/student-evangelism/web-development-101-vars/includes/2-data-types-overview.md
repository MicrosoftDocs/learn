In order to properly understand JavaScript (the language that provides interactivity on the web), we need to first understand the language's various data types and variables and how to create them. Most importantly, you need to understand when and where and how to use them.  
