...
- **Build applications**: You can use the LLM to generate code like a Web API based on prompts.
- **Maintain applications**: If you work on an existing codebase, an LLM can help you update or maintain the existing code.
- **Improve applications**: You can use an LLM to improve code for a specific metric, like increased security or logging.
