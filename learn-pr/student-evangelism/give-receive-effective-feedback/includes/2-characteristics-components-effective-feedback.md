...
To understand the importance of feedback and how it can help empower your recipient, review the following video (3:35):
<br>
...
- Can you think of a time when you were affected negatively by feedback?
...
One of the best ways to improve learning is to give effective feedback. Effective feedback provides constructive criticism to people that they can apply toward making concrete, measurable progress. If they can receive it effectively, people can move more easily through the self-regulated feedback cycle. 

In a group environment, such as that in our scenario, feedback also allows peers to build and maintain a team conversation over time. In the field of computer science&mdash;and programming in particular&mdash;effective feedback delivered in a timely, constructive manner can facilitate greater skill development in the entire team. This in turn can result in measurable performance improvement.

On the other hand, negative feedback can adversely affect people’s self-confidence and, occasionally, make them feel like they have failed. It might even discourage otherwise-talented people from taking further steps to address their knowledge gaps. Such feedback can provide new perspectives, but many people find it difficult to accept critical feedback, even when it’s meant to help them grow or improve.

:::image type="content" source="../media/2-negative-feedback.png" alt-text="Cartoon-style drawing of a feedback recipient being presented a box covered in thorns, which represents negative, discouraging feedback." border="false":::
...
Feedback can come in written or oral form, or a combination of both. You can also provide feedback in a group setting or one-on-one. As you're determining the mode of communicating your feedback to someone, consider the following questions:

- How positive or negative is the feedback? Will the recipient be put on the spot and have to accept or respond to certain feedback in real time, or might the person need time to process the feedback in private?

- How will the written feedback be received? Written feedback has few signals about tone and is received privately. Will it have an impact on inclusiveness? Will your intent be known?
