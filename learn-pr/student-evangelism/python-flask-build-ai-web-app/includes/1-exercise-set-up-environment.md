...
>
> 1. Find the directory with your python.exe file
> 1. Copy the path to the directory, which could look something like: _"C:\Users\<USER>\AppData\Local\Programs\Python ..."_
> 1. Open the Start menu and  for **Edit the system environment variables**, which opens up a System Properties window.
> 1. Under the Advanced tab, click on the **Environment Variables** button.
> 1. Under the user variables, double click on the variable **path**, then select **New** and paste in the copied path
