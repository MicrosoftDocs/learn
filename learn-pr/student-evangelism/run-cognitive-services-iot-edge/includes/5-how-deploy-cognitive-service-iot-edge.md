...
- Configure the Azure Cognitive Services API to the Language Detection containerized module
...
1. Configure the Cognitive Services API to the Language Detection module
