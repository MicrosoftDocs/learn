Cognitive services can be used in many scenarios on edge devices. For example, the ability to detect language from text on an edge device can help in undertaking follow-on action such as translation.  Cognitive services on IoT Edge enables you to implement a language detection solution in areas affected by natural disaster. 
...
- Implement a cognitive service for performing language detection on an IoT Edge device
