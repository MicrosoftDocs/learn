...
Secondly, you will create a Cognitive Service resource that will consume the Text Analytics API.

Thirdly you will deploy a module to the edge device. To do that, you will select the Language Detection module from the Azure Marketplace and set your target IoT Edge device to receive the module. Then you will configure Cognitive Service endpoint and API key for billing information.
Finally, you will specify the route for how messages are passed between modules and to IoT Hub.
