Consider the scenario of detecting the void spaces on the shelves of a retail store. Your goal is to run machine learning models on your cameras, train models for your objects, and deploy at the edge devices so that voids on shelves can be detected.
