...
The increase in production has some additional considerations. You need to rapidly deploy the solution and you also need to ensure that the solution will scale up or down as needed. Your team is well versed in development but not in operations including managing and provisioning infrastructure. Hence, you want to avoid scoping the architecture in advance.

![Diagram showing the scenario architecture using Azure Functions for IoT.](../media/scenario.jpg)
