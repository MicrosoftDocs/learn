...
This module is a part of a multimodal approach to learning. So you can also follow along with a video tutorial in the [Learn with Dr. G video series](https://aka.ms/LearnWithDrG).
...
- Strategies for cleaning and manipulating your data.
