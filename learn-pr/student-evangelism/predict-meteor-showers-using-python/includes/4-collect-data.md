...
[Comet Halley](https://solarsystem.nasa.gov/asteroids-comets-and-meteors/comets/1p-halley/in-depth/?azure-portal=true) was first discovered in 1531. However, not until 1705 was it discovered that the comet sighted in 1531, 1607, and 1682 was the same comet. 
...
- [constellations.csv]() - This file contains data for the four constellations that are radiants for the five meteor showers. Data includes the latitudes for which they are visible and the month for the best viewing. (Data acquired from [Wikipedia](https://en.wikipedia.org/wiki/IAU_designated_constellations?azure-portal=true).)
...
This module focuses on these four data files. But you can also gather other types of data that might affect the likelihood of viewing a meteor shower:
- Weather
