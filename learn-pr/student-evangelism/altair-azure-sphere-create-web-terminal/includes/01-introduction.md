...
When your Altair emulator connects to IoT Central you will be able to set several properties include startup CPU State, LED brightness, as well as report memory usage, and environment data.

> [!div class="mx-imgBorder"]
> ![The illustration shows the IoT Central about view of the Altair emulator.](../media/iot-central-view-properties.png)
