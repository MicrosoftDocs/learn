...
**arm_nn_examplescifar10_weights.h:** Quantized weights and bias. It is available in [project folder](https://github.com/MicrosoftDocs/mslearn-oxford-image-classification-azure-sphere/tree/master/CMSISNN-Cifar10).

**arm_nn_examplescifar10_parameter.h:** Quantized bias, out shift values. It is available in [project folder](https://github.com/MicrosoftDocs/mslearn-oxford-image-classification-azure-sphere/tree/master/CMSISNN-Cifar10).

The steps you will follow for this unit:

1. You will clone a [Microsoft sample image classification repository](https://github.com/MicrosoftDocs/mslearn-oxford-image-classification-azure-sphere) to take quantized weights, parameter and CMSIS-NN library.
2. Modify and update the source code of your image classification application that you newly created.

In the end of the unit, your model will be configured with required settings so that you will be able to deploy the application to the microcontroller for inferencing.