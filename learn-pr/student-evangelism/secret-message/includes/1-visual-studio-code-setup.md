...
The first thing we'll do is make sure our command center (also called a _code editor_) works. We'll give a command to Python and tell it to print a message. This code is also a clue to revealing the meaning of the secret message . . .
