...
The way a neural network works is very similar to how our brains work. The human brain consists of neurons or nerve cells that transmit and process information that's received from our senses. Many of these nerve cells are arranged together to form a network of nerves in our brain. The nerves pass electrical impulses from one neuron to next neuron.
...
Neural networks have millions of neurons and nerves. To build a functional neural network, we wire all of them together in two steps:
