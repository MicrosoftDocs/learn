The following list outlines the steps that you'll follow in the next exercise to deploy your own private (and free) MQTT broker:
...
1. Test the Mosquitto broker.
1. Update the Altair emulator configuration.
