...
We have covered a lot of ground in this module and here are some of the topics you did in the module.
...
Linear regression is a simple, yet surprisingly effective and extremely popular, method for predictions. And with the knowledge gained in this module you can now make linear (or even non linear with the right features) prediction models for any dataset of choice. 
