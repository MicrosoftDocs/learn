...
Open Visual Studio Code and, on the **Welcome** tab, select **Open Folder**. Another way to do this is to select **File** > **Open**, and then go to the folder you created.
...
:::image type="content" source="../media/jupyter-file.png" alt-text="Screenshot that shows a blank Jupyter Notebook file open in Visual Studio Code and Python 3 idle.":::
...
Visual Studio Code should show you this data if you select the CSV file:

:::image type="content" source="../media/csv-visual-studio-code.png" alt-text="Screenshot that shows viewing the CSV file in Visual Studio Code.":::

## Check the local setup with Python libraries

Now that you have your local environment and data ready to go, you should check to make sure everything is set up properly. 
...
If that completes successfully, you should see `[1]` next to the cell and no output: 
...
If that is successful, you should see `[2]` next to the cell (if you're continuing on with the file created in the [preceding *Space Jam: A New Legacy*-inspired module](/learn/modules/predict-basketball-player-efficiency-ratings?azure-portal=true), you might see number other than 2, and no output.
...
Finally, make sure that you've installed the [Visual Studio Code CodeTour extension](https://aka.ms/codetour-mslearn). If you have, you should see it at the bottom of Visual Studio Code Explorer. This will come in handy later when you create the web app because there are a lot of ways to build a basic JavaScript app. We will guide you through how we built ours!
