...
Furthermore, we can start to experiment with how data can help inform a more novice coach with a not-so-typical team. In *Space Jam: A New Legacy*, we see a team of Tune Squad players that each have unique skills they bring to the court that even a professional basketball coach might probably not be able to predict how well each player might do!
