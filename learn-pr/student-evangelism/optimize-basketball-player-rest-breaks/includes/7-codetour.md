...
When you've finished a CodeTour, the next one will be available for you to start. Each CodeTour guides you through creating a portion of the functionality for this app without giving you the exact code. If you get stuck, remember that you can always take a look at this Learn module or at the `complete-code` branch in the repository you cloned.
