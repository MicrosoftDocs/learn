...
1. Triage/symptom checker, powered by built-in medical protocols: The end user describes a symptom to the health bot instance and the bot helps the user to understand it and suggests how to react; for example, "I have a headache."
    ...
    :::image type="content" source="../media/2-A.png" alt-text="Triage/Symptom Checker Demo":::
...
:::image type="content" source="../media/2-B.png" alt-text="Information about particular diseases":::
...
:::image type="content" source="../media/2-C.png" alt-text="Information about Aspirin":::
...
:::image type="content" source="../media/2-D.png" alt-text="Help command":::
...
:::image type="content" source="../media/2-E.png" alt-text="Cancel command":::

### Start over

Users can use the “start over” command to restart the current scenario.

:::image type="content" source="../media/2-F.png" alt-text="Start over command":::
...
:::image type="content" source="../media/2-G.png" alt-text="What do you know command":::

### Forget me

Both the user variables and conversation history can be deleted by the end user by using the “forget me” command.

:::image type="content" source="../media/2-H.png" alt-text="Forget me command":::
...
:::image type="content" source="../media/2-I.png" alt-text="Log command":::
...
:::image type="content" source="../media/2-J.png" alt-text="Feedback command":::
...
:::image type="content" source="../media/2-K.png" alt-text="Terms command":::
