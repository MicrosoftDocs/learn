To configure the built-in scenarios of a bot, open the Configuration menu.  
 ...
 :::image type="content" source="../media/3-configuration-menu.png" alt-text="Configuration Menu":::
...
:::image type="content" source="../media/3-infermedica-settings.png" alt-text="Infermedica Settings":::
...
:::image type="content" source="../media/3-medical-information.png" alt-text="Medical Information":::
...
:::image type="content" source="../media/3-privacy-tab.png" alt-text="Privacy Tab":::
...
:::image type="content" source="../media/3-security-tab.png" alt-text="Security Tab":::
...
:::image type="content" source="../media/3-agree-terms.png" alt-text="Agree to terms":::
...
:::image type="content" source="../media/3-interactions.png" alt-text="Interactions":::
...
:::image type="content" source="../media/3-automatic-welcome.png" alt-text="Automatic Welcome":::
...
:::image type="content" source="../media/3-navigation.png" alt-text="Navigation":::
...
:::image type="content" source="../media/3-help-section.png" alt-text="Help section":::
...
:::image type="content" source="../media/3-correction.png" alt-text="Spelling correction":::
...
:::image type="content" source="../media/3-human-handoff.png" alt-text="Human Handoff":::
