...
> [!NOTE]
> If you already followed the previous module in this learning path where you [decoded a secret message](../../wonder-woman-secret-message/?azure-portal=true), you can use the same folder as before.
