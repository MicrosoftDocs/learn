To make learning Blazor a hopefully fun activity, we will teach you to build a game of "Connect Four". In this unit, we will cover concepts like how this game works and what constructs of Blazor you need to know about to produce a game.

## Connect Four

The idea with the game "Connect Four" is for you to lay out four game pieces in a row horizontally, vertically or diagonally before your opponent does. Things you need to consider when implementing this is to keep track of your current state of game pieces, your opponents and to check for a winner. It's useful when programming to think of game loop, a set of actions you need to repeat until you can declare a winner. Something like so:
...
An important guidance when it comes to state in game development is to keep state separate from UI as it make modifications easier and your code easier to read among some benefits.
...
In this case, there's a `State` class containing information on who plays the game and how many game round have been played, if the game is still active and so on.
...
Exactly what goes in here is up to you, but this should give you an idea.

## Handling player interactions using events

When you or your opponents make a move, you need to capture this interaction. You encode this as events that your game/app should respond to.

For example, you might click a button or perform a drag n drop movement to move a game piece.
