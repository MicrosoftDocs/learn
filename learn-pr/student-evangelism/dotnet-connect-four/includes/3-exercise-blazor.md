...
1. Copy the following content into the new *Board.razor.css* file:
    ...
    > [!TIP]
    > For convenience, you can also find this content in the [Board.razor.css](https://raw.githubusercontent.com/dotnet/intro-to-dotnet-web-dev/main/5-blazor/0-start/Shared/Board.razor.css) file.
