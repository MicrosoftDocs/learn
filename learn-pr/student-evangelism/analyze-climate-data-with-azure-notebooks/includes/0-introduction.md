Azure Notebooks is a cloud-based platform for building and running [Jupyter](https://jupyter.org/) notebooks. Jupyter is an environment based on [IPython](https://ipython.org/) that facilitates interactive programming and data analysis using a variety of programming languages, including Python. Jupyter notebooks enjoy widespread use in research and academia for mathematical modeling, machine learning, statistical analysis, and for teaching and learning how to code.
...
> [!Note]
> If you receive a `FutureWarning` error message while working on the exercises in this module, you can ignore the message.
> The warning is regarding an outdated library, which is a known issue that's being addressed.
> 
