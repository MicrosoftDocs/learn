...
![The illustration shows the scenario image.](../media/scenario-diagram.png)
...
In this module, you'll run an Azure IoT Edge solution that uses Custom Vision and Speech Services and deploy the solution to the Edge device. The application consists of a number of modules that scan the items using a camera, classify the scanned items, and convert the identified items to speech. 
