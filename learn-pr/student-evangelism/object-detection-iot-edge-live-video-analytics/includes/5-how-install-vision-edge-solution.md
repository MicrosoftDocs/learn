[Vision on Edge solution](https://github.com/Azure-Samples/azure-intelligent-edge-patterns/tree/master/factory-ai-vision/EdgeSolution) is a web-based solution using Live Video Analytics on IoT Edge that interacting with edge modules. In this unit, you'll learn how to install Vision on Edge solution through Azure Cloud Shell. 
...
- [deploy-custom-vision-arm.json](https://github.com/Azure-Samples/azure-intelligent-edge-patterns/blob/master/factory-ai-vision/Installer/deploy-custom-vision-arm.json) is an **Azure Resource Management template** for deploying various resources in Azure required.
- [deployment.template.json](https://github.com/Azure-Samples/azure-intelligent-edge-patterns/blob/master/factory-ai-vision/Installer/deployment.lva.json) is a template the script uses to generate a **deployment manifest** which can be used for deploying Live Video Analytics on IoT Edge module (and others).
...
Upon the successful completion of the installer, you should see all of the required Azure resources in your subscription, and Vision on Edge solution is deployed on IoT Edge. Next, you will connect to the Vision on Edge solution.