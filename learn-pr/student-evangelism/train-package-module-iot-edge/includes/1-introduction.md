...
![An illustration showing the flow for deploying azure machine learning module to the Edge device](../media/train-package-module.png)
 ...
 In this module, you will develop a machine learning module and deploy it to a Linux device running Azure IoT Edge. Your solution will:
