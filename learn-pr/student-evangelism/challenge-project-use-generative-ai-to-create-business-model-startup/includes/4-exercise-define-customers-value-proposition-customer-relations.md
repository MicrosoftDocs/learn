...
```
Can you help me think about who our key customers will be with their respective demographics.
The customers could belong to any market type. Please summarize the main points of your response in short bullet points.
```
...
Please use bullet points to simply list out a short phrase of each value proposition.
```
