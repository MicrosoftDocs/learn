In this module, you are going to use [Custom Vision](https://azure.microsoft.com/en-us/products/ai-services/ai-custom-vision), part of the Azure Cognitive Services suite, to detect your favorite animal in an image. Before we jump into training AI, we need to set up our work environment. In this case, your work environment will be all in the browser on Azure.
