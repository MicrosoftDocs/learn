...
![Fei Fei and Bungee after a hard day's work building the rocket.](../media/fei-fei-bungee.png)

In this module, you will choose an animal, which could be your pet. You will train a custom vision AI to be able to identify your pet in an image. And you will do all of this without needing to know how to code!

Remember, while you can use technical skills to build almost anything, the ultimate goal should always be to help people. Designing technology to help people is something Microsoft is passionate about, *especially* when it applies to AI. We focus on [AI for Good](https://www.microsoft.com/en-us/ai/ai-for-good) and want to encourage you to start your AI journey by always thinking about how you can help improve our world.
