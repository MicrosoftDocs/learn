...
![An illustration showing the flow for IoT devices connecting to IoT Hub, and managing and controlling by IoT Hub.](../introduction-to-iot-hub/media/IotHub.png)
