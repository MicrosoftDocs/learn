...
In this module, you'll use Microsoft Azure and Azure Cognitive Services to build your automated system. Specifically, you'll use:

- Azure Blob Storage to store photos
- The Custom Vision service in Azure Cognitive Services to analyze photos to determine whether they include polar bears
