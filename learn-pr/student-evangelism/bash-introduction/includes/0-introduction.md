...
Let's learn the basics of Bash - the standard shell scripting language for Linux - starting with the syntax and with commonly used commands such as `ls` and `cat`.
