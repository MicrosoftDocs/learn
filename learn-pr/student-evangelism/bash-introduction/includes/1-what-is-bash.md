A vital tool you must learn to manage Linux machines is Bash. The name stands for "**B**ourne **A**gain **SH**ell."
...
Let's learn the basics of Bash, starting with the syntax and with commonly used commands such as `ls` and `cat`.
