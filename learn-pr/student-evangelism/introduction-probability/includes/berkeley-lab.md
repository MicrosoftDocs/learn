...
1. Wait for another minute or so while the environment is set up for you. In the background we're installing some components you'll need for the exercise. You'll see that a list of notebook (.ipynb) files will appear in the pane on the left.
