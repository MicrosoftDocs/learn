...
**Deployment:** Enables you to deploy new models to different kinds of platforms, including IoT Edge. You'll aim to understand and leverage the unique characteristics of the target platform.
...
- The entry script and any additional assets such as text, data, etc. that are required by the model(s) and entry script.
