...
| **Offload processing to Edge devices** | Do you plan to offload processing to edge devices?           |
| **Scale**                              | Do you have millions of IoT assets to manage?                |
| **Modelling physical spaces**          | Do you need to model a physical spaces using sensors?        |
