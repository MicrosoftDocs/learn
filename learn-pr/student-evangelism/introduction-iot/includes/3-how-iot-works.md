...
## Software as a Solution solutions
...
**Azure Sphere:** Azure Sphere is an end-to-end solution for securing Microcontroller Unit (MCU) powered devices. Azure Sphere comprises three parts: Azure Sphere Operating System, Azure Sphere Certified MCUs, and the Azure Sphere Security Service:
- Azure Sphere Operating System is a secure OS that creates a secured platform for IoT devices. 
- Azure Sphere Certified MCUs provide connectivity and dependable hardware root of trust.  
