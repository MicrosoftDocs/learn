...
Finally, you need to maintain the data about the consignment for insurance and audit purposes. By analyzing the data, you can anticipate future problems before they occur.  Customers can now be provided data about the fruit – for example, the carbon footprint.
