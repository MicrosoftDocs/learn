...
![A screenshot of the Polyglot Notebooks extension on Visual Studio Code's marketplace](../media/image6.png)
...
![A screenshot of the "Polyglot Notebook: Create new blank notebook" command in the command palette](../media/image7.png)
...
![A screenshot showing C# code written in a code cell](../media/image8.png)
...
![A screenshoot showing the +Code and +Markdown button, with the +Markdown selected](../media/image9.png)
