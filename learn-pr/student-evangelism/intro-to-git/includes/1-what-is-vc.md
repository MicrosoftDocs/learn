...
To understand Git, you have to understand the terminology. Here's a short list of terms that Git users frequently use. Don't be concerned about the details for now; all of these terms will become familiar as you work your way through the exercises in this module.
...
As you work with Git, you might wonder about the difference between the features it offers and the features offered on [GitHub](https://github.com?azure-portal=true).  
