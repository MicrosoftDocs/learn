...
To learn more about **GitHub**, see the [Introduction to GitHub](https://docs.microsoft.com/en-us/learn/modules/introduction-to-github?azure-portal=true) Microsoft Learn module or the [Getting started with GitHub](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github?azure-portal=true) help documentation. 
