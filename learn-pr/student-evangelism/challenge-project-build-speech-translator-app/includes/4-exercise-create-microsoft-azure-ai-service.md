...
- To validate if this work and if everything is working fine. In Power Apps, add `AzureBatchSpeech-to-text` to your data source and connect using the key and region from details from the Microsoft Azure portal.
