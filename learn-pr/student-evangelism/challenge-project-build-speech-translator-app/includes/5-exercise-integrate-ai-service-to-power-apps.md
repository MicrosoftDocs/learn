...
- The flow uses the created transcription with the transcription files to extract the text.
...
**Congratulations!** Your commitment paid off. You built a speech translator application using low-code Power Apps and successfully integrated Microsoft Azure AI Speech. You're a perfect definition of an AI-skillful low-code developer.
