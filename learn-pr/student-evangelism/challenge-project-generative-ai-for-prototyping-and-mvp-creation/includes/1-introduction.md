...
![Screenshot showing a Copilot with Bing conversation where the user asks "Can AI help with prototyping?" and the response is "Yes."](./media/prototype-help.png)
...
By the end of this module, you learn how to use Copilot with Bing to guide you on how to create prototypes/ mock-ups of your solution and on implementing the project.
...
You need Copilot with Bing to do this exercise. It involves text and image generation. If you don't have Copilot with Bing, you can use other tools, but you may need to change some steps. Here are some places where you can find these tools:

- Copilot Designer at [Copilot Designer](https://www.bing.com/images/create?WT.mc_id=academic-114050-bethanycheum)
- ChatGPT at [OpenAI](http://openai.com/)
- Dalle-2 at OpenAI - [OpenAI](http://openai.com/)

You can use other platforms if you would like. However, the directions are intended for Copilot with Bing therefore, you might have to adapt a few things specifically when it comes to image creation.
