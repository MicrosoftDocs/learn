In this unit, you'll learn about GPIO hardware interfaces and some of the terminology you will need.
...
- They are open source and contributions are welcome.
- They are built from the [Azure Sphere Samples](https://github.com/Azure/azure-sphere-samples) and aim to demonstrate best practices.
