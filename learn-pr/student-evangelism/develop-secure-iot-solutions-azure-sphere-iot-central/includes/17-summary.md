You run applications on the Azure Sphere to stream room environment data to the cloud to IoT Central. You monitored the data being sent from Azure IoT Central web portal. You were able to send commands from Azure IoT Central to the control the device.
