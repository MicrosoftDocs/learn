...
2. Review the pin mappings set up for the Azure Sphere Developer Learning Path.
...
2. Update the connection properties for the Azure IoT Central application.
...
## Step 9: Understand the Azure Sphere application
...
## Step 10: Deploy the application to Azure Sphere
...
1. Open the Visual Studio Code **Output** tab to view the output from **Log_Debug** statements in the code.
   ...
   > [!TIP]
   > You can open the output window by using the Visual Studio Code Ctrl+K Ctrl+H shortcut or clicking the **Output** tab.
