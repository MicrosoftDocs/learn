...
Providing and receiving effective feedback to others can help guide them towards enhancing their cognitive flexibility.

As a first step, review their goals with them and offer to give feedback on the goals they’ve just described. The feedback can include suggestions on:

- How they can reorient their goals.

- Review the problem from different perspectives.

- Rethink their strategy.

You can share what you noticed about the other person’s goals and provide specific suggestions for next steps. You could choose to ask a question of your own, such as those listed in the following table.
...
| Evaluate different perspectives. | What stood out about your experience? What did you find most useful or interesting? What would you have liked to be different? Is there anything you would have liked to approach differently? |
...
:::image type="content" source="../media/5-varied-input.png" alt-text="A person seeing various types of inputs to enhance their cognitive flexibility." border="false":::

Feedback is effective only when it’s specific, timely, and contains concrete guidelines or steps for improvement. By providing effective feedback to someone, also known as *wise* feedback, you can help reinforce their self-confidence and motivate them to persist in their efforts. When sharing your feedback with others, apply the following guidelines to enhance their cognitive flexibility:
...
- Provide them with tools, tips, and guidelines that they can effectively apply to overcome challenges.
...
- Maybe this program is not the right fit for you.
...
External feedback can provide new perspectives that you need to pivot and persist. However, critical feedback given without positive signals and additional guidance can undermine your confidence. Instead of encouraging you to persevere, it can have the opposite effect of making you drop out or give up.
...
:::image type="content" source="../media/5-sleeping-dragon.png" alt-text="A person using cognitive flexibility and effective feedback to create an alternative plan when faced with a challenge." border="false":::