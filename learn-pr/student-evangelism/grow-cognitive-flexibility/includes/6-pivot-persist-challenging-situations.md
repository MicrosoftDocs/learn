...
| Link | Make connections between various angles of the situation. | Is the current problem related to any other knowledge gaps? Are there any other skills that I can leverage to overcome this challenge? |
...
| Act | Formulate a new plan. | What will be my new approach? What can I do differently from before? |

### Pivot rather than panic in the face of difficulty

Each person has their own unique way of reacting to a problem. Some might get stuck when attempting to solve a problem. If you are helping a person who seems stuck, try to give them a few moments before nudging with them with a tip. Encourage them to ask for clarification on the problem given to them. You can ask them to articulate their thought process to help clarify where they’re stuck. Additionally, they can benefit greatly by collaborating with others and by brainstorming new ideas.

:::image type="content" source="../media/6-collaboration-product.png" alt-text="Team collaborating on a new product." border="false":::

### Common reactions to setbacks

How do you react when you’re faced with a setback or disruption? Explore the following different reactions to an unexpected setback, and then examine how open you are to stretching beyond your comfort zone:
...
Do any of the preceding reactions to an unexpected obstacle feel familiar to you? Which of these reactions indicate a higher level of cognitive flexibility in a person? Do you seek feedback from others? Do you have a strategy for unpacking the feedback?

## Scenarios and strategies

What kind of situations might you face where cognitive flexibility can be a useful tool? The following list illustrates some example scenarios that you or your participants might encounter in the tech industry:
...
Here are some strategies that you and your participants can use to enhance cognitive flexibility:

- Ask questions to clarify your doubts about the problem.

- Adapt your approach and be ready to change your approach when new information suggests you should do so.
...
- Seek other people’s opinions and feedback.

- Question your own long-standing assumptions and encourage others to question theirs.

- Objectively analyze situations—evaluate the pros, cons, and implications of different courses of action.
...
:::image type="content" source="../media/6-pause-pivot-persist.png" alt-text="A person demonstrating cognitive flexibility by pausing, pivoting, and persisting." border="false":::