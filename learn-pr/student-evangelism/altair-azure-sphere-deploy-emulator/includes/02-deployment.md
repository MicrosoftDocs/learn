In this unit, you will learn how to deploy the Altair on Azure Sphere high-level and real-time applications to your Azure Sphere.
...
In the following exercise, you will config and deploy the Altair emulator to your Azure Sphere.
