...
The challenge that Fei Fei runs into is one of weight: she hasn't taken into account an unexpected companion, Chin. Chin sneaks onto her rocket just before takeoff, and his extra weight completely throws off her calculations, making it impossible to reach the Moon. We saw this in real life too, during Apollo 13, when one of the five engines stopped two minutes early. While Fei Fei had extra weight, the Apollo 13 crew lost thrust. The result can be the same: not enough thrust-to-weight ratio to break through Earth's atmosphere. 
...
This module is part of a multi-modal approach to learning, which means that you can also follow along with a video tutorial on the [Learn with Dr G Learn TV video series](https://aka.ms/LearnWithDrG).
