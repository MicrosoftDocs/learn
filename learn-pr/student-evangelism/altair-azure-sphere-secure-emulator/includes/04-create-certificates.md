...
By default, the solution uses the public **test.mosquitto.org** MQTT broker. The Altair emulator communicates with the MQTT broker over TLS using the wolfSSL library.
