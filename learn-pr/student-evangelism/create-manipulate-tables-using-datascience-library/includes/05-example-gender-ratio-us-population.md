...
### Female to male gender ratio at each age
...
For any given age, we can get the Female to Male gender ratio by dividing
...
range. Here are the Females to Male ratios for people aged more than 75.
