...
:::image type="content" source="../media/features.png" alt-text="A diagram that shows how humans extract and identify features from what they see. First, a picture of motorcycle. Arrows move from the motorcycle into an extraction algorithm, which happens in the human brain. Next, arrows from the extraction algorithm produce a geometric table labeled as features. The table of features has nine boxes that show parts of the motorcycle." loc-scope="Azure":::
