...
A preparatory step is to import image data. We also need to get the libraries to help process the data on the computer tat we'll train. The computer transforms the images into matrixes of numbers so the images are in a format the computer can read.
