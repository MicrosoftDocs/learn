...
There are many other libraries that you can use to create an AI model. To learn about other common AI libraries and what they do, see [Top 8 Python libraries for machine learning and artificial intelligence][PythonLibs].


<!-- Links -->

[PythonLibs]: https://hackernoon.com/top-8-python-libraries-for-machine-learning-and-artificial-intelligence-y08id3031?azure-portal=true
