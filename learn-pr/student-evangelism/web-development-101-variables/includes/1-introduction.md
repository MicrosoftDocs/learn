...
An important fundamental concept is *variables*. Your source code can have anywhere from 10 lines to many thousands of lines and be spread out over hundreds of files. To better keep track of the flow of the program, you use variables. Variables are named references that help you keep track of important values in your program.
