...
1. To create the health bot app, search for and select **Developer Portal**.
   ...
   :::image type="content" source="../media/3-teams-developer-portal-search.png" alt-text="Screenshot that shows search results for Developer Portal." lightbox="../media/3-teams-developer-portal-search.png":::
...
1. The **Developer Portal** app opens. Select the **Apps** tab at the top of the page, and then select **New App**.
   ...
   :::image type="content" source="../media/3-teams-developer-portal-new-app.png" alt-text="Screenshot that shows the New app button.":::
...
1. Enter the following values under **Basic information**:
   ...
   :::image type="content" source="../media/3-teams-app-basic-information.png" alt-text="Screenshot that shows the developer information values.":::
...
1. Under **Advanced**, select **App content**. Select the **Loading indicator** and **Full-screen mode** checkboxes.
    ...
    :::image type="content" source="../media/3-teams-app-advanced.png" alt-text="Screenshot that shows the App content menu and Loading Indicator and Full-screen mode boxes selected.":::

1. Under **Configure**, select **App features**, and then select **Bot**.

   :::image type="content" source="../media/3-teams-app-features-bot.png" alt-text="Screenshot that shows the Bots selection in the left pane.":::
...
1. Under **Select the scopes in which people can use this command**, select **Personal** and **Team**, and then select **Save**.
   ...
   :::image type="content" source="../media/3-teams-app-existing-bot-setup.png" alt-text="Screenshot that shows the Existing bot setup values.":::
