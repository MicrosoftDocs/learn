...
2. Provide the necessary information, including your username, email address, and password.
   1. You may need to verify your email address to create your personal account.
...
1. Log in to GitHub, if you’re not logged in already.

1. Navigate to your dashboard and locate the "+" icon in the top-right corner and select it.  
...
1. Optionally, add a description to provide an overview of your project, its purpose, and its key features.
   1. Consider adjusting other repository settings based on your requirements, such as including a README file or adding a license.
...
1. Copy the repository's URL provided in the dropdown, you'll use it later to create a local copy of the repository on your machine.
...
1. Open a terminal or Git Bash on your local machine and navigate to the directory where you want to clone the repository.
