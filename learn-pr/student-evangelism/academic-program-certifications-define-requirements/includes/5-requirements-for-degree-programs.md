...
If you're developing a new program for your home institution, you likely will want to follow the general steps in which the program leader and teaching team:
...
*“Our MSc Cloud Computing program aims to provide students with an extensive learning experience that equips them with the cutting-edge skill sets required within the fast-growing cloud computing industry. Students will have the opportunity to gain in-demand skills for professional roles such as Cloud Developers, Solution Architects, DevOps, and Data specialists.*
