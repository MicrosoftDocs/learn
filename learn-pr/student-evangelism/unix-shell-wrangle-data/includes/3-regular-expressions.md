...
If you completed the previous unit, you should now have a sample of the open dataset `NASA-software-API.txt`. We'll use this dataset to do some pattern matching with regex in Cloud Shell.
...
1. Make sure that the **regex** option is switched on, as shown in the following screenshot.
     ...
     :::image type="content" source="../media/clair-vscode-screenshot.png" alt-text="Screenshot showing the Cloud Shell search box and regex option selected.":::
...
:::image type="content" source="../media/nasa-software-capability.png" alt-text="Screenshot showing Cloud Shell search results in a text file.":::
