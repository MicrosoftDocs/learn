...
The experiments will require a collaboration between the experts on Earth, the astronauts "in the field" (on the Moon), and the machines that are programmed on Earth and actioned on the Moon. With communication being more difficult between Earth and the Moon, and the inability to "just go back for another quick look", the preparation is starting years in advance to ensure we have the highest likelihood of success in our discoveries. 
