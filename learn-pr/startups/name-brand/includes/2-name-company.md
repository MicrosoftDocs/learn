...
By naming your company too narrowly, you run the risk that the name will no longer fit if you later add other products, pivot away from your current product entirely, or focus on other markets.
...
So, before you commit to a name for your company, make sure you can have *\<your-company-name\>.com*. If it's available to register, you can do that straight away. If someone has registered the domain and is sitting on it, you'll need to make an offer to buy it. A number of domain registrars offer anonymous brokerage services, such as [GoDaddy](https://www.godaddy.com/domains/domain-broker?azure-portal=true).
...
Remember that the principles we've discussed in this unit are a guide only. Some companies have been successful despite breaking one or more of these principles.
