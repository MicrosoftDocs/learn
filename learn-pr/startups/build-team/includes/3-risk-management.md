...
Disagreement among cofounders can lead to a breakdown in working relationships. If not addressed, this can cause startups to fail.
...
- The names of the cofounders (it's surprisingly common for some individuals to assume they'll be a cofounder, only to later realize their teammates held a different view).
- The contribution expected from each cofounder (including time and capital).
- The equity stake each cofounder will have.
- The process that will be used for reviewing and adjusting equity stakes over time.
- Salaries or other financial compensation (relevant once the company is generating revenues or raises external capital).
- The functional roles and responsibilities of each cofounder, and what decisions they're responsible for making (bearing in mind that in the early days it's generally best not to be overly prescriptive about roles because everyone has to do a bit of everything).
...
It's important to draft a cofounder agreement before anyone has created any substantive intellectual property (such as writing code) or there's any money involved (either customer revenues or investor funds). Lastly, make sure that each cofounder actually signs the agreement!

## Vesting of founder shares

Despite your best efforts, it's possible that you or one of your cofounders will decide to leave the company. Departure of a cofounder in the first few years of a startup is a surprisingly common occurrence and can happen for many reasons including financial pressures or disagreements between founders.

If a founder does leave, but remains a large shareholder, this can be a major demotivating factor for the remaining founders who are working hard but for no additional benefit. It can also make the company much less attractive to investors because a sizeable chunk of equity is now owned by someone who is (at best) passive and not contributing, or (at worst) disgruntled and actively seeking to disrupt the company by blocking decisions or refusing to sign critical documents.

To address this issue, startups frequently adopt *founder vesting* in which each founder earns their equity over time, contingent on their ongoing involvement and performance.

The mechanics of founder vesting vary somewhat by region. However, in essence, they enable issuing of shares to cofounders on company formation, with the company holding the right to buy back some or all of those shares at nominal cost in the event that the individual leaves.
...
This can be a contentious point but is often requested by investors because they're backing a team and want to have confidence that all members of the founding team are committed to the business going forward.
