It's important to consider the value of teams versus sole founders. Startups are often started by a sole founder, but before long, most sole founders realize that having a team is critical to the success of their company – not just to manage the volume of work, but also to tap into a broad range of skills and perspectives and the moral support that comes with being part of a team.

With that in mind, in this unit we're going to talk about startup teams. First we'll look at the personal attributes that are highly correlated with success in startup teams. We'll then consider functional roles and how to ensure they're filled at the right time.

## Attributes of successful startup teams

Below are some important attributes that should exist within every startup founding team. It's not essential (or likely) that every team member will have all these attributes, but it's highly desirable that each of the attributes exists somewhere within the team.

It's also important to look for these attributes in early employees, not just because they tend to correlate with high performance, but also because it's vital to have a good cultural alignment between founders and key employees.

### Curiosity

Curious founders are genuinely interested in understanding problems, and this leads to solutions that better meet the needs of customers.

Founders with this attribute:
...
- Have often acquired a range of self-taught skills to satisfy their thirst for knowledge.

### Domain knowledge

Startups that deeply understand the domain in which the startup is operating are more likely to have important insights that are invisible to others.

Founders with this attribute:

- May have worked in the domain for an extended period.
- Have often experienced the pain point themselves.
- Have rare or unique insights that may be counter-intuitive.
...
- Can delay gratification by working hard towards a long-term goal despite little near-term payoff.
...
Let's now look at the core functional roles that need to be filled in a startup. As we highlighted above, every startup is different, so you'll have your own ideas about the specific roles you need to fill in your company.

Below are several broad functional roles that need to be filled in most early-stage startup teams. In the early days, it's not essential (and in fact often not possible) to have a one-to-one mapping of an individual to a role. One person may have multiple roles, and roles may be split across individuals.
...
If you're a sole founder, or a small founding team, and you recognize there are some missing skill sets within the team, you might decide to try to fill these gaps by bringing in another cofounder.

If your startup is still at the idea stage, this may be a great option. By bringing in someone at (or close to) the beginning of the journey, they'll be able to help you with all the crucial tasks of developing hypotheses, interviewing customers, running experiments, developing your value proposition, naming the company, building and launching an MVP, etc. Because they've joined before any real value has been created, there's a good chance they'll feel like a cofounder and make a serious commitment to the company, notwithstanding that they didn't come up with the initial idea.

Successful founding teams frequently have an existing strong relationship between cofounders, sometimes developed over years of working together in other settings. When cofounders already know each other well, it's common for them to have worked out how to function effectively as a team, to understand each other's strengths, weaknesses and communication styles, and even know how to navigate difficult decisions and deal with conflict.
...
Sometimes the best approach is to invite the person to work with you on a specific task, paid if necessary, and use this as an opportunity to evaluate their fit. It's generally not a good idea to offer them any equity at this point.

If you've been working on your startup for a while, and especially if you've already launched a product, the idea of bringing in a cofounder can be less straightforward. Anyone who joins as a cofounder at this point will likely face the question of whether they're genuinely a founder in the same way as you and any other founders who were there from the beginning.

Late-joining cofounders are often offered a lower-equity stake than the initial founders in an attempt to reconcile the fact that they weren't involved in coming up with the idea or taking the first steps to pursue it. As a result, their level of commitment can be considerably lower, and this can lead to tensions within the team. 

In these situations, you may be best hiring an employee or a contractor.

## Hiring employees and contractors

In the early days of most startups, there's limited funding to pay anyone. Therefore the founders do most, if not all, of the work.
