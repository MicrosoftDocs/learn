...
Interviewing customers is a powerful way of getting inside the mind of your target customer and testing your assumptions before building a product. It is also generally cheap and time efficient.
...
- Let them do 80% of the talking (that means you do 20% of the talking and a lot of listening).
...
- Ask how much time and/or money they’ve spent trying to solve the problem.
- Invite them to suggest others you should speak to, as it this is an efficient way of recruiting more customers to interview.
...
As a guide, for business-to-business (B2B) startups, it’s generally important to interview at least 50 customers, and for business-to-consumer (B2C) startups, you should aim for at least 200.

Wherever possible your questions should be framed as falsifiable statements, and you should set a minimum success criterion above which you will consider your hypothesis to be validated, and below which it will be invalidated.
...
By completing the Value Proposition Canvas and the Lean Canvas, Emily identified more than 20 assumptions. Then by using an Assumptions Matrix she was able to narrow the list down to five assumptions that she believed were highly important and about which she had relatively little knowledge. She also made sure that she had at least one assumption in each category of desirable, feasible, and viable.
...
1. I believe that at least 25% of banking customers have personal bank accounts with more than one bank. (Desirable)
2. I believe that at least 50% of these customers experience regular frustration with being unable to view all of their finances in one place. (Desirable)
3. I believe that at least 25% of these customers would be willing to pay $10 a month for a product that consolidated their bank feeds. (Viable)
4. I believe that it is possible for me to create a product that accesses bank feeds in close to real-time from all major banks and presents them in a simple dashboard. (Feasible)
5. I believe that at least 50% of these customers would be willing to sign up for a free trial of the product. (Viable)

## A note of caution about online surveys

It’s tempting to believe that you can capture meaningful feedback from customers by sending out an online survey and analyzing the results. Surveys are quick and easy to create, but unfortunately, they are one of the least useful methods of capturing customer insights. Many people complete surveys with very little thought about their responses, and even with well-constructed questions you have no ability to delve deeper into interesting points that are raised by the respondent.

Where surveys can play a useful role is in capturing factual or numerical responses such as demographic information alongside customer interviews.
...
User personas are important because they help you to develop empathy for your users and create a product with their specific needs in mind. Having accurately defined user personas also helps you to make decisions about product functionality and design.

User personas are based on the insights you’ve gleaned from customer interviews. If you plan to serve multiple different customer segments, it’s generally helpful to have a different persona representing each of these.
...
- Personal information such as name and location plus any details that help you to identify with the persona. If your startup is B2B you should include job title, company, and a role description.
...
She has incorporated some of the common themes that arose in her interviews with customers, such as the banking brands they currently associate with and the software products they are familiar with and typically use.
