...
We worked through a founder alignment exercise to make sure you and your cofounders are on the same page. You also now have two checklists that will hopefully prove useful to you. One checklist helps you identify attributes of successful startups and integrate these into your company. The other checklist helps you identify indicators of failure and avoid making mistakes that could cause your company to fail.
...
- Your most important job early on is to find a repeatable, scalable business model. Resist the temptation to try acquiring users or generating revenue until you have strong evidence that your idea addresses a real pain point. You must have a clear understanding of the needs of your target users and what product they need you to build.
