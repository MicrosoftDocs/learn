Let’s assume that you’re here because you’re working on an early-stage startup, or a startup idea, and you’d like to make sure you have a good grasp of essential startup concepts before you go much further.
...
To be a successful entrepreneur you need to be passionate about solving a problem. Many successful entrepreneurs have reported that they would have pursued their idea regardless of whether there was a business opportunity, because they were so passionate about solving that particular problem.
The road from startup idea to successful business is often a long one, with the typical time from launch to exit being anywhere from four to ten years. For more information, see [What every startup founder should know about exits](https://techcrunch.com/2018/07/31/what-every-startup-founder-should-know-about-exits/) and [How Long Does It Take a Startup to Exit?](https://about.crunchbase.com/blog/startup-exit/).

Bear in mind that very few startup founders set out with anything like this commitment up-front; it’s entirely rational to start a company with a modest time horizon and become more committed as the opportunity solidifies and the company grows.  
...
**Ask yourself:** Am I really passionate about solving this problem and can I imagine devoting years of my life to working on it? 

## Do you have deep domain expertise?

The odds of a startup succeeding are always higher if the founders have unique insights into the problem space in which their startup will operate. These insights typically come from having deep domain expertise acquired over a long period of time (either through work or a personal interest), accompanied by a thirst for understanding problems and exploring potential solutions.
...
There are four main ways in which startup founders can leverage their domain expertise to create value:

1. By identifying an important problem that many others don’t realize exists. It’s well known that many great startup ideas came from spending time “marinating” in the problem space - exploring interesting problems with potential customers and developing unique insights over a long period of time. Finding great problems to work on often means skipping over the problems that everyone else is working on and identifying others that are hidden, or that seem unsolvable, but which still represent a great opportunity.
1. By coming up with a compelling solution which is non-obvious and on face value seems unlikely to succeed. Many of the best startup ideas seemed crazy at the outset, and it was only with hindsight that their value became evident. 
1. By tapping into their existing network, or leveraging their profile as a thought leader, founders can make connections with customers that would be very difficult for a newcomer.
1. In the case of deep-tech startups (i.e., those based on advanced technology or scientific research), by developing novel, cutting-edge technology that can become the basis for the company’s competitive advantage.

**Ask yourself:**

1. Does my startup idea leverage the investment of time and energy I’ve already put into my career or my other interests? 
1. What insights do I have that most of my peers don’t, which will open up an opportunity that may have been invisible to others?
...
Technically capable founders may have a slight advantage over non-technical founders in that they can spend their time building the product, rather than having to spend cash to pay an external developer to build it for them.
...
As a startup founder there are three tasks you need to work on to determine your startup’s financial runway:

1. Understand the cost of building and launching your product.

   - This should include all outlays including legal, marketing, and staffing costs.

1. Predict the likely revenues you will generate once the product is in the hands of customers and how long it will take to reach that juncture.
   ...
   - Almost all startup pitch decks are heavily influenced by optimism bias and have a revenue chart that goes steeply up and to the right. A good rule of thumb is to double the length of time you think it will take to get to revenue and halve the amount of revenue you think you’ll generate.

1. Determine how much capital you have and are willing to invest in the company before you’ll be able to fund the company from revenues or external investment. If you have co-founders, this is a great topic to discuss as a team.

Answering these questions will go a long way to helping you develop a cashflow forecast that enables you to make informed decisions about where to invest time and money early on.
...
Misaligned expectations among co-founders can lead to a loss of team cohesion. This is one of the most common causes of startup failure, particularly if it occurs early in the startup’s life.

Co-founder misalignment can take many forms, including:
...
- Differences in what each founder wants to get out of building the startup – such as financial reward, freedom, self-actualization, or fame and recognition; and 
...
One way to do this is for co-founders to each reflect on their individual goals for the company and themselves, to write these down, and then to come together as a team and discuss their responses.

If you’re a sole founder, it’s still useful to capture these thoughts and discuss them with friends / family / your significant other in order to pressure test your own goals and the viability of your expectations.

**Worksheet:** Download and complete the Founder Alignment Worksheet  and use it as a discussion-starter with your co-founders (or if you’re a sole founder, with your friends / family).
...
For many people this can be done part-time around your existing job or other commitments.

By identifying critical milestones or inflection points that allow you to build increasing conviction, it’s possible to identify stages in the development of your company that will allow you to commit additional time and money as you gain greater certainty about the prospects of your company.
...
| --- | --- | --- | --- |
| Complete 50 customer interviews, at least 50% identify with the problem and would be interested in a solution | 1 person month (evenings and weekends) over the next 3 months to build an MVP | $500 to run some social ad campaigns to test demand | I won’t need to reduce my income and I have enough savings to pay for the ads |
| Launch MVP, get at least 100 people using it, collect positive feedback | 1 day per week (reduce job to 4 days) plus evenings and weekends to focus on building version 1 of the product and connecting with at least 3 banks | $5,000 to hire a front-end developer to help build the product | I’ve discussed with my manager, and she is supportive of me taking time off to explore this without jeopardizing my employment. <br> I have enough savings to cover the reduced income and am willing to cut back on some discretionary expenditure. |
| Launch v 1.0 and get first 50 paying customers | Leave my job to go full-time, but with up to 2 days a week available to do contract / project work if I need the income | $10,000 to keep front end developer working on the product and do some paid customer acquisition | 50 paying customers demonstrates demand for the product and represents $5,000 in revenue |
| 200 paying customers, at least 90% retention of first 50 customers after 6 months | Full-time | $20,000 in savings, will need to raise seed round soon! | 200 customers equate to $20,000 in revenues. <br> High retention rate supports assumption of high LTV. <br> Should be enough to raise a seed round. |

## Worksheet

Download and complete the milestone worksheet . Use it as a tool to capture your thoughts about what milestones you will need to hit before you’re prepared to invest time and cash in your company.
