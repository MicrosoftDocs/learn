...
By far the most common reason that startups fail is they build products that nobody wants. In reality, nearly every startup can find someone who will use their product. But, as discussed in the previous unit, it's essential that you find a both a common problem and one that is sufficiently intense or frequent such that people will actively seek out a solution and pay for it.

Without proven demand from customers, it's likely that you'll build either entirely the wrong product or a product that's not exactly what your target customer needs, and this will prevent you from creating a viable, scalable business.
...
Let's say you're going to create a product that allows people to do a certain task, and they're currently able to do that task by using something that's free and readily available, like a spreadsheet or a Facebook group.
