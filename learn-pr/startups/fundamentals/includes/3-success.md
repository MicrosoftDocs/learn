...
However, a lot of people tend to come up with ideas that are perfectly good but are so obvious (the green set on the right, excluding the intersect) that many startups tend to be working on a similar idea.
...
If you're looking at a number of customer pain points that you could address, try plotting them on a chart with intensity and frequency on the axes. The problems in the top right (high intensity, high frequency) quadrant are likely to be the best ones to go after.
...
Once you've built the product and invested in developing and launching it, a scalable business model will enable your company to grow rapidly.
...
There's an optimal time for every startup idea. You need to ensure you're not launching your startup too far ahead of the opportunity, or too far behind.

An example of launching too far ahead of the opportunity would be a marketplace for the sharing of quantum computing capability. Quantum computing is going to be a huge opportunity at some point. But it may not be wise to set up a marketplace for sharing that capability today; you'd be some years ahead of the curve.
...
On a related note, the best ideas often benefit from "tailwinds" that help push them along. These are shifts in technology, consumer behavior, or regulations that make it easier to get your startup started (or that make it possible, if it would previously have been impossible).
...
Hotmail is a great example. The company started in 1996 and at that time was just about the first browser-based email service. Free browser-based email is ubiquitous and free today, but in 1996, in the early days of the internet, nearly everyone's email address was tied to their ISP. That was inconvenient because if you changed your ISP, then you had to change your email address.
