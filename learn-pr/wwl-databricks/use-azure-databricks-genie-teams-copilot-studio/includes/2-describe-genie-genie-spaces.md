...
You can access Genie Spaces directly in **Azure Databricks**, through the **Genie mobile app**, through the **Databricks app in Microsoft Teams**, or through a **Copilot Studio agent**. The next units explore the Teams paths in detail.
