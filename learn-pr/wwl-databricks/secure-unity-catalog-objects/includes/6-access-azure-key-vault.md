...
:::image type="content" source="../media/create-secret-scope.png" alt-text="Screenshot of the Azure Databricks Create Secret Scope feature." border="false" lightbox="../media/create-secret-scope.png":::
