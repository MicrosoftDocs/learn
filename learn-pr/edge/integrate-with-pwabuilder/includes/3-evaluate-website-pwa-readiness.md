...
1. Enter the link to your web app, or if you don't have a web app to try, add https://webboard.app/ for the link.
1. Select **Start** to generate a readiness report for the example website.
1. For this activity, review the generated report and pay attention to Action Items.
1. Select the ℹ️ icon next to each action item to get more information about errors and warnings.
...
After you've generated the readiness report, your action items should look something like this:
...
Make sure to check all the warnings and errors. Those must be addressed before packaging the web app for app stores. 
