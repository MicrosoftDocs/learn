...
>[NOTE] In order to complete this, you will need an Azure subscription. If you don't already have one, you can create a [free account](https://azure.microsoft.com/free/?WT.mc_id=A261C142F).
...
>[NOTE] As you create other resources in this tutorial, you will need to be sure to use the same region as you select in this first step.
