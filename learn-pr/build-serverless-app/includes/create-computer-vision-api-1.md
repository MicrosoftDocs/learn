We'll continue enhancing our serverless web application by creating an instance of the Azure Computer Vision API so that we can use machine learning to analyze images that are uploaded via the site.
