In this module, you've learned how to filter objects out of the pipeline by using the **Where-Object** cmdlet to specify various criteria. The following are the key takeaways:
 ...
 -  The **Where-Object** command has basic and advanced forms of syntax (also called *simplified syntax* and *scriptblock syntax* in Microsoft documentation). Both forms are defined by an extensive list of parameter sets—one for each comparison operator.
