...
## Learn more
 ...
 -  [SQL Server Backup to URL](/sql/relational-databases/backup-restore/sql-server-backup-to-url?view=sql-server-ver15)
 -  [Frequently asked questions for SQL Server on Azure VMs](/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-faq)
 -  [About SQL Server Backup in Azure VMs](/azure/backup/backup-azure-sql-database)
 -  [File-Snapshot Backups for Database Files in Azure](/sql/relational-databases/backup-restore/file-snapshot-backups-for-database-files-in-azure?view=sql-server-ver15)
 ...
 -  [Backup and restore on SAP HANA on Azure](/azure/virtual-machines/workloads/sap/hana-backup-restore)
 -  [Automated Backup for SQL Server 2014 Virtual Machines (Resource Manager)](/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-automated-backup)
 -  [Automated Backup v2 for Azure Virtual Machines (Resource Manager)](/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-automated-backup-v2)
 ...
 -  [SAP Note \#2039883](https://launchpad.support.sap.com/#/notes/2039883)
 -  [SAP Note \#1642148](https://launchpad.support.sap.com/#/notes/1642148)
 -  [SAP Note \#1820529](https://launchpad.support.sap.com/#/notes/1820529)
