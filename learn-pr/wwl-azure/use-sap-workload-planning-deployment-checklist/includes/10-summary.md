...
- Explored the pilot phase.
- Explored the non-production phase.
- Explored the production preparation phase.
- Explored the Go Live phase.
- Explored the post production phase.
...
- [Create a managed image of a generalized virtual machine in Azure](/azure/virtual-machines/windows/capture-image-resource)
...
- [Configure LVM on a Linux virtual machine in Azure](/azure/virtual-machines/linux/configure-lvm)
