...
:::image type="content" source="../media/AZ104_Next_Hop-8efe42db.png" alt-text="Screenshot of the Next hop page. The Next hop button is highlighted showing that the next hop is a virtual appliance on IP address 10.1.2.4.":::
