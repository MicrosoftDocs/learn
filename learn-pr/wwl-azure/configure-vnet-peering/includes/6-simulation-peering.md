...
+ There is one office, Seattle, in another region.
+ All the offices need to be networked together so they can share information. 

## Architecture diagram

:::image type="content" source="../media/lab05.png" alt-text="Architecture diagram as explained in the text.":::
...
+ **Task 1**: Create the infrastructure environment. In this task, you will deploy three virtual machines, each into a separate virtual network, with two of them in the same Azure region and the third one in another Azure region.
...
+ **Task 2**: Configure local and global virtual network peering. 
    + Create a local vitual network peering between the two virtual networks in the same region.
