...
You need a storage account in which to place the Azure virtual hard disk for the VM operating system and data disks, with drive caching switched off. This data disk is for the Active Directory database, log files, and SYSVOL.
