...
IT staff at Contoso are considering deploying domain controllers on Windows Server VMs in Azure IaaS as a means to extend authentication and identity from on-premises and into the cloud. You must determine if this is the ideal solution. Keep in mind that Contoso could also implement Microsoft Entra ID or Microsoft Entra Domain Services.
