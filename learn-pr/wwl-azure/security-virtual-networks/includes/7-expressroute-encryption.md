...
:::image type="content" source="../media/express-route-encryption-324f8bed.png" alt-text="Diagram of how to deploy an Azure Virtual WAN to establish an IPsec/IKE VPN connection.":::
