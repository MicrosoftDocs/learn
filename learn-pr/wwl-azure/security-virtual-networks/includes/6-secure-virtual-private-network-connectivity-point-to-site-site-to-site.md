...
:::image type="content" source="../media/new-site-to-site-virtual-private-network-e32aac6e.png" alt-text="Diagram showing an example of a site-to-site virtual private network.":::
