...
## :::image type="content" source="../media/virtual-network-peering-and-vpn-gateway-49da19b5.png" alt-text="Table showing a comparison of virtual network peering and VPN Gateway."::: 
