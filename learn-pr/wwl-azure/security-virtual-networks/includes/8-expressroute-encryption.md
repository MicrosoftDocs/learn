...
:::image type="content" source="../media/express-route-virtual-wide-area-network-35af6db6.png" alt-text="Diagram showing an example of a network within the on-premises network connected to the Azure hub virtual private network gateway over ExpressRoute private peering.":::
