...
:::image type="content" source="../media/azure-network-watcher-cf554286.png" alt-text="Diagram showing an example of network watcher monitoring and diagnoistic tools.":::
