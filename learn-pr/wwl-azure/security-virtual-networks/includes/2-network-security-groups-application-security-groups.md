...
:::image type="content" source="../media/azure-network-security-group-rules-e86bda4a.png" alt-text="Screenshot showing network security rule properties and explanations.":::
<br>
