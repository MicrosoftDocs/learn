...
:::image type="content" source="../media/site-to-site-vpn-2350071a.png":::
...
:::image type="content" source="../media/ipsec-ikev2-s2s-9770600e.png" alt-text="Image showing how a VPN Gateway can be configured in active-standby mode using one public IP or in active-active mode using two public IPs.":::
...
:::image type="content" source="../media/point-to-site-vpn-8139481d.png":::
