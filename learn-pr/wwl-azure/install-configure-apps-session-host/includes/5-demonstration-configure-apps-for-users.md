...
:::image type="content" source="../media/create-an-application-group-d77b79df.png" alt-text="Screenshot of the application groups basics tab filled out using values from table.":::
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Subscription where you want the app group to run.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
  ...
  :::column-end:::
  :::column:::
    Resource group you've created for Azure Virtual Desktop resources.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
...
:::image type="content" source="../media/create-application-group-users-groups-2c910498.png" alt-text="Screenshot of the assignments tab with Add Azure AD users or user groups highlighted.":::
...
:::image type="content" source="../media/create-application-group-add-applications-478c0c11.png" alt-text="Screenshot of the applications tab with add applications highlighted.":::
...
:::image type="content" source="../media/demo-configure-apps-users-image-4-053167b0.png" alt-text="Screenshot that shows WordPad selected.":::
...
:::image type="content" source="../media/demo-configure-apps-users-image-5-2438b37f.png" alt-text="Screenshot that shows workspace tab with yes selected.":::
