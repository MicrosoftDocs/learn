...
3.  Join an Azure Active Directory (Azure AD) connection by following the instructions in [Join an Active Directory connection](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/virtual-desktop/create-fslogix-profile-container.md#join-an-active-directory-connection).
