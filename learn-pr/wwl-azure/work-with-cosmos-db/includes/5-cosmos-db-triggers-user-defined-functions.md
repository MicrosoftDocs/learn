...
For examples of how to register and call a trigger, see [pre-triggers](/azure/cosmos-db/sql/how-to-use-stored-procedures-triggers-udfs) and [post-triggers](/azure/cosmos-db/sql/how-to-use-stored-procedures-triggers-udfs).
