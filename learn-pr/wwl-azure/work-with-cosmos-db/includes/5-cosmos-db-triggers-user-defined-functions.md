...
For examples of how to register and call a trigger, see [pre-triggers](https://docs.microsoft.com/azure/cosmos-db/sql/how-to-use-stored-procedures-triggers-udfs#pre-triggers) and [post-triggers](https://docs.microsoft.com/azure/cosmos-db/sql/how-to-use-stored-procedures-triggers-udfs#post-triggers).
