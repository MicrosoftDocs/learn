The **PowerShellGet** module includes cmdlets for accessing and publishing items in the PowerShell Gallery. This module was introduced in Windows Management Framework 5.0, which is included in Windows 10 and Windows Server 2016. You can upgrade older Windows operating systems to include Windows Management Framework 5.0 or newer and thereby obtain the **PowerShellGet** module. Alternatively, if you can't update to Windows Management Framework 5.0, there's an .msi installer for **PowerShellGet** that you can use on systems with Windows PowerShell 4.0.
