You can tune the plans generated by the Handlebars planner. In this exercise, you generate a plan, modify the template, and use it as a function prompt. Let's try it out!
...
1. Enter `dotnet run` in the terminal to see the output of your planner template.
    ...
    The output generated should recommend a song to the user based on their recently played music. Your output may look similar to the following:
