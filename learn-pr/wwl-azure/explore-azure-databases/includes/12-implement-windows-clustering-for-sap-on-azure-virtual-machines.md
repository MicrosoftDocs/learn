...
- A Microsoft Azure subscription with the sufficient number of available DSv2 and Dsv3 vCPUs (one Standard\_DS1\_v2 VM with 1 vCPU and 4 Standard\_D4s\_v3 VMs with 4 vCPUs each) in the Azure region you intend to use for this lab.
...
During this lab ([full instructions on GitHub](https://aka.ms/az-120-lab-01b)) you'll complete the following exercises:
