...
In this module, you learned how to determine when to use Azure Files versus Azure Blob Storage. You discovered how to configure Azure file shares and file share snapshots. You explored features and use case scenarios for the Azure File Sync agent. You reviewed Azure File Sync components and configuration steps.
