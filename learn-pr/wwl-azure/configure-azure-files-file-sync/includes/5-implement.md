...
:::image type="content" source="../media/azure-file-sync.png" alt-text="Illustration depicting that Azure File Sync can be used to cache an organization's file shares in Azure Files. Different graphics represent different geographic locations like Mexico, Munich, Seattle, and a branch office, with Azure represented by a standard cloud icon.":::
