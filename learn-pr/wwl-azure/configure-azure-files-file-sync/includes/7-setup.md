...
1.  **Deploy the Storage Sync Service**. The Storage Sync Service can be deployed from the Azure portal. You will need to provide Name, Subscription, Resource Group, and Location.<br><br>:::image type="content" source="../media/AZ104_File_Sync_Initial_Steps2-1cabfa1e.png" alt-text="Screenshot of deploy the storage sync service from the portal.":::
    <br><br>
...
:::image type="content" source="../media/AZ104_File_Sync_Initial_Steps3-87fd2fab.png" alt-text="Screenshot of the Server Registration UI with fields for the Azure Subscription, Resource Group, and Storage Sync Service.":::
