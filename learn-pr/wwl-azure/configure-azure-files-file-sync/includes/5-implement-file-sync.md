...
:::image type="content" source="../media/file-sync-1d3fd2e7.png" alt-text="Illustration depicting that Azure File Sync can be used to cache an organization's file shares in Azure Files.":::


There are many uses and advantages to file sync.

 -  **Lift and shift**. The ability to move applications that require access between Azure and on-premises systems. Provide write access to the same data across Windows Servers and Azure Files. 
