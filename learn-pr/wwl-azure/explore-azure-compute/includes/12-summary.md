...
- Learned how to scale Azure virtual machines.
- Examined Azure virtual machine scaling considerations.
- Explored network bandwidth allocation.
- Explored data flows.
- Examined Azure virtual machine compute considerations.
- Learned how to implement and verify high availability SAP HANA on Azure virtual machines.
