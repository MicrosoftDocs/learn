...
Key considerations for re-sizing include:

 -  The Azure region may not contain the hardware requirements to support the desired sizes
 -  Re-sizing without the need to restart the VM depending on the current hardware cluster
