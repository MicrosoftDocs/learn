...
In this exercise, you create a storage account, a blob container, and upload a file that you'll share with a partner.
...
[:::image type="content" source="../media/launch-exercise-button.png" alt-text="Button to launch exercise.":::](https://microsoftlearning.github.io/Share-files-securely/Instructions/Labs/2-exercise-create-storage-upload-file.html)