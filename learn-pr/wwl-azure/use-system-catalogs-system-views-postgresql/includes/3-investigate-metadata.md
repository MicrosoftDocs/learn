...
:::image type="content" source="../media/3-metrics.png" alt-text="Screenshot of C P U percent metrics." lightbox="../media/3-metrics.png":::
...
* pg_database
    pg_database has basic information such as the database owner (in **datdba**), the collation, and the connection limit (in **datconnlimit**). A **datconnlimit** of **-1** signifies that there is no connection limit.

    :::image type="content" source="../media/3-query-code.png" alt-text="Screenshot of query of pg_database." lightbox="../media/3-query-code.png":::

* pg_stat_database
    pg_stat_database contains lock information for each database, updated in real time. This enables you to see the number of rollbacks and deadlocks on each database.

    :::image type="content" source="../media/3-query-code-1.png" alt-text="Screenshot of query of pg_stat_database." lightbox="../media/3-query-code-1.png":::
...
- **pg_statio_user_tables** lists I/O metadata about user tables in the database.
    :::image type="content" source="../media/3-query-code-2.png" alt-text="Screenshot of query on pg_statio_user_tables." lightbox="../media/3-query-code-2.png":::
