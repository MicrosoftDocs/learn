In this module you've learned how to use PowerShell to manage users, groups, and licenses in Azure AD. You've also learned how to manage some of the cloud services included in Microsoft 365. The following are the key takeaways:
