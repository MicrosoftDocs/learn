...
:::image type="content" source="../media/azure-landing-zone-example.png" alt-text="Diagram showing an example of an Azure landing zone hierarchy for multiple tenants." lightbox="azure-landing-zone-example":::
