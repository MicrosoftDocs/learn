...
For information on the most recent updates to virtual network configuration, see [Create, change, or delete a virtual network](/azure/virtual-network/manage-virtual-network) 
