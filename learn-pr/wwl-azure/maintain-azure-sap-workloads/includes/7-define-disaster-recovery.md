...
For example, you should add a pre-action script to facilitate failover SQL Availability group. Similarly, you should add a post action script to attach a load balancer on the failed over Azure VMs. 
