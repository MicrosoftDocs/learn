...
:::image type="content" source="../media/create-custom-route-0e4d9372.png" alt-text="Screenshot of the Add route page. The Next hop type drop-down is highlighted. Virtual appliance is selected.":::
