...
You can use the Active Directory module for Windows PowerShell to automate AD DS administration. By using PowerShell for AD DS administration tasks, you can speed them up by making bulk updates instead of updating AD DS objects individually. If you don't have the Active Directory module installed on your machine, you'll need to download the correct Remote Server Administration Tools (RSAT) package for your operating system. RSAT is included as a set of Features on Demand, starting with the Windows 10 October 2018 Update. To install an RSAT package, open **Settings** and go to **Optional features**. On Windows 11, select **View features**; on Windows 10, select **Add a feature**. Search for and install **RSAT: Active Directory Domain Services and Lightweight Directory Services Tools**.
