...
1. Select your subscription, and then review the **Azure Defender features**. 
1. Return to the main **Security Center** blade. 
1. Under, **General**, select **Recommendations**.
1. Review **Secure Score**, **Recommendations status**, and **Resource Health**.
1. From the main **Security Center** blade, under **Cloud Security** select **Regulatory compliance**.
...
1. From the main **Security Center** blade, under **Cloud Security** select **Azure Defender**. 
1. Review the **Coverage**, **Alerts**, and **Advanced protection** features. 
