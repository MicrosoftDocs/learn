...
To help you protect yourself against these challenges, Microsoft Defender for Cloud provides you with the tools to:
 ...
 -  **Get secure faster**: In Security Center, everything is done in cloud speed. Because it is natively integrated, deployment of Microsoft Defender for Cloud is easy, providing you with auto-provisioning and protection with Azure services.

### Architecture

Because Microsoft Defender for Cloud is natively part of Azure, PaaS services in Azure - including Service Fabric, SQL databases, and storage accounts - are monitored and protected by Microsoft Defender for Cloud without necessitating any deployment.

In addition, Microsoft Defender for Cloud protects non-Azure servers and virtual machines in the cloud or on-premises, for both Windows and Linux servers, by installing the Log Analytics agent on them. Azure virtual machines are auto-provisioned in Microsoft Defender for Cloud.
...
When you enable Microsoft Defender for Cloud, the security policy built-in to Microsoft Defender for Cloud is reflected in Azure Policy as a built-in initiative under the Microsoft Defender for Cloud category. The built-in initiative is automatically assigned to all Microsoft Defender for Cloud registered subscriptions (Free or Standard tiers). The built-in initiative contains only Audit policies.

Microsoft Defender for Cloud makes mitigating your security alerts one step easier by adding a Secure Score. The Secure Scores are now associated with each recommendation you receive to help you understand how important each recommendation is to your overall security posture. This is crucial in enabling you to prioritize your security work.

:::image type="content" source="../media/microsoft-defender-for-cloud-secure-score-recommendations-7ce1161b.jpg" alt-text="Screenshot of Microsoft Defender for Cloud Secure Score Recommendations.":::
