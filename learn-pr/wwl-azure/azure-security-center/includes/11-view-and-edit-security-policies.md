...
:::image type="content" source="../media/security-roles-viewing-and-editing-security-policies-d0489add.png" alt-text="Screenshot showing which security role can view, update, and dismiss alerts.":::
