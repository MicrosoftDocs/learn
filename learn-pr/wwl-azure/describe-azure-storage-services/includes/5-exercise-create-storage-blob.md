...
1. Select + Container and complete the information.
...
1. Back in the Azure portal select the container you created, then select Upload.
1. Browse for the image file you want to upload. Select it and then select upload.
...
1. Copy the URL from the URL field and paste it into a new tab.
