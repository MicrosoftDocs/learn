...
:::image type="content" source="../media/user-risk-level-evaluation.png" alt-text="Diagram that shows how users are evaluated to determine their user risk level." border="false" lightbox="../media/user-risk-level-evaluation-expanded.png":::
