In this module, you learned how to configure and enable Azure Arc for Windows machines in your environment. Enabling Arc-enabled servers can be done either manually or by using an automated method with a provided template script.<br>

## Learning objectives<br>

In this module, you learned how to:

 -  Connect hybrid machines to Azure using a deployment script.<br>
