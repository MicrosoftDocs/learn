...
:::image type="content" source="../media/2-multi-version-concurrency-control.png" alt-text="Screenshot of Multi-Version Concuuenct Control diagram showing a read query reading the original data and a write query updating a snapshot." lightbox="../media/2-multi-version-concurrency-control.png":::
