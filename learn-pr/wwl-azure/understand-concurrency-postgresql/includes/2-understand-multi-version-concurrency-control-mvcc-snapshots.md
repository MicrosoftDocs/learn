...
You start a transaction with a BEGIN TRANSACTION or START TRANSACTION and complete it with either COMMIT, to save all of the changes made in the transaction, or ROLLBACK, to undo any changes made by the transaction. For example:
