...
1. On the **Private access** tab, select **+ Create private endpoint connection**.

    ![Screenshot showing the Networking page of a container registry instance.](../media/private-endpoint-exist-registry.png)

1. On the **Basics** tab of the Create a private endpoint page, enter or select the following information:
...
1. On the **Resource** tab of the Create a private endpoint page, enter or select the following information:
...
1. On the **Configuration** tab of the Create a private endpoint page, enter or select the information:
