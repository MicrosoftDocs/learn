The following private package sources give you a starting point for finding the most relevant feeds.
...
The following table contains a nonexhaustive list of self-hosting options and SaaS offerings to host package privately feeds for each type covered.
