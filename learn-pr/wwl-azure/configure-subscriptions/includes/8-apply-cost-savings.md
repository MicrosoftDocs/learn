...
:::image type="content" source="../media/AZ104_Pricing_Calculator-eb3f1a29.png" alt-text="Screenshot of the Pricing Calculator. Estimates are provided in this example for an instance of a D1 series virtual machine on the Windows OS, running in the West US region, at the standard tier level.":::
