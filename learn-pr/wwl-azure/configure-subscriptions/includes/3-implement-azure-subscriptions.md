...
:::image type="content" source="../media/azure-subscriptions.png" alt-text="Diagram showing the relationship between an Azure subscription and an account, which is simply an identity in Azure Active Directory. Users and services accessing subscription resources first authenticate through Azure AD.":::
