...
- **Bypass**. Nothing is blocked and there are no warnings or prompts. Intended for use when a PowerShell script is built into a larger application with its own security model.
