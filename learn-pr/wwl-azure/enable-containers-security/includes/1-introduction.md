Containers are a great choice for running applications in Azure. Those containers, just like virtual machines needed to locked down to protect your data and business. Use the built-in Azure container tools to keep you container based solutions secure.
