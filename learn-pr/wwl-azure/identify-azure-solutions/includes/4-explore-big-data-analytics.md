...
[Azure Synapse Analytics]( https://docs.microsoft.com/azure/sql-data-warehouse?azure-portal=true) (formerly Azure SQL Data Warehouse)  is a limitless analytics service that brings together enterprise data warehousing and big data analytics.
...
✔️ For a full list of big data and analytics services available with Azure, visit the page [Analytics](https://azure.microsoft.com/product-categories/analytics?azure-portal=true).
