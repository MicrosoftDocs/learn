...
:::image type="content" source="../media/2-activity-query.png" alt-text="Screenshot of pg_stat_activity query." lightbox="../media/2-activity-query.png":::
...
1. Select **Server parameters** and navigate to the **pg_stat_statements.track** setting.
    :::image type="content" source="../media/2-statements-track-setting.png" alt-text="Screenshot of pg_statements.track setting." lightbox="../media/2-statements-track-setting.png":::
