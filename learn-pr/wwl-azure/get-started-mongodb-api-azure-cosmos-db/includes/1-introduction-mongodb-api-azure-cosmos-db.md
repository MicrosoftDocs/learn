...
- **99.999% availability** - Azure Cosmos DB offers [99.999%](/azure/cosmos-db/high-availability) read and write availability for multi-region databases. For information about the SLA, see [Azure Cosmos DB service-level agreements](/support/legal/sla/cosmos-db/v1_4/).
