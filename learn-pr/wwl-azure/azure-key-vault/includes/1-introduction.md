...
An organization needs a secure place to store certificates and secret.  Azure Key Vault gives a cloud based vault where you can secure store and programatically access your secrets and certificates to protect your applications, identities, and data.
