Once you have keys and secrets stored in the key vault it's very important to think about a rotation strategy. There are several ways to rotate the values:
