...
:::image type="content" source="../media/az500-key-vault-rotation-0d01efe7.png" alt-text="Screenshot showing how Event Grid and Function Apps can be used to automate the process.":::
