...
In this unit, you learn how to create an Azure Virtual Desktop image with these customizations:
 ...
 -  [Windows Restart customizer](https://docs.microsoft.com/azure/virtual-machines/linux/image-builder-json?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&amp;toc=/azure/virtual-machines/windows/toc.json#windows-restart-customizer)
 -  [Windows Update customizer](https://docs.microsoft.com/azure/virtual-machines/linux/image-builder-json?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&amp;toc=/azure/virtual-machines/windows/toc.json#windows-update-customizer)
