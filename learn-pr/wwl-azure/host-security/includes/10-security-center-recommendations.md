...
:::image type="content" source="../media/az500-host-recommendations-1-5d8e05d6.png" alt-text="Screenshot that depicts data collection from VMs turned on for a security policy.":::
...
:::image type="content" source="../media/az500-host-recommendations-2-1e3dd486.png" alt-text="Screenshot that depicts the Virtual machines blade with recommendations for your VMs.":::
