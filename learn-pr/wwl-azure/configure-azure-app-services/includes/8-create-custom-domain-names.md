...
:::image type="content" source="../media/app-service-custom-domain-1aa14379.png" alt-text="Screenshot that shows the Custom domains page in the Azure portal with a custom domain named contoso and the app URL constoso dot-com.":::
