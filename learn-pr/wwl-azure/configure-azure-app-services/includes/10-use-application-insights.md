...
:::image type="content" source="../media/app-insights.png" alt-text="Application Insights is receiving information from web pages, client apps, and web services. The information is transferred to Alerts, Power BI, and Visual Studio.":::
