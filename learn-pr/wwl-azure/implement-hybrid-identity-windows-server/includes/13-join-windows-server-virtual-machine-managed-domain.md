...
[Tutorial: Join a Windows Server virtual machine to an Azure Active Directory Domain Services managed domain](https://aka.ms/join-windows-vm?azure-portal=true)
