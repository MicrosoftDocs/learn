...
- Enable Azure AD login in a Windows VM.
...
[Enabling Azure AD login in for Windows VM in Azure](https://aka.ms/azure-ad-login-in-windows-vm-azure?azure-portal=true)
