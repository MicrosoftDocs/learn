...
:::image type="content" source="../media/AZ104_Connected_Sources1-00fe9089.png" alt-text="VM agents in Azure and on-premises are providing data to a workspace.":::


This following diagram shows how Connected Sources flow data to the Log Analytics service.

:::image type="content" source="../media/AZ104_Connected_Sources2-551a8edb.png" alt-text="Diagram showing who Connected Sources flow data to the Log Analytics service. The flow and steps in the graphic are numbered 1 to 5, and are described in the content.":::
