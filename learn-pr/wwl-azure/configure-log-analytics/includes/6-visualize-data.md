...
:::image type="content" source="../media/log-analytics-querying.png" alt-text="Screenshot of a Log Analytics query. Shows 120 results based on data source with bar chart visualizations of the query results.":::
