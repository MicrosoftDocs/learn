...
:::image type="content" source="../media/AZ104_Log_Analytics_Querying-0aac2e32.png" alt-text="Screenshot of a Log Analytics query. Shows 120 results based on data source with bar chart visualizations of the query results.":::
