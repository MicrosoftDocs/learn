...
After making a PSSession to a remote computer, you run the desired commands within the session, but you leave the PSSession running. By doing this, you can run more commands in the session.
