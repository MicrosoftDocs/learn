...
:::image type="content" source="../media/azure-landing-zone-architecture-example-ce4b31c9.png" alt-text="Diagram showing an example of an Azure landing zone hierarchy for multiple tenants." lightbox="../media/azure-landing-zone-architecture-example-ce4b31c9.png":::
