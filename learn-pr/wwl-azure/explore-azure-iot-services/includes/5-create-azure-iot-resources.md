...
> [!TIP]
> After completing the lab, if you've finished exploring Azure IoT Hub and Azure IoT Hub Device Provisioning Service, delete the Azure resources that you may have created during the exercise.
