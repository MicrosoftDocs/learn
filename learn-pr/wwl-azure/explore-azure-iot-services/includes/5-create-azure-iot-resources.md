The instructions for this lab can be found [here](https://github.com/MicrosoftLearning/MSLearnLabs-AZ-220-Microsoft-Azure-IoT-Developer/blob/master/Instructions/Labs/LAB_AK_02-getting-started-with-azure-iot-services.md). You can complete the lab exercises using a Windows machine and your own Microsoft Azure subscription. If you don't have an active Azure subscription, you can create a [free account](https://azure.microsoft.com/free).
