...
:::image type="content" source="../media/mcsb-regulatory-compliance-controls-ca9f08d2.png" alt-text="Screenshot showing the Defender for Cloud Regulatory compliance dashboard.":::
...
:::image type="content" source="../media/mcsb-control-detail-4ae8685a.png" alt-text="Screenshot showing the Defender for Cloud Regulatory compliance Control details.":::
