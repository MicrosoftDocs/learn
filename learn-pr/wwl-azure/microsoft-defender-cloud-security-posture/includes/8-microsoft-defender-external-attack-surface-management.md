...
:::image type="content" source="../media/easm-dashboard-37118bce.png" alt-text="Screenshot showing the Defender EASM Resource dashboard.":::
...
:::image type="content" source="../media/easm-add-discovery-group-614f50f2.png" alt-text="Screenshot showing the Defender EASM add discovery group page.":::
...
:::image type="content" source="../media/easm-security-posture-6352042e.png" alt-text="Screenshot showing the Defender EASM security posture page.":::
...
:::image type="content" source="../media/easm-inventory-eee9ac9f.png" alt-text="Screenshot showing the Defender EASM inventory page.":::
