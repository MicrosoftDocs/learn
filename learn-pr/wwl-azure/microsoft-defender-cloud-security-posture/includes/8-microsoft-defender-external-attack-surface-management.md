...
:::image type="content" source="../media/external-attack-surface-management-dashboard-42ccb3e7.png" alt-text="Screenshot showing the Defender EASM Resource dashboard.":::
...
:::image type="content" source="../media/external-attack-surface-management-add-discovery-group-4b84e7a4.png" alt-text="Screenshot showing the Defender EASM add discovery group page.":::
...
:::image type="content" source="../media/external-attack-surface-management-security-posture-7c206c1e.png" alt-text="Screenshot showing the Defender EASM security posture page.":::
...
:::image type="content" source="../media/external-attack-surface-management-inventory-48001845.png" alt-text="Screenshot showing the Defender EASM inventory page.":::
