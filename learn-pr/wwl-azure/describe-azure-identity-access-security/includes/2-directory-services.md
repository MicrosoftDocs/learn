...
:::image type="content" source="../media/azure-active-directory-sync-topology-7359f2b8.png" alt-text="Illustration of Azure A D Connect Sync syncronizes information back to the Azure AD tenant from on-premises A D.":::
