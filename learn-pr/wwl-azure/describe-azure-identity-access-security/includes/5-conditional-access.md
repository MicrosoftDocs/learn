...
:::image type="content" source="../media/conditional-access-9bd268b8.png" alt-text="Illustration showing the conditional access flow of a signal leading to a decision, leading to enforcement.":::
