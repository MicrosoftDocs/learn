...
For an up-to-date list of common error messages and recommended action, see [Troubleshoot Azure VM file recovery](/azure/backup/backup-azure-vm-file-recovery-troubleshoot).
...
For an up-to-date list of common issues, see: [Troubleshoot replication of Azure VMs with Azure Site Recovery](/azure/site-recovery/azure-to-azure-troubleshoot-replication).
