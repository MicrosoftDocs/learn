...
For an up-to-date list of common error messages, see [Troubleshoot backup errors with Azure VMs](/azure/backup/backup-azure-vms-troubleshoot).
...
- [Troubleshoot scheduled backup job failures with Data Protection Manager](/troubleshoot/system-center/dpm/troubleshoot-scheduled-backup-job-failures)