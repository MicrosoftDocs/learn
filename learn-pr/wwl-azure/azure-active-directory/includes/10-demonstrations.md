...
1. Go to the [Azure AD pricing page](https://azure.microsoft.com/pricing/details/active-directory/) and review the features and pricing for each edition.
...
1. Review the **Group types**: **Security** and **Microsoft 365**.
