...
3.  Select either **Create new user** or **Invite external user** from the menu.
    ...
    :::image type="content" source="../media/azure-active-directory-users-page-new-user-e07c9173.png" alt-text="Screenshot showing an example of the Microsoft Entra users page for creating a new user.":::
...
There might be scenarios where you want to manually create consumer accounts in your Azure Active Directory B2C (**Azure AD B2C**) directory. If you have an environment with Microsoft Entra ID (**cloud**) and Windows Server Active Directory (**on-premises**), you can add new users by syncing the existing user account data.
