...
## Passwordless authentication methods
 ...
 -  **Temporary Access Pass (preview)** \- A time-limited passcode allows you to set up security keys and the Microsoft Authenticator without ever needing to use, much less know, your password!

:::image type="content" source="../media/azure-active-directory-authentication-methods-b98c79c7.png" alt-text="Screenshot of Azure AD, Security, Authentication methods panel.  Listed on the screen are the available methods that can be used for authenticating user including FIDO2, the Authenticator App, and the preview of Temporary Access Pass.":::
