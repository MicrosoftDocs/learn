...
## Requirements
 ...
 -  A Microsoft Azure subscription with the sufficient number of available DSv2 and Dsv3 vCPUs (four Standard\_DS1\_v2 VMs with 1 vCPU and six Standard\_D4s\_v3 VMs with 4 vCPUs each) in an Azure region that supports availability zones.
 -  A lab computer with an Azure Cloud Shell-compatible web browser and access to Azure.

## Exercises

During this lab ([full instructions on Github](https://github.com/MicrosoftLearning/AZ-120-Planning-and-Administering-Microsoft-Azure-for-SAP-Workloads/blob/master/Instructions/AZ-120_Lab03b-SQL_HA_Infrastructure_Deployment.md)) you will complete the following exercises:
