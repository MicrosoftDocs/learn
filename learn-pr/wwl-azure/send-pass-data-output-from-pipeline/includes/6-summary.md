In this module, you've learned how to send pipeline data to files and in various output formats. The following are the key takeaways:
 ...
 -  PowerShell has the `ConvertTo-Html` command that you can use when you need to display your PowerShell output in a web browser or pass it to another process. Note that `Send-MailMessage` is officially deprecated and should not be used in new scripts.
