...
:::image type="content" source="../media/configure-gateway-connections.png" alt-text="Screenshot of the Add Connection page in the Azure portal. TestVNet4GW is selected as the second virtual network gateway. The Shared key is abc123.":::
