...
:::image type="content" source="../media/AZ104_VPN_Standby-ccf4c670.png" alt-text="Diagram showing an active and standby VPN Gateway. The active gateway is connected to an on-premises VPN.":::
...
:::image type="content" source="../media/AZ104_VPN_Active-cf03055a.png" alt-text="Diagram showing two active VPN Gateways connecting through multiple paths to two on-premises VPN gateways.":::
