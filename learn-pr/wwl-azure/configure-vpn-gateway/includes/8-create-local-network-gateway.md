...
:::image type="content" source="../media/AZ104_Local_Network_Gateway2-588d3719.png" alt-text="Screenshot of the Create local network gateway page. The Name is VNet1LocalNet. The IP address is 128.8.8.8. The Address space is 10.101.0.0 24.":::
