...
> [!Important]
> Take time to carefully plan your network configuration before you begin the implementaton. Consider a scenario where a duplicate IP address range exists on both sides of your VPN connection. In this case, traffic won't route as expected.