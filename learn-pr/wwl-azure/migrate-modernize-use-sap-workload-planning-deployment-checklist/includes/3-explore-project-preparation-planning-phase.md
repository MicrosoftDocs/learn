...
- **High Availability and Disaster Recovery architecture**.
  ...
  - If you decide to use a combined HA/DR configuration that uses Azure Availability Zones, ensure that the Azure region you select supports Availability Zones. Note that cross zone latency is higher comparing with latency between Azure VMs that are part of the same availability set.
