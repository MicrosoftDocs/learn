...
3.  Once you've connected to Wi-Fi, the **Configuration** screen will appear. This will say:
...
4.  On the **Set up iOS device** screen, choose whether you want to:
...
For more information, refer to [Automatically enroll iOS devices with Apple's Device Enrollment Program](/intune/intune-service/enrollment/tutorial-use-device-enrollment-program-enroll-ios).
