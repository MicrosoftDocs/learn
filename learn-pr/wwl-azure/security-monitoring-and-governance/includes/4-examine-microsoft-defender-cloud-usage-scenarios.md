...
:::image type="content" source="../media/security-center-incident-response-figure-1-cab022fe.png" alt-text="Screenshot of a set of circles linked with arrows illustrates the closure stages of an incident response plan detection, assessment, diagnosis, and stabilization.":::
