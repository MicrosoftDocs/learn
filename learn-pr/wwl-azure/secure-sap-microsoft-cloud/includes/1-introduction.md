...
- Integrating Azure Identity Services with SAP RISE and Implementing single sign-on and MFA.
- Transitioning from SAP Identity Management to Microsoft Entra ID Governance.
- Using Microsoft Security Copilot with SAP RISE.
- Implementing Microsoft Sentinel Solution for SAP with SAP RISE.
- Implementing the SAP LogServ add-on for Microsoft Sentinel Solution for SAP.
...
- Understand and configure single sign-on (SSO) with MFA for SAP environments running in ECS/RISE using Microsoft Entra ID. 
...
- Implement the SAP LogServ add-on for Microsoft Sentinel solution for SAP.
