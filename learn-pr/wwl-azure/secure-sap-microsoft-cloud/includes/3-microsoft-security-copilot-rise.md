...
In addition to that the Security Copilot experience is embedded on the Defender XDR portal. Next to an AI-generated summary, recommendations, and remediation like password reset for SAP are provided out-of-the-box. Learn more about [fully automatic attack disruption](/azure/sentinel/sap/deployment-attack-disrupt) and [semi-automatic SAP attack disruption](https://www.youtube.com/watch?v=b-AZnR-nQpg).
