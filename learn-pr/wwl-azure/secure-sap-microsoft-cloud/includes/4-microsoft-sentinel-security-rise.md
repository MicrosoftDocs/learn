...
-	Visualize the data with [built-in workbooks](https://learn.microsoft.com/azure/sentinel/sap/sap-audit-log-workbook).
...
For more information about deploying the agentless data connector, see [Microsoft Sentinel for SAP deployment overview](https://learn.microsoft.com/azure/sentinel/sap/deployment-overview).
