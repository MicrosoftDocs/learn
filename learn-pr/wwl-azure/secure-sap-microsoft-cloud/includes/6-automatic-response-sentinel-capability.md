...
:::image type="content" source="../media/sap-rise-sentinel-adaptive-card.png" alt-text="Using Microsoft Sentinel SOAR capability with SAP RISE/ECS.":::
...
For more information on Microsoft Sentinel and SAP, including a deployment guide, see [Microsoft Sentinel product documentation](/azure/sentinel/sap/deployment-overview?tabs=agent).
