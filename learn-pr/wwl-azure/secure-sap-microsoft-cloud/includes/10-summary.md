...
- Implement Microsoft Sentinel solution for SAP for monitoring, detection, and response to suspicious activities in SAP applications. 
- Configure the SAP LogServ Add-On for Microsoft Sentinel Solution for SAP to add infrastructure layer detections otherwise owned by SAP ECS only.
- Understand the limitations of Azure Monitor for SAP solutions with SAP RISE/ECS and the alternatives available.

## More reading

- [Microsoft Sentinel Solution for SAP product documentation](/azure/sentinel/sap/solution-overview)
- [Microsoft Entra ID Governance SAP Scenarios Hub](https://aka.ms/entrasaphub)