...
![Diagram showing a network and router. Includes a transparent home and computers in each room with a router connecting them all.](../media/network-router.svg)
