In this module you have learned about connection handling, and how you can use connection pooling to improve database performance. You have also learned about some of the client tools available to work with PostgreSQL servers.
...
- [Quickstart: Connect and query PostgreSQL - Azure Data Studio | Microsoft Docs](/sql/azure-data-studio/quickstart-postgres?view=sql-server-ver15)
- [Tutorial: Design an Azure Database for PostgreSQL - Single Server - Azure PowerShell | Microsoft Docs](/azure/postgresql/tutorial-design-database-using-powershell)
- [Limits - Azure Database for PostgreSQL - Flexible Server | Microsoft Docs](/azure/postgresql/flexible-server/concepts-limits)
