...
:::image type="content" source="../media/git-release-tag-28ff3ca4.png" alt-text="Git Release Tag":::
...
:::image type="content" source="../media/tag-history-ed9cbbd4.png" alt-text="Tag History":::
