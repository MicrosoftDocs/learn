...
- Final item state and release reporting.
...
- Identify blocked items by pull request state.
- Audit delivery quality and completion criteria.
- Support retrospectives with factual trace data.
