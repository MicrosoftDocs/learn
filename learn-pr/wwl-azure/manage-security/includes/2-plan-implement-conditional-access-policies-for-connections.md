...
The benefits of deploying Conditional Access are:
 ...
 -  **Manage cost**. Moving access policies to Microsoft Entra ID reduces the reliance on custom or on-premises solutions for Conditional Access, and their infrastructure costs.

### Prerequisites

 -  A working Microsoft Entra tenant with Microsoft Entra ID P1 or P2 or trial license enabled.
