...
6.  In the **Create managed disk** page, type in a name for the disk and adjust the other settings as necessary. When you're done, select **Create**.:::image type="content" source="../media/create-a-disk-1906b02f.png" alt-text="Create a managed disk with proper name and settings.":::
