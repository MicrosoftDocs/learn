...
:::image type="content" source="../media/az500-role-based-access-control-08483ded.png" alt-text="Classic subscription administrator roles, RBAC roles, and Microsoft Entra administrator roles are related at a high level.":::


> [!IMPORTANT]
> Note that a subscription is associated with only one Microsoft Entra tenant. Also note that a resource group can have multiple resources but is associated with only one subscription. Lastly, a resource can be bound to only one resource group.
