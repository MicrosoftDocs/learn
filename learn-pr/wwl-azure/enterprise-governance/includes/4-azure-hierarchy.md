...
> ![Azure Resource Manager authenticates and handles requests for backend services.](../media/az500-resource-manager-interface.png)
...
> [!div class="mx-imgBorder"]
> ![Azure hierarchy with management groups, subscriptions, resource groups and resources.](../media/az500-hierarchy.png)
...
> [!div class="mx-imgBorder"]
> ![Management Group hieracrchy with geographical locations.](../media/az500-management-group-geography.png)
