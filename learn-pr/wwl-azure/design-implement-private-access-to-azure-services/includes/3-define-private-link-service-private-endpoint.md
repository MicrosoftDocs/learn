...
:::image type="content" source="../media/consumer-provider-endpoint.png" alt-text="Private link service workflow" lightbox="../media/consumer-provider-endpoint-2c5222b7.png":::
