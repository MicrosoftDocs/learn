...
All Azure Database for PostgreSQL servers include the [**pg_stat_statements** extension](https://www.postgresql.org/docs/current/pgstatstatements.html). This is already installed to provide functionality for tracking execution statistics of SQL statements. The server parameter **pg_stat_statements.track** defines what statements are counted by the extension. The options are:
