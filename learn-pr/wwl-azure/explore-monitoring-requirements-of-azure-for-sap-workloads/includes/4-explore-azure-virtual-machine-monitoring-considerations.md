...
Azure Monitor for SAP Solutions uses existing Azure Monitoring capabilities such as Log Analytics and Workbooks to provide additional monitoring capabilities.
