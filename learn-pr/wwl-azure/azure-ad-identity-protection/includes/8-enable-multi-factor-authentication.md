...
> ![Screenshot of the multi-factor authentication user page. Several users are selected. Drop-downs are shown for Views and Multi-Factor Auth status.](../media/az500-enable-multifactor-authentication.png)
