...
A security engineer uses Azure AD Identity Protection to share configure Azure features that monitor and protect identities in the tenant; you will work on such tasks as:
