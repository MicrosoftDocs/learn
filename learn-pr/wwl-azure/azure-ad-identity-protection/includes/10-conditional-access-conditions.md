...
> ![Image showing a Condition to test a user's access. The Condition will allow enforce MFA, or block the users access. ](../media/az500-conditional-access-policies.png)
