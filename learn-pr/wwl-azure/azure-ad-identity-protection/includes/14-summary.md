Azure AD Identity Protections helps to keep your users safe by completing access reviews, monitoring and reporting how each identity access resource on your Azure site, and implementing conditional access to control access to resources.
...
+ [Secure Azure Active Directory users with multifactor authentication](/learn/modules/secure-aad-users-with-mfa/)
