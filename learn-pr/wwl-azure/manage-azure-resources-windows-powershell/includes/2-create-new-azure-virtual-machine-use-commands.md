...
You use the resource group later when creating or modifying a VM or the resources attached to a VM.
...
> **Additional reading:** For more information about the parameters that you can use with the `New-AzVM` command, refer to [New-AzVM](/powershell/module/az.compute/new-azvm).
