...
- [Pre-migration steps for data migrations from MongoDB to Azure Cosmos DB's API for MongoDB](/azure/cosmos-db/monogdb/pre-migration-steps)
...
- [Tutorial: Migrate MongoDB to Azure Cosmos DB's API for MongoDB offline using MongoDB native tools](/azure/cosmos-db/monogdb/tutorial-mongotools-cosmos-db)
...
- [Migrate data from MongoDB to an Azure Cosmos DB for MongoDB account by using Azure Databricks](/azure/cosmos-db/monogdb/migrate-databricks)
