...
| Offline | *[Existing Mongo Tools <br>• mongodump <br>• mongorestore <br>• Studio3T)](/azure/cosmos-db/monogdb/tutorial-mongotools-cosmos-db)* | • Easy to set up and integration <br>• Needs custom handling for throttles |
| Offline | [Azure Databricks and Spark](/azure/cosmos-db/monogdb/migrate-databricks) | • Full control of migration rate and data transformation <br> • Requires custom coding |
