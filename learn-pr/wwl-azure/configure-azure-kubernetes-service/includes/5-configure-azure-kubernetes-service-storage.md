...
:::image type="content" source="../media/azure-kubernetes-service-storage.png" alt-text="Storage options for applications in an Azure Kubernetes Services cluster.":::
