...
For scripts running in Azure, managed identity is also supported. For the full list of parameter sets, see the [Connect-SPOService reference](https://learn.microsoft.com/en-us/powershell/module/sharepoint-online/connect-sposervice).
