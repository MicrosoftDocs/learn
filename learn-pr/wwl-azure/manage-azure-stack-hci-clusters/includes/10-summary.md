...
- [Manage Azure Stack HCI clusters using Windows Admin Center](https://docs.microsoft.com/azure-stack/hci/manage/cluster)
- [Manage Azure Stack HCI clusters using PowerShell](https://docs.microsoft.com/azure-stack/hci/manage/cluster-powershell)
- [Update Azure Stack HCI clusters](https://docs.microsoft.com/azure-stack/hci/manage/update-cluster)
- [Monitor Azure Stack HCI clusters](https://docs.microsoft.com/azure-stack/hci/manage/monitor-cluster)
- [Set up a cluster witness](https://docs.microsoft.com/azure-stack/hci/manage/witness)
