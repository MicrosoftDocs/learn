...
You'll direct foreign principals in the Fabrikam directory (without suffix `fabrikam.onmicrosoft.com`) to sign in using `https://portal.local.azurestack.external/fabrikam.onmicrosoft.com`.
