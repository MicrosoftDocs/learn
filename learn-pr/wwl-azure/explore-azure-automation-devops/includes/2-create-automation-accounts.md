To start using the Microsoft Azure Automation service, you must create an [Automation account](https://azure.microsoft.com/documentation/articles/automation-security-overview/) from within the Azure portal.
