...
:::image type="content" source="../media/azure-management-groups-38f2d580.png" alt-text="Diagram showing an example of the hierarchy of management groups and subscriptions.":::
...
:::image type="content" source="../media/management-groups-and-subscriptions-1558cb98.png" alt-text="Diagram showing an example of the role definition and assignment hierarchy path.":::
...
:::image type="content" source="../media/audit-management-groups-367e6dae.png" alt-text="Screenshot showing an example of audit management groups using activity logs.":::
