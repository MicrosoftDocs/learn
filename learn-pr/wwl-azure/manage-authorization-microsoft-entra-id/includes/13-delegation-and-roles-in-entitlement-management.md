...
:::image type="content" source="../media/delegate-administrators-managers-4aed1265.png" alt-text="Diagram showing an example of delegate access governance.":::
...
:::image type="content" source="../media/entitlement-management-delegate-881906a0.png" alt-text="Diagram showing an example of catalogs with resources.":::
...
| User                               | Catalog owner                   | Only if group owner        | Only if group owner             | Only if app owner<br><br> |
