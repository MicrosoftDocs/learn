...
:::image type="content" source="../media/add-network-security-rule-2f306d23.png" alt-text="Screenshot that shows how to configure settings to create an inbound security rule in the Azure portal.":::
