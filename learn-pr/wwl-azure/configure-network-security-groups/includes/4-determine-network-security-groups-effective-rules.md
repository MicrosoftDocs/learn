...
:::image type="content" source="../media/AZ104_NSG_Eff_Rules-bdeda8a8.png" alt-text="A NSG is shown controlling traffic to a subnet. Inside the subnet another NSG is shown controlling traffic to a virtual machine NIC.":::
...
:::image type="content" source="../media/AZ104_NSG_Eff_Rules2-fb01b3b3.png" alt-text="Screenshot of the Networking blade in the Azure portal. The Effective security rules link is highlighted.":::
