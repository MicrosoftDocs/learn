...
Your organization wants to ensure access to virtual machines is restricted.  As the Azure Administrator you need to:
...
+ **Task 2**: Create a network security group and associate the group with the virtual machine.
    ...
    + Associate the network security group with the virtual machine network interface.  
+ **Task 3**: Configure an inbound security port rule to allow RDP.
    + Verify you can't connect to the virtual machine using RDP.
