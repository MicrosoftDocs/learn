...
:::image type="content" source="../media/new-web-application-firewall-9bba4b53.png" alt-text="Diagram showing an example of a web application firewall providing centralized protection.":::
