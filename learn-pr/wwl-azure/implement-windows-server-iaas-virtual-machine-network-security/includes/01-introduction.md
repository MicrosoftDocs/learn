...
In this module, you learn how to implement Network Security Groups (NSGs), adaptive network hardening, and Azure Firewall. You learn how to choose an appropriate network traffic filtering solution, and how to log traffic with Network Watcher.
