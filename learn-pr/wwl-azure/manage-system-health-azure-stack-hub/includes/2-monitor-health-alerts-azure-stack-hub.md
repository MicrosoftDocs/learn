...
:::image type="content" source="../media/monitor-health-alerts-image-1-ad62f4a5.png" alt-text="Screenshot showing Region Management in the Azure Stack Hub administrator portal.":::
...
:::image type="content" source="../media/monitor-health-alerts-image-2-515c83c4.png" alt-text="Screenshot showing the list of infrastructure roles.":::
...
:::image type="content" source="../media/monitor-health-alerts-image-3-3cc20d2b.png" alt-text="Screenshot showing alerts and  warnings in Azure Stack Hub administrator portal.":::
...
:::image type="content" source="../media/monitor-health-alerts-image-4-e0e11389.png" alt-text="Screenshot showing filter by critical or warning status in Azure Stack Hub administrator portal.":::
...
:::image type="content" source="../media/monitor-health-alerts-image-5-380011a1.png" alt-text="Screenshot showing alert details blade in Azure Stack Hub administrator portal.":::
