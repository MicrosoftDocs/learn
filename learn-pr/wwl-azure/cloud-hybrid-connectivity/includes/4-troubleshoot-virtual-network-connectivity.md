...
:::image type="content" source="../media/4-gateway-transit.png" alt-text="Screenshot of gateway transit with virtual network peering." border="false":::
...
- By default, VNetA is peered with VNetC.
