...
![Illustration of a fingerprint.](../media/fingerprint.png)

Modern tools that use this type of identity are very advanced. Using a face for ID involves a number of things. For example, these tools may measure the distance between the center of their eyes. It also may examine the shape of their mouth. The size of their forehead may play a factor. All of these pieces of data are used together to identify them.
...
Any programmer that uses these tools should let the user know that they are using them. And data should be stored very carefully. Users should always have the chance to delete any biometric data. Users also should have the option to sign in to their devices in ways other than using biometrics.
