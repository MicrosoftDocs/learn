...
:::image type="content" border="true" source="../media/Key-roles-for-Microsoft-Dev-Box.png" alt-text="Diagram of key roles required for Microsoft Dev Box." lightbox="../media/Key-roles-for-Microsoft-Dev-Box.png":::
