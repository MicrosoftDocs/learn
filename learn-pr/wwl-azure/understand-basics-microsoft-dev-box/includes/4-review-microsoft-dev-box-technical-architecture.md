...
:::image type="content" source="../media/high-level-architecture-microsoft-dev-box.png" alt-text="Diagram of High level architecture of Microsoft Dev Box." lightbox="../media/high-level-architecture-microsoft-dev-box.png" :::
