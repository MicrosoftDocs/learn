...
| --- | --- | --- | --- | --- | --- | --- |
| Usage | Development, test | Development, test | Dedicated development, test | Production workloads | Enhanced scale, performance | High performance, security, isolation |
