...
In this module’s scenario, you’ll navigate to the Data hub to manage the stored data from your SAP BW system and Cosmos DB.
...
In this module’s scenario, you’ll use the Develop hub to move and analyze your data with SQL scripts for pipelines and machine learning.

### Integrate

The Integrate hub helps you manage data integration pipelines. If you’re familiar with Azure Data Factory, then you’ll feel at home, because the pipeline creation experience is the same as in Azure Data Factory. This hub eliminates the need to use Azure Data Factory separately for data movement and transformation pipelines.

In this module’s scenario, you’ll use the Integrate hub to build a pipeline to bring in the data with linked services and transform it for analysis.
...
In this module’s scenario, you’ll use the Manage hub to set up linked services that will help you access the SAP and Cosmos DB data, then bring the data into a SQL pool for analytics.
...
In this module’s scenario, you’ll use the Visualize hub with Power BI to visualize data in the SQL pool.
