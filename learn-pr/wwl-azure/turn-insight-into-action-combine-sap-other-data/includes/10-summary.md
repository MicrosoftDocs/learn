...
- [Copy data from an SAP table - Azure Data Factory & Azure Synapse | Microsoft Docs](/azure/data-factory/connector-sap-table?tabs=data-factory)
- [Azure Synapse workspace access control overview - Azure Synapse Analytics | Microsoft Docs](/azure/synapse-analytics/security/synapse-workspace-access-control-overview)
- [Tutorial: Get started analyze data in Storage accounts - Azure Synapse Analytics | Microsoft Docs](/azure/synapse-analytics/get-started-analyze-storage)
