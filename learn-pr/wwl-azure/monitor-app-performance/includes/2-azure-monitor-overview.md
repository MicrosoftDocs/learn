...
* **Azure resource monitoring data**: Data about the operation of an Azure resource. For a complete list of the resources that have metrics or logs, visit [What can you monitor with Azure Monitor?](https://docs.microsoft.com/azure/azure-monitor/monitor-reference#list-of-azure-monitor-supported-services)
