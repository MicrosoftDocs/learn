...
A greenfield project is one done on a green field, that is, undeveloped land. A brownfield project is one done on the used ground that has for other purposes.

Because of the land use that has once occurred, there could be challenges with reusing the land. Like existing buildings, some would be obvious but less obvious, like polluted soil.<br>

## Applied to software or DevOps Projects

The same terms are routinely applied to software projects and are commonly used to describe DevOps Projects.
