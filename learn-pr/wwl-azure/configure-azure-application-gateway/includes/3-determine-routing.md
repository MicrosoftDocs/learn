...
:::image type="content" source="../media/app-gateway-path.png" alt-text="Path-based routing.":::
...
:::image type="content" source="../media/app-gateway-site.png" alt-text="Multiple site routing.":::
