You'll need to consider which identity provider you want to use for Azure Stack Hub deployment, either Azure Active Directory (AD) or Active Directory Federation Services (AD FS). You can't switch identity providers after deployment without full system redeployment. If you don't own the Azure AD account and are using an account provided to you by your Cloud Solution Provider, and if you decide to switch provider and use a different Azure AD account, you'll have to contact your solution provider to redeploy the solution for you at your cost.
