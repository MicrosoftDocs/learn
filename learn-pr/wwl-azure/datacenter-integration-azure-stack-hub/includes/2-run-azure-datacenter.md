...
There are some differences between Azure and Azure Stack Hub. Some are visible, and others can't be seen until late in the implementation cycle. Be aware of the following differences:
...
For guidance on specific elements of the cloud adoption journey, see the [Microsoft Cloud Adoption Framework](/azure/cloud-adoption-framework/scenarios/azure-stack/).

:::image type="content" source="../media/azure-stack-hybrid-1-13730b73.png" alt-text="Overview of Azure Stack Hub hybrid model.":::
