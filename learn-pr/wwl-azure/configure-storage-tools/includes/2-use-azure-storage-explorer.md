...
:::image type="content" source="../media/storage-explorer.png" alt-text="Screenshot of the Storage Explorer. The navigation pane is expanded and a folder in the blob container is selected. The folder contains several documents.":::
...
:::image type="content" source="../media/storage-explorer-connection-options-1.png" alt-text="Screenshot of the Azure Explorer Manage Accounts page.":::
...
:::image type="content" source="../media/storage-explorer-connection-options-2.png" alt-text="Screenshot of Storage Explorer. The wizard to connect to external storage is displayed, prompting for an account name, account key, and storage endpoint domain.":::
