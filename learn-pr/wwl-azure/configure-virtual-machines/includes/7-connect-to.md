There are several ways to access your Azure virtual machines. There are options for connecting Windows and Linux machines, and making connections by using Azure Bastion.
...
:::image type="content" source="../media/connect-bastion.png" alt-text="Screenshot that shows a virtual machine connection with Azure Bastion in the Azure portal.":::