Before you create an Azure virtual machine, it's helpful to make a plan for your machine configuration. 
...
For Storage pricing, you're charged separately for the Azure Storage the virtual machine uses. The status of the virtual machine has no relation to the Azure Storage charges that are incurred. You're always charged for any Azure Storage used by the disks. 
