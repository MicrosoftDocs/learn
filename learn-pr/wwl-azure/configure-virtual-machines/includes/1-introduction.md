...
You're responsible for deploying the new virtual machines. Your deployment tasks will include correctly sizing the machines, selecting storage, and configuring networking.
