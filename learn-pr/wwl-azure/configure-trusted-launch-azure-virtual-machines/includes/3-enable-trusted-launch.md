...
:::image type="content" source="../media/trusted-launch-security-type-upgrade.png" alt-text="Diagram showing a Standard security VM transitioning through an Enable Trusted Launch step to a Trusted Launch VM with Secure Boot, vTPM, and integrity monitoring active." lightbox="../media/trusted-launch-security-type-upgrade.png":::
