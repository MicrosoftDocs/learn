...
If you have a scratch of the architecture you are planning for the DevOps implementation, you already know part of the resources to consume.

For example, you started with version control-implementing Git and created some pipelines to build and release your code.

If you have multiple teams building their solutions, you do not want to wait in the queue to start building yours.
...
To consider:
 ...
 -  Do you have an advanced Packagement Management strategy? Maybe you need more space for Artifacts.
