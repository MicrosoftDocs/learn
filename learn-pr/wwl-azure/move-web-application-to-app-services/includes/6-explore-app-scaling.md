...
Unless you have this data based on your current implementation, spending time gather some data to see how your application performs under "normal" conditions may help you create rules for those scenarios when you expect more demand.
