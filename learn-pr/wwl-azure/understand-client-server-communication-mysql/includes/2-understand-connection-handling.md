...
For best performance, you should typically use **ProxySQL**, or **Heimdall Data Proxy** proxy solutions for MySQL. For more information on copnnection efficiency, see [Connection Efficiency](/azure/mysql/single-server/concept-performance-best-practices).