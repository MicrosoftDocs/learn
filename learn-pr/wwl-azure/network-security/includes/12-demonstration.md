...
1. Make a note of the virtual machines **private IP** address.
1. On the **Inbound port rules** tab, click **Add inbound port rule**. This rule will only allow certain IP address on port 80. As you go through the configuration settings be sure to discuss each one. 
	* Source: **Service Tag**
