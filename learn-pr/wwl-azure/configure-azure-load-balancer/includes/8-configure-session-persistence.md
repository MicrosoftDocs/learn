...
:::image type="content" source="../media/AZ104_Session_Persistence-bab43adc.png" alt-text="Illustration of hash-based distribution with a load balancer and 3 virtual machines.":::
