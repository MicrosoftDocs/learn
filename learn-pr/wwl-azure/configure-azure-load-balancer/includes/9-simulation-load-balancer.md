...
+ **Task 1: Provision the lab environment.** In this task, you'll deploy four virtual machines into the same Azure region. The first two will reside in a hub virtual network, while the remaining two will reside in a separate spoke virtual network.
