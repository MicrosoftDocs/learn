...
:::image type="content" source="../media/internal-load-balancer.png" alt-text="Diagram showing how an internal load balancer works. Three VMs are shown going through a load balancer to access SQL servers in the database tier subnet. The SQL servers are responding on port 1443.":::
