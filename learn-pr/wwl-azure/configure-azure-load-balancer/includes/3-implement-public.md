...
:::image type="content" source="../media/public-load-balancer.png" alt-text="Diagram showing how public load balancer works. Incoming requests on port 80 are sent to the public load balancer. The LB sends requests on port 80 to three VMs in the web tier subnet.":::
