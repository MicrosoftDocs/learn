...
:::image type="content" source="../media/health-probes-1.png" alt-text="Screenshot of the HTTP custom probe page. The port is 80. The interval is 5. The unhealthy threshold is 2.":::
