...
:::image type="content" source="../media/backend-pool-1.png" alt-text="Flowchart. The frontend is connected to the load balancer. The load balancer is connected to the backend.":::
...
:::image type="content" source="../media/backend-pool-2.png" alt-text="Screenshot of the Settings for Backend pools shows the list of options available for configuring the backend pool.":::
