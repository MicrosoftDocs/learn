...
6.  In the main Parts Unlimited menu, click **Pipelines,** then **Releases**, **Edit** to see the release pipeline. Click the link to **View stage tasks**.
...
12. From the **Azure Subscription** drop-down list, find and select the **Azure Resource Manager Service Connection** that we created.
