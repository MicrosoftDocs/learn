...
![Image showing various computers with an IP Address underneath each one](../media/ip-address-computers.svg)
...
![Image showing hierarchy of computers to portray a newtwork and subnets](../media/network-subnets.svg)
