...
> ![Diagram showing an internal user going to on-premises AD and Azure. External users are using the web application proxy.](../media/az500-federation-azure-active-directory.png)
