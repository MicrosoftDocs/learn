...
:::image type="content" source="../media/four-part-circle-infrastructure-ca68be80.png" alt-text="Screenshot of four-part circle with Infrastructure, app architecture, monitoring, and continuous validation.":::
