:::image type="content" source="../media/private-links-602b4a62.png" alt-text="An Azure Private Link connects a N S G private endpoint with S Q L database. A direct connection is not allowed.":::
