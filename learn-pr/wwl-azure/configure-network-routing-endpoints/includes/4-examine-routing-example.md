...
:::image type="content" source="../media/rout-example.png" alt-text="A public subnet uses a routing table to access the private subnet.":::
...
:::image type="content" source="../media/create-routing-table.png" alt-text="Screenshot of the Create route table page. BGP route propagation is Enabled.":::
...
:::image type="content" source="../media/associate-route.png" alt-text="Screenshot of a route table being assocated with a virtual network.":::
