...
:::image type="content" source="../media/system-routes.png" alt-text="Diagram of two subnets. One subnet is using a System route to access the internet. The other subnet is using a System route to access the first subnet. Both subnets are accessing a route table.":::
