:::image type="content" source="../media/private-links.png" alt-text="An Azure Private Link connects a NSG Private endpoint with SQL database. A direct connection is not allowed.":::
