...
:::image type="content" source="../media/service-endpoint-addresses.png" alt-text="Diagram of a VM connecting to the Azure service through a service endpoint. The Azure services include CosmosDB, Event Hub, Key Vault, SQL, and Storage. The Azure Service cannot connect to the Internet.":::
