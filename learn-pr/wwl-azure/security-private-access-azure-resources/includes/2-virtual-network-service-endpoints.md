...
:::image type="content" source="../media/dec-service_endpoints_overview-59d58c8e.png" alt-text="Screenshot showing how to secure Azure service access from on-premises.":::
