...
Virtual network integration supports connecting to a virtual network in the same region. Using virtual network integration enables your app to access:
 ...
 -  Resouces in the virtual network you're integrated with.<br>
...
:::image type="content" source="../media/vnetint-how-regional-works-93ffceb1.png":::
...
## :::image type="content" source="../media/rbac-permissions-fea6d4f2.png" alt-text="Table showing permsiions actions and descriptions.":::  Routes
