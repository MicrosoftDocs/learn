...
Once you've made edits to the file, you'll need to run the "git add" command to stage the file, and then a git commit to commit the file to the current branch of the repo.
