...
Once the files are in the staging area, you need to commit the files to your local branch and repository. The git commit command adds the files into the current branch and makes them a permanent part of your local repository.
