...
In addition to GitHub, Azure DevOps, SourceForge, and BitBucket are also common git repository hosting sites.
...
:::image type="content" source="../media/git-bash-interface.png" alt-text="Screenshot of the git bash interface with the git help command run.":::
