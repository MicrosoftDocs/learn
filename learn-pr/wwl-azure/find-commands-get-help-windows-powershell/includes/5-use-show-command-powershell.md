The **Show-Command** cmdlet opens a window that displays either a list of commands or a specific command's parameters. This is the same window that displays when you select the **Show** **Command Window** option in the ISE.
