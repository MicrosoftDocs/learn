...
:::image type="content" source="../media/configure-secure-signatures-be02fa89.png" alt-text="Screenshot of the Create a S A S key page.":::
...
> [!NOTE]
> SAS provides both **account-level** and **service-level** control. The account-level SAS delegates access to resources in one or more of the storage services. The service-level SAS delegates access to a resource in just one of the storage services.
