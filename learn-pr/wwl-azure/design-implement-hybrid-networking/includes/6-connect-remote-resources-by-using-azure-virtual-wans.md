...
There are two types of Virtual WANs: Basic and Standard. This table shows the available configurations for each type.
...
:::image type="content" source="../media/cross-tenant-connectivity-8c970006.png" alt-text="Diagram of a virtual hub connection.":::
...
To learn more about how to configure routing, view [How to configure virtual hub routing](/azure/virtual-wan/how-to-virtual-hub-routing).
