...
5.  Select **Enable** all to enable all of the plans for Defender for Cloud.
    ...
    :::image type="content" source="../media/enable-all-plans-fe385b32-a9dc981e.png" alt-text="Screenshot showing an example of how to Enable all plans in Defender for Cloud's Settings page.":::
