...
:::image type="content" source="../media/microsoft-defender-for-cloud-subcription-8a3695a1.png" alt-text="Screenshot showing an example of how to search for Microsoft Defender for Cloud.":::
