...
We would specify extra production configurations, such as registry configurations, MSIexec of other components. Any of those environment configurations you would hand off to your ops folks to prepare the VM.
...
To run unit tests, you could place the following stage between builder and publish.
...
When you hit F5, Visual Studio will compile the code on your dev machine. It then volume mounts the output to the built runtime image, the first stage.

This way, you can test any configurations you have made to your production image, such as registry configurations or otherwise.
