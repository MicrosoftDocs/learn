...
( ) To provide extra security measures for Azure Pipelines. {{Incorrect. Agents are not used to provide extra security measures for Azure Pipelines.}}
...
( ) To define a value that can't be changed from run to run or job to job of your pipeline. {{Incorrect. Variables are mutable and their value can change from run to run or job to job of your pipeline.}}
...
( ) A trigger is a prepackaged script that performs an action. {{Incorrect. This describes the purpose of a task, not a trigger.}}
