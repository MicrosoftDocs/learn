...
:::image type="content" source="../media/monitor-alerts.png" alt-text="Screenshot of the Alerts page in Azure Monitor, displaying a list of all current alerts." lightbox="media/monitor-alerts-expanded.png" border="true":::
