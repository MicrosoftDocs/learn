...
:::image type="content" source="../media/alert-grouping-options-and-descriptions-ed6c3d91.png" alt-text="Table showing alert grouping options and descriptions.":::
<br>
...
:::image type="content" source="../media/automated-response-tab-2d26d892.png" alt-text="Screenshot showing how to create a new scheduled rule.":::
...
:::image type="content" source="../media/review-and-create-tab-44de7fa6.png" alt-text="Screenshot showing how to view a rule and its output.":::
