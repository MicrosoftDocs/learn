...
:::image type="content" source="../media/add-new-playbook%20%281%29-bbdac620.png" alt-text="Screenshot showing steps to create a new playbook in Microsoft Sentinel.":::
...
:::image type="content" source="../media/create-playbook-basics-3ecbebc8.png" alt-text="Screenshot showing the create palybook page.":::
...
1. In the **Basics** tab:
 ...
 -  If your playbooks need access to protected resources that are inside or connected to an Azure virtual network, you may need to use an integration service environment (ISE). If so, mark the **Associate with integration service environmen**t check box, and select the desired ISE from the drop-down list.
