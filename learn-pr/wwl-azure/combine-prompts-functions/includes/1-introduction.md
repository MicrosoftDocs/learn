...
For example, you can design a prompt with a function that can complete a designated item on a user's todo list. Or you could design a prompt that uses a function to retrieve the user's music preferences and provide personalized concert recommendations. Nesting functions within prompts allows you to create complex interactions and provide more value to your users.
