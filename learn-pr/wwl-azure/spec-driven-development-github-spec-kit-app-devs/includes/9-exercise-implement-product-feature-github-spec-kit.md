...
1. Create the spec.md file for a new feature using stakeholder requirements.
1. Update the spec.md file with clarified requirements.
1. Generate the plan.md file using the spec.md file and constitution.
1. Generate the tasks.md file using the spec.md file, plan.md file, and constitution.
