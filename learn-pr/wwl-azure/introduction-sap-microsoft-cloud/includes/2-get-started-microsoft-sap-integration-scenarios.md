[According to SAP over 87% of total global commerce is SAP customers](https://www.sap.com/documents/2017/04/4666ecdd-b67c-0010-82c7-eda71af511fa.html) and more SAP systems are running in the cloud each year. The SAP platform provides a foundation for innovation for many companies and can handle various workloads natively. Explore our integration section further to learn how you can combine the Microsoft Azure ecosystem with your SAP workload to accelerate your business outcomes. Among the scenarios are extensions with Power Platform, secured APIs with Azure API Management, automated business processes with Logic Apps, and SAP Business Technology Platform.

:::image type="content" source="../media/power-automate-data-inclusive.png" alt-text="Image showing how Power Platform works with other parts of the Microsoft ecosystem to extend SAP solutions.":::
...
We have over 30 years of partnership between SAP and Microsoft, which is a foundation to support common goals long-term, including a joint commitment by SAP and Microsoft to simplify and streamline customers to the cloud. For more information, see:
...
| Area | Description |
| ---- | ----------- |
| [Azure OpenAI service](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#azure-openai-service) | Learn how to integrate your SAP workloads with Azure OpenAI service. |
| [Microsoft Copilot](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-copilot) | Learn how to integrate your SAP workloads with Microsoft Copilots. |
| [SAP RISE managed workloads](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/rise-integration-services.md) | Learn how to integrate your SAP RISE managed workloads with Azure services. |
| [Microsoft Entra ID (formerly Azure Active Directory)](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-entra-id-formerly-azure-ad) | Ensure end-to-end SAP user lifecycle, authentication, and authorization with Microsoft Entra ID. Identity governance, Single sign-on (SSO) and phish-resistant multifactor authentication (MFA) are the foundation for a secure and seamless user experience. |
| [Threat Monitoring and Response Automation with Microsoft Security Services for SAP](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-security-for-sap) | Learn how to best secure your SAP workload with Microsoft Defender XDR, Defender for Cloud, the [SAP certified](https://www.sap.com/dmc/exp/2013_09_adpd/enEN/#/solutions?id=s:33db1376-91ae-4f36-a435-aafa892a88d8) Microsoft Sentinel solution, and immutable vault for Azure Backup. Prevent incidents from happening, detect, and respond to threats in real-time. |
| [Microsoft Power Platform](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-power-platform) | Learn about the available out-of-the-box SAP solutions enabling your business users to achieve more with less. |
| [Microsoft Teams](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-teams) | Discover collaboration scenarios boosting your daily productivity by interacting with your SAP applications directly from Microsoft Teams. |
| [Microsoft Universal Print](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-universal-print) | Learn about the available cloud native printing capabilities for SAP. |
| [SAP Fiori](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#sap-fiori) | Increase performance and security of your SAP Fiori applications by integrating them with Azure services. |
| [Microsoft Office](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#microsoft-office) | Learn about Office Add-ins in Excel, doing SAP Principal Propagation with Office 365, SAP Analytics Cloud, and Data Warehouse Cloud integration and more. |
| [Azure Integration Services](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#azure-integration-services) | Connect your SAP workloads with your end users, business partners, and their systems with world-class integration services. Learn about codevelopment efforts that enable SAP Event Mesh to exchange cloud events with Azure Event Grid, understand how you can achieve high-availability for services like SAP Cloud Integration, automate your SAP invoice processing with Logic Apps and Azure AI services and more. |
| [App Development in any language including ABAP and DevOps](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#app-development-in-any-language-including-abap-and-devopss) | Apply best-in-class developer tooling to your SAP app developments and DevOps processes. |
| [Azure Data Services](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#azure-data-services) | Learn how to integrate your SAP data with Data Services like Azure Synapse Analytics, Azure Data Lake Storage, Azure Data Factory, Power BI, Data Warehouse Cloud, Analytics Cloud, which connector to choose, tune performance, efficiently troubleshoot, and more. |
| [SAP Business Technology Platform (BTP)](https://github.com/MicrosoftDocs/azure-docs/blob/main/articles/sap/workloads/integration-get-started.md#sap-btp) | Discover integration scenarios like SAP Private Link to securely and efficiently connect your BTP apps to your Azure workloads. |
...
- [Outbound E-Mail from SAP to Exchange Online](/azure/sap/workloads/integration-get-started?source=recommendationsd)
- [Enable SAP Principal Propagation for live OData feeds with Excel](/azure/sap/workloads/expose-sap-odata-to-power-query)
...
For more information about integration with Microsoft Teams, see [Native SAP apps on the Teams marketplace](https://appsource.microsoft.com/marketplace/apps?page=1&search=sap&product=teams). Also see the following SAP resources. 
...
- [Overview of SAP integration](/power-platform/sap/connect/connect-power-platform-and-sapp)
...
- [Universal Print for SAP frontend scenarios](/azure/sap/workloads/universal-print-sap-frontend)
- [Universal Print for SAP backend scenarios](https://github.com/Azure/universal-print-for-sap-starter-pack)

Also see the following SAP resources:

- [It's easy to print from SAP with Microsoft Universal Print](https://community.sap.com/t5/technology-blogs-by-members/it-has-never-been-easier-to-print-from-sap-with-microsoft-universal-print/ba-p/13672206)
