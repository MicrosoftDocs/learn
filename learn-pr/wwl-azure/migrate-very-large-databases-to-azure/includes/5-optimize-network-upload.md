...
:::image type="content" source="../media/copy-on-premises-r3load-azure-blob-storage-with-azcopy-b74811ab.png" alt-text="Copy from on-premises R3load export servers to Azure blob storage via Public Internet with AzCopy":::
...
:::image type="content" source="../media/4-intel-r3load-servers-running-r3load-320bdf60.png" alt-text="Block diagram illustrating 4 Intel R3load servers running R3load":::
