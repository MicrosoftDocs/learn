...
:::image type="content" source="../media/block-typical-vldb-os-db-migration-71f8df6e.png" alt-text="Block diagram of a typical VLDB OS DB migration and move to Azure":::
