...
For example, two S1 units are 2x12 = 24 new connections/sec, but you have at least 100 new connections/sec across your units. With nine S1 units, you have 108 new connections/sec (9x12) across your units.
  :::column-end:::
  :::column:::
...
For example, two S1 units are 2x12 = 24/sec, but you have at least 100 send operations/sec across your units. With nine S1 units, you have 108 send operations/sec (9x12) across your units.
  :::column-end:::
  :::column:::
...
:::row:::
  :::column:::
    Maximum device stream data transfer\*
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    The maximum number of concurrent jobs is 1 (for Free and S1), 5 (for S2), and 10 (for S3). However, the maximum number of concurrent device import/export jobs is 1 for all tiers.
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Paid SKU hubs may have 10 additional endpoints. Free SKU hubs may have one other endpoint.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
...
:::row:::
  ...
  :::column-end:::
  :::column:::
    Maximum message size 64 KB. The maximum number of pending messages for delivery is 50 per device.
  :::column-end:::
:::row-end:::
:::row:::
  :::column:::
