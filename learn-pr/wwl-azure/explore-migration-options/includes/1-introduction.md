...
The SAP Landscapes that your company will migrate to Azure are in different stages in the SAP software update cycle and have different SAP software. You will need to migrate some SAP workloads in conjunction to performing an upgrade and need to choose the appropriate migration strategy.
