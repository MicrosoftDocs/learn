...
Description automatically generated](../media/asd-module-troubleshoot-web-app-down-scenarios-with-app-service-diagnostics-clean-copy-22-03.png)

 

[Alt Text: Screenshot of the resulting call stack and exception message from the memory dump file via Crash Monitoring.]
