...
:::image type="content" source="../media/module-troubleshoot-web-app-down-scenarios-with-app-service-diagnostics-clean-copy-22-01.png" alt-text="<Screenshot of an HTTP 503 Server Error detected.>"::: 
