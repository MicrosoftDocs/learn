...
:::image type="content" source="../media/module-troubleshoot-web-app-down-scenario-with-app-service-diagnostics-22-04.png" alt-text="Screenshot of Ask Genie showing an insight pointing out that the app does not have a certificate configured against it." lightbox="../media/module-troubleshoot-web-app-down-scenario-with-app-service-diagnostics-22-04.png":::
