...
- **Migrating databases**. There are a few large on-premises SQL server databases that need to be migrated to the cloud that contains anywhere from 40 TB to 80 TB off data. 
