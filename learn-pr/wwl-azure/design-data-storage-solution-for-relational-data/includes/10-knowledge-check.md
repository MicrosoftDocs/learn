...
- **Inventory application**. you plan to migrate the inventory application workload with a databse to the cloud, but you use a third-party application that requires Windos authentication. 
...
- **Migrating databases**. There are a few large on-premises SQL server databases that need to be migrated to the cloud that contain anywhere from 40 to 80 TB off data. 
