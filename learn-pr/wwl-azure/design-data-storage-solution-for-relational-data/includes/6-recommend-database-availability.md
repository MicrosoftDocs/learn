...
### Things to know about availability in the General Purpose tier
...
:::image type="content" source="../media/general-purpose.png" alt-text="Diagram that shows SQL database high availability in the vCore General Purpose tier." border="false":::
...
### Things to know about availability in the Business Critical tier
...
:::image type="content" source="../media/business-critical.png" alt-text="Diagram that shows SQL database high availability in the vCore Business Critical tier." border="false":::
...
### Things to know about availability in the Hyperscale tier
...
### Things to consider when choosing a service tier for database availability
...
| SQL Database vCore tier | SQL Managed Instance DTU tier | Database availability support |
| --- | --- | --- |
...
| **Hyperscale** | n/a | Offers highly scalable storage and meets read-scale requirements for business workloads |