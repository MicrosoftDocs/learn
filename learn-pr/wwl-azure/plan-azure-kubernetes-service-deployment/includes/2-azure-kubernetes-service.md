...
:::image type="content" source="../media/kubernetes-architecture-components1-b33d5784.png" alt-text="Diagram showing how the basic components and resources for Azure Kubernetes.":::
