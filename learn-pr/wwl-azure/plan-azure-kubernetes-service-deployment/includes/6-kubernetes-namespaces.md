...
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| *default*     | Where pods and deployments reside. In smaller environments, you can deploy applications directly into the default namespace without creating other logical separations. The default namespace when you interacting with the Kubernetes API, such as with kubectl get pods. |
