The built-in capabilities of Microsoft Defender for IoT enable you to use the service without developing custom Microsoft Defender for IoT security agents.

If Microsoft Defender for IoT was previously disabled, you can re-enable it as follows:
...
To secure your IoT solution, IP addresses of incoming and outgoing connections to and from your IoT devices, IoT Edge, and IoT Hub(s) are collected and stored by default. This information is essential to detect abnormal connectivity from suspicious IP sources. For example, when attempts are made to establish connections from an IP source of a known botnet or from an IP source outside your geolocation. Microsoft Defender for IoT service offers the flexibility to enable and disable collection of IP address data at any time.
...
By default, turning on the Microsoft Defender for IoT solution automatically secures all IoT Hubs under your Azure subscription.
