...
Congratulations! You've sucesffuly installed Git and Visual Studio Code. You've also configured Visual Studio Code to start working with your Git repository.
