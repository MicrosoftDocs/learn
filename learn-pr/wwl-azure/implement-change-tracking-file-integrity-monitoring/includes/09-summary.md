...
- [File Integrity Monitoring in Azure Security Center](https://aka.ms/security-center-file-integrity-monitoring?azure-portal=true)
...
- [Enable Update Management from the Azure portal](https://docs.microsoft.com/azure/automation/update-management/update-mgmt-enable-portal)
