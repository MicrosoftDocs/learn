...
To use a Log Analytics workspace for File Integrity Monitoring, the workspace must be running under the Defender for Cloud Standard tier. If it isn't, any workspaces that are on the File Integrity Monitoring node will have an **UPGRADE PLAN** link.

> [!TIP] 
> Those workspaces that are already in the Defender for Cloud Standard tier are indicated with an ENABLE link.

To upgrade the workspace to Defender for Cloud Standard tier, use the following procedure:
...
[![A screenshot of the Azure portal, Defender for Cloud File Integrity Monitoring page. Several workspaces are listed. One is marked with UPGRADE PLAN, and two are marked ENABLE.](../media/m10-upgrade-plan-1.png)](../media/m10-upgrade-plan-1.png#lightbox)
...
1. Select **ENABLE** for any workspaces that you want to enable for File Integrity Monitoring.
   ...
   ![A screenshot of the Azure portal, Enable File Integrity Monitoring page of the Defender for Cloud is displayed. Recommended settings are  Windows Files, Registry, and Linux Files.](../media/m10-enable-file-integrity-monitoring-1.png)
...
After you have enabled File Integrity Monitoring, on the File Integrity Monitoring dashboard in Defender for Cloud, the following information is provided for each workspace:
...
![A screenshot of the  Defender for Cloud's File Integrity Monitoring blade. Three servers display, with six changes.](../media/m10-file-integrity-monitoring-dashboard-1.png)
