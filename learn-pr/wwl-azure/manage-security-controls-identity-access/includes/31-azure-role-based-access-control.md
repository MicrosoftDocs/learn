...
:::image type="content" source="../media/security-principal-e76321d5-2b53aa5f.png" alt-text="Diagram showing an example of the Azure role-based access control security principal.":::
...
:::image type="content" source="../media/role-definition-1e3bf690-3cab3ad5.png" alt-text="Diagram showing an example of the Azure role-based access control role definitions.":::
...
:::image type="content" source="../media/role-based-access-scope-9bb52854-29b3f177.png" alt-text="Diagram showing an example of the Azure role-based access control set of resources.":::
...
:::image type="content" source="../media/role-based-access-overview-967362c8-dda8fdde.png" alt-text="Diagram showing an example of the Azure role-based access control role assignments.":::
...
:::image type="content" source="../media/groups-transitive-a12061a3-100b6777.png" alt-text="Diagram showing an example of the Azure role-based access control groups.":::
...
:::image type="content" source="../media/multiple-roles-52c0419e-5053e0fc.png" alt-text="Diagram showing an example of Azure role-based access control multiple role assignments.":::
...
:::image type="content" source="../media/evaluation-logic-051afc54-42335dba.png" alt-text="Diagram showing an example of Azure role-based access control evaluation logic.":::
