...
:::image type="content" source="../media/audit-management-groups-367e6dae-b3cbaaa0.png" alt-text="Screenshot showing an example of audit management groups using activity logs.":::
