...
5.  **Associate a network security group with a subnet** \- this is where you'll associate the network security group you create above, with the subnet of the virtual network you created in stage 2 above.
