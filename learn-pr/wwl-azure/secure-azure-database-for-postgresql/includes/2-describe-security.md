...
Azure Database for PostgreSQL encrypts data in transit and at rest. This is discussed in Unit 5.
...
> [!NOTE]
> Only flexible server supports SCRAM authentication - not single server.