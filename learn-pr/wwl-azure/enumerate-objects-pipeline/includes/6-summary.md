In this module, you've learned how to enumerate objects in the pipeline so that you can work with one object at a time during automation. The following are the key takeaways:
 ...
 -  The **ForEach-Object** command that performs enumeration has a simplified syntax and a scriptblock syntax. In the simplified syntax, you can run a single method or access a single property of the objects that were piped into the command.
