...
In this module, learn how to implement scaling for virtual machine scale sets and load-balanced VMs. Also learn how to implement Azure Site Recovery. By the end of this module, you're able to help Contoso dynamically adjust to increases and decreases in workloads while ensuring business continuity.
