Azure Kubernetes Service (AKS) is a managed Kubernetes service that you can use to deploy and manage containerized applications. You don't need container orchestration expertise to use AKS. AKS reduces the complexity and operational overhead of managing Kubernetes by offloading much of that responsibility to Azure. AKS is an ideal platform for deploying and managing containerized applications that require high availability, scalability, and portability. AKS supports deploying applications to multiple regions, using open-source tools, and integrating with existing DevOps tools.
...
> [!IMPORTANT]
> As of November 30, 2025, Azure Linux 2.0 node images are no longer supported or receiving security updates. If you're using Azure Linux 2.0, migrate to Azure Linux 3 by upgrading your node pools or migrating to a supported OS version. Node images will be removed beginning March 31, 2026.
...
The following list describes some of the common use cases for AKS, but by no means is an exhaustive list:
 ...
 -  [Bursting from AKS with ACI](/azure/architecture/reference-architectures/containers/aks-start-here): Use virtual nodes to deploy pods inside ACI that start in seconds and scale to meet demand.
