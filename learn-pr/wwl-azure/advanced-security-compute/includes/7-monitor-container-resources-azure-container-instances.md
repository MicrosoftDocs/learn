...
:::image type="content" source="../media/container-metrics-example-620ccadc.png" alt-text="Screenshot showing an example of how to view container metrics in the Azure portal.":::
