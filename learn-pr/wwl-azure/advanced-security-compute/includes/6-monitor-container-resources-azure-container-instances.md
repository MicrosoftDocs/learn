...
:::image type="content" source="../media/container-metrics-a8bdc623.png" alt-text="Screenshot showing container instances in the Azure portal.":::
...
:::image type="content" source="../media/container-dimension-53415aad.png" alt-text="Screenshot showing the Azure monitoring metrics page.":::
