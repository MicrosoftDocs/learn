...
- Workload identities for pod authentication with Azure services.
...
- Pod Security Standards and Pod Security Admission for enforcing security policies.
- The Azure Policy add-on for AKS to enforce pod security at scale.
- Scanning images and runtime for vulnerabilities using Microsoft Defender for Containers.
