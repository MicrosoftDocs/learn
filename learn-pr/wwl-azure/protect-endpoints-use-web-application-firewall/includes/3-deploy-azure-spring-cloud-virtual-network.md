...
When you recreate your Spring Cloud instance in the virtual network, you'll also need to update some of the steps from the previous exercise:<br>
...
1.  Delete the existing Azure Spring Apps instance.
