You now have a self-signed certificate in Key Vault. Next, you'll configure a public domain name in Azure Spring Apps using the self-signed certificate.<br>
