...
In this exercise, you'll choose to use a self signed certificate for educational purposes. Do note that for production systems you use a publicly signed certificate.

You need to acquire a self-signed certificate and add it to Key Vault. You can use the below guidance for the correct steps.
