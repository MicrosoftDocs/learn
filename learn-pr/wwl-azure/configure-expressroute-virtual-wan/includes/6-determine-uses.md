...
:::image type="content" source="../media/verify-virtual-wan.png" alt-text="ExpressRoute, S2S, and P2S connections are using a Virtual WAN to access Azure virtual networks.":::
