...
| properties.maintenanceWindow.expirationDateTime | Effective expiration date of the maintenance window in YYYY-MM-DD hh:MM format. The window is created in the time zone provided to daylight savings according to the zone. You must set the expiration date to a future date. The default value it will be set to the maximum datetime 9999-12-31 23:59:59. |
