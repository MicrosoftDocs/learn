...
![Workflow and component diagram outlining how playbooks can run in different circumstances.](../media/ansibleworkflow.png)

In the workflow, Ansible playbooks:

1. **Provision resources**. Playbooks can provision resources. In the diagram, playbooks create load-balancer virtual networks, network security groups, and VM scale sets on Azure.
