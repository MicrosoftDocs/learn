...
:::image type="content" source="../media/new-project-beta-38cd122d.png" alt-text="New GitHub Project (beta).":::
...
:::image type="content" source="../media/github-projects-beta-add-issues-33d0a6b6.png" alt-text="GitHub Projects (beta) list.":::
...
:::image type="content" source="../media/github-projects-beta-settings-6b354d9f.png" alt-text="GitHub Projects (beta) settings.":::


You can create custom fields to add to your project.

:::image type="content" source="../media/github-projects-beta-settings-custom-field-5094a01a.png" alt-text="GitHub Projects (beta) settings to create custom fields.":::


Manage access and permissions by adding collaborators.

:::image type="content" source="../media/github-projects-beta-settings-access-e302fba5.png" alt-text="GitHub Projects (beta) settings manage access.":::
