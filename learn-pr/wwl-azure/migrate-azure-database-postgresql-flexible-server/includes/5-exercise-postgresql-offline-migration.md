...
In this exercise, you create an Azure Database for PostgreSQL flexible server and perform an offline database migration from an on-premises PostgreSQL server. For this migration, you use the Migration feature within the Azure Database for PostgreSQL flexible server.
