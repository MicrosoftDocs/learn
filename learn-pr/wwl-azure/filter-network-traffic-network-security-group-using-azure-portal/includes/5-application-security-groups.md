...
:::image type="content" source="../media/application-security-groups-fab4e68f.png" alt-text="Screenshot showing an example of Azure Networek Security Groups and Application Security Groups.":::
