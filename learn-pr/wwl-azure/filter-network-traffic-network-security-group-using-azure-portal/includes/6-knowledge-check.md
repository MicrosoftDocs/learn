...
( ) To manage user access to Azure resources {{Incorrect. This is the role of Azure Active Directory (AAD) and Azure role-based access control (RBAC).}}
...
## Multiple Choice
Which of the following is NOT a valid network security rule in an NSG?
...
## Multiple Choice
How can you associate an NSG with an Azure resource?
