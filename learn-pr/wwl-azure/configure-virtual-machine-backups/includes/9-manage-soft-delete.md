Azure Storage now offers the _soft delete_ option for Azure Blob objects. With this feature, you can more easily recover your data when it's accidently modified or deleted.
