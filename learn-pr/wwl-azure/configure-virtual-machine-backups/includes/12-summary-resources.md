...
You can learn more by reviewing the following.
 ...
 -  [Introduction to Azure Backup](/learn/modules/intro-to-azure-backup/)
 -  [Protect your virtual machines by using Azure Backup](/learn/modules/protect-virtual-machines-with-azure-backup/)
 -  [Implement hybrid backup and recovery with Windows Server IaaS](/learn/modules/implement-hybrid-backup-recovery-windows-server-iaas/)
