...
:::image type="content" source="../media/AZ104_Imp_VM_Restore-52a738da.png" alt-text="Screenshot of the recovery services vault. Highlighted is a backup item for an Azure virtual machine.":::
