...
:::image type="content" source="../media/virtual-machines-restore.png" alt-text="Screenshot of the recovery services vault. Highlighted is a backup item for an Azure virtual machine.":::
