...
As you begin to teach this module, get familiar with what the students will learn during the module. In this module students will learn about Azure queues and the difference between Azure queues, Event Grid, Event Hub, and Service Bus. They will also learn how to create an Event Grid subscription and publish Event Grid events. 

This module consists of two lessons: 

- Lesson 1 – Explore Azure Event Grid 
- Lesson 2 – Explore Azure Event Hub 
