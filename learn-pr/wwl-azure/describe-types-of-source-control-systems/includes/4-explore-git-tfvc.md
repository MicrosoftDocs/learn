...
TFVC has two workflow models:
 ...
 -  **Local workspaces** \- Each team member takes a copy of the latest codebase version with them and works offline as needed. Developers check in their changes and resolve conflicts as necessary. Another system that works this way is Subversion.
