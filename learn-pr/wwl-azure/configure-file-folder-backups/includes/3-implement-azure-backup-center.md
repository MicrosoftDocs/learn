...
:::image type="content" source="../media/backup-center-b3bf1f45.png" alt-text="Screenshot of the Backup Center. Jobs and Backup Instances are shown.":::


Some of the key benefits of Backup Center include:

 -  **Wide range of capabilities**. Backup Center is designed to function well across a large and distributed Azure environment. You can use Backup Center to efficiently manage backups spanning multiple workload types, vaults, subscriptions, regions, and tenants.
