...
:::image type="content" source="../media/Azure-spring-apps-conceptual-39e2d78c.png" alt-text="Graphic of Azure Spring Apps services.":::


You deploy an instance of the Azure Spring Apps service using the Azure portal or the Azure CLI.<br>
...
To install Apache Maven, extract the content of the *.zip* file by running unzip apache-maven-3.8.5-bin.zip. Add the path to the bin directory of the extracted content to the `PATH`environment variable by running the following command from the Git Bash shell:<br>

```Bash
export PATH=~/apache-maven-3.8.5/bin:$PATH
```

To install JDK, follow the instructions provided in [JDK Installation Guide](https://docs.oracle.com/en/java/javase/18/install/installation-jdk-microsoft-windows-platforms.html). Set the `JAVA_HOME` environment variable by running the following command from the Git Bash shell:<br>
...
:::image type="content" source="../media/azure-spring-cloud-resources-f587a987.png" alt-text="View of the Spring Cloud resource groups.":::
...
:::image type="content" source="../media/service-apps-spring-cloud-80f4a288.png" alt-text="Graphic of apps for Azure Spring Cloud.":::
