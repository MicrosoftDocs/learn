...
As you prepare to implement QoS, keep the guidelines listed after this in mind:
...
Traffic congestion across a network will significantly affect media quality. A lack of bandwidth leads to performance degradation and a poor user experience.
