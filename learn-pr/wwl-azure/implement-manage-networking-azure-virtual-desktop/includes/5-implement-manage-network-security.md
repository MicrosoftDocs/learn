...
:::image type="content" source="../media/network-security-auzre-firewall-71cb8db3.png" alt-text="Azure Virtual Desktop architecture.":::
...
```
 ...
 -  Create a network rule collection add the following rules:
     ...
     -  Allow KMS – allow traffic from your Azure Virtual Desktop virtual machines to Windows Activation Service TCP port 1688.
