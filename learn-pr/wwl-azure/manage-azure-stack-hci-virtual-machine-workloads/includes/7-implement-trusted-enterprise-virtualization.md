Given the highly sensitive nature of its financial operations, Contoso business leads want to ensure that their data running on Azure Stack HCI is sufficiently protected from cyber threats. This must be the case even if there is a successful exploit of the operating system running on the cluster nodes. To address these demands, you want to use the trusted enterprise virtualization capabilities built into the Azure Stack HCI hardware and hypervisor.
