...
## Requirements
 ...
 -  An **Azure subscription** to which you have at least the **Owner-level access**. If you do not have an Azure subscription, you can sign up for a [free trial](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).
