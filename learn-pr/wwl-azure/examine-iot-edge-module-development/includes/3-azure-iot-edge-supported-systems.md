...
For the full list of IoT Edge releases and support documentation, see: [https://docs.microsoft.com/azure/iot-edge/support?view=iotedge-2020-11](/azure/iot-edge/support?view=iotedge-2020-11)
...
:::image type="content" source="../media/m07-l01-edge-modules-and-containers-only-moby-for-production-92fdfb4d.png" alt-text="IoT Edge Modules - Container Support":::
...
:::image type="content" source="../media/m07-l01-edge-modules-and-containers-edge-on-device-a76c40f2.png" alt-text="IoT Edge Modules - OS Support for Containers":::
...
:::image type="content" source="../media/m07-l01-edge-modules-and-containers-edge-on-vm-8eb82df6.png" alt-text="IoT Edge Modules - VM Support for Containers":::
