...
- Code snippets. in [Microsoft Docs](/?azure-portal=true) and [Microsoft Learn](/learn/?azure-portal=true), select the **Try It** option that displays with the Azure CLI and Azure PowerShell code snippets:
