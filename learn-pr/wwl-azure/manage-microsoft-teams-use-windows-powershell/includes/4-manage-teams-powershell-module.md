...
| -Visibility                | Determines whether the team is public or private. Public teams are noticeable to everyone in the team gallery, and anyone can join without team owner approval, whereas only the team owner can add members to private teams. |
| -AllowAddRemoveApps        | Determines whether members (not just owners) can add apps to the team. |
| -AllowCreateUpdateChannels | Determines whether members (not just owners) can create channels. |
| -AllowUserEditMessages     | Determines whether users can edit messages they've posted. |
