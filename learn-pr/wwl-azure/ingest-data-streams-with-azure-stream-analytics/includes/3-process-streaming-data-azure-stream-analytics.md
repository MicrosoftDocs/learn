[Azure Stream Analytics](/azure/stream-analytics/stream-analytics-introduction) is the recommended service for stream analytics on Azure. Stream Analytics provides you with the ability to ingest, process, and analyze streaming data from Azure Event Hubs (including [Azure Event Hubs from Apache Kafka](/azure/event-hubs/event-hubs-for-kafka-ecosystem-overview)) and Azure IoT Hub. You can also configure static data ingestion from Azure Blob Storage. This integration allows you to quickly create hot-path analytics pipelines to generate powerful insights to drive real-time actions. Azure Stream Analytics is meant for a wide range of scenarios that include, but aren't limited to:

- Dashboards for data visualization
- [Real-time alerts](/azure/stream-analytics/stream-analytics-set-up-alerts) from temporal and spatial patterns or anomalies
- Extract, Transform, Load (ETL)
- [Event Sourcing pattern](/azure/architecture/patterns/event-sourcing)
- [IoT Edge](/azure/stream-analytics/stream-analytics-edge)
