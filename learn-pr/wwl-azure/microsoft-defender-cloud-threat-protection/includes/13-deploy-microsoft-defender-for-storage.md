...
| Clouds:                         | :::image type="content" source="../media/yes-icon-783bde2a.png" alt-text="Icon of Yes.":::  Azure Commercial clouds\*<br>:::image type="content" source="../media/no-icon-9b1fdaa3.png" alt-text="Icon of No.":::  Azure Government (only activity monitoring support on the classic plan)<br>:::image type="content" source="../media/no-icon-9b1fdaa3.png" alt-text="Icon of No.":::  Azure China 21Vianet<br>:::image type="content" source="../media/no-icon-9b1fdaa3.png" alt-text="Icon of No.":::  Connected AWS accounts |
