...
| Clouds:                          | :::image type="content" source="/azure/defender-for-cloud/media/icons/yes-icon.png" alt-text="Icon of Yes.":::  Commercial clouds\*<br>:::image type="content" source="/azure/defender-for-cloud/media/icons/no-icon.png" alt-text="Icon of No.":::  Azure Government (only activity monitoring support on the classic plan)<br>:::image type="content" source="/azure/defender-for-cloud/media/icons/no-icon.png" alt-text="Icon of No.":::  Microsoft Azure operated by 21Vianet<br>:::image type="content" source="/azure/defender-for-cloud/media/icons/no-icon.png" alt-text="Icon of No.":::  Connected AWS accounts |
