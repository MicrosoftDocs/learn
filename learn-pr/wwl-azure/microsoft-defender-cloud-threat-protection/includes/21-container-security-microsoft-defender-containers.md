...
:::image type="content" source="../media/resource-filter-92f0e7e1-d362170e.png" alt-text="Screenshot showing an example of how to use the resource filter to review the outstanding recommendations.":::
...
:::image type="content" source="../media/overview-page-alerts-links-21a0d7d2-5e700bcf.png" alt-text="Screenshot showing an example of how to  view security alerts in Defender for Cloud's overview page.":::


The security alerts page opens:

:::image type="content" source="../media/view-containers-alerts-88aa964c-f6130263.png" alt-text="Screenshot showing an example of how to view security alerts for runtime workload in the clusters.":::
