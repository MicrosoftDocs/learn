...
## Common attack techniques
 ...
 -  **Deploy backdoor containers** \- Attackers run their malicious code in a container in the cluster. By using the Kubernetes controllers such as DaemonSets or Deployments, attackers ensureed that a constant number of containers run in one, or all, the nodes in the cluster.<br>
