...
2.  In the Defender plans page, select **Defender for Containers** and select **Settings**.
    ...
    :::image type="content" source="../media/containers-settings-8873d7bf-4f5d07e9.png" alt-text="Screenshot showing how to enable Defender for Containers in the Settings page.":::
    ...
    :::image type="content" source="../media/defender-plans-deprecated-indicator-cc5b760f-73a208ce.png" alt-text="Screenshot showing the subscription already has Defender for Kubernetes and Defender for container registries enabled.":::
    
3.  Turn the relevant component on to enable it.
    
    :::image type="content" source="../media/container-components-f83671a3-46d6ec9f.png" alt-text="Screenshot showing how to turn on the relevant component.":::
...
2.  In the [Azure portal](https://portal.azure.com/), open Microsoft Defender for Cloud's security alerts page and look for the alert on the relevant resource:
    ...
    :::image type="content" source="../media/sample-kubernetes-security-alert-79455e5a-3c2a5541.png" alt-text="Screenshot showing Microsoft Defender for Cloud's security alerts page.":::
...
2.  Search for and select **Policy**.
    ...
    :::image type="content" source="../media/find-policy-08c93581-0dc28f6b.png" alt-text="Screenshot showing how to assign a custom workspace through Azure policy.":::
    
3.  Select Definitions.
4.  Search for policy ID `64def556-fbad-4622-930e-72d1d5589bf5`.
    
    :::image type="content" source="../media/assignments-tab-d859a246-bd144dcc.png" alt-text="Screenshot showing assignments that are configured in the Policy definition page.":::
...
:::image type="content" source="../media/no-assignment-44221ebd-e54819b9.png" alt-text="Screenshot showing how to create a new assignment with custom workspace.":::
...
3.  Select a LogAnalyticsWorkspaceResource ID from the dropdown menu.
    ...
    :::image type="content" source="../media/drop-down-menu-33a6777b-f104c2d7.png" alt-text="Screenshot showing how to select a Log Analytics Workspace Resource ID.":::
...
:::image type="content" source="../media/already-assigned-fd01abc9-297c3371.png" alt-text="Screenshot showing an existing assignment is enabled in the Policy definition page.":::
...
1.  Select the relevant assignment.
    ...
    :::image type="content" source="../media/relevant-assignment-42e9a8c2-ff5eb04b.png" alt-text="Screenshot showing how to assign custom workspace assignment from the Policy definition page.":::
...
4.  Select a LogAnalyticsWorkspaceResource ID from the dropdown menu.
    ...
    :::image type="content" source="../media/drop-down-menu-example-b0b13240-aef85720.png" alt-text="Screenshot showing how to configure parameters for a Log Analytics Workspace.":::
