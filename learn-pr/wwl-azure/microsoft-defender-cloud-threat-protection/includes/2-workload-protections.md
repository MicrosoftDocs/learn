...
:::image type="content" source="../media/defender-for-cloud-workload-protection-f027c82d.png" alt-text="Diagram showing an example of Defender for Cloud protecting workloads.":::
<br>
...
:::image type="content" source="../media/protect-cloud-workloads-ef6b37ec.png" alt-text="Table showing cloud workload protection capabilities.":::
