...
2.  Second illustration of watermark progressing without an early arrival policy: :::image type="content" source="../media/m04-l05-asa-queries-time-handling-watermark-graph-2-93f8f93a.png" alt-text="Time Handling Considerations - Watermark Graph 1":::
...
3.  In the final illustration, substreams are used (OVER the DeviceId). Multiple watermarks are tracked, one per stream. There are fewer events with their times adjusted as a result. :::image type="content" source="../media/m04-l05-asa-queries-time-handling-watermark-graph-3-a5212b12.png" alt-text="Time Handling Considerations - Watermark Graph 1":::
