...
:::image type="content" source="../media/overview-of-sap-cloud-platform-identity-authentication-028c559c.png" alt-text="Diagram that illustrates the relationship between Azure Active Directory and SAP Cloud Identity Authentication. SAP Cloud Platform Identity Authentication acts as a Proxy Identity Provider to SAP applications. Azure Active Directory in turn acts as the leading Identity Provider in this setup":::
