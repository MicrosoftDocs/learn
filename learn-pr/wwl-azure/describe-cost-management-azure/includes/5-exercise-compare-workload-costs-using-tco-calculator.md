...
<br>:::image type="content" source="../media/tco-calculator-steps-3c2dc1d4.png" alt-text="A visual representation of the three steps, define your workloads, adjust assumptions, and view the report.":::
