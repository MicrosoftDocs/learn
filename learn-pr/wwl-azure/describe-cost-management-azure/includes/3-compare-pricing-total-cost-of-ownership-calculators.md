...
> [!NOTE]
> The Pricing calculator is for information purposes only. The prices are only an estimate. Nothing is provisioned when you add resources to the pricing calculator, and you won't be charged for any services you select.<br>
...
:::image type="content" source="../media/total-cost-ownership-657fe344.png" alt-text="Screenshot of the Total Cost of Ownership calculator.":::
