...
In this module, you will:
 ...
 -  Examine the features and capabilities of Azure IoT Edge.
 -  Examine the IoT Edge runtime and modules.
 -  Examine IoT Edge security and certificates.

By the end of this module, you will be able to describe the components of an Azure IoT Edge environment and the capabilities that it provides to the local device.
