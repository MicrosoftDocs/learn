...
Source control management (SCM) systems provide a running history of code development. Also, it helps to resolve conflicts when merging contributions from multiple sources.
...
:::image type="content" source="../media/source-control-f1d31c38.png" alt-text="Source control":::


Without version control, you are tempted to keep multiple copies of code on your computer. It could be dangerous. Easy to change or delete a file in the wrong code copy, potentially-losing work.
...
Tools and processes alone are not enough to accomplish the above, such as adopting Agile, Continuous Integration, and DevOps. Believe it or not, all rely on a solid version control practice.
...
There are several perspectives on version control.
 ...
 -  For developers, it is a daily enabler for work and collaboration to happen. It is part of the daily job, one of the most-used tools.
 -  For management, the critical value of version control is in IP security, risk management, and time-to-market speed through Continuous Delivery, where version control is a fundamental enabler.
