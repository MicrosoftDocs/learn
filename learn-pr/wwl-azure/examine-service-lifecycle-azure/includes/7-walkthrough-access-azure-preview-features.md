...
5. In the **Kubernetes Version** drop-down notice there is a **Preview** version. Not all services will have a version in preview.   
    ...
    ![Screenshot of Azure Kubernetes Services pane with the create Kubernetes service button highlighted.](../media/azure-kubernetes-services-pane.png)  
...
2. You will see several different status based filter options named **Now Available**, **In preview** and **In development**
