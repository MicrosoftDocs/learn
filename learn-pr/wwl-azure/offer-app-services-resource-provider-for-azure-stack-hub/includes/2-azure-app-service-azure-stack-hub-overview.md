...
Below are key features of Azure App Service:
 ...
 -  **Multiple languages and frameworks**: Azure App Service has first-class support for [ASP.NET](http://asp.net/), Node.js, Java, PHP, and Python. You can also run Windows PowerShell and other scripts or executables on App Service virtual machines.
