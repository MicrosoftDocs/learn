...
The [Open Web Application Security Project (OWASP)](http://owasp.org) is a global charitable organization focused on improving software security.
...
OWASP also publishes an intentionally vulnerable web application called [The Juice Shop Tool Project](https://owasp.org/www-project-juice-shop/) to learn about common vulnerabilities and see how they appear in applications.

It includes vulnerabilities from all the [OWASP Top 10](https://owasp.org/www-project-top-ten/).
