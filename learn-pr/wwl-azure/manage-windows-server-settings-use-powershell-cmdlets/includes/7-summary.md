...
- The `ServerManager` module for PowerShell contains cmdlets for managing server features, roles, and services. These cmdlet names include the noun `WindowsFeature`. These cmdlets target only Windows Server operating systems and don't run on Windows client-based operating systems.
...
- [GroupPolicy module reference](/powershell/module/grouppolicy/)
- [IISAdministration module reference](/powershell/module/iisadministration/)
- [Hyper-V module reference](/powershell/module/hyper-v/)
