...
:::image type="content" source="../media/azure-extension-for-sap-animated-09db31af.gif" alt-text="S A P SAPOSCOL / S A P Host Control process reads, writes and requests Azure Monitor for SAP and Windows Azure Diagnostic Agent Extension data.":::
