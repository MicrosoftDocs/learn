...
:::image type="content" source="../media/azure-extension-for-sap-animated-09db31af.gif" alt-text="Azure Extension for S A P and Windows Azure Diagnostic Agent Extension are installed on Azure virtual machines running S A P Net Weaver. The S A P SAPOSCOL / S A P Host Control process reads, writes and requests Monitoring data.":::
