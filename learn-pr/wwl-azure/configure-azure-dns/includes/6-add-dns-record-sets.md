...
:::image type="content" source="../media/dns-record-set-1.png" alt-text="Screenshot of the Add a record set page.":::
...
:::image type="content" source="../media/dns-record-set-2.png" alt-text="Screenshot of the Add a record page.":::
