...
:::image type="content" source="../media/AZ104_DNS_Record_Set1-1513fae7.png" alt-text="Screenshot of the Add a record set page.":::
...
:::image type="content" source="../media/AZ104_DNS_Record_Set2-8093b97a.png" alt-text="Screenshot of the Add a record page.":::
