...
:::image type="content" source="../media/private-zones-single.png" alt-text="A VNet is shown with two VMs.VMs are querying the Azure DNS and private IP addresses are returned.":::
...
:::image type="content" source="../media/private-zones-multiple.png" alt-text="Two VNets, VNet1 and VNet2. VNet1 has VM1 and VM2. VNet2 has VM3, VM4, and VM5. Both VNets are connected to Azure DNS with records.":::
