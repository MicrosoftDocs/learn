...
:::image type="content" source="../media/AZ104_Private_Zones_Multiple-ffeafaa8.png" alt-text="Two VNets, VNet1 and VNet2. VNet1 has VM1 and VM2. VNet2 has VM3, VM4, and VM5. Both VNets are connected to Azure DNS with records.":::
