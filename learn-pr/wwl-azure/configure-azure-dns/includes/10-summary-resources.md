...
You can learn more by reviewing the following. A *sandbox* indicates a hands-on exercise. 
 ...
 -  [Host your domain on Azure DNS (Sandbox)](/learn/modules/host-domain-azure-dns/)
 -  [Implement DNS for Windows Server IaaS VMs](/learn/modules/implement-dns-for-windows-server-iaas-virtual-machines/)
