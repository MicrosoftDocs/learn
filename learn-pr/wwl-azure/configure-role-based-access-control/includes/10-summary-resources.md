...
- Manage access [to Azure subscriptions with RBAC](/training/modules/manage-subscription-access-azure-rbac/).

## Learn more with optional hands-on exercises

- Secure [your Azure resources with RBAC (sandbox)](/training/modules/secure-azure-resources-with-rbac/).
