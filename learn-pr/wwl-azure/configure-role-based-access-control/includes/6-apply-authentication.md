...
The following diagram illustrates how you can apply Microsoft Entra administrator roles and Azure RBAC roles in your organization.

:::image type="content" source="../media/role-based-authentication-b3dda7ae.png" alt-text="Diagram that shows how Microsoft Entra admin roles and Azure RBAC roles can be used together to authenticate users and control access to resources." border="false":::
