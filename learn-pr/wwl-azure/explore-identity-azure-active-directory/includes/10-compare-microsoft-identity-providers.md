...
An identity provider (IdP) is a system that creates, manages and stores digital identities.  Microsoft Azure Active Directory is an example. The capabilities and features of identity providers can vary. The three most common components are:
...
Microsoft provides several different tools for identity based on your business needs and goals.  Azure Active Directory should be your go to starting point for cloud based identity.  Other services can provide supporting capabilities as you transition from on-premises to the cloud.

| Azure AD Domain Services | Azure Active Directory | Active Directory Domain Services |
| :----- | :----- | :----- |
