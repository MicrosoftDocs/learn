...
- **There are Microsoft 365, Office 365, and Windows licenses** - These licenses are assigned to a Microsoft Entra user or group to grant them access to use Office or Windows products.  You'll need one license for each user who needs access to Windows and / or office.
- **Monthly Active User (MAU) license** - This license is used with Microsoft Entra External ID.  A monthly report is pulled for billing purposes, looking for external users that have logged in during the month.
