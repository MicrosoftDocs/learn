...
<a name='common-azure-ad-terminology'></a>

## Common Microsoft Entra terminology

Microsoft Entra ID is a cloud-based identity and access management solution, with integrated security.  It has a simple flat architectural design, so ensure it is fast, reliable, scalable, and redundant. Microsoft Entra ID provides organizations with Identity as a Service (IDaaS) solutions that cater to all the apps across the cloud as well as the on-premises.
...
- **User** - A single personal identity in Microsoft Entra ID, that can or has been verified.
...
- **Azure tenant/directory** - A dedicated and trusted instance of Microsoft Entra ID, a Tenant is automatically created when your organization signs up for a Microsoft cloud service subscription.
...
- **Administrative Unit** - A portioned off piece of a Microsoft Entra tenant for to create and administrative boundary.
