...
For more information about rolling certificates for enrollments groups with expiring certificates, see: [How to roll X.509 device certificates](/azure/iot-dps/how-to-roll-certificates).
