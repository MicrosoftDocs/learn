...
:::image type="content" source="../media/m11-l04-adt-alerts-in-the-portal-af75b2f7.png" alt-text="ADT - enable ADT alerts in the Azure portal":::
...
:::image type="content" source="../media/m11-l04-adt-create-alert-rule-in-the-portal-d87fcfce.png" alt-text="ADT - create alert rules in the Azure portal":::
