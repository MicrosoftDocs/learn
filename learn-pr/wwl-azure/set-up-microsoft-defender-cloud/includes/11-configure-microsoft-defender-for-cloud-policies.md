...
- **Add your own custom initiatives** - If you want to customize the security initiatives applied to your subscription, you can do so within Defender for Cloud. You receive recommendations if your machines don't follow the policies you create.
