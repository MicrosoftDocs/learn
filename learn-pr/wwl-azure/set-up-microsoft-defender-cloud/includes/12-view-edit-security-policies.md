...
:::image type="content" source="../media/security-roles-view-edit-security-policies-ced23899.png" alt-text="Diagram showing which security role can view, update, and dismiss alerts.":::
