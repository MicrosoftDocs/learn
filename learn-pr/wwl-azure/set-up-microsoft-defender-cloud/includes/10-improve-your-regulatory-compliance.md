...
> [!NOTE]
> Advanced regulatory compliance features, including the ability to add multiple compliance standards, require **Defender CSPM**.
...
The dashboard provides you with an overview of your compliance status and the set of supported compliance regulations. You see your overall compliance score, and the number of passing vs. failing assessments associated with each standard.
...
The following list has a numbered item that matches each location in the image, and describes what is in the image:

1. Select a compliance standard to see a list of all controls for that standard.
2. View the subscription that the compliance standard is applied on.
...
> [!NOTE]
> Assessments **run approximately every 12 hours,** so you'll see the results on your compliance data only after the next run of the relevant assessment.
...
The regulatory compliance has both automated and manual assessments that need to be remediated. Using the information in the regulatory compliance dashboard, improve your compliance posture by resolving recommendations directly within the dashboard.

### Remediate an automated assessment

1. Sign in to the **Azure portal.**
2. Navigate to **Defender for Cloud** then select, **Regulatory compliance.**
...
The regulatory compliance has automated and manual assessments that need to be remediated. Manual assessments are assessments that require input from the customer to remediate them.
