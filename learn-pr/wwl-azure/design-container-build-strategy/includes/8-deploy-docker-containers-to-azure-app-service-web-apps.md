...
In this lab, you'll learn how to use an Azure DevOps CI/CD pipeline to build a custom Docker image, push it to Azure Container Registry, and deploy it as a container to Azure App Service.
...
## Requirements
 ...
 -  Verify that you have a Microsoft or Entra account with the Contributor or the Owner role in the Azure subscription. For details, refer to [List Azure role assignments using the Azure portal](/azure/active-directory/roles/manage-roles-portal) and [View and assign administrator roles in Entra ID](/azure/active-directory/roles/manage-roles-portal).
...
](https://go.microsoft.com/fwlink/?linkid=2270304)
