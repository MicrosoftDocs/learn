...
The first line refers to the parent image that this new image will be based upon.
...
The RUN command is run when the image is being created by the **docker build**. It's used to configure items within the image.
