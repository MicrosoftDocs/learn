...
:::image type="content" source="../media/azure-joined-devices.png" alt-text="A device is shown connecting to Azure AD. Azure AD is shown connecting with On-premises AD.":::
