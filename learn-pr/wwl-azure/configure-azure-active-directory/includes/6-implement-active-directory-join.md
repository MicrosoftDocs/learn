...
:::image type="content" source="../media/AZ104_Azure_Joined_Devices-548d169e.png" alt-text="A device is shown connecting to Azure AD. Azure AD is shown connecting with On-premises AD.":::
