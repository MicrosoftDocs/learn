...
:::image type="content" source="../media/properties-self-service-password-rest.png" alt-text="Screenshot of the Password reset - Properties page in Azure portal showing the options for which groups can be enabled for self-service password reset None, Selected, and All.":::
...
:::image type="content" source="../media/authentication-self-service-password-rest.png" alt-text="Screenshot from the Azure portal of the Password reset - Authentication methods page showing Azure AD authentication methods available and the number required.":::
