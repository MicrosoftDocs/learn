...
6.  After the installation, add the parameter 'basepath\_shared = no' to the global.ini file. This parameter enables SAP HANA to run in scale-out without 'shared' **/hana/data** and **/hana/log** volumes between the nodes. Details are documented in [SAP Note \#2080991](https://launchpad.support.sap.com/#/notes/2080991).
