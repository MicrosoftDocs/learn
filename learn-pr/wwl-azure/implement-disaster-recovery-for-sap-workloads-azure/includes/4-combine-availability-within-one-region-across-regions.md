...
:::image type="content" source="../media/three-vms-over-two-regions-multi-target-ha-bf40d221.png" alt-text="Diagram of four VMs over two regions multi-target, high availability":::
