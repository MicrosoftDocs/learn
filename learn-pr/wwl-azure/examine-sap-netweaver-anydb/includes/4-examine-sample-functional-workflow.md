...
:::image type="content" source="../media/sap-netweaver-anydb-workflow-example-e1119375.png" alt-text="Diagram of S A P Net Weaver with Any D B on Azure virtual machines sample functional workflow.":::
