...
:::image type="content" source="../media/sap-netweaver-on-sql-sample-functional-workflow-542d89f3.png" alt-text="SAP NetWeaver with AnyDB on Azure virtual machines sample functional workflow":::
