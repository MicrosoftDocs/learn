...
:::image type="content" source="../media/devops-cycle-98924900-a8ba6dc4.png" alt-text="Collaboration DevOps cycle with plan, build, continuous integration, deploy, operate, and continuous feedback.":::
...
:::image type="content" source="../media/devops-road-3eb79373-55826718.png" alt-text="Observe, orient, decide, and act as cycle.":::
...
:::image type="content" source="../media/devops-road-validated-learning-b7c460aa-622f7b18.png" alt-text="Strive for validated learning. Good, indifferent, and bad.":::
...
:::image type="content" source="../media/devops-road-shorten-cycle-time-360c6a21-d01a6ac6.png" alt-text="Validated learning versus deployment frequency. Good, indifferent, and bad cycle.":::
