The contraction of "Dev" and "Ops" refers to replacing siloed Development and Operations. The idea is to create multidisciplinary teams that now work together with shared and efficient practices and tools. Essential DevOps practices include agile planning, continuous integration, continuous delivery, and monitoring of applications. DevOps is a constant journey.<br>

:::image type="content" source="../media/devops-cycle-98924900.png" alt-text="Collaboration DevOps cycle with plan, build, continuous integration, deploy, operate, and continuous feedback.":::
...
:::image type="content" source="../media/devops-road-3eb79373.png" alt-text="Observe, orient, decide, and act as cycle.":::
...
:::image type="content" source="../media/devops-road-validated-learning-b7c460aa.png" alt-text="Strive for validated learning. Good, indifferent, and bad.":::
...
:::image type="content" source="../media/devops-road-shorten-cycle-time-360c6a21.png" alt-text="Validated learning versus deployment frequency. Good, indifferent, and bad cycle.":::
...
:::image type="content" source="../media/devops-road-optimize-learning-3f77fb52.png" alt-text="Validated learning versus deployment frequency. Good, indifferent, and bad cycle. Value of improvement metric.":::
