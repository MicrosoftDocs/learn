...
:::image type="content" source="../media/devops-build-success-69efebb2-803ae977.png" alt-text="Build succeeded. Completed.":::
...
:::image type="content" source="../media/devops-continuous-delivery-4d3ba30a-a69bad15.png" alt-text="Continuous Delivery of software solutions to production and testing environments and phases image.":::
...
:::image type="content" source="../media/devops-version-control-44e5f5cf-767b9d74.png" alt-text="Master, feature 1, and feature 2 branches representation.":::
...
:::image type="content" source="../media/devops-kanban-d25edf00-c923e411.png" alt-text="Kanban board with columns to-do, in progress, ready to code, in progress, ready, in progress, review, and done.":::
...
:::image type="content" source="../media/devops-monitor-2245ddb9-849d61af.png" alt-text="Charts example.":::
...
:::image type="content" source="../media/devops-public-clouds-ccd59e8f-573f79a6.png" alt-text="Public cloud.":::
...
:::image type="content" source="../media/devops-iac-a1053dfd-0287e57b.png" alt-text="Infrastructure as Code (IaC) representation.":::
...
:::image type="content" source="../media/devops-microservices-e82164aa-715837d6.png" alt-text="Monolithic and microservices representation.":::
...
:::image type="content" source="../media/devops-containers-30f81aa2-b4f50fae.png" alt-text="Containers.":::
...
:::image type="content" source="../media/devops-build-strength-652939a0-bcf2c379.png" alt-text="A person is doing exercises showing it will get easier when stronger.":::
