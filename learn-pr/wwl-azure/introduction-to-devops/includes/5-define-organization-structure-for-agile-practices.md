...
:::image type="content" source="../media/devops-ds-image-101-cd10ac81-579ed473-4116f357.png" alt-text="Teams has been divided into UI, SOA, and Data. Each team has Email, Voice, and TV.":::


By comparison, vertical team structures span the architecture and are aligned with skillsets or disciplines:

:::image type="content" source="../media/devops-ds-image-103-b26487ac-24ceba66-43ffd70d.png" alt-text="Teams has been divided into Email, Voice, and TV. Each team has UI, SOA, and Data.":::
...
:::image type="content" source="../media/devops-ds-image-102-2a966b63-ba75b645-2d2f4153.png" alt-text="Vertical teams have been added for Customer Profile, Shopping Cart, Service Status, and Internet. Each team has UI, SOA, and Data.":::
