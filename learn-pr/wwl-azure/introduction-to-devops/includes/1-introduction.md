...
People in these modules are interested in designing and implementing DevOps processes. Also, they are preparing for the [AZ-400 - Designing and Implementing Microsoft DevOps Solutions](/learn/certifications/exams/az-400) certification exam.
...
Exam candidates must be proficient with Agile practices. They must be familiar with Azure administration, Azure development, and experts in at least one of these areas.
...
:::row:::
  :::column:::
    Define and implement continuous delivery (CD) and release management strategies.
  :::column-end:::
  :::column:::
    10-15%
  :::column-end:::
