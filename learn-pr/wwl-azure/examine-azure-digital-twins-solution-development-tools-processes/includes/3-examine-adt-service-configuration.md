...
:::image type="content" source="../media/m11-l03-adt-create-azure-digital-twins-instance-c25c2c94.png" alt-text="ADT - create an Azure Digital Twins instance":::
...
:::image type="content" source="../media/m11-l03-adt-create-instance-add-role-assignment-586d27e4.png" alt-text="ADT - configure ADT access role assignment":::
...
:::image type="content" source="../media/m11-l03-adt-create-endpoint-330a8fcf.png" alt-text="ADT - create an ADT endpoint":::
...
:::image type="content" source="../media/m11-l03-adt-create-event-route-103cae57.png" alt-text="ADT - create an ADT event route":::
...
:::image type="content" source="../media/m11-l03-adt-create-event-route-filters-basic-3c22338e.png" alt-text="ADT - create a basic ADT event route filter":::
...
:::image type="content" source="../media/m11-l03-adt-create-event-route-filter-advanced-db13e6e2.png" alt-text="ADT - create an advanced ADT event route filter":::
