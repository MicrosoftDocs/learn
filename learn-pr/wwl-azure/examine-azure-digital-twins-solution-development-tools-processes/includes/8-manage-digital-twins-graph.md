...
1.  Imagine a digital twin with a model of foo\_old. foo\_old defines a required property mass.
2.  The new model foo\_new defines a property mass, and adds a new required property temperature.
