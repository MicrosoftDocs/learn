...
>
> Wow, those are some great benefits to moving to the cloud and addressing the capability needs of Contoso. I bet your applications could benefit as well. Let's take a quick look at several of these in the context of the growth of Contoso Ltd:
> 
>**High Availability** is a must. At Contoso, we make money and keep our customers happy when they can quickly access our products.  When our site goes down, or our shipping systems and drones can't talk with each other, it becomes a critical situation.
>
>**Scalability** and **Elasticity** is something that we at Contoso have wished for in the past. We have purchased thousands of servers, had to manually set each one up and manage it, and then many of the servers sit idle, waiting on users to log-in. They use power, heating / cooling, and have to be maintained. When there was a rush of people logging in during seasonal parts of the year, things really bogged down due to our lack of flexibility.
>
>**Disaster Recovery** would be great to have. Right now, we run an on-premises backup system, and then transport the backup offsite for storage. This is time consuming, costly, and really slow to restore if we ever have an issue. Backing up customers orders, history, and data the moment it is entered is an absolute must.  We can't survive if we cannot get to our customer's information.
...
3. Next to each concept you listed, write out a scenario where your company has experience. Where might one (or more) of the cloud concepts/capabilities have helped?
