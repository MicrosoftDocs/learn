...
![A large image of money and an arrow to the right of this progressing to a series of smaller money images.](../media/capex-versus-opex-1.png)
...
![A graph showing how expected demand can be different from real demand and how CapEx infrastructure can be exceeded by demand.](../media/3-c-capex-versus-opex.png)
