...
( ) They're always free to deploy. {{Incorrect. There can be a cost associated with deployment.}}
( ) They're inherently more secure than traditional apps. {{Incorrect. Cloud-native apps share many of the same security issues as other app types.}}
(x) They can efficiently scale and adapt to changing workloads. {{Correct! Cloud-native apps are designed for the cloud, and therefore gain the benefits provided by the cloud platform, such as scaling.}}

## Multiple Choice
What is the main advantage of cloud-native applications?
( ) Cloud-native applications aren't resilient to failure and can't scale to meet demand. {{Incorrect. Cloud-native applications are designed to be resilient to failure and can scale to meet demand.}}
...
( ) Cloud-native applications aren't automated, so you can't build, test, and deploy them quickly and reliably. {{Incorrect. Cloud-native applications are automated, so you can build, test, and deploy them quickly and reliably.}}
