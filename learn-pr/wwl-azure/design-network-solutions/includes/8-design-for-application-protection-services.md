Azure offers several networking services to help protect your network resources. You can protect your applications by using one service or a combination of services. In this unit, we examine service endpoints, Azure Private Link, Virtual Network security groups, Azure Firewall, Web Application Firewall, and  Azure DDoS Protection. 
