Azure offers several networking services to help deliver applications. In this unit, we examine Azure Load Balancer, Application Gateway, Traffic Manager, Front Door, and Content Delivery Network. 
