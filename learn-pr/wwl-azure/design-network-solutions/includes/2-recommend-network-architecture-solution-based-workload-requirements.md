Azure offers several networking services with capabilities that can be used together or separately to support workload requirements. You can [**connect Azure resources and on-premises resources**](/azure/networking/fundamentals/networking-overview), [**protect your applications**](/azure/networking/fundamentals/networking-overview), and support [**application delivery in the Azure network**](/azure/networking/fundamentals/networking-overview).
