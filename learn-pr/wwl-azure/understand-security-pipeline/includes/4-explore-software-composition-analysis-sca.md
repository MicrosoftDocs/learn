...
In Azure DevOps, *Azure Artifacts* is an integral part of the component workflow for organizing and sharing access to your packages. Azure Artifacts allows you to:
 ...
 -  Keep your artifacts organized. Share code easily by storing Apache Maven, npm, and NuGet packages together. You can store packages using Universal Packages, eliminating the need to keep binaries in Git.
...
> [!NOTE]
> After you publish a particular package version to a feed, that version number is permanently reserved.
