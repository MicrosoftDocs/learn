...
1. By default, MFA is required on activation. For this demonstration, change the requirement to **None**.
...
1. Notice you can send notifications when members are assigned and activated.
1. Click **Update**.
...
1. On the **Membership settings** page set the **Assignment type** is **Active**.
