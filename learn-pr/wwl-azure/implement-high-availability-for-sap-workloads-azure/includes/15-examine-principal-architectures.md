...
Choosing the correct Azure region for an SAP system that will be accessed by a geographically dispersed user-base has a significant impact on high availability and performance for mission-critical workloads. The following evaluation criteria will help with devising the right strategy:
