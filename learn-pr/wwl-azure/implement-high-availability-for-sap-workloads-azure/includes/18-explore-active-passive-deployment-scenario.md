...
- You should deploy dormant VMs in the passive zone (from a DBMS point of view) so you can start application resources if there is a zone failure.

> [!NOTE]
> Azure Site Recovery is currently unable to replicate active VMs to dormant VMs between zones.

- You should invest in automation that allows you, if there is a zone failure, to automatically start the SAP application layer in the second zone.
