...
This module will guide you through the steps required to develop your own Langston's Ant project. Your code will use interfaces to represent the functions the ants can perform. By the end of this module, your project will be able to display two ants creating a mirrored pattern.
