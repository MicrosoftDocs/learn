...
The languages, and their supported versions, are updated on a regular basis. You can can an updated list by using the following command in the Cloud Shell.
