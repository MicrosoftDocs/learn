...
1. Which character is used to identify variables?
...
2. Which command would you use to assign a numerical value of 20 to a variable?
...
3. The variable $ip is a string with a value of "10.100.4.2". Which command would you use to divide $ip into four separate numbers?
...
( ) $ip | Break 4 {Incorrect. You use the Split method to divide a string into parts. To use the split method, you need to provide the character that acts as the separator. In this case, dot "." is the separator.}}
