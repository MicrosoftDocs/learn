...
Application Insights is a feature of Azure Monitor that provides extensible application performance management (APM) and monitoring for live web apps. Developers and DevOps professionals can use Application Insights to:<br>
...
## How Application Insights works<br>
...
You'll need to check whether an Application Insights instance is linked to your Spring Cloud Service.<br>
...
The output seen above shows that Application Insights is enabled and that your applications are sending monitoring data to Application Insights.<br><br>If your output differs, and there's no instrumentation key, you'll need to reconfigure Application Insights.
