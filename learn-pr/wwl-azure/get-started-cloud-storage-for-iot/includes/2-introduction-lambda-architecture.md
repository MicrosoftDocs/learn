The list below includes three distinct purposes for storing telemetry readings that are generated by IoT devices:
...
The sections below describe the hybrid nature of the IoT lambda architecture.
