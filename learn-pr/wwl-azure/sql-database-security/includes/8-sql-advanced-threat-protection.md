...
:::image type="content" source="../media/cms-sql-advanced-threat-protection-server-settings-template-29d440ae.png" alt-text="Screenshot showing SQL Advanced Threat Protection server settings template.":::
