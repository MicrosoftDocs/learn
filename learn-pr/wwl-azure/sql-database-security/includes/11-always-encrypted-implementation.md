...
:::image type="content" source="../media/az500-always-encrypted-flow-new-ee112bee.png" alt-text="High level data flow for implementation of Always Encrypted" lightbox="../media/az500-always-encrypted-flow-new-ee112bee.png":::
