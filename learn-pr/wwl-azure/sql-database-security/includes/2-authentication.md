...
:::image type="content" source="../media/az500-database-authentication-e61f1571.png" alt-text="Data authentication flow for Microsoft Entra ID and SQL server. A Microsoft Entra database administrator and SQL database administrator are shown.":::
