...
- **Microsoft Premier Support**, which is recommended if SAP workloads are based on Windows Server and/or SQL Server. This option offers the best enterprise-level support for Azure, Windows and/or SQL Server.
