...
4. Copy the **Application (client) ID** value, and store it for later.<br>
...
:::image type="content" source="../media/run-command-7f02363f.png" alt-text="Screenshot showing the terminal run command to run an test the sample application.":::
