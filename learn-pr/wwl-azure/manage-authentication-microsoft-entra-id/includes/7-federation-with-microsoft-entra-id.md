...
:::image type="content" source="../media/federation-with-microsoft-entra-id-3d47d0f1.png" alt-text="Diagram showing an example of federation with Microsoft Entra ID.":::
