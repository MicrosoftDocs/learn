...
:::image type="content" source="../media/federation-with-microsoft-entra-id-3d47d0f1-7d9846c7.png" alt-text="Diagram showing an example of federation with Microsoft Entra ID.":::
