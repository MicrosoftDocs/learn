...
:::image type="content" source="../media/microsoft-entra-cloud-synchronization-example-14a3b39d.png" alt-text="Diagram showing an example of Microsoft Entra synchronization functionality.":::
