...
:::image type="content" source="../media/microsoft-entra-cloud-synchronization-functionality-a8c756a1.png" alt-text="Diagram showing an example of Microsoft Entra synchronization functionality.":::
