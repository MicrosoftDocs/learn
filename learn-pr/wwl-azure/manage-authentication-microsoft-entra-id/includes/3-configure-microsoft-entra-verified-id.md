...
## :::image type="content" source="../media/microsoft-entra-verified-id-configuration-steps-806ee747.png" alt-text="Image showing how to run and test a Microsoft Entra Verified ID sample application."::: <br>
