Azure Time Series Insights can be configured within your IoT solution and used to visualize IoT device telemetry.
...
By the end of this module, you will be able to analyze IoT telemetry data using Azure Time Series Insights.
