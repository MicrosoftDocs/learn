...
5.  Find **Add non-Azure servers** and select **Configure**.
    ...
    :::image type="content" source="../media/onboard-get-started-tab-new-fd416374.png" alt-text="Screenshot displays the Defender for Cloud resources for getting started.":::
