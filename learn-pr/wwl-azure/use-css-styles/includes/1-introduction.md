...
Imagine you're creating a webpage for your resume. You created the page using HTML, and want to set various style options such as the color and fonts. You will modify the style by using CSS.
