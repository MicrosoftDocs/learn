...
Each horizontal row in the figure is an environment. Each column (the vertical dimension) is an SAP system for a business function (for example, ERP and BI).
