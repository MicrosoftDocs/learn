...
:::image type="content" source="../media/auth-method-access-key-fca3f084.png" alt-text="Screenshot showing the authentication method s m b file share page.":::
...
:::image type="content" source="../media/default-auth-account-create-portal-9e44903b.png" alt-text="Screenshot showing the default authorization account portal.":::
