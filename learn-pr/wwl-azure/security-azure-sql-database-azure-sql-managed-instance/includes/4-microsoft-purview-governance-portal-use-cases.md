...
:::image type="content" source="../media/new-microsoft-purview-governance-portal-5316021e.png" alt-text="Screenshot showing the Microsoft Purview governance portal for managing manage your on-premises, multicloud, and software-as-a-service data.":::
