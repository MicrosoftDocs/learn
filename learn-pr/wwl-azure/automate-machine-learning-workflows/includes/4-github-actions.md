...
1. Check out the repo to make it available on the runner.
2. Install the Azure Machine Learning extension for the CLI.
3. Sign in to Azure using the predefined `AZURE_CREDENTIALS`.
4. Navigate to the `src` folder, which contains all your production code.
5. Run the Azure Machine Learning pipeline.
