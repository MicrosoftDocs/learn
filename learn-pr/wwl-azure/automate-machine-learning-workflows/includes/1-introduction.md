When you want to implement AI at scale, automation is a key part for moving from experimentation to machine learning operations (MLOps). 
...
> [!Note]
> Pipeline is a concept that you'll find within several services in Azure. To clarify which pipeline is implied, the full product name will be included for Azure Machine Learning pipelines, Azure (DevOps) Pipelines, and GitHub Actions.
