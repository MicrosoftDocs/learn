When implementing SAP HANA-based workloads in Azure, you have the choice of deploying HANA on Azure virtual machines or bare-metal, purpose-built hardware referred to as **SAP HANA on Azure (Large Instances)** (frequently abbreviated to **HANA Large Instances** or **HLI**).
