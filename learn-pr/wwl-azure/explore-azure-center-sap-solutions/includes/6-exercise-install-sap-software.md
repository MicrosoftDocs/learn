...
1. Create an **Ubuntu 20.04** virtual machine in Azure. For more information, see [how to create a Linux virtual machine in the Azure portal](/azure/virtual-machines/linux/quick-create-portal?tabs=ubuntud).
...
1. Install Ansible 2.11.12 on the virtual machine.
