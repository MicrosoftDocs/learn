...
- Each virtual network has its own CIDR block and can be linked to other virtual networks and on-premises networks.
...
Virtual networks can be used in many ways. As you think about your configuration plan for your virtual networks and subnets, consider the following scenarios.
