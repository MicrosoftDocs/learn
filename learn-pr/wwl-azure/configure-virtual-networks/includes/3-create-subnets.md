...
:::image type="content" source="../media/subnets.png" alt-text="The Create virtual network page of the Azure portal is shown. The Address space, 10.1.0.0 16, is highlighted. Connected to the address space are two subnets.":::
