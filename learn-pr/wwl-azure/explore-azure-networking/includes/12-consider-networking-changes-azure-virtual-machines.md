You might need to account for extra network requirements as part of a deployment of Azure Virtual Machines or large instances of SAP HANA on Azure.
...
When you enable a Service Endpoint, you restrict the flow of traffic, and enable your Azure Virtual Machines to access the service directly from your private address space. Devices can't access the service from a public network. On a deployed virtual machine vNIC, if you look at Effective routes, you'll notice the Service Endpoint as the Next Hop Type.
