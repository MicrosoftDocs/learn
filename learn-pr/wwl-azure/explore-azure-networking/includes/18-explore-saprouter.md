...
:::image type="content" source="../media/deployment-schema-sap-hana-saprouter-13a4e7de.png" alt-text="Rough deployment schema for SAP HANA without a site-to-site connection and SAProuter":::
