...
3.  **Datacenter efficiency**. Microsoft datacenters that host Azure are more energy-efficient at datacenter-specific tasks, such as cooling and lighting, than typical datacenters.
