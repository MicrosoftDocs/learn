...
+ **Task 5**: Configure Azure virtual machine diagnostic settings.
    + Review the virtual macine monitoring settings and enable guest-level monitoring.
...
![Screenshot of the simulation page.](../media/simulation-monitor-thumbnail.jpg)(https://mslabs.cloudguides.com/guides/AZ-104%20Exam%20Guide%20-%20Microsoft%20Azure%20Administrator%20Exercise%203?azure-portal=true)
