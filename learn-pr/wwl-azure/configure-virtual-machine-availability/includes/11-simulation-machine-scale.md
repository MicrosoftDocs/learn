...
+ **Task 2**: Configure Azure virtual machines by using virtual machine extensions. 
    ...
    + Upload an [Azure PowerShell script](https://github.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator/tree/master/Allfiles/Labs). This script will install the Windows Server Web Server role on a virtual machine. 
    + Use the custom script extension feature to run the script on a virtual machine. Export the template.
    + Configure the exported [template](https://github.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator/tree/master/Allfiles/Labs) to install the role on a different virtual machine. 
+ **Task 3**: Scale compute and storage for Azure virtual machines. In this task, you'll scale compute for Azure virtual machines by changing their size and scale their storage by attaching and configuring their data disks.
    ...
    + [Use Azure PowerShell](https://github.com/MicrosoftLearning/AZ-104-MicrosoftAzureAdministrator/tree/master/Allfiles/Labs) to initialize and partition the new disk.
