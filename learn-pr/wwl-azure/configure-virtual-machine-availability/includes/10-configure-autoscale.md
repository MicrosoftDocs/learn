...
:::image type="content" source="../media/AZ104_Implementing_Autoscale-18f4c62c.png" alt-text="Screenshot of the instances and autoscale settings. The instance count is 2 and the instance size is DS1\_v2. Autoscale is enabled. The minimum number of VMs is 1 and the maximum number of VMs is 10.":::
