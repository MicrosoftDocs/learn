...
:::image type="content" source="../media/scale-vertical.png" alt-text="Vertical scaling shows a single VM getting larger.":::
...
:::image type="content" source="../media/scale-horizontal.png" alt-text="Horizontal scaling shows more VMs being added.":::
