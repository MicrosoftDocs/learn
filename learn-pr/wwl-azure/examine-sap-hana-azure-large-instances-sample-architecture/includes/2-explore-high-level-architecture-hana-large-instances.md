...
:::image type="content" source="../media/hli-architectural-overview-373f9bd5.png" alt-text="Diagram showing architectural overview of S A P HANA on Azure (Large Instances).":::
...
:::image type="content" source="../media/sap-hana-architecture-azure-large-instances-2c79e078.png" alt-text="Diagram illustrating S A P HANA architecture using Azure Large Instances.":::
