...
GitHub Copilot provides access to a range of AI models from multiple providers. The available models change as new models are released and older models are retired. The table below lists some of the key models available at the time of writing. For the most current list, see [Plans for GitHub Copilot](https://docs.github.com/en/copilot/about-github-copilot/subscription-plans-for-github-copilot).
