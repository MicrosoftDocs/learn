...
In this exercise, you examine the GitHub Copilot configuration settings in Visual Studio Code and complete a quick tour of GitHub Copilot features.
...
[![Button to launch exercise.](../media/launch-exercise.png)](https://go.microsoft.com/fwlink/?linkid=2320038&azure-portal=true)
