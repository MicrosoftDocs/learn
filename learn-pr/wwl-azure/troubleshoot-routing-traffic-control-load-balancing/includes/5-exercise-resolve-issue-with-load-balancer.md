...
:::image type="content" source="../media/7-load-balancer-search.png" alt-text="A screenshot showing searching for load balancers.":::
...
:::image type="content" source="../media/7-load-balancer-rule-web.png" alt-text="A screenshot of the load balancer rule, showing the session persistence set to Client IP. This is the error.":::
...
:::image type="content" source="../media/7-rule-deployed.png" alt-text="A screenshot showing the successful deployment of the updated load balancer rule.":::