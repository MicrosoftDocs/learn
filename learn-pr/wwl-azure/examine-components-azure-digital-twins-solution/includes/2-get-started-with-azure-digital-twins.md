...
:::image type="content" source="../media/m11-l02-simple-twins-environment-38963825.png" alt-text="Diagram that shows an Azure Digital Twins graph that represents a small building with two floors and one room on each floor.":::
