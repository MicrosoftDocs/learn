...
In this exercise, you configure a C# project to use custom Copilot instructions and create two or more custom agents that collaborate through handoffs. Tasks include:
...
1. Optionally create a "Tester" agent or use the built-in test capabilities.
