...
The EXO V3 module uses REST API connections rather than remote PowerShell over WinRM. Basic authentication in WinRM is not required and does not need to be configured.
