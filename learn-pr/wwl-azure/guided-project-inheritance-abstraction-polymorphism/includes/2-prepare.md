...
1. Download the zip file containing the Starter project code by selecting the following link: [Starter Files](https://codeload.github.com/MicrosoftLearning/Challenge-Project-implement-inheritance-abstraction-polymorphism/zip/refs/heads/main).
...
1. Unzip the download files to your working directory.
    ...
    1. Open the **Challenge-Project-implement-inheritance-abstraction-polymorphism-main** folder.
