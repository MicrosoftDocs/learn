...
2. If you have access to multiple tenants, use the **Settings** icon :::image type="content" source="https://learn.microsoft.com/en-us/entra/identity-platform/media/common/admin-center-settings-icon.png" alt-text="Icon of gear.":::
