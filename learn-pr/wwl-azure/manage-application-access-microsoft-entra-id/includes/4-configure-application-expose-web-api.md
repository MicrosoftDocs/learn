...
2.  If you have access to multiple tenants, use the **Settings** icon
    ...
    :::image type="content" source="../media/admin-center-settings-icon-9ac42b6c-292854d4-7bb85e27.png" alt-text="Icon of gear.":::
...
> [!NOTE]
> You can use the default value of `api://`. The App ID URI acts as the prefix for the scopes you'll reference in your API's code, and it must be globally unique."

6.  Select **Add a scope**:

:::image type="content" source="../media/expose-application-program-interface-c51f4c95-613ce84e-593ba49b.png" alt-text="Screenshot showing the applications registrations page.":::
...
:::image type="content" source="../media/verify-exposed-scopes-dbb01a99-534cee85-30640952.png" alt-text="Screenshot showing how to verify exposed scopes.":::
