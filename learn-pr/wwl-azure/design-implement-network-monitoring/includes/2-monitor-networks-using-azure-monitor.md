...
1. **Insights** provides visualizations for applications, containers, networks, and virtual machines. Also, **Azure Monitor Network Insights** provides health, metrics, and topology for all deployed network resources.
