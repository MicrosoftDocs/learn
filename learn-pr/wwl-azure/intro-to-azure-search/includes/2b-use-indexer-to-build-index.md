So far, we have discussed the index schema. Now we will describe how to create search documents and use them to populate the index. An index needs to be populated with JSON search documents before it can be queried. 
