...
![Screenshots of navigating forward and backward through several iOS Settings app pages](../media/2-stack-navigation-illustration.png)
...
![Illustration of a fictitious conference app's page structure. One navigation path is highlighted to show how the user might move from the general home page to more specific pages. The navigation path includes four pages: Home, Food, Restaurants, and Restaurant Details.](../media/2-stack-navigation-general-to-specific.png)
...
![Illustration showing the components of a Xamarin.Forms NavigationPage, with a top navigation bar and bottom content area](../media/2-navigation-page-components.png)
...
![Illustration showing a navigation bar's back button](../media/3-navigation-bar-back-button.png)
