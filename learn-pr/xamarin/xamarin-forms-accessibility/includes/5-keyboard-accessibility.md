...
Sometimes you may want to exclude a control from the tab order. The `IsTabStop` property can be set to `false` to ignore it from the tab-navigation infrastructure.
