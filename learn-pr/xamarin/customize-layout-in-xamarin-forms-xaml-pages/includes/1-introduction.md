...
In this module, you'll build a Xamarin.Forms application that looks similar across different devices. You'll start by setting the preferred size and position of a view. Then you'll arrange views vertically using `StackLayout`. Next, you place views into rows and columns using `Grid`. By the end of the module, you'll have a Xamarin.Forms application that looks consistent on every device type and screen size.
