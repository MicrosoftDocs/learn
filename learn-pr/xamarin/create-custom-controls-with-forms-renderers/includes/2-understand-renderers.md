...
![Diagram of a button element with corresponding native controls](../media/buttonElementWithMatchingNativeControls.png)
...
![Diagram of button element with platform renderers](../media/buttonElementWithRenderers.png)
...
![Diagram of renderer routing a Click event](../media/rendererRoutingNativeEvent.png)
