...
App Center maintains a [list of available devices and their operating system version](/appcenter/test-cloud/devices/android). Generally, you will find the most common device configurations, representing the most popular devices from major manufacturers. You can also find older configurations of popular devices that may have reached the end of their system updates.
