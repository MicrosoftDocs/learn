...
|                                                                       |
| List some of the tools that implement IaC for popular cloud platforms |
| and describe some of the differences between them                     |
+-----------------------------------------------------------------------+
...
Visual Studio and Visual Studio Code. Figure 6.4 shows a template for
...
thousands of lines long. The template in Figure 6.4 is a simple one, but
...
Figure 6.4: Simple ARM template for provisioning an Azure storage
account.
...
Azure Portal. Figure 6.5 shows how the template in Figure 6.4 appears in
...
![](media/image1.png){width="6.0in" height="4.375in"}

Figure 6.5: ARM template rendered in the Azure Portal.
...
As Figure 6.6 illustrates, the architecture of a system running the
...
![](media/image2.png){width="5.995138888888889in"
height="3.6354166666666665in"}

Figure 6.6: Puppet's standard deployment architecture.
...
deployment architecture is quite simple (Figure 6.7). The server is
...
Figure 6.7: Chef's standard deployment architecture.
...
6.8 shows a segment of a playbook from an open-source Ansible
...
Figure 6.8: Sample Ansible script written in YAML.
