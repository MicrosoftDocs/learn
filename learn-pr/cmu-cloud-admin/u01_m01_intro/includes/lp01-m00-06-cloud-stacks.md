...
![](media/image1.png){width="6.5in" height="3.401388888888889in"}

Figure 1.10: Amazon Web Services regions[^2]
...
![](media/image2.png){width="6.5in" height="3.15625in"}

Figure 1.11: Microsoft Azure regions[^3]
...
![](media/image3.png){width="6.5in" height="3.511111111111111in"}

Figure 1.12: Google Cloud Platform regions[^4]
...
[^3]: Microsoft (2019). *Azure regions*. <https://azure.microsoft.com/en-us/global-infrastructure/regions/>.
