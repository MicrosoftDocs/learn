---
title: Cloud Building Blocks and Service Models
---
...
![https://oli.cmu.edu/repository/webcontent/0ea6fc470a0001dc68390ea2588ab51d/\_u01\_intro/\_u01\_m01\_intro/webcontent/cloud\_computing\_stack.png](media/image1.png){width="3.125in" height="3.0416666666666665in"}
...
![](media/image2.png){width="6.5in" height="3.482638888888889in"}
...
Infrastructure-as-a-service is defined as follows:

Infrastructure-as-a-service (IaaS) is a cloud-computing model in which cloud providers make computing resources available to clients, usually in the form of virtual machines
...
Platform-as-a-Service is defined as follows:

Platform-as-a-service (PaaS) is a model that provides a software platform such as a database server or web server without the complexity of purchasing, installing, and maintaining the underlying hardware and software
...
Software-as-a-Service is defined as follows:

Software-as-a-service (SaaS) is a software delivery model in which software is hosted in the cloud. The infrastructure, the platform, and the software itself are managed by the cloud provider, and the software is consumed as a service.
...
Increasingly, cloud providers are offering APIs -- functions that are called over the Internet using the HTTP(S) protocol and that serve as building blocks for applications -- as SaaS services. One example is Azure's Computer Vision API, which lets developers write code that identifies objects in photos, generates captions and search metadata for photos, finds faces in photos, and more using artificial intelligence (AI). Amazon offers a similar API called Rekognition, while Google calls its offering the Vision API. Intelligence APIs offered in the form of SaaS services enable software developers to infuse AI into their apps without becoming AI experts themselves and exmplfy the continuing evolution of cloud computing.
...
[^1]: ZDNet (2018). ​*Linux now dominates Azure*. <https://www.zdnet.com/article/linux-now-dominates-azure/>.
