...
Figure 5.11: Programming languages supported by popular serverless-function runtimes.
...
[^1]: Microsoft (2019). *Automate handling emails and attachments with Azure Logic Apps*. <https://docs.microsoft.com/en-us/azure/logic-apps/tutorial-process-email-attachments-workflow>.
