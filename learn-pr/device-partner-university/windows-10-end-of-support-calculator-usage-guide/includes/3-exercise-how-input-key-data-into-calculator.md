The Windows 10 EOS Calculator homepage summarizes the model and how your inputs are analyzed. There’s no separate setup—the calculator processes data in real time as you enter values.
