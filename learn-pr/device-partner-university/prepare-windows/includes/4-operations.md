Let’s build on your earlier assessment of operational readiness and deployment plan to close any gaps. To get your operations ready for Windows 11, we recommend the following tasks and deliverables. 
...
As you work on closing the gaps to prepare your estate for Windows 11 upgrade, involve all the stakeholders you’ve identified in your roles and responsibilities and RACI tables. Across the tasks in this module, keep these charts close to assign the tasks to the appropriate owners and to notify others. Consider a way to keep track of key stakeholder approvals and follow-ups.

> [!NOTE]
> ***Recommended deliverable***
>
> Your previously prepared RACI tables and roles and responsibilities. If needed, consider creating a stakeholder approval tracking system.

## [Optional] Set up a Proof of Concept (PoC) lab environment
...
At a high level, your PoC tasks could be:

1. Identify a group of users or devices to receive Windows 11.
2. Identify which apps you want to test.
3. Deploy the update to devices.
4. Implement security baselines.
5. Implement configuration updates.
6. Validate the deployment process.
7. Deploy and/or test applications.
...
> ***Recommended deliverable***
>
> Document your test results and findings, in particular any notable failures that will need to be addressed before production deployment can commence. Check: Do you need to get stakeholder approvals?

## Update the deployment plan, assigning devices to rings

In the Plan module, you’ve considered a ring-based approach to OS updates. This approach enables you to stay current with less effort and less effect on productivity. Have you already established the rings for your Windows 11 deployment? Have you opted for a traditional *Test-First-Fast-Broad* ring structure or created custom rings with multiple deployment phases?
...
Review your deployment plan to confirm that the number of rings and planned dates still meet your requirements.
...
> ***Recommended deliverable***
>
> Updated deployment plan, including devices assigned to all rings. Check: Do you need to get stakeholder approvals?
