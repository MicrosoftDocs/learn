...
| Device readiness | [Work from anywhere report](/intune/endpoint-analytics/work-from-anywhere) | Endpoint analytics | Plan |
...
| Device provisioning | [Work from anywhere report](/intune/endpoint-analytics/work-from-anywhere) | Endpoint analytics | Plan |
| Device identity | [Work from anywhere report](/intune/endpoint-analytics/work-from-anywhere) | Endpoint analytics | Plan |
...
| Endpoint analytics | Same prerequisites as Microsoft Intune. For more information, visit [What is Endpoint analytics?](/intune/endpoint-analytics/?pivots=intune#prerequisites). |
