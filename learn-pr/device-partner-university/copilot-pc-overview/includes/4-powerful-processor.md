...
All three processors completed the task — but the results were very different:
...
The NPU completed the task faster while generating less heat and using significantly less energy. This efficiency is what enables Copilot+ PCs to run AI features continuously — like Live Captions or Windows Studio Effects during a video call — without draining battery life or slowing down other applications.

> [!TIP]
> This demonstration illustrates a key concept: the NPU isn't just faster at AI tasks — it's more *efficient*. In a business context, efficiency means employees can use AI features throughout the workday without carrying a charger or closing other apps to free up resources.
...
When discussing Copilot+ PCs with business decision-makers, the platform story is often the most compelling angle: these aren't just faster PCs — they're the foundation for how the organization will build, deploy, and manage AI going forward. The NPU is a critical piece of that foundation, enabling a new class of AI-powered experiences that are efficient, responsive, and secure.