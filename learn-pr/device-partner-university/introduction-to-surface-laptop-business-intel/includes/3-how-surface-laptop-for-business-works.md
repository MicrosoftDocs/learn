:::image type="content" border="true" source="../media/surface-laptop-intel-ports.png" alt-text="Diagram of Microsoft Surface Laptop for Business (Intel) ports and hardware.":::

| **Microsoft Surface Laptop for Business (Intel) ports and hardware** | **Microsoft Surface Laptop for Business (Intel) ports and hardware** |
| :---: | :---: |
...
eSIM is a digital way to connect to your mobile operator, which allows you to switch easily between mobile operators and data plans. Here are the steps to add and manage an eSIM on your Surface Laptop for Business (Intel):
...
- After setting up the eSIM profile, follow these steps to connect to cellular data:
  - Select the **Start** button, then enter **settings**. Select **Settings** > **Network & internet** > **Cellular** > **eSIM profiles**.
  - Under **Profiles for cellular data**, select the eSIM profile you want, and then select **Use**.
  - Select **Yes** for **This will use cellular data from your data plan and may incur charges. Do you want to continue?** After accepting, you'll be connected to a cellular data network and ready to go.
- You can temporarily turn off cellular data when not in use.
  - Open **Settings**.
...
- If you don't want to use a profile anymore, you can easily delete it from your Surface Laptop for Business (Intel).
  - Select the **Start** button, then enter **settings**. Select **Settings** > **Network & internet** > **Cellular** > **eSIM profiles**.
  - Under **Profiles for cellular data**, select the profile to delete, and then select **Delete**.
  - At the prompt that warns you that the profile will be permanently deleted, select **Yes**.

>[!NOTE]
> If your Surface Laptop for Business (Intel) is managed by your organization, you might not be able to delete an eSIM profile because of a policy that's set by your organization.

:::image type="content" border="true" source="../media/sim-card-install.gif" alt-text="Animation of installing a SIM card into a Surface Laptop for Business (Intel).":::

The other method of connecting to cellular data on your Surface Laptop for Business (Intel) is through a physical SIM card. Surface Laptop for Business (Intel) accepts Nano SIM cards. To begin, you'll need an active SIM from your mobile carrier.

Surface Laptop for Business (Intel) comes with a SIM ejector tool. To find it, look for an instruction card in the box your Surface was packaged in. You'll need this tool to place a SIM card in your Surface Laptop for Business (Intel).

:::image type="content" border="true" source="../media/surface-laptop-sim-tool.jpeg" alt-text="Photo of Surface Laptop for Business (Intel) SIM ejector tool.":::

Now you're ready to install your SIM card into your Surface. Follow these steps to complete installation:

- Locate your SIM card tray on the side of the device near the rear right corner before the Surface Connect port.
...
- Place the SIM card face up in the SIM card tray. Make sure the small notch in the corner of the SIM card matches the one in the SIM card tray so that it fits properly.
- With the small hole closest to the front of the laptop, slide the SIM card tray back into the SIM card slot until it clicks. Make sure the SIM card tray slides in smoothly. Once installed, your Surface Laptop for Business (Intel) will automatically connect to your mobile network.
