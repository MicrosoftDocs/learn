The latest Surface for Business devices are Copilot+ PCs—which means they're optimized for the future of AI applications. All Surface Copilot+ PCs feature on-device AI experiences with neural processing units (NPUs). For higher education teachers, this helps to accelerate their repetitive tasks.

Imagine you're a university professor balancing teaching, research, and collaboration throughout the day. You plan to teach a class, do some research, and collaborate with fellow researchers on a call. With Surface devices and AI tools, you can stay organized and be productive. Let's explore how Surface can help you make the most of your day.

## Summarizing emails in Outlook

To start your day, you open your email inbox and calendar in Outlook. Upon reviewing your inbox, you see a message thread with multiple back-and-forth messages. You have a busy day ahead, and reading through every message would be time-consuming. Copilot can help  reduce time spent reviewing long or complex email threads. Follow these steps to summarize an email thread:
...
After teaching your class, it's time to work on research. In your on-campus office you have a dual monitor set up and Surface USB4 Dock. Connecting this dock to your Surface Pro allows you to have a desktop experience that is more comfortable for research and your Surface provides enough power to run academic, productivity, and AI apps simultaneously.
...
| :---: | :---: | :---: |
| 7 | USB-C port (power supply only) | Input power only |
| 2 | USB-A port | Connecting external drives, printers, headsets, etc. |
| 3 | Security lock slot | For attaching a security lock cable, such as a Kensington Lock |
| 4 | Gigabit Ethernet port | For dependable and fast network connection to a wired network |
| 5 | HDMI 2.1 | Connect to an external 4K monitor |
...
:::image type="content" border="true" source="../media/snap-layouts.gif" alt-text="Animation showing how to use Snap Layouts to organize windows on a screen.":::
...
With the multimonitor setup with Surface USB4 Dock and Snap Layouts, you're able to utilize the power of your Surface device and complete your research more efficiently.

## Windows Studio Effects

After your research, the next part of your day involves jumping on a call to speak with your research collaborators. In this session, you'll be leading the conversation so it's important that you look and sound your best. With the AI-enhanced 1080p Studio Camera, dual studio mics, and Omnisonic speakers with Dolby Atmos on your Surface, you can look and sound your best.
