:::image type="content" border="true" source="../media/surface-portal-roles.png" alt-text="Photo of user interacting with a Surface device while using Surface Slim Pen.":::
