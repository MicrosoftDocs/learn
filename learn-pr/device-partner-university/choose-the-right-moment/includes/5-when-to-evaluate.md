...
:::image type="content" source="../media/windows-server-modernization-decision-tree.svg" alt-text="Decision tree that helps you decide whether to stay the course or start a Windows Server modernization evaluation based on security, operations, or business signals.":::
