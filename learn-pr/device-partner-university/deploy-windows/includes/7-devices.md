| Tasks | Deliverables |
|-------|--------------|
| - Monitor update deployment status.<br>- Sign off and update procedural documentation. | • Procedural documentation of testing, remediation, and results |

## Monitor update deployment status

As you expand your deployment of Windows 11 to more devices, you should regularly monitor the status to ensure that you are on track and are likely to achieve your deployment plan. There are several reports that you can use to review the status of the deployment.  
...
> [!TIP]
>
> Build a regular review of the deployment status into your schedule. This will enable you to keep on top of any trending issues and to quickly identify fixes.

> [!TIP]
>
> ***Recommended deliverable:***
>
> Identify and document any issues that need to be addressed.
