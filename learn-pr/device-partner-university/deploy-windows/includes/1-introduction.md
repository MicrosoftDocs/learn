...
Keep in mind that, in practice, the six areas we’ll address—operations, applications, infrastructure, configurations, devices, and users—often require simultaneous or overlapping attention. Deliverables should be in a format that’s easy to share and collaboratively edit throughout the life of the project.
Also keep in mind that the size and complexity of your organization will influence your overall approach.
