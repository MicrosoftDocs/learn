...
- When you're satisfied with your artwork, simply select the generated image in the side pane to apply it to the Paint canvas. You can keep editing or save it.

If you encounter an image result that's unexpected, you can report it using the Feedback button in the Cocreator pane.
