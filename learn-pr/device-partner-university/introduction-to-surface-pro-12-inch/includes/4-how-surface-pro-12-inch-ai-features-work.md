As a Copilot+ PC, Surface Pro 12-inch enables on-device AI experiences that help complete repeatable tasks quicker. Let's learn how to utilize some of these experiences.
...
- Click to Do is enabled by default on Surface Pro 12-inch. If you do not want to use this feature, this is how to disable it:
...
Note: It is recommended that you plug in your Surface Pro 12-inch for the initial search indexing to get completed.
...
And it supports all the usual file types for documents (.txt, .pdf, .docx, .doc, .rtf, .pptx, .ppt, .xls, .xlsx) and images (.jpg/.jpeg, .png, .gif, .bmp, .ico)

## Cocreator in Paint

Cocreator in Paint allows you to create artwork with the help of AI. Start by entering a text prompt and start drawing on the Paint canvas, and Cocreator will generate artwork based on your input as you draw. Here's how to use this feature:
...
- When you are satisfied with your artwork, simply click the generated image in the side pane to apply it to the Paint canvas. You can keep editing or save it.

If you encounter an image result that is unexpected, you can report it using the Feedback button in the Cocreator pane.
