...
- **[Windows Autopatch](/windows/deployment/windows-autopatch):** Automates the deployment of monthly security updates and quality patches across the organization. Autopatch uses update rings and phased rollouts to minimize risk and disruption. Windows Autopatch can be enabled through Microsoft 365 Business Premium or Enterprise subscriptions. IT admins configure update rings and policies in the Microsoft Intune admin center.
