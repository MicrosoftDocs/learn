...
For data that resides on a local computer, you can use any of the tools shown in the following list to send data from your computer to Azure Data Lake Storage:
...
For Azure Storage Blob data, you can use any of the tools shown in the following list to copy blobs to Azure Data Lake Storage:
