...
Like the training and consumption code that is autogenerated, Model Builder provides you with templates to autogenerate .NET applications that include your model for predictions. The templates include:
...
- **\<MODEL-NAME\>.mbconfig**: The *.mbconfig* file for your model and generated training and consumption code. These files are is copied over from the class library project you originally added the machine learning project to.
