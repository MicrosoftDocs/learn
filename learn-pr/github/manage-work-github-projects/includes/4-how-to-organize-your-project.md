...
1. Then click, **New field**.
   ...
   :::image type="content" source="../media/4-project-new-field.png" alt-text="An image of the top of a Project with the columns for Notes and Priority and the New Field Button as a plus sign highlighted.":::
...
1. In the drop down menu below, click the Single select option. This will allow you to create your own classification for your new field.
   ...
   :::image type="content" source="../media/4-new-field-drop-down.png" alt-text="A view of the drop down menu for a New Field that contains Text, Number, Date, Single select, and Iteration with the Single Select option highlighted.":::
...
1. Then, make sure to click Save. Now that you have your priority classification set up, next up you'll need to classify your issues and pull requests based on priority.
...
1. One of the great features of this particular view is you can now drag and drop issues into new priority fields easily.
   ...
   :::image type="content" source="../media/4-priority-classification-example.png" alt-text="Example of Priority Classification within Project List view with Issues and Pull Requests that are organized and grouped as High, Medium, and Low classifications.":::
...
1. Once you click out of the tab the name of your new view will automatically save.

   :::image type="content" source="../media/4-project-boards.png" alt-text="An example of a Project board with 4 columns labeled; no status, todo, in-progress, done.":::
