For private repositories with GitHub Advanced Security, secret scanning has a few configurable parameters such as excluding files from being scanned and configurable notification recipients. But before you can configure secret scanning on a repository, you must enable it.
...
Follow the steps below to enable secret scanning and push protection on a private repository:

1. In your repository, navigate to **Settings > Code security and analysis**.
2. Select the **Enable** button next to **GitHub Advanced Security**.
...
Follow the steps below to enable secret scanning and push protection for an organization:
