This exercise checks your knowledge on excluding files from being scanned by secret scanning.
...
> [Start the exercise on GitHub](https://github.com/githubtraining/exercise-exclude-files-from-secret-scanning)
