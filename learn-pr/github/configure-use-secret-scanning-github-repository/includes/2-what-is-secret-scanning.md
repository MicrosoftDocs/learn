...
:::image type="content" source="../media/secret-scanning-alerts.png" alt-text="Screenshot of secret scanning alerts in GHAS."::: 
...
For a list of the service providers and patterns GitHub automatically detects in public and private repositories, please check out Secret scanning patterns 
...
Secret scanning for partners runs automatically on public repositories and public npm packages to notify service providers about leaked secrets on GitHub.com. Secret scanning alerts for users are available for free on all public repositories. Organizations that are allowed to use GitHub Advanced Security features can also enable secret scanning on their private and internal repositories. 
