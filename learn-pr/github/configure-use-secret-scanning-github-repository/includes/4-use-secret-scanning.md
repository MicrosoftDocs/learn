...
You can review and sort the alerts in **Security > Secret scanning** to determine source, provider, type, and more. The alerts can be filtered with the following to determine specific attributes:
- Bypassed 
- Validity
- Secret type
- Provider
...
As mentioned earlier in the "What is secret scanning?" unit of this module, GitHub automatically scans public and private repositories for secret patterns provided by GitHub and GitHub partners. However, for private repositories with GitHub Advanced Security, you can also scan for other secret patterns, such as those that are internal to your organization.
