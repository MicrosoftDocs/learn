...
:::image type="content" source="/media/reporting-and-logging/org-audit-log-export.png" alt-text="A wide screenshot of the GitHub interface for exporting an organization's audit log, with the Filters field and the Export drop-down":::
