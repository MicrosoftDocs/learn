As agent systems become more capable, the most important design question is no longer what they can do—it is what they should be allowed to do.
...
In the GitHub ecosystem, governance isn't a separate system. It is enforced directly via repository controls, workflows, and enforceable policies.
