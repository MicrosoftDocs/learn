In this unit we'll discuss how to sign up for GitHub Copilot, configure GitHub Copilot using Visual Studio Code, and some steps to troubleshoot GitHub Copilot using Visual Studio Code.
