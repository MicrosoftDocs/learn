...
This module covers the following learning objectives as defined in the objective domains for the following certifications:
...
|Locate an asset from the GitHub Marketplace for a specific need (for example, find the Azure Pipelines GitHub App in the Marketplace, install it, and configure it to deploy your code) | | | 1.9| |
| Contrast a GitHub App and an action (for example, their permissions, how they’re built, how they’re consumed)|  | | 1.10| |
