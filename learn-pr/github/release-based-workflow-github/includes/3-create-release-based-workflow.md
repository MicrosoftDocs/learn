In this exercise, you'll use GitHub Learning Lab to implement a release based workflow on GitHub using project boards, branches, and releases.
...
> [Start the learning lab on GitHub](https://lab.github.com/githubtraining/create-a-release-based-workflow?azure-portal=true)
