...
Suppose you have been using open source libraries for your projects and at work for quite some time. In the spirit of the open-source community, you have decided to contribute back to some of these libraries and frameworks. You first need to find a project to contribute to on GitHub as well as familiarise yourself with the project and its community standards. You will also need to identify tasks that you can help with as well as best practices to submit your contributions.
