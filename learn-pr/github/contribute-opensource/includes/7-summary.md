...
After discovering where you can provide help, you learned how to use GitHub to create your first contribution and submit a pull request. You learned that it is important to write a succinct description of the changes you make to a project. Use imperative, present tense, explaining _what_ and _why_ and not _how_. This will increase the likelihood of your changes getting merged. Finally, you learned how to communicate effectively with project maintainers and how to conduct code reviews.
