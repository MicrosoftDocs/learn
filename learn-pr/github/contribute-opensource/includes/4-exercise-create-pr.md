...
**Bonus:** check Microsoft's Accessibility Guidelines and Requirements, and in particular the bit about ["describing interactions with UI"](https://docs.microsoft.com/en-us/style-guide/procedures-instructions/describing-interactions-with-ui), to avoid ablist language in your Docs contributions. Customers interact with products using different input methods: keyboard, mouse, touch, voice, and more. You will want to use generic verbs that work with any input method, for instance "select" instead of the input-specific "click" or "swipe".
