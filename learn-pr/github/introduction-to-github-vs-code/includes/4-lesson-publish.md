...
If you're starting with a new project you haven't yet pushed to GitHub, the process for _getting_ it up on GitHub looks something like this...
...
1. Specify which files should be pushed to GitHub.
   1. Any files that you don't select will automatically be added to a `.gitignore` file which is created during the publish process.
