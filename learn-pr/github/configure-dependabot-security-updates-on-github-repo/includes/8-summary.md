...
Finally, you learned how to configure your notifications based on the way that you want to receive alerts about vulnerabilities in your repository. You also learned how to use the security digest email as a concise way to receive a daily or weekly list of vulnerabilities in your repository.
...
- [Enabling the dependency graph and Dependabot alerts on your enterprise account](https://docs.github.com/en/enterprise-server@3.0/admin/configuration/managing-connections-between-your-enterprise-accounts/enabling-the-dependency-graph-and-dependabot-alerts-on-your-enterprise-account)
- [Connecting your enterprise account to GitHub Enterprise Cloud](https://docs.github.com/en/enterprise-server@3.0/admin/configuration/managing-connections-between-your-enterprise-accounts/connecting-your-enterprise-account-to-github-enterprise-cloud)
