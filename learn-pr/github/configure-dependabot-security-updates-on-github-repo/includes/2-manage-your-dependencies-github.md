...
- The **indirect dependencies**, also known as transitive dependencies or sub-dependencies, which are dependencies used by packages that are dependencies of your project.
- The **vendored dependencies** that are checked into a specific directory in your repository but are not referenced in your manifest file (only available for some package managers).
...
1. Navigate to your GitHub repository.
2. Click your repository **Insights**.
...
In the remaining units, you will learn more about using Dependabot in your repository.
