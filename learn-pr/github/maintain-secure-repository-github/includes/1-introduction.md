Software security is always an important topic, and it spans the entire software development lifecycle. While much focus is afforded to the process of writing secure code and locking down infrastructure, it's as important to protect the processes that happen elsewhere in DevOps. 
