...
This module builds on the concepts described in [Manage an InnerSource program by using GitHub](/training/modules/manage-innersource-program-github). It assumes you've already completed that module first.
