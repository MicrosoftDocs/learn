...
![Diagram of open-source process levels.](../media/2-process-levels.png)
...
- **Optimized**, which have a process that's continually and reliably improving through both incremental and innovative changes. Success depends on reducing the risk of change.
