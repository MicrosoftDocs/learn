In this exercise, you navigate to a GitHub repository and validate your ability to install a GitHub App for a GitHub organization.

This GitHub exercise is graded automatically once you attempt a solution to the challenge. The results of your actions, and helpful feedback, are provided in real time within the `grade-learner` workflow logs.
...
When you finish the exercise in GitHub, return here to continue with the module.
