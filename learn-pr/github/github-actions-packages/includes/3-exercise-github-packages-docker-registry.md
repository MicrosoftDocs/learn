In this exercise, you use GitHub Learning Lab to learn how to create a CI job with GitHub Actions, build your container image, and publish it to GitHub Packages.
...
> * Learn more about other types of packages you can use with GitHub Packages
> * A summary of what you've learned
> * To earn a badge for completing this module

> [!div class="nextstepaction"]
> [Start the learning lab on GitHub](https://lab.github.com/githubtraining/github-actions:-publish-to-github-packages?azure-portal=true)
