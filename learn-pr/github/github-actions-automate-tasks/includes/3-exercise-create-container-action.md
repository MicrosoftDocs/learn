In this exercise, you'll use GitHub Learning Lab to create a GitHub repository, a container action that will print a greeting in the action's log file, and a workflow that triggers on a push to this repository.
