Here, you're introduced to GitHub Actions and workflows. You learn the types of actions you can use and where to find them. You also look at examples of these types of actions and how they fit in a workflow.
...
A *GitHub Actions workflow*  is a process that you set up in your repository to automate software development life-cycle tasks, including GitHub Actions. With a workflow, you can build, test, package, release, and deploy any project on GitHub.
