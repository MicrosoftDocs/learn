...
GitHub Enterprise Managed Users (EMUs) are GitHub Enterprise Cloud accounts owned by companies and not individual users. These accounts are controlled, managed, and audited by the company’s GitHub administrators. Using EMUs, you can connect your GitHub Enterprise Account to an identity provider (IdP); either Microsoft Entra ID or Okta. From here, you'll be able to centrally manage the user provisioning lifecycle and create a true single sign-on experience for your members and contractors. To ensure everything works smoothly, Admins have complete jurisdiction over the EMU accounts and their corresponding private repositories.
