:::image type="content" source="../media/metallic-version-of-the-git-hub-copilot-icon.png" alt-text="Metallic version of the GitHub Copilot Icon with a black background.":::
