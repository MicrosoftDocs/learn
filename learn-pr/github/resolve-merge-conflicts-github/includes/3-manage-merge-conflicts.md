This exercise checks your knowledge on settling overlapping commits across branches by using merge conflict resolution.
...
- Select the **Start course** button or the **Use this template** feature within the template repository. This prompts you to create a new repository. We recommend creating a public repository, as private repositories use Actions minutes.
...
> [Start the exercise on GitHub](https://github.com/skills/resolve-merge-conflicts?azure-portal=true)
