In this exercise, you use GitHub Learning Lab to create a new repository with all of the files needed. GitHub Learning Lab will then walk you through creating a workflow for continuous integration of a Node.js project from a template, and then customizing this workflow.

GitHub Learning Lab has an easy to use integrated experience where you get feedback and instruction throughout the lab right in your GitHub repository.
