In this exercise, you'll use GitHub Learning Lab to interact with the GitHub API from GitHub Actions by using GitHub Script.
...
> [Start the learning lab on GitHub](https://lab.github.com/githubtraining/github-actions:-using-github-script?azure-portal=true)
