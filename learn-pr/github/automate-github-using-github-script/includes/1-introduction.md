GitHub Script is a workflow action that provides you with access to the GitHub API from within your GitHub Actions. It offers convenient support for any API usage available in [octokit/rest.js](https://octokit.github.io/rest.js/v18).
...
In this module, you learn how to interact with the GitHub API from a GitHub Actions workflow by using GitHub Script.
...
It is recommended that you complete [Automate development tasks by using GitHub Actions](/learn/modules/github-actions-automate-tasks/) before beginning this module.
