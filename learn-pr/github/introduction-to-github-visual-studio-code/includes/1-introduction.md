...
:::image type="icon" source="../media/vscode-github.png":::
...
By the end of this module, you will gain an introduction on leveraging GitHub and source control features inside of Visual Studio Code.
