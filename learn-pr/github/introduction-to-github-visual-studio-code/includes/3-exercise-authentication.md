...
1. Make sure you have the latest version of Visual Studio Code installed. Select the Profile/accounts icon in the activity bar, then select **Check for Updates**, and then install the latest version, if necessary.
