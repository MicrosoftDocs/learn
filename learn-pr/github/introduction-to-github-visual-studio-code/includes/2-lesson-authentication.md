...
You can select the account icon at the bottom of the activity bar and sign in with your GitHub account. A browser window will open, and you'll be asked to grant permission for Visual Studio Code to access GitHub. 
