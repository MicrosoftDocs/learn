...
You'll publish to GitHub in the next unit. In this unit, we provide an overview of the publishing process.
...
## Options for publishing to GitHub from Visual Studio Code
...
> [!TIP]
> You can always use Git from the built-in terminal in Visual Studio Code as well. Just because you're using visual source-control tools in Visual Studio Code doesn't mean that you have to completely forgo using the command line.

### Option 1: Publish from the SCM View
...
Selecting this button will start the publishing process. You'll be prompted to do the following:
...
### Option 2: Publish from the command palette
