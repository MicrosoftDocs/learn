...
Interpreted query results are automatically displayed in the source code in CodeQL for Visual Studio Code. Output results that the CodeQL CLI generates can be in many formats for use with various tools.
