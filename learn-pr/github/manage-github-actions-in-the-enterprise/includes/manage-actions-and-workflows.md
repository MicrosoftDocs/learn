This unit explores the different tools and strategies available to you in GitHub Enterprise Cloud and GitHub Enterprise Server in order to share GitHub actions and workflows and manage their use within your enterprise.
...
If you want to enable only specific actions to be used within your enterprise, click **Allow select actions** and choose the option corresponding to your use case, as shown below.
