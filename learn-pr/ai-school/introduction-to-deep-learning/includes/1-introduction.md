Deep learning has made significant progress in recent years, becoming the new state-of-the-art area in AI. Deep learning takes what we did with neural networks and makes it bigger and better.
