Next we’re going to do another programming exercise - we'll make a basic neural network using Keras.
...
1. Select the exercise `08. Neural Networks Introduction - Python.ipynb`.  
...
1. Select the exercise `08. Neural Networks Introduction - R.ipynb`.  
1. Then click __'Run on Free Compute'__.
