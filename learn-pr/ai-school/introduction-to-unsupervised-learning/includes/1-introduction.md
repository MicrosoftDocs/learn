...
![On a plot there are many unlabelled data points. Four circles are drawn over the data points, each circle labelling the data points a different colour.](../media/71-ca.gif)
