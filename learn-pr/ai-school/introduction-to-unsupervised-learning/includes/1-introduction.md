...
![Scatter plot titled 'Clustering', with the Y-axis labeled 'Independent variable 2' and the X-axis labeled 'Independent variable 1'. There are two distinct areas with data points, one in the top left-hand corner and one in the bottom-right hand corner. The top left-hand corner is circled, with all the data points blue, with a label 'Cluster 1'. The bottom right-hand corner data points are also circled, with the data points green, labeled 'Cluster 2'.](../media/71-c-1.png)
