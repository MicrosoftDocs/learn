Classification can be thought of as sorting examples into categories. The graph below shows a logistic regression, an example of a classification model, where the values are classified into two categories - satisfied customers and dissatisfied customers.
