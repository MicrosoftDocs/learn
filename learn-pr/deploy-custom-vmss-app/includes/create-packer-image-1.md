...
- **Builders** - define how the base VM itself should be configured and deployed. In Azure, the builder defines the credentials when the base VM is created, the target location for the final image, the size and location of the base VM and any tags to apply to the image.
