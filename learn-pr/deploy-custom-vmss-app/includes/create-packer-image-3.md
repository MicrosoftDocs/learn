...
In the *builders* section of the template file shown above, replace the Azure credential information placeholders with your own values. The placeholders are of the format  **"YOUR xxxx_id HERE"**.  
