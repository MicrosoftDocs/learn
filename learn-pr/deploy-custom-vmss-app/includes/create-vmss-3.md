When you created your scale set in the previous step, Azure CLI 2.0 also created an Azure load balancer. The VM instances created from your Packer image were attached to this load balancer. The Azure load balancer distributes traffic to the VM instances in a scale set based on defined rules.
