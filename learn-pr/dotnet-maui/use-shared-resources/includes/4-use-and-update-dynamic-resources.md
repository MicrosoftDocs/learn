In the previous unit, you defined a resource in XAML and used it as a static value. However, tThere are some cases where **StaticResource** isn't appropriate. Consider the following scenarios:
