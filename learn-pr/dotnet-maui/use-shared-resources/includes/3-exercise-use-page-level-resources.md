...
1. Take a few minutes to examine and run the application so you understand how it behaves.
    ...
    :::image type="content" source="../media/3-standard-tip-page.png" alt-text="The StandardTipPage of the Tip Calculator in Android.":::
    ...
    :::image type="content" source="../media/3-custom-tip-page.png" alt-text="The CustomTipPage of the Tip Calculator in Android.":::
