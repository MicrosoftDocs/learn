...
:::image type="content" source="../media/10-ios-android-pref.png" alt-text="Setting the text size preference on an iOS and Android device.":::
...
:::image type="content" source="../media/10-style-example.png" alt-text="Examples showing the built-in styles":::
