...
:::image type="content" source="../media/2-login-page.png" alt-text="Screenshot of the login page generated by the C# code. It shows a title, 2 text boxes for username and password. And a button to login with.":::
