...
![Image of the **Server logs** page for Azure Database for MySQL.](../media/5-mysql-server-logs.png)
...
![Image of the **Query Performance Insight** page for Azure Database for PostgreSQL, showing the **Long running queries** tab.](../media/5-query-insight.png)
...
![Image of the **Query Performance Insight** page for Azure Database for PostgreSQL, showing the **Wait statistics** tab.](../media/5-query-insight-waits.png)
