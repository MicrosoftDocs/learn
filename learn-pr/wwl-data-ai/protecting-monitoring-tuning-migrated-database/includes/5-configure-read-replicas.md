...
![Image of the **Replication** page for Azure Database for PostgreSQLThe **+ Add Replica** command is highlighted.](../media/5-configure-replica.png)
...
![Image of replicas on the **Replication** page for Azure Database for PostgreSQL.](../media/5-replicas.png)
