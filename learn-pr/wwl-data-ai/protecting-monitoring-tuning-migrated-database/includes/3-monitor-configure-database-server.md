...
![Image of the chart showing the values captured for the CPU percent, Memory percent, IO percent, and Active connections metrics](../media/5-metrics-chart.png)
...
![Image of the **Server parameters** page for Azure Database for PostgreSQL](../media/5-server-parameters.png)
