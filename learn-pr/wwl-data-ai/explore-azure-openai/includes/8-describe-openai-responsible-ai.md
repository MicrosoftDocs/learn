It is important to consider the ethical implications of working with AI systems. Azure OpenAI provides powerful natural language models capable of completing a variety of tasks and operating in several different use cases, each with their own considerations for safe and fair use. Teams or individuals tasked with developing and deploying AI systems should work to identify, measure, and mitigate harm.
...
- **Fairness**: Al systems should not make decisions that discriminate against or support bias of a group or individual.
...
- **Transparency**: AI systems should have explanations so users can understand how they are built and used.
