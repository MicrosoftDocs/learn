...
To continue learning about Azure OpenAI and find resources for implementation, you can check out the [documentation on Azure OpenAI](/azure/cognitive-services/openai?azure-portal=true) and the [Develop AI solutions with Azure OpenAI Learning Path](/training/paths/develop-ai-solutions-azure-openai?azure-portal=true).