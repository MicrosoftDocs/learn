...
To continue learning about Azure OpenAI and find resources for implementation, you can check out the [documentation on Azure OpenAI](/azure/cognitive-services/openai?azure-portal=true).