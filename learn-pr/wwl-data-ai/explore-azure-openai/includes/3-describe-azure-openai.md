...
Azure OpenAI supports many common AI workloads and solves for additional workloads. 
...
Additional AI workloads Azure OpenAI supports can be categorized into three groups: 
