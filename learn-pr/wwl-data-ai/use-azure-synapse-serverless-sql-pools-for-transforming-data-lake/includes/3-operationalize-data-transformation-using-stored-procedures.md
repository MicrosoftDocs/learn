Once you prepare your data transformation query, you can encapsulate the transformation logic using stored procedures. Stored procedures can accept input parameters and return multiple values in the form of output parameters to the calling program. In the context of serverless SQL pools, you will perform data transformation using CREATE EXTERNAL TABLE AS SELECT (CETAS) statement as shown in the following example.
