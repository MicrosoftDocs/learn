...
The disadvantage of using the portal to create Azure resources is that it is not an easily repeatable process. However, it is easy to get started with the portal, and using the portal a new administrator can quickly get up and running.
