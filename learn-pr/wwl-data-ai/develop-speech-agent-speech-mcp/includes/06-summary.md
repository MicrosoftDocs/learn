...
- [Azure Speech in Foundry Tools for the Azure MCP Server](/azure/developer/azure-mcp-server/tools/ai-services-speech)
...
- [Azure Speech service overview](/azure/ai-services/speech-service/overview)
