...
- **Machine learning** – the ability for computer programmes to learn from large amounts of data, in a process known as "training".
...
You can find out more about Azure AI services in the [service documentation](/azure/ai-services/).
