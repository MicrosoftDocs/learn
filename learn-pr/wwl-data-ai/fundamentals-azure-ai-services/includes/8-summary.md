Azure AI services are easy to use AI capabilities made available as resources on the Azure platform. AI service capabilities include Language, Speech, Vision, Decision, Cognitive Search, and Azure OpenAI.
...
- **Artificial Intelligence (AI)** – computer programmes that respond in ways that are normally associated with human reasoning, learning, and thought. 
- **Azure AI services** – a portfolio of AI services that can be incorporated into applications quickly and easily without specialist knowledge. 
- **Azure AI Services** – a resource created in the Azure portal that provides access to multiple Azure AI services with a single key and endpoint. 
...
- **Machine learning** – the ability for computer programmes to learn from large amounts of data, in a process known as 
"training".
