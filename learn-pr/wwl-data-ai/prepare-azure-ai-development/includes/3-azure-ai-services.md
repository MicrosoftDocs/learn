...
| ![Microsoft Foundry icon.](../media/ai-services.png)<br>**Microsoft Foundry**  | The Microsoft Foundry resource type includes the following services, and supports working with them through a Microsoft Foundry project\*: <ul><li>Azure OpenAI</li><li>Azure AI Speech</li><li>Azure AI Language</li><li>Microsoft Foundry Content Safety</li><li>Azure AI Translator</li><li>Azure AI Vision</li><li>Azure AI Face</li><li>Azure AI Document Intelligence</li><li>Azure AI Content Understanding</li></ul>|
