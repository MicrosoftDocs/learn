...
1. In the Visual Studio Codespace, expand the **03-Create-a-knowledge-store** folder and the **C-Sharp** folder it contains.
...
1. In the Visual Studio Codespace, expand the **03-Create-a-knowledge-store** folder and the **Python** folder it contains.
