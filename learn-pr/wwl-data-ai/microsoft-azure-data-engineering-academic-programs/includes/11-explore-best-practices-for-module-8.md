...
As you begin to teach this module, get familiar with what the students will learn during the module. In this module students will learn about Azure Synapse Analytics, Azure Active Directory, how to use managed identity, authentication, and how to manage access to databases and data warehouses in Azure. 
...
- Azure Active Directory Managed Identities can minimize the need for keys, secrets, and passwords 
