...
You can learn more about the REST APIs in the [Azure Speech to text REST API documentation](/azure/cognitive-services/speech-service/rest-speech-to-text). In practice, most interactive speech-enabled applications use the Speech service through a (programming) language-specific SDK.
