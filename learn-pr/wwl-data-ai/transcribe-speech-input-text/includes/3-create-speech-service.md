...
1. Select **+ Create a resource**. In the **Search the Marketplace** box, enter **speech**, and press **Enter**.
...
1. Create a new resource group (RG) named **mslearn-speechapi** to hold your resources. You can also choose an existing RG if you want.
...
> [!TIP]
> If you miss the notification that your resource is published, select the notification icon in the top bar of the portal, and then select **Go to resource**, as shown in the following image.
