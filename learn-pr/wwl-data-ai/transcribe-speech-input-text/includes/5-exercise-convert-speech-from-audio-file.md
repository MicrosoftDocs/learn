...
1. Visual Studio Codespaces installs the package for use with the AudioConfig class that will be used in the code
1. In Program.cs, replace the text **YourSubscriptionKey** by pasting the Speech Service key.
1. Enter your location, such as **westus**, in the **YourServiceRegion** option of that same line.
1. Locate the text **YourAudioFileName** and replace it with **../media/narration.wav**.
