...
- **Discovering new features:** For example, before you migrate or upgrade with the help of the Azure Database Migration Service (DMS), the database can take advantage of new features available in the target SQL Server platform. 
