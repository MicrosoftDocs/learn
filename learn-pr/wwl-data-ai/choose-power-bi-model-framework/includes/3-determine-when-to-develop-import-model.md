...
> [!TIP]
> Hybrid tables are described in [unit 4](/learn/modules/choose-power-bi-model-framework/5-determine-when-to-develop-composite-model). For information about real-time datasets, work through the [Monitor data in real-time with Power BI](/learn/modules/monitor-data-real-time-with-power-bi/) module.
