...
![Graphic shows the Power BI report described in the previous paragraph.](../media/model-frameworks-analytic-query-example.png)
...
![Graphic shows a star schema design with a fact table in the center and dimension tables forming the points of the star.](../media/model-frameworks-star-schema-design.png) 
