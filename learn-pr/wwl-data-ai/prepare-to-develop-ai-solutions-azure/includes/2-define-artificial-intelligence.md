...
| ![An image of a text document](../media/text.png)  | **Text analysis** - The ability to use *natural language processing (NLP)* to not only "read", but also extract semantic meaning from text-based data. |
...
| ![An image of a human head with a cog](../media/speech.png) | **Decision making** - The ability to use past experience and learned correlations to assess situations and take appropriate actions. For example, recognizing anomalies in sensor readings and taking automated action to prevent failure or system damage. |
