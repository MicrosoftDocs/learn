...
> [!NOTE]
> For more information about Azure Applied AI Services, see the [Azure Applied AI Services](https://azure.microsoft.com/product-categories/applied-ai-services/) web page.
