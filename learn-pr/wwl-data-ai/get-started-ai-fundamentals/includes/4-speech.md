...
![Diagram of a user's spoken input being converted to text.](../media/speech-recognition.png)
...
![Diagram of text being converted to audible speech.](../media/speech-synthesis.png)
