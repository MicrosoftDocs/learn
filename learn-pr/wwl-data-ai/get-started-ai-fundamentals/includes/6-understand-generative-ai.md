...
Azure OpenAI supports many foundation model choices that can serve different needs. The service features are available for use and testing in the **Azure AI Foundry portal** and other programming languages. You can use the Azure AI Foundry portal to manage, develop, and customize generative AI models.

![A screenshot of the the Azure AI Foundry portal landing page before sign-in.](../media/azure-ai-foundry1.png)
![A screenshot of the home page of the Azure AI Foundry portal interface which includes quick-start buttons.](../media/azure-ai-foundry.png)