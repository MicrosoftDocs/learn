...
Azure OpenAI supports many foundation model choices that can serve different needs. The service features are available for use and testing with **Azure AI Foundry**. You can use the Azure AI Foundry portal to manage, develop, and customize generative AI models.
