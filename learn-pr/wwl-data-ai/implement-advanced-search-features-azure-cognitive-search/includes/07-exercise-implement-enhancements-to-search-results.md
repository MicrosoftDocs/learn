...
1. On the **Overview** pane, select **Import data**.
    ...
    :::image type="content" source="../media/import-data-new-small.png" alt-text="A screenshot showing the import data menu." lightbox="../media/import-data-new.png":::
...
1. On the **Add cognitive skills (Optional)** tab, expand **Attach AI  Services**, then select **Create new AI Services resource**.
    ...
    :::image type="content" source="../media/add-cognitive-services-new-small.png" alt-text="A screenshot showing selecting, adding, Azure AI Services."lightbox="../media/add-cognitive-services-new.png":::
...
1. Expand the **Add enrichments** section.
    ...
    :::image type="content" source="../media/add-translation-enrichment-new-small.png" alt-text="A screenshot showing adding Portuguese translation." lightbox="../media/add-translation-enrichment-new.png":::
...
1. Add the following fields and weights under **Weights**:
    ...
    :::image type="content" source="../media/add-weights-new.png" alt-text="A screenshot of weights being added to a scoring profile."lightbox="../media/add-weights-new.png":::
