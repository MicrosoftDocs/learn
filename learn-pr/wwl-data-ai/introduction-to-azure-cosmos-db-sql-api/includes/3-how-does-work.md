...
![Diagram showing how an Azure Cosmos DB SQL API account is the parent resource to a database, which is itself a parent resource to a container](../media/3-resource-hierarchy.png)
