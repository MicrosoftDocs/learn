...
For example, you may use generative AI to translate images to text. Users with visual disabilities can use generative AI to understand what the image represents. Generative AI can even explain the context or punchline of a joke, even if it's a picture.
...
![Graph depicting AI methodologies (deep learning, machine learning, and data science) and AI as purpose (AI and generative AI).](../media/2-identify-basic-ai-technology-concepts-1.png)
