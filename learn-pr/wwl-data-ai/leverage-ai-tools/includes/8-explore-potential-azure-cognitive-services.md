...
* **Decision:** These models provide recommendation on best decisions to take. They can raise an alert when they detect anomalies in your data, or flag potentially unsafe content. There's also Personalizer, a recommendation model that suggests which content to show to each user based on their behavior.
