...
:::image type="content" source="../media/azure-databricks-notebooks-language.png" alt-text="Screenshot of available languages in Azure Databricks notebooks." lightbox="media/article-folder-name/image-file-expanded.png":::
