...
:::image type="content" source="../media/endpoint-api-version.png" alt-text="A screenshot of search explorer and finding the endpoint and api version." lightbox="../media/endpoint-and-api-version.png":::
