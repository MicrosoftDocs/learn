In this exercise, you use Azure Language to build a custom text classification model.
...
[![Button to launch exercise.](../media/launch-exercise.png)](https://go.microsoft.com/fwlink/?linkid=2322137&azure-portal=true)
