...
To help resolve issues, refer to the sections on [Create Statistics to Improve Performance](/training/modules/optimize-data-warehouse-query-performance-azure-synapse-analytics/7-create-statistics-to-improve), [Understand performance issues related to tables](/training/modules/optimize-data-warehouse-query-performance-azure-synapse-analytics/2-understand-performance-issues-related-to-tables), [understand table distribution design](/training/modules/optimize-data-warehouse-query-performance-azure-synapse-analytics/4-understand-table-distribution-design), and [use indexes to improve performance](/training/modules/optimize-data-warehouse-query-performance-azure-synapse-analytics/5-use-indexes-to-improve)
