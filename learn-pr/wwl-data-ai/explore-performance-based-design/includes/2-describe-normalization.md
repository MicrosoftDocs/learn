...
Note that if the price for a product was different based on the color of the product, then the fourth table would be in second normal form, because the price would depend on both parts of the key: ProductID and Color. 
