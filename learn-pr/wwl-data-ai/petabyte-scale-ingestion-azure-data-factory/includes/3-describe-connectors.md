...
There are too many data stores to list, but the following table list the categories of data stores and two examples of the types of connectors that exist
