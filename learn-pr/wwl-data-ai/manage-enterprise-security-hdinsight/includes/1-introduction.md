...
As a data architect you need to be able to design data processing landscapes that are compliant, secure, and auditable on demand. Security considerations are not just restricted to the HDInsight service in question, but span across multiple other services that HDInsight interacts with. This can include Azure networking, operating systems, Azure Active Directory Domain Services (Azure AD DS), and Azure Storage. 
