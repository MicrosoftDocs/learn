...
- Azure Cosmos DB backups are stored in Azure Blog storage.
...
- Snapshots of the backup are replicated to another region through geo-redundant storage (GSR). This replication, provides resiliency against regional disasters.
- Backups can't be access directly. To restore the backup, a support ticket needs to be opened with the Azure Cosmos DB team.
