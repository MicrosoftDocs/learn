Azure Databricks and the Spark engine provide optimizations necessary for working with Big Data. By now, you should Understand the difference between a Transformation and an Action, know the difference between a Wide and Narrow Transformation, and be aware that your code is evaluated and optimized by the Catalyst Optimizer.
