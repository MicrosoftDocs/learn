...
1. In the **Import Notebooks** dialog box, select the URL and paste in the following URL:
     ...
     `https://github.com/solliancenet/microsoft-learning-paths-databricks-notebooks/blob/master/data-science/07-Machine-Learning.dbc?raw=true`

1. Select **Import**.
1. Select the **07-Machine-Learning** folder that appears.
