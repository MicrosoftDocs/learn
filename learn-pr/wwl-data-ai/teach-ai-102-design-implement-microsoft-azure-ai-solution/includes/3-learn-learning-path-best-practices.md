...
As an educator, you play a pivotal role in empowering students for future success. Skilling our future generations is critical work. The AI-102: Designing and Implementing a Microsoft Azure AI Solution course provides students with skills to build, manage, and deploy AI solutions that use Azure Vision, Azure AI services, Azure OpenAI Service, and Azure AI Search. 
