...
![Script to rebuild indexes on DimProduct table](../media/6-rebuild-indexes.png)

### Update statistics
The following example creates statistics on the **ProductCategory** column of the **DimProduct** table:

![Script to CREATE statistics on the ProductCategory table](../media/6-update-statistics.png)
