...
> [!TIP]
> Alternatively, if you would like to use a development environment on your own computer, follow these [**exercise instructions**](https://github.com/MicrosoftLearning/mslearn-cosmosdb-mongodb-vcore/blob/master/Instructions/01-create-account.md).
