...
The auto-pause delay feature allows you to specify the period of inactivity before the database is automatically paused. This delay can be set from as short as 15 minutes to as long as seven days (10,080 minutes), in 1-minute increments. Alternatively, you can disable the auto-pause feature if desired.
