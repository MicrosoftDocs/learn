...
![Image shows the report action bar and highlights the refresh command.](../media/real-time-automatic-page-refresh-action-bar-refresh.png)
...
![Image shows the incremental refresh and real-time data set up, and it highlights the Get the latest data in real-time with DirectQuery option.](../media/real-time-automatic-page-refresh-set-up-incremental-refresh.png)
...
![Image shows the layout of a streaming dataflow that does grouping, from Event Hub to output table.](../media/real-time-streaming-dataflow-designer.png)
...
![Image shows the Page refresh setting enabled.](../media/real-time-automatic-page-refresh-enabled.png)
...
![Image shows the Change detection measure window.](../media/real-time-automatic-page-refresh-create-change-detection-measure.png)
...
![Image shows Performance Analyzer results, including recorded change detection queries.](../media/real-time-automatic-page-refresh-performance-analzyer.png)
...
![Image shows the A P R capacity settings.](../media/real-time-automatic-page-refresh-capacity-settings.png)
