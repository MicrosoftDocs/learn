Azure Purview offers a central place to discover and understand assets to use in your day-to-day activities. This central place, Azure Purview data catalog, provides advanced search capabilities to quickly find the right assets and information. Using keywords, business terms and Azure Purview data catalog functionalities, you can find the assets needed to build and design reports.

As a data analyst looking for assets, you'll be searching the Azure Purview data catalog. This assumes that the *Azure Purview data Map* has been created by your organization. The data map provides the foundation for data discovery. The data map captures metadata about enterprise data in analytics and operations systems on-premises and in the cloud and must be established before the data catalog can be searched. 

>[!NOTE]
> Learn more about the [Azure Purview data map](/azure/purview/concept-elastic-data-map) components.

## Search the Azure Purview data catalog

From the Azure Purview Studio home page, users can type relevant keywords to start discovering assets. In this scenario, you're looking for “product sales.”

![Azure Purview data catalog interface, displaying a search bar with the terms product sales entered.](../media/azure-purview-catalog.png)
...
![Azure Purview data catalog search results displaying a results for the product sales search, including .csv files and Azure SQL Tables.](../media/azure-purview-catalog-2.png)
...
![Azure Purview data catalog interface, displaying search results.](../media/azure-purview-catalog-3.png)
...
![Azure Purview data catalog search results, displaying two Azure SQL database tables, one of which is certified.](../media/azure-purview-catalog-4.png)
...
![Azure Purview data catalog asset description, containing a sentence that tells analysts this is the correct resource to use for reporting.](../media/azure-purview-asset-descrip.png)
...
>[!NOTE]
>Azure Purview comes with more than 200 classifications out of the box. For a full list of classifications, see [System classifications in Azure Purview](/azure/purview/supported-classifications).
...
![Azure Purview data catalog asset classifications. data in the ReportTable_Prod asset is classified as credit card number, person's name, and franmer product.](../media/azure-purview-asset-descrip-2.png)

>[!IMPORTANT]
>You may notice that the classifications displayed above are sensitive or contain personally identifiable information (PII). data encryption is done at the source level, and Azure Purview stores only the metadata. It does not preview data.

You can also view the *collection path*, *hierarchy* and *glossary terms* on the right side of the overview tab.

The *collection path* refers to the location of the asset inside Azure Purview. You have the option to move an asset to another collection.

![Azure Purview data catalog asset collection path, displaying the ability to move an asset to another collection.](../media/azure-purview-collection-path.png)
...
![Azure Purview data catalog asset collection path, diaplying the asset hierarchy.](../media/azure-purview-hierarchy.png)
...
![Azure Purview data catalog asset glossary terms, located on the overview tab. Glossary terms for this asset are customer product, product client, products, sales, sales with tax, and SSN.](../media/azure-purview-glossary.png)
...
![Azure Purview data catalog contact interface, displaying two experts and two owners for the sample dataset.](../media/azure-purview-contacts.png)
...
![Azure Purview data catalog related interface, displaying related assets.](../media/azure-purview-related.png)

The ability to search the Azure Purview data catalog has the potential to break down data silos and enable the next level of enterprise analytics.
