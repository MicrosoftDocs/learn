Most of the tools that work with SQL Server will work out of the box with serverless SQL pool. From web-based client Synapse Studio to BI tools like Power BI it’s now easier than ever to start being productive even if you data resides in the data lake.
