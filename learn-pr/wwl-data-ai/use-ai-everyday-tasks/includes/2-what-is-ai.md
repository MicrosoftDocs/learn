...
> [!TIP]
> **AI Agents**, often referred to as virtual assistants, are designed to perform specific tasks or provide assistance based on user input. These agents are created using advanced technologies like machine learning and natural language processing. They can be customized and trained to handle a wide range of tasks, from answering questions to automating routine or repetitive activities. AI agents need to be developed and configured to understand specific commands and perform particular functions. Examples of AI agents include chatbots, virtual customer service representatives, and personal assistants like Siri or Alexa. To learn more, review [Introducing Copilot agents](https://support.microsoft.com/en-us/topic/introducing-copilot-agents-943e563d-602d-40fa-bdd1-dbc83f582466#:~:text=Copilot%20agents%20are%20specialized%20AI,expanding%20their%20reach%20and%20functionality.).
...
> ### **Responsible AI**
>
> As AI becomes more integrated into our daily lives, it's very important to use it responsibly. Here are some key points to keep in mind so we can use AI in ways that are fair, trustworthy, and beneficial to society:
>
...
>
> - **Gender bias**. AI systems can perpetuate gender stereotypes if trained on biased data. For example, a hiring algorithm may favor male candidates over female candidates due to historical data biases.
> - **Racial bias**. AI systems can exhibit racial bias, leading to discriminatory outcomes. For instance, facial recognition systems may have higher error rates for people of color compared to white individuals.
> - **Socioeconomic bias**. AI systems can favor individuals from higher socioeconomic backgrounds. A credit scoring algorithm, for example, may disproportionately favor applicants from wealthier neighborhoods.
>
