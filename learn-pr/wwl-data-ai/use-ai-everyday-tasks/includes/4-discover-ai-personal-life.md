...
|--|--|--|--|
| **Open-ended questions** | Where should I go on my next adventure? |Where should I go on my next adventure **that is a good day trip from [location]?**| Where should I go on my next adventure that is a good day trip from [location]? **List the pros and cons of each option.**|
...
| **Budget-related queries** | Leaving from [location], what is the least expensive destination in [location]? | Leaving from [location], what is the least expensive destination in [location], **and how much money will I need for a one-week trip staying in nice hotels?** |- Leaving from [location], what is the least expensive destination in [location], and how much money will I need for a one-week trip staying in nice hotels? **Provide a list of suggested hotels sorted from least to most expensive.** |
| **Flight info** | What’s the best deal on a flight from [location] to [location] from December 28-January 2? | What’s the best deal on a flight from [location] to [location] from December 28-January 2? **Provide at least one nonstop flight option.** | What’s the best deal on a flight from [location] to [location] from December 28-January 2? Provide at least one nonstop flight option, **and present the information in a table.** |
...
| **Packing lists** | I’m going backpacking at [location]. Create a packing list. | I’m going backpacking at [location]. Create a packing list **of the essentials I'll need for a two-week trip.** | I’m going backpacking at [location]. Create a packing list of the essentials I'll need for a two-week trip, **including clothing, gear, and any specific items needed for the local climate and terrain. Format the response with headings for each category.**  |
