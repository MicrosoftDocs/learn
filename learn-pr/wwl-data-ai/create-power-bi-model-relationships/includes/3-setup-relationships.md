...
>
> ![Image shows two tables in the model diagram with the cardinality indicators highlighted.](../media/DP500-model-diagram-cardinality.png)
...
>  
> ![Image shows two tables in the model diagram with the cross filter arrowhead highlighted.](../media/DP500-model-diagram-cross-filter-direction.png)
...
>
> ![Image shows two tables in the model diagram and two relationships; one solid line for active and one dashed line for inactive.](../media/DP500-model-diagram-active-vs-inactive-relationship.png)
