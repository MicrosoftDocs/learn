...
1. In the **Models** list, select all the models that you want to include in the new composed model, and then select **Compose**.
    ...
    :::image type="content" source="../media/3-create-composed-model.png" alt-text="Screen shot showing how to compose a model in Forms Recognizer Studio." lightbox="../media/4-create-composed-model.png":::
