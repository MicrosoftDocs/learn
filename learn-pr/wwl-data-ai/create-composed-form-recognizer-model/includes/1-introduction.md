If you've created and trained custom models in Azure Form Recognizer, you can combine them into a single composite model and publish that as a single service. Composite models help when there are multiple versions of a form in use or when users find it difficult to keep track of the correct model for each form. They can also assist when you want customers to upload different types of documents to a single location for analysis and you don't know which type was uploaded.
