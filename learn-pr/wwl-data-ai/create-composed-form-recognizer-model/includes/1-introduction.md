If you've created and trained custom models in Azure Form Recognizer, you can combine them into a single composite model and publish that as a single service.
