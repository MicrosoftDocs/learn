...
1. In the **Import Notebooks** dialog box, select the URL and paste in the following URL:
     ...
     `https://github.com/solliancenet/microsoft-learning-paths-databricks-notebooks/blob/master/data-science/08-Train-a-ML-model.dbc?raw=true`

1. Select **Import**.
1. Select the **08-Train-a-ML-model** folder that appears.
