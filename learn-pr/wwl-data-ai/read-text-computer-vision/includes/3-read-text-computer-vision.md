...
4. Make sure the the type of shell indicated on the top left of the Coud Shell pane is switched to *PowerShell*. If it is *Bash*, switch to *PowerShell* by using the drop-down menu. 
...
This simple app shows only some of the OCR capabilities of the Computer Vision service. To learn more about what you can do with this service, see the [OCR page](/azure/cognitive-services/computer-vision/overview-ocr).
