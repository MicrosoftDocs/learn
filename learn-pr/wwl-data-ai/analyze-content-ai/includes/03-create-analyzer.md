...
After creating a project, the first step in building an analyzer is to define a schema for the content the analyzer will process, and the information it will extract. Microsoft Foundry provides a schema editor interface in which you can upload a file (document, image, audio, or video) on which the schema should be based. You can then apply an appropriate schema template and define the specific fields you want the analyzer to identify.

![Screenshot of the Define schema user interface in Microsoft Foundry.](../media/define-schema.png)
...
![Screenshot of the Test analyzer user interface in Microsoft Foundry.](../media/document-analysis.png)
...
After building your analyzer, you can continue to test it in the Microsoft Foundry portal, and refine the schema to create new named versions with different capabilities.
