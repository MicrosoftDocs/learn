...
For a list of alerts, see the [Alerts for SQL Database and Azure Synapse Analytics in Microsoft Defender for Cloud](/azure/defender-for-cloud/alerts-sql-database-and-azure-synapse-analytics).
