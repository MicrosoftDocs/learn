...
By sorting the dataset, we can find the highest or lowest value within a column. Sorting can be performed on any data type, but often this is done on a date or number type, to answer a question such as the highest number of sales. String data can be sorted alphabetically in ascending or descending order.
...
In this video, you will see how a dataset can be filtered to answer a question, and how columns can be sorted to discover the highest and lowest values within a range:
