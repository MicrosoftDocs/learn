...
5. Reselect the values in the **Sales** column if you deselected them, and then in the **Conditional Formatting** pane, click **&#65291;** to add a new rule with the following settings:
    ...
    Click **Done** to apply the formatting and then close the **Conditional Formatting** pane with the **x** icon at its top right. The cells containing sales values in the bottom 10% are highlighted in red (again, you may need to scroll to see them).
