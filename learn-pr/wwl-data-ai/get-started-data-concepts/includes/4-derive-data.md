...
In this video, you will see how a new column is added to a dataset using the current data. Then you will learn how to add summary data by aggregating the values in the new column:
