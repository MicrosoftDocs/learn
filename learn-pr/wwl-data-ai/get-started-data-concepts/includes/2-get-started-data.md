...
- **Temporal data** - Temporal data are dates held against an event, such as when an order was placed, or a package was shipped. Dates have a natural order, and we know that 12/24/2021 comes before 25/12/2021, and after 12/23/2021. Because of this natural order, it's easy to measure values over time.
...
In this video, you will see an example of a dataset and how the different types of date, string, and numeric fields combine into rows and columns. You will then learn how analysis can be done on a dataset to understand patterns within the data:
