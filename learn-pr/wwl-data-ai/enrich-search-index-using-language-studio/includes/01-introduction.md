Language Studio, included with Azure Language, lets you use UI tools to explore and build AI models focused in language into your solutions. These AI models have endpoints that can be used in search solutions to enrich indexes.
...
Here you'll explore the features of Azure Language, see how to manually enrich an existing search index, and finally complete an exercise to create and enrich your own search index.

By the end of this module you'll learn to:
- Use Azure Language to enrich Azure AI Search indexes.
