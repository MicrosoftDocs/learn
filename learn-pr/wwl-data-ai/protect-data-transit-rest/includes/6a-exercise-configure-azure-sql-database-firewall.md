...
1. In the search bar at the top of the Azure Portal, type SQL. The SQL servers icon will appear. Select SQL servers. Select the server name to be taken to the detail page for the server you created in Lab 2
...
1. On the Database Settings screen, change **Edition of Azure SQL Database** to **General Purpose**. Change the **Service Objective** to **GP_Gen4_2** and then select **Next**.
