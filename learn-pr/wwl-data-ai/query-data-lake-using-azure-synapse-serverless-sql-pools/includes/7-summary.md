...
To learn more about using serverless SQL pools to query files, refer to the [Azure Synapse Analytics documentation](/azure/synapse-analytics/sql/on-demand-workspace-overview?azure-portal=true).
