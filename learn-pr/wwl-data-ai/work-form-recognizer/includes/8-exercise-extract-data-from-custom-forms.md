...
- Train and test a custom model using unlabeled sample forms using the Python or .NET SDK.
- Train and test a custom model using labeled sample forms using the Python or .NET SDK.
