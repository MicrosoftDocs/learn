...
To extract form data using a prebuilt model, use the **Analyze** REST API function (or [equivalent SDK method](https://docs.microsoft.com/en-us/azure/cognitive-services/form-recognizer/quickstarts/client-library)).
