...
![Diagram of an app submitting a call to an Azure AI Services resource through a language-specific SDK, which abstracts the JSON request and response.](../media/sdk.png)
