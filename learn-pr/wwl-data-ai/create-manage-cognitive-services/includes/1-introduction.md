...
Azure AI services includes a wide range of individual AI services across multiple categories, as shown in the following table.
...
While the details of each Azure AI service can vary, the approach to provisioning and consuming them is generally the same.

In this module, you will learn how to:

- Provision an Azure AI service resources in an Azure subscription.
