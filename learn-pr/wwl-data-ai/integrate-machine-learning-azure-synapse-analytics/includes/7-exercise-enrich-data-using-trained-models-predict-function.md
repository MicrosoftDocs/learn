...
![ProductQuantityForecast table in the SQL pool](../media/explore-table-productquantityforecast.png)
...
>
>![Text Analytics service integration code in notebook](../media/data-enrichment-text-analytics-code.png)
...
![Sentiment analysis on data from the Spark table](../media/data-enrichment-text-analytics-results.png)
