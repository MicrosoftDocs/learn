...
The names of the DMVs are all prefixed with **sys.dm_** followed by the functional area and then the specific function of the object. SQL Server organizes dynamic management objects into many functional categories — including OS-related, execution-related, database-related, index-related, I/O-related, transaction-related, security-related, and replication-related — among others. Common examples include:
