...
- [Quickstart: Create an Azure Cosmos DB and a container by using an ARM template][/azure/cosmos-db/sql/quick-create-template]
- [Bicep documentation][/azure/azure-resource-manager/bicep/]
- [ARM template documentation][/azure/azure-resource-manager/templates/]
- [Microsoft.DocumentDB &vert; databaseAccounts][/azure/templates/microsoft.documentdb/databaseaccounts]
