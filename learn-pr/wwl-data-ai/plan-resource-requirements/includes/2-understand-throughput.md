...
![Throughput provisioned at container level](../media/2-container.svg)
...
![Throughput provisioned at database level](../media/2-database.svg)
...
![Throughput provisioned at both container and database level](../media/2-mixed.svg)
