...
Using Azure Machine Learning jobs, you want to execute all necessary steps to preprocess the data and train the model. By defining the job in YAML and running the job with the CLI (v2), your worklflow can be scheduled or triggered whenever the model needs to be retrained. For example, when you have new data that the model should be trained on.
