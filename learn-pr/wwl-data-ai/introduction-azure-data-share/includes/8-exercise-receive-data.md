...
![Specification of Invitation from Azure Data Share](../media/ADSSpecificationDataShareInvitation.png)
...
![Target Data Share Account](../media/ADSTargetDataShareAccount.png)
...
![Configure Datasets to receive data into target data store](../media/ADSConfigureDatasetReceivingDataIntoTargetDataStore.png)
...
![Snapshot Schedule Enablement ](../media/ADSSnapshotScheduleEnable.png)
