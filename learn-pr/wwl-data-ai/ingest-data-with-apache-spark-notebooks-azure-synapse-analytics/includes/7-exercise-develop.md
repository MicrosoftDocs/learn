...
3. Use [Shortcut keys under command mode](/azure/synapse-analytics/spark/apache-spark-development-using-notebooks). Press **A** to insert a cell above the current cell. Press **B** to insert a cell below the current cell.
...
2.  You can also use [shortcut keys under command mode](/azure/synapse-analytics/spark/apache-spark-development-using-notebooks). Press **Ctrl+Alt+↑** to move up the current cell. Press **Ctrl+Alt+↓** to move the current cell down.
...
2. You can also use [shortcut keys under command mode](/azure/synapse-analytics/spark/apache-spark-development-using-notebooks). Press **D,D** to delete the current cell.
