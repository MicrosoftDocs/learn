...
* Setting a primary language Azure Synapse Studio notebook.

The Azure Synapse Studio notebook have support for four Apache Spark languages to be set as primary languages in a notebook. 
...
* Using temp tables to reference data across languages. 
...
When you, for example,  need to revoke a cell operation, you can do so within the Azure Synapse Studio notebook environment. 

* Move a cell. 

If you want to align different cells of code and put them in a correct order, the notebook environment gives you the opportunity to do so. 

* Delete a cell. 

If you have written a cell of code, but no longer need it or it needs to be deleted, the functionality can be used within the notebook environment. 
