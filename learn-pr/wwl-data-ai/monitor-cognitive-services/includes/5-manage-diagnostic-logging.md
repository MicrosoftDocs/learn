...
With your log destinations in place, you can configure diagnostic settings for your Cognitive Services resource. You define diagnostic settings on the **Diagnostic settings** page of the blade for your Cognitive Services resource in the Azure portal. When you add diagnostic settings, you must specify:
...
![Diagnostic settings for an Azure Cognitive Services resource](../media/diagnostic-settings.png)
...
![An Azure log Analytics query returning diagnostic data logged for a Cognitive Services resource](../media/azure-log-analytics.png).

> [!NOTE]
> For more information, see [Enable diagnostic logging for Azure Cognitive Services](/azure/cognitive-services/diagnostic-logging) in the Azure Cognitive Services documentation.
