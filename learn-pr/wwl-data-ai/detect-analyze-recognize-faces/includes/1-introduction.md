Face detection, analysis, and recognition is a common computer vision challenge for AI systems. The ability to detect when a person is present, identify a person's facial location, or recognize an individual based on their facial features is a key way in which AI systems can exhibit human-like behavior and build empathy with users.

In this module, you will learn how to detect, analyze, and recognize faces using Azure Cognitive Services.
