...
> [!NOTE]
> To learn more about the translation options, including some not described here, see the [Translator service documentation](/azure/cognitive-services/translator/reference/v3-0-translate).
