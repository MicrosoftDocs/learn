...
:::image type="content" source="../media/translator-resource.png" alt-text="Diagram showing an Azure Translator resource performing language detection, one-to-many translation, and transliteration.":::
