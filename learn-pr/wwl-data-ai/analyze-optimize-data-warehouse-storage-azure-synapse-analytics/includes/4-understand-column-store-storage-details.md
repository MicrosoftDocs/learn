...
For additional content on optimizing row group and clustered columnstore indexes review the content [Investigating Row Group Health](../../M04-optimize-data-warehouse-query-performance-azure-synapse-analytics/Includes/5-use-indexes-to-improve.md)
