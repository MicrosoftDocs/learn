...
- Avoid using NVARCHAR when you only need VARCHAR. Variable-width data types have two extra bytes of overhead.
...
- If you only need to store a date and not the time make sure you use SMALLDATETIME instead of DATETIME. There is a 4 bytes difference between the two.
