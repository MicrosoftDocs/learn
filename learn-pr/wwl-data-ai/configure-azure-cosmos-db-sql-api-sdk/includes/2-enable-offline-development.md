...
The emulator is available as a download from Microsoft Learn and supports various APIs depending on the platform. The SQL API is universally supported across all platforms.
