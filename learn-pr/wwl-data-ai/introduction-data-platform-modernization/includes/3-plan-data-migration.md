...
|**3.** |**Refactor**|Migration to IaaS or PaaS with minimal application changes|This approach removes the need for datacenter management and gives a higher **Return on Investment** (ROI) through a lower **Total Cost of Ownership**(TCO). It can also enable a lower management overhead through consolidation of databases.|
