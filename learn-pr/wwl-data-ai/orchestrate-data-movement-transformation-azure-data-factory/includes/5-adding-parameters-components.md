...
If you can not use the built-in parameterization since you're using a different type of connector, you are able to edit the JSON through the UI:
...
The reason why it's recommended is of the native integration with CI/CD where global parameters are added as an ARM Template parameter due to changes in several environment that are worked in. 
