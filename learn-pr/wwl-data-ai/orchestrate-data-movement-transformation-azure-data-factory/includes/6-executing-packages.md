...
* Running packages taht are or to be deployed into file system, Azure Files, or SQL Server database (MSDB) hosted by your Azure SQL Managed Instance in Package Deployment Model
...
Most of the familiar tools such as SQL Server Data Tools (SDDT), SQl Server Management Studio (SSMS), Azure Data Studio, and command line utilities are Azure- enabled, and therefor ready to be used. 
