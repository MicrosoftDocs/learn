...
This enables you to deploy and schedule the activities efficiently, through the use of a single pipeline, versus managing each activity independently. 
...
What we mean with that, is that the activity dependency defines how subsequent activities depend on previous activities. 
