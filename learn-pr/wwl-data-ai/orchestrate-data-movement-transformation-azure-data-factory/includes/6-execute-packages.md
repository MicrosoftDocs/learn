Azure Data Factory enables you to execute packages for SSIS. With Azure Data Factory, you can provision an Azure-SQL Server Integration Services (SSIS) integration runtime (IR).
...
After the Azure-SSIS IR is provisioned, the same familiar tools for deployment and running the packages in Azure can be used. Most of the familiar tools such as SQL Server Data Tools (SDDT), SQL Server Management Studio (SSMS), Azure Data Studio, and command-line utilities are Azure-enabled, and therefore ready to be used.
