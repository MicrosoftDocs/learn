...
After the project meeting, the project manager asked you to focus on how your team will actually migrate the company's SQL Servers. You'd know that you have a range of databases with different lengths downtime they can have. So you'll need to make use of the different options available.
