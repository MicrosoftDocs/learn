...
To learn more about log shipping, see [Log Shipping Tables and Stored Procedures](https://learn.microsoft.com/sql/database-engine/log-shipping/log-shipping-tables-and-stored-procedures)
