SQL Server on Azure virtual machines (VMs) lets you run full versions of SQL Server without having to manage and maintain on-premises hardware. Azure hosts a large gallery of VM images allowing you to quickly deploy a VM with the exact version, edition, and operating system you need. This Infrastructure as a Service approach has real benefits, as well as considerations that you need to take into account when taking this migration approach.

You work as a data engineer for Adventureworks. Your company has a number of servers running different versions of SQL Server. Your SQL Server versions range from 2008 to 2014. The DBA team has been asked to upgrade the older SQL Servers workloads. The project is looking for ways to reduce the operating costs of its data estate, and would like your advice on the possibility of migrating your SQL Servers to run on Azure virtual machines.
