...
Now that you've learned about Azure relational database services, consider learning more about data-related workloads on Azure by pursuing a Microsoft certification in [Azure Data Fundamentals](/credentials/certifications/azure-data-fundamentals/).