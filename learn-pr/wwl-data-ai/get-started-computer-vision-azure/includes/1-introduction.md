...
AI vision systems can be created using a range of Azure AI services. In this module we explore **Microsoft Azure Vision**, a cloud service that developers can use to create a wide range of computer vision solutions. 
