By default, access to cognitive services resources is restricted through the use of subscription keys. Management of access to these keys is a primary consideration for security.
...
![Cognitive Services credentials retrieved from Azure key Vault](../media/azure-key-vault.png)
...
> [!NOTE]
> For more information about authentication options for Cognitive Services, see the [Cognitive Services documentation](/azure/cognitive-services/authentication).
