...
:::image type="content" source="../media/complexity-of-governance.png" alt-text="Image showing the complexity of data governance." lightbox="../media/complexity-of-governance-expanded.png":::
