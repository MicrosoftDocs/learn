...
**Manage data permissions**: Use SQL GRANT and REVOKE statements to assign or remove access to data assets. For example, GRANT SELECT ON TABLE sales_data TO ROLE analyst;
