...
:::image type="icon" source="../media/fairness-icon.png":::
...
:::image type="icon" source="../media/reliability-icon.png":::
...
:::image type="icon" source="../media/privacy-icon.png":::
...
:::image type="icon" source="../media/inclusiveness-icon.png":::
...
:::image type="icon" source="../media/transparency-icon.png":::
...
:::image type="icon" source="../media/accountability-icon.png":::
...
> 
>![Photograph showing people working and talking around a table.](../media/3-reflection.jpg)
