...
:::image type="content" source="../media/rest-api.png" alt-text="Diagram of an app submitting a JSON request to an Azure AI services REST API and receiving a JSON response.":::
