...
:::image type="content" source="../media/model-scoring-new-small.png" alt-text="Screenshot of the View model scoring tab." lightbox="../media/model-scoring-new.png":::
...
:::image type="content" source="../media/model-confusion-matrix-new-small.png" alt-text="Screenshot of a sample confusion matrix." lightbox="../media/model-confusion-matrix-new.png":::
