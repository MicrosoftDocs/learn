...
:::image type="content" source="../media/extraction-development-lifecycle-small.png" alt-text="Conceptual diagram showing a project steps to define entities, tag data, train model, view model, improve model, deploy model, and extract entities." lightbox="../media/extraction-development-lifecycle.png":::
