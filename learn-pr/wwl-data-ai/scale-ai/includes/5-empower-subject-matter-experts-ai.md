...
> ![Graph depicting AI for researchers and subject matter experts: it empowers experts, enables collaboration, and drives enterprise-wide transformation.](../media/5-empower-subject-matter-experts-ai-1.png)
:::column-end:::
:::row-end:::

Let's see some examples.

* **Pharmaceutical industry:** Some pharmaceutical companies are using AI to test molecules as a first step in their drug development process. This procedure enables to accelerate drug discovery.

* **Food industry:** Food processing industries are leveraging AI to generate new recipes based on existing recipes, sales data, and customer preferences. These initiatives allow experts to launch new products faster than with traditional research.
