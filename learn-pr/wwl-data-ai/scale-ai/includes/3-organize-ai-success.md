...
:::image type="content" source="../media/03-organizational-setup.png" alt-text="Screenshot of the end-to-end organizational setup.":::
...
:::image type="content" source="../media/03-establish-ai-related-roles.png" alt-text="Diagram that shows that AI requires multidisciplinary skills: domain understanding, IT skills, and AI skills.":::

:::column-end:::
:::row-end:::

AI requires multidisciplinary skills: domain expertise, IT capabilities, and AI knowledge.
Senior executive leadership ultimately owns the AI strategy and investment decisions. They set the tone for an AI-ready culture, drive change management, and establish responsible AI policies. The following table is an example of an AI Governance structure:
...
![Photograph of a person who is a business leader standing in front of a building.](../media/03-chief-executive-officer.jpg)
...
![Photograph of a person who is a human resources leader.](../media/03-human-resources-leader.jpg)
...
![Photograph of a person who is an IT leader.](../media/03-information-technology-leader.jpg)
