...
![An image showing the workloads listed above.](../media/workloads.png)
...
Types of ML:
- *Supervised and Learning*: Learns from labeled data (such as: regression for predicting prices, classification for spam detection).
- *Unsupervised Learning*: Finds patterns in unlabeled data (such as: clustering for customer segmentation).
