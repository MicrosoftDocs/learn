...
You can view command line instructions [here](https://learn.microsoft.com/azure/cognitive-services/openai/how-to/create-resource?pivots=cli/?portal=true). When you create a resource, you will need to provide your subscription, resource group, region, instance name, and pricing tier.  
