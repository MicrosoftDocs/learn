You can create highly scalable AI-powered apps by incorporating Azure OpenAI into your PostgreSQL database. This integration allows you to use the familiar SQL language and the flexibility of PostgreSQL to build intelligent solutions within your database layer. Whether it's natural language processing, recommendation systems, or content generation, Azure OpenAI empowers your applications.

The `azure_openai` schema installed by the Azure AI extension allows you to connect to and interact with an Azure OpenAI Service instance. This schema enables seamless integration with the Azure OpenAI service, allowing you to create powerful generative AI applications directly from your PostgreSQL database.
...
- `azure_openai.create_embeddings(text,text,integer,boolean)`
- `azure_openai.create_embeddings(text,text[],integer,boolean,integer)`
