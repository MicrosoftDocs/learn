In the 1950's, machine learning developed as a subset of AI. Machine learning algorithms take in data and fit models to the data. Deep learning is a subset of machine learning and uses layers of algorithms to output results. In the beginning of the 2000's, data scientists began to use layers of algorithms to solve for language learning problems. These approaches are categorized as **Natural language processing** (NLP) methods, which enable machines to process and understand the context of language.
