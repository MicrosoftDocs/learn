...
The image below highlights the different ways in which you could run a DBMS such as SQL Server, starting with an on-premises system in the bottom-left-hand corner, to PaaS in the top right. The diagram illustrates the benefits of moving to the PaaS approach.
