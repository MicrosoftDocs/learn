...
>[!VIDEO https://learn-video.azurefd.net/vod/player?id=eb6af217-d7a8-404b-aec1-e403ec929a00]
...
| OrderNo | CustomerName | CustomerAddress      | ProductName | UnitPrice | Qty |
|---------|--------------|----------------------|-------------|-----------|-----|
