Monitoring your vCore-based Azure Cosmos DB for MongoDB helps maintain its health and performance. Using Azure Monitor, combined with either an Azure Log Analytics workspace or an Azure Storage account, allows you to capture and store diagnostic logs that provide clarity on your database operations.
...
With either a Log Analytics workspace or an Azure Storage account set up, you can configure diagnostic settings to channel logs to these services, enabling you to:
...
These queries provide actionable insights, helping you to optimize operations and troubleshoot issues effectively. For more information on the Kusto Query Language, refer to the [Kusto Query Language documentation](azure/data-explorer/kusto/query/).
