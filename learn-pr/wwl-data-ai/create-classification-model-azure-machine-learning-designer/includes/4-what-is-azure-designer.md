In Azure Machine Learning studio, there are several ways to author classificaiton machine learning models. One way is to use a visual interface called *designer*, that you can use to train, test, and deploy machine learning models using a drag-and-drop interface. The drag-and-drop interface makes use of clearly defined inputs and outputs that can be shared, reused, and version controlled.  
