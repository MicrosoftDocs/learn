...
- **Actions on approval**: Specific steps that will execute ("Issue return label, credit 249.99 USD to original payment method within 3-5 days")
...
For lower-stakes approvals, the timeout might default to auto-approval rather than rejection. A loyalty points adjustment under 25 US dollars might auto-approve after 2 hours if the manager hasn't responded—the business risk is minimal, and auto-approval serves the customer better than indefinite waiting.
