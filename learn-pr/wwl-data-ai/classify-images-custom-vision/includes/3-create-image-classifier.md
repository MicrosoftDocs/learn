...
After you have set up the Python environment and cloned the **ai-fundamentals** repository, you're ready to explore image analysis with Custom Vision.

1. Open the **Image Classification.ipynb** notebook in the **ai-fundamentals** folder. If you're using the notebook editor in Azure Machine Learning studio, use the **&#8810;** button to collapse the file explorer pane and give you more room to focus on the notebook tab.
