...
:::image type="content" source="../media/partitionby.png" alt-text="An image of a diagram showing how PARTITION BY further sub-divides the rows defined in the OVER clause.":::
