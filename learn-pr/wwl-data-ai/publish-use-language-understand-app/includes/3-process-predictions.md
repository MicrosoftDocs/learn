...
- **kind** - indicates which language feature you're requesting. For example, this is `Conversation` for conversational language understanding, or `EntityRecognition` to detect entities
