...
Without semantic search, queries such as "sunny" don't match products called "bright natural light" even though it's an intended match. While this issue could be solved by adding extra product keywords, this process creates an issue when creating new property listings. If the keywords aren't added, the product could be undiscoverable without an exact keyword match.
