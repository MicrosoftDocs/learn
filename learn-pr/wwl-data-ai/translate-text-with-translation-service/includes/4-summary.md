...
You can find out more about the using these services for translation in the [Translator text service documentation](https://docs.microsoft.com/azure/cognitive-services/translator/) and the [Speech service documentation](https://docs.microsoft.com/azure/cognitive-services/speech-service/).
