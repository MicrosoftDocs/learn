...
>[!VIDEO https://learn-video.azurefd.net/vod/player?id=d04541d8-d397-4f40-b7bd-432f738d4b5d]
...
- **Invoke**: 
Invokes an AI agent from your project or creates a new one. Agent nodes can return free-text responses or structured outputs (like JSON) that other nodes can use. They're used for classification, reasoning, recommendations, or any AI-driven task.
