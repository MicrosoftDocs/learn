...
![Add SQL Server to DataSet Type ](../media/ADSAddDatasetSQLServer.png)
...
![Running script ](../media/ADSScriptSQLAuthentication.png)
...
![Select Tables](../media/ADSSelectTables.png)

Select both tables:

![Select Both Tables](../media/ADSSelectBothTables.png)

Select next:

![Overview Datasets ](../media/ADSDatasetOverviewSQL.png)

Select continue which will land you in the following page:

![Add Recipient to Dataset Share](../media/ADSAddRecipientToSQLShare.png)
...
![Set up Snapshot Schedule](../media/ADSSnapshotSchedule.png)
...
![Review and Create ](../media/ADSReviewAndCreateSQLShare.png)
...
![Overview Data Share Invitation ](../media/ADSTaxiDataOverviewInvitation.png)
...
![Received Datasets](../media/ADSReceivedDatasets.png)
...
![Select Datasets to Map to Target](../media/ADSSelectDatasetMapToTarget.png)

Once you select map to target you’ll be redirected to the following screen:


![ Map to Target](../media/ADSMapDatasetTarget.png)
...
![Snapshot Schedule ](../media/ADSSnapshotScheduleSQL.png)
...
![Full Copy Trigger Snapshot ](../media/ADSTriggerSnapshotFullCopy.png)

Select History tab, and click Refresh to monitor snapshot status.

![Snapshot Status ](../media/ADSSnapshotStatusHistory.png)
...
![Start Time Drill Down ](../media/ADSStartTimeSnapshotHistory.png)
...
![Path of ADLS Gen2 ](../media/ADSPathADLSGen2.png)
...
![Storage Explorer ](../media/ADSStorageExplorer.png)
