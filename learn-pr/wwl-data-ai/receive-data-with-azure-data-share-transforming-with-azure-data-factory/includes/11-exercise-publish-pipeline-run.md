...
![Debug Run of Dataflow ](../media/ADFDebugRunClusterStart.png)
...
![Finished Debug Run of Dataflow ](../media/ADFFinishedDebugRun.png)

When you select the eyeglass you will be redirected to the following screen:

![Specification of Debug Run of Dataflow ](../media/ADFSpecsDebugRunMappingDataflow.png)
...
![Specification of Transformation in Debug run ](../media/ADFTransformationSpecificationMappingDataflow.png)
...
![Add a trigger to the pipeline ](../media/ADFAddTriggerPipelineRunDataflow.png)
...
![Manual Trigger Parameters ](../media/ADFManualTriggerParameters.png)
...
![Activity Runs view ](../media/ADFActivityPipelineRunMonitoring.png)
