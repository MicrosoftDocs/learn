Now it's your chance to configure and deploy CI/CD pipelines for Azure SQL Database projects.
...
[![Button to launch exercise.](../media/launch-exercise.png)](https://microsoftlearning.github.io/mslearn-sql-dev/Instructions/Labs/02-deploy-pipelines-sql-database.html?azure-portal=true)
