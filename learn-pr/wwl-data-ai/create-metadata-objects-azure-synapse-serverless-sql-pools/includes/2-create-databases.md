...
To create a new database as a Azure Synapse serverless SQL pool, go to the **Data** hub, click **+** button and select **Synapse SQL database**.  
  
![Create a Synapse SQL Database in Azure Synapse Studio](../media/create-synapse-sql-database.png)

This will show you a possibility to choose pool type between two options: 
