...
The Azure Translator service is a cloud-based service that uses neural machine translation technology to enable quick and accurate source-to-target text translation in real-time across [all supported languages](/azure/ai-services/translator/language-support).
...
This module shows how to use the Azure Translator service with Azure Database for PostgreSQL - Flexible Server. In this module, you will:
...
- Provision an Azure Translator service.
