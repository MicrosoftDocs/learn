...
> [!NOTE]
> The next hands-on exercise will only step through **a prebuilt receipt model**. If you would like to train a **custom model** you can refer to the [Azure AI Document Intelligence documentation](/azure/ai-services/document-intelligence/?view=doc-intel-3.1.0?azure-portal=true) for quickstarts. 
