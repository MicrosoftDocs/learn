...
Here, you'll explore how to use the Debug Session tool inside Azure Cognitive Search, look at debugging and then fixing a specific skill, and finally look at an approach to locally debugging your own custom skills.
## Explore how to use the Debug Session tool in Azure Cognitive Search

The Debug Session tool is an interactive visual editor that lets you step through the enrichment pipeline of a document as it's enriched. You can step into each individual skill, make changes and fixes, and then rerun the indexer in real-time. Once you've fixed any issues you can update and re-publish the indexer so that it can be re-run to enrich all the documents in your index. 
...
:::image type="content" source="../media/debug-sessions-cognitive-search.png" alt-text="A screenshot of the Debug Session tool in Azure Cognitive Search." lightbox="../media/debug-sessions-cognitive-search.png":::
...
To create a Debug Session, navigate to your search service in the Azure portal and follow these steps.

### Create a Debug Session

1. In the **Overview** page of your search service, select the **Debug Sessions** tab.

    :::image type="content" source="../media/new-debug-session.png" alt-text="A screenshot of the Azure portal showing how to create a new Debug Session." lightbox="../media/new-debug-session.png":::
...
1. In **Storage connection**, find a general-purpose storage account for caching the debug session. 
...
1. In **Document to debug**, choose the first document in the index or select a specific document.
    ...
    :::image type="content" source="../media/debug-session-new.png" alt-text="A screenshot of the new debug session pane.":::
...
1. In the dependency graph, select a **skill**.
    ...
    :::image type="content" source="../media/enriched-doc-output-expression.png" alt-text="A screen shot of the Expression evaluator." lightbox="../media/enriched-doc-output-expression.png":::
...
1. To edit the skill, select the **Skill Settings** tab.
    ...
    :::image type="content" source="../media/edit-skill-debug-session.png" alt-text="A screenshot showing editing a skill in the Debug Session." lightbox="../media/edit-skill-debug-session.png":::
...
1. Select **Skill Graph**, and check that **Dependency graph** is selected.
    ...
    :::image type="content" source="../media/field-mappings.png" alt-text="A screenshot showing the field mappings pane." lightbox="../media/field-mappings.png":::
