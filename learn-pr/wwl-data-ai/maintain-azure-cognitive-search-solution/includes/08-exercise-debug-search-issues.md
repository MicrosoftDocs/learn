...
1. On the **Overview** pane, select **Import data**.
      ...
      :::image type="content" source="../media/import-data-small.png" alt-text="A screenshot showing the import data menu selected." lightbox="../media/import-data.png":::

1. On the import data pane, for the Data Source, select **Samples**.

      :::image type="content" source="../media/import-data-selection-screen-small.png" alt-text="A screenshot showing the completed fields." lightbox="../media/import-data-selection-screen.png":::
...
1. Expand the **Add enrichments** section.
    ...
    :::image type="content" source="../media/add-enrichments-small.png" alt-text="A screenshot of the add enrichments options." lightbox="../media/add-enrichments.png":::
...
:::image type="content" source="../media/indexer-warnings-small.png" lightbox="../media/indexer-warnings.png" alt-text="A screenshot showing 150 warnings on the indexer.":::
...
1. Select **+ Container** to add a new container. Name it **acs-debug-storage**.
    ...
    :::image type="content" source="../media/create-storage-container-small.png" alt-text="A screenshot showing creating a storage container." lightbox="../media/create-storage-container.png":::
...
1. Select **Save Session**.
    ...
    :::image type="content" source="../media/warning-skill-selection-small.png" lightbox="../media/warning-skill-selection.png" alt-text="A screenshot showing the three errors on an enriched document.":::
...
1. In the dependency graph, select **Language detection**.
    ...
    :::image type="content" source="../media/language-detection-error-small.png" lightbox="../media/language-detection-error.png" alt-text="A screenshot showing the Skill Settings for the Language Detection skill.":::
...
1. Select **source** under inputs, and change the field to `/document/Description`.
    :::image type="content" source="../media/language-detection-fix.png" light="../media/language-detection-fix.png" alt-text="A screenshot of the Language Detection SKill screen showing the fixed skill.":::
1. Select **Save**.
1. Select **Run**.

    :::image type="content" source="../media/rerun-debug-session-small.png" light="../media/rerun-debug-session.png" alt-text="A screenshot showing the need to run after updating a skill.":::
...
1. Now you need to make sure that your skillset is attached to an Azure AI Services resource, otherwise you'll hit the basic quote and the indexer will timeout. To do this, select **Skillsets** in the left pane, then select your **hotels-sample-skillset**.
    ...
    :::image type="content" source="../media/update-skillset-small.png" lightbox="../media/update-skillset.png" alt-text="A screenshot showing the skillset list.":::

1. Select the **AI Services** tab, then select the AI services resource in the list.

    :::image type="content" source="../media/skillset-attach-service.png" alt-text="A screenshot showing the Azure AI Services resource to attach to the skillset.":::
...
1. Now run your indexer to update the documents with the fixed AI enrichments. To do this select **Indexers** in the left pane, select  **hotels-sample-indexer**, then select **Run**.  When it has finished running, you should see that the warnings are now zero.
    ...
    :::image type="content" source="../media/warnings-fixed-indexer-small.png" lightbox="../media/warnings-fixed-indexer.png alt-text="A screenshot showing everything resolved.":::
