Organizations need to be able to trust the security of their search solutions. Azure Cognitive Search (ACS) gives you control over how to secure the data you search.
...
ACS security builds on Azure's existing network security features. When you think about securing your search solution, you can focus on three areas:
...
> [!TIP]
> For detailed steps on how to use customer-managed keys for encryption, see [Configure customer-managed keys for data encryption in Azure Cognitive Search](/azure/search/search-security-manage-encryption-keys)
...
> [!TIP]
> For more information about authenticating with RBAC, see [Use Azure role-based access controls (Azure RBAC) in Azure Cognitive Search](/azure/search/search-security-rbac).
