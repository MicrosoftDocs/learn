...
:::image type="content" source="../media/azure-monitor-cognitive-search-small.png" alt-text="A screenshot of the monitor tab in Azure Cognitive Search." lightbox="../media/azure-monitor-cognitive-search.png":::

You can also check what resources your search solution is using on the **Usage** tab.

:::image type="content" source="../media/usage-tab-cognitive-services-small.png" alt-text="A screenshot of the usage tab on the overview page of Azure Cognitive Search service." lightbox="../media/usage-tab-cognitive-services.png":::
