...
![Screenshot of a Microsoft Fabric logo.](../media/fabric-icon.png)**[Microsoft Fabric](https://www.microsoft.com/microsoft-fabric)** is a unified, end-to-end SaaS analytics platform built on **OneLake**. It offers two primary analytical store experiences:
