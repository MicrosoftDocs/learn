...
1. In the **Import Notebooks** dialog box, select the URL and paste in the following URL:
     ...
     `https://github.com/solliancenet/microsoft-learning-paths-databricks-notebooks/blob/master/data-science/05-User-Defined-Function.dbc?raw=true`

1. Select **Import**.
1. Select the **05-User-Defined-Function** folder that appears.
