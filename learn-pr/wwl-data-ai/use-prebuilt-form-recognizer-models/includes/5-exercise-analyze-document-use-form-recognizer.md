In this exercise, you'll set up a Forms Recognizer resource in your Azure subscription. You'll use both the Forms Recognizer Studio and C# code to submit forms to that resource for analysis.

## Create a Forms Recognizer resource
...
1. In the **Name** textbox, type **FormsRecognizerResources** and then select **OK**.
...
Let's start by using the **Forms Recognizer Studio** and the read model to analyze a document with multiple languages. You'll connect Forms Recognizer Studio to the resource you just created to perform the analysis:
