...
1. 1. Select the radio button for **Create from scratch**.
1. Select **Next**.
...
1. 1. Under **Filter Dialog**, select **Greeting**.
...
:::image type="content" source="../media/ask-question.png" alt-text="Ask a question node with properties pane":::
