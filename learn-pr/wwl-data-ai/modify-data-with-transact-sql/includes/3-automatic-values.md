You may need to automatically generate sequential values for one column in a specific table. Transact-SQL provides two ways to do this. You can use the IDENTITY property with a specific column in a table. Or, you can define a SEQUENCE object and use values generated by that object.
