...
Azure offers preview features that are designed for nonproduction usage. It's important to note that previews are subjected to reduced or different service terms. Depending on the region your resources are hosted, preview features may not be available and may have limited service level agreements (SLA), and functionality. 
...
Private preview features require that Microsoft add your subscription to an allow list for a given feature.  
...
You can check the latest public preview features on the [Azure updates page](https://azure.microsoft.com/updates/) by filtering the **Status** to *In preview*.
