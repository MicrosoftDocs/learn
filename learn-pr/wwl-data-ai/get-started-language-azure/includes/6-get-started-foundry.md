...
![Screenshot of Azure AI Language page in Microsoft Foundry portal.](../media/ai-foundry-language-1.png)

Microsoft Foundry provides a unified platform for enterprise AI operations, model builders, and application development. Microsoft Foundry portal provides a user interface based around **hubs** and **projects**. To use any of the Azure AI services, including Azure AI Language or Azure AI Translator, you create a project in Microsoft Foundry, which will also create an Azure AI services resource for you. 
...
![Screenshot of Azure AI Language playground in Microsoft Foundry portal with an example of sentiment analaysis.](../media/ai-foundry-language-sentiment.png)

![Screenshot of Azure AI Translator playground in Microsoft Foundry portal with an example of text translation.](../media/ai-foundry-translator-playground.png)
