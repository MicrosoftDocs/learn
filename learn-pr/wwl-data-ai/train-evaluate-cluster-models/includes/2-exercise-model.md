...
After you've created a Jupyter environment and cloned the **ml-basics** repository, you're ready to explore clustering.

 1. In Jupyter, open the **Clustering.ipynb** notebook in the **ml-basics** folder and follow the instructions it contains.
