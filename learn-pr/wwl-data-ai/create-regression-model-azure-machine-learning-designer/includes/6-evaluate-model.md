...
6. When the experiment run has completed, select **Job details**. This will take you to another window. Find and double click on the **Evaluate Model** module. 
    ![Screenshot of location of evaluate model module.](../media/evaluate-model-help-1.png)

7. In the settings pane, on the **Outputs + logs** tab, select **Show data outputs**. Then select the **Preview Data** graph icon to view the results. 
    ![Screenshot of location of performance metrics.](../media/evaluate-model-help.png)
8. Review the regression performance metrics. These include the following metrics:
...
8. Close the **Evaluate Model result visualization** window.
