...
3. On the **Compute** page, on the **Compute clusters** tab, open the **aml-cluster** compute target and select **Edit**. Then set the **Minimum number of nodes** setting to **0** and select **Update**.
