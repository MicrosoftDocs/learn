...
![Image highlighting the **Allow access to Azure services** action setting in the firewall configuration for Azure Database for MySQL/PostgreSQL](../media/5-configure-firewall.png)
...
![Image showing the virtual network rules for Azure Database for MySQL/PostgreSQL](../media/5-vnet-rules.png)
...
![Image highlighting the **Enforce SSL connection** setting on the **Connection security** page for Azure Database for MySQL/PostgreSQL](../media/5-ssl-settings.png)
...
![Image showing the **Advanced Threat Protection** page for Azure Database for MySQL/PostgreSQL](../media/5-configure-apt.png)
...
![Image showing the backup configuration section of the pricing tiers page for Azure Database for MySQL/PostgreSQL](../media/5-backup-options.png)
...
![Image showing the point-in-time restore page for Azure Database for MySQL/PostgreSQL](../media/5-point-in-time-restore.png)
...
![Image showing the server details section when creating an Azure Database for MySQL/PostgreSQL server](../media/5-geo-restore.png)
