...
> [!Note]
> Today, once youe enable Synapse Link on an Azure Cosmos DB account, it cannot be disabled. Enabling Synapse Link on an account has no billing implications until containers are created with the analytical store enabled.
