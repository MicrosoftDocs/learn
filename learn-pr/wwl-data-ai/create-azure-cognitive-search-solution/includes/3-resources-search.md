...
1. In the Codespace you created previously, right-click (Ctrl+click if using a Mac) the **01-Create-a-search-solution** folder and select **Open in Integrated Terminal**. This will open a new bash terminal pane.
