...
- **Storage Optimized (L)**: Use a storage optimized tier (**L1** or **L2**) when you need to create extremely large indexes, at the cost of higher query latency.
...
Depending on the pricing tier you select, you can optimize your solution for scalability and availabilty by creating *replicas* and *partitions*.
...
3. When prompted, follow the link, enter the provided code, and sign into your Azure subscription.
4. When the script completes, note the following information about your Azure resources (you will need this later):
    - Resource group name
...
5. In a new browser tab, open the Azure portal at [https://portal.azure.com](https://portal.azure.com?azure-portal=true), signing in with the credentials associated with your Azure subscription if prompted.
6. In the Azure portal, find the resource group that was created by the setup script, and verify that it contains the Azure Storage account and Azure Cognitive Search resource.
