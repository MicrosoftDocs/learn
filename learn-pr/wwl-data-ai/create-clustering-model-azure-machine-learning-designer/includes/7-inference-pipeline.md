...
> [!div class="centered"]
> ![Replace Score Model with Assign Data to Clusters](../media/assign-clusters.png)
...
8. Submit the pipeline as a new experiment named **predict-iris-cluster** on the **aml-cluster** compute cluster. This may take a while!
