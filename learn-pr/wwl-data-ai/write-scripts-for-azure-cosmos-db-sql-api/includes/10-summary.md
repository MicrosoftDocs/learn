In this module, you learned how to use the **az cosmosdb** command group and many of the NoSQL API relevant subgroups to create and manage resources within an Azure Cosmos DB account.
