...
The following Python code sample uses the **get_azure_openai_client()** method to get an OpenAI client with which to chat with a model that has been deployed in the project'a Azure AI Foundry resource.
...
try:
    ...
    # Get a chat client
    chat_client = project_client.get_azure_openai_client(api_version="2024-10-21")
