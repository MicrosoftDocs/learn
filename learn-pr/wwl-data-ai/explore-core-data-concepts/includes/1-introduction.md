Over the last few decades, the amount of data generated by systems, applications, and devices have increased significantly. Data is everywhere, in a multitude of structures and formats.
...
The capability to capture, store, and analyze data is a core requirement for every organization in the world. In this module, you learn about options for representing and storing data, and about typical data workloads. By completing this module, you build the foundation for learning about the techniques and services used to work with data.
