...
:::image type="content" source="../media/metric.png" alt-text="A screenshot showing metrics for an AI services resource.":::
...
:::image type="content" source="../media/metric-dashboard.png" alt-text="A screenshot showing metrics in a dashboard.":::
