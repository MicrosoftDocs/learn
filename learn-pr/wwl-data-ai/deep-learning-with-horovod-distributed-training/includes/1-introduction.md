...
1. Learn how you can use Azure Databricks and Horovod to run long-running, distributed deep learning training jobs on Spark
1. Use Petastorm to enable training and evaluation of deep learning models from datasets in Apache Parquet format
