...
It enables you to use both technologies within 1 platform, which allowed you to switch between Spark or SQL based on the needs and expertises you have in-house. 
...
* A shared Hive-compatible metadata system enables you to define tables on files in the data lake such that i can be consumed by either Spark or Hive.
...
C:\contentdev\learn-pr\LP_AI_perform-data-engineering-azure-synapse-apache\Modules\M04-integrate-sql-apache-spark-pools-azure-synapse-analytics\media\design-sql-spark-integration.png
...
Spark reads the data in parallel all based on the user provisioned workspace default data lake storeage. 
...
https://docs.microsoft.com/azure/synapse-analytics/spark/synapse-spark-sql-pool-import-export