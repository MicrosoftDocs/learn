...
> **More Information**: For more information about using the Azure Machine Learning extension for Visual Studio Code, see the [documentation](/azure/machine-learning/how-to-manage-resources-vscode).
