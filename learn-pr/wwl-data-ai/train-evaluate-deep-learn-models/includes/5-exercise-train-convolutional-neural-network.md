...
In this exercise, you'll use your preferred framework to create a simple CNN-based image classifier for images of simple geometric shapes. The same principles can be applied to images of any kind. To complete the exercise, you'll need:
...
After you've created the environment, open the **Convolutional Neural Networks (PyTorch).ipynb** or **Convolutional Neural Networks (Tensorflow).ipynb** notebook, depending on your framework preference, and follow the instructions it contains.
