...
1. In the **Import Notebooks** dialog box, select the URL and paste in the following URL:
    ...
    ```
    https://github.com/MicrosoftLearning/microsoft-learning-paths-databricks-notebooks/blob/master/data-engineering/DBC/12-Production-Workloads-with-Azure-Data-Factory.dbc?raw=true
    ```
