Imagine you're a machine learning engineer, working together with a data science team. The workflow created by the data science team preprocesses data and trains a classification model. You want to automatically execute the workflow. By doing so, you'll enable automated training (and retraining) of the classification model in different environments, driven by different events. 
