...
1. In the **Import Notebooks** dialog box, select the URL and paste in the following URL:
     ...
     `https://github.com/solliancenet/microsoft-learning-paths-databricks-notebooks/blob/master/data-science/10-Hyperparameter-Tuning.dbc?raw=true`

1. Select **Import**.
1. Select the **10-Hyperparameter-Tuning** folder that appears.
