...
- **Cooling Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a cooling tower structure, highlighting the essential cooling mechanisms for datacenter operations.](../media/cooling-tower-structure.png)](../media/cooling-tower-structure.png#lightbox)
...
- **Networking and Communication Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's network infrastructure, showcasing organized cabling and redundant network paths for reliable data transfer and security.](../media/datacenter-network-infrastructure.jpg)](../media/datacenter-network-infrastructure.jpg#lightbox)
  ...
  - **Network Security Devices**: Firewalls, intrusion detection/prevention systems (IDS/IPS), and security appliances that protect the data and infrastructure from external threats.  
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's network infrastructure, highlighting organized server racks and extensive cabling for efficient data transfer and security.](../media/datacenter-network-cabling.jpg)](../media/datacenter-network-cabling.jpg#lightbox)

- **Security Systems**

    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter entrance featuring a revolving door with access control, emphasizing the importance of physical security measures.](../media/datacenter-entrance-security.png)](../media/datacenter-entrance-security.png#lightbox)
...
- **Data Storage and Backup Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's storage infrastructure, highlighting data storage arrays and backup solutions essential for data redundancy and high availability.](../media/datacenter-storage-infrastructure.png)](../media/datacenter-storage-infrastructure.png#lightbox)
...
- **Fire Suppression and Environmental Monitoring**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's fire suppression system, showcasing the sprinkler mechanism essential for protecting the facility from fire damage.](../media/datacenter-fire-suppression-system.jpg)](../media/datacenter-fire-suppression-system.jpg#lightbox)
...
- **Facility and Building Infrastructure**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's structural framework, highlighting the raised flooring and ceiling systems essential for cable management and cooling efficiency.](../media/datacenter-structural-framework.png)](../media/datacenter-structural-framework.png#lightbox)
...
- **Redundancy and Resilience Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter's critical infrastructure, showcasing redundant network cabling essential for ensuring high availability and reliability.](../media/datacenter-redundant-infrastructure.png)](../media/datacenter-redundant-infrastructure.png#lightbox)
...
- **Monitoring and Management Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter team discussing infrastructure management, emphasizing the importance of BMS and DCIM systems for monitoring and controlling facility operations.](../media/datacenter-management-systems.png)](../media/datacenter-management-systems.png#lightbox)
...
- **Disaster Recovery Systems**
    ...
    >[!div class="mx-imgBorder"]
    >[![Screenshot of a datacenter worker managing equipment, highlighting the importance of disaster recovery solutions and contingency planning for ensuring business continuity.](../media/datacenter-disaster-recovery-contingency-planning.png)](../media/datacenter-disaster-recovery-contingency-planning.png#lightbox)
