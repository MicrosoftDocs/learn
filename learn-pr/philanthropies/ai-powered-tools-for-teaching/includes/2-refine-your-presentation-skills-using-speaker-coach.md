...
In this activity, you will practice using Speaker Coach, an AI-powered tool in Microsoft PowerPoint, to refine your presentation skills.

**Time**: 30 minutes

**Task**:

1. Create a PowerPoint presentation (limited to eight slides) with a primary focus on AI tools. Illustrate how AI tools are shaping modern learning and training, identify tools suitable for instructional purposes, and highlight their advantages. Below are suggested titles for your PowerPoint presentation:
...
1. Once you have finished creating the presentation deck, try practicing your presentation skills by using the Speaker Coach feature located on the Slide Show tab. Select “Rehearse with Coach” from the Rehearse group.
   :::image type="content" source="../media/rehearse-with-coach.png" alt-text="A screenshot of PowerPoint SlideShow menu highlighting 'Rehearse with Coach' option":::
...
1. Click on “Start Rehearsing” and begin speaking. The microphone icon will become active on the screen when you are speaking.
   :::image type="content" source="../media/microphone-icon.png" alt-text="A screenshot of 'Rehearse with Coach' PowerPoint feature highlighting 'Start Rehearsing' option":::

1. Once the rehearsal is finished, double-click the screen to stop the recording. A preview of your rehearsal report will immediately appear on the screen.
   :::image type="content" source="../media/rehearsal-report.png" alt-text="A screenshot of PowerPoint 'Your Rehearsal Report (Preview)' feature":::
