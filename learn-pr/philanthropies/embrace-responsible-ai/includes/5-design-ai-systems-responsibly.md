In this exercise, you will utilize the knowledge you have gained about the six AI principles from the module, Apply Responsible AI Principles in Learning Environments. You will write a summary for each principle and critically analyze how these principles influence the design aspects of an AI system.
...
1. Under this new section create a table to document summary and impact for each Microsoft's AI principle. Refer to the table below as an example.
