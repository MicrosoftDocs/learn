In this exercise, you'll practice using Copilot to brainstorm volunteer recruitment program. Start by using the prompt templates, then create your own prompts to follow up.
