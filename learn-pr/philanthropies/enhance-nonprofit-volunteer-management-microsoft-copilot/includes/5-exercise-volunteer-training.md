In this exercise, you'll practice using Copilot to create a volunteer training handbook. Start by using the prompt template, then create your own prompts to reinforce what you've learned. 
