In this exercise, you'll practice using Copilot to help draft a volunteer retention program. Start by using the prompt template, then create your own prompts to reinforce what you learned.
