Microsoft Copilot, an AI tool, can significantly support you in creating learning-centered training plans. It can help you create personalized plans by generating content tailored to individual learners' needs and preferences. This customized approach can engage learners with improved materials that enhance their understanding. It can also complement existing pedagogical approaches and introduce innovative methods for training. By leveraging Microsoft Copilot, you can create comprehensive, effective, and learner-centered training plans.

## Task

This activity involves using Microsoft Copilot to design a personalized training plan. Think of a topic you would like to teach in an upcoming training session. This topic will be used to create your plans. After using Microsoft Copilot, you will write up a formal training program for your specific training topic. This task requires a computer or mobile device with internet access, and a pen and paper or word processor for reflection afterward.

To open Microsoft Copilot visit: [https://copilot.microsoft.com](https://copilot.microsoft.com)

The learning design should follow the format below. Follow each step below to create your personal training plan.
...
| Pre-assessment questions | The pre-assessment measures learners' strengths, weaknesses, prior knowledge, and experience in time management. It also provides data to guide personalization of the learning experience.<br><br>Use these prompts in Microsoft Copilot:<br>- What are good pre-assessment questions to use for a [insert topic] training program?<br>- Create pre-assessment questions for a learner-centered [insert topic] training session. Here is the learning objective: [insert the learning objective]. |
...
Use the lesson design template below to create a formal guide for your training program and plans.
...
| Pre-assessment questions *[Write a realistic and engaging scenario that sets the context and background for the learning activity.]* |
| ------------------------------------------------------------------------------------------------------------ |
| ____________________________________________________________________________________________________________ |
| ____________________________________________________________________________________________________________ |
| ____________________________________________________________________________________________________________ |
...
| Evaluation *[Write a short description of how you will evaluate the effectiveness and impact of your learning activity based on learners’ performance and satisfaction.]* |
| ------------------------------------------------------------------------------------------------------------ |
| ____________________________________________________________________________________________________________ |
| ____________________________________________________________________________________________________________ |
| ____________________________________________________________________________________________________________ |
...
- How would it have been different if you had not used Microsoft Copilot?
- How can you apply the skills and knowledge gained from this task to enhance your role as a trainer?

In this unit, you've learned how to harness the power of Microsoft Copilot to help create engaging training programs. You discovered its advanced AI capabilities and how they can be leveraged to enhance the quality of your content. As you move to the next unit, you'll be introduced to Microsoft Designer, a tool that can help you create visuals to complement your training content.
