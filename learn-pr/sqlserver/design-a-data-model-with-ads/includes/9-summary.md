...
* Worked with the data model to see how table relations and constraints are utilized.

Without these concepts, the data model would contain duplicate rows, potentially inaccurate data and query time would affect the user experience. By thinking about how data will be accessed and stored, creating a data model that scales with the business needs and grow with customer demands is possible using basic table concepts you've learned in this module.
...
* [Configure and manage SQL database security](/training/modules/sql-database-security/)
