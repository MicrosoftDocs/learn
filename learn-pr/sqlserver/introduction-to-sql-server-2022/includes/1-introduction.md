...
SQL Server 2022 is designed to help organizations looking to modernize their data estate from older versions of SQL Server. SQL Server 2022 provides new cloud connected capabilities for those looking to enable hybrid data scenarios.
...
- **Language enhancements for developers**: Finally, you'll learn new T-SQL language capabilities to help developers build new application scenarios leverage SQL Server.

## What is the main goal?

When you finish this module you'll have the knowledge to understand what are the new innovations in SQL Server 2022. You will have information to help you decide whether using this new major version can modernize your data estate, reduce total cost of ownership, accelerate performance for your application, protect your data, and connect your data to Azure and data lakes.