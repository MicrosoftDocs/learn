In this module, you've seen how to install SQL Server onto the Ubuntu, SUSE, and Red Hat Linux distributions. You've also learned how to deploy SQL Server to a Linux container. You've deployed SQL Server to one or more of these versions of Linux.
