...
Here, you'll learn how to install and configure SQL Server on RHEL.

## Hardware and software requirements

If you want to install SQL Server 2019 on RHEL, the server must meet the following requirements:

- RHEL 7.3, 7.4, 7.5, 7.6, or 8 Server: later versions are likely to be supported, but aren't fully tested at time of writing
