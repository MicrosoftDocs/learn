...
* **Data:** A data access policy allows a Microsoft Entra account to log into SQL Server and have access to read data from user tables in any database for the instance. This feature is currently in public preview.
