...
If you have an internal application, you might have the luxury of being able to migrate the database when it's not in use at the weekend, and then switch over the database connection string.
