...
If you choose SQL Server on Linux as the data platform of choice for Wide World Importers, you can deploy all of your existing SQL Server databases—which currently run on the Windows platform—onto Linux. You'll also be able to run your existing applications using the Linux version of SQL Server, and your organization can reuse their existing DBA and application-development skills.
