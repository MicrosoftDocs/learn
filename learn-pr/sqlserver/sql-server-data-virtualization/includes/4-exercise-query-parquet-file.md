...
:::image type="content" source="../media/schema-discovery.png" alt-text="Diagram of the schema results of the external Parquet data source in SQL Server Management Studio.":::
