In this module, you learned how to decide if a database needs to be upgraded, and what questions should be answered prior to making any decisions. You have also seen the available methods for database upgrades, and the tasks to take after you have migrated. You also learned how to ensure your queries run quickly in the upgraded database.

If you have a high number of SQL Server instances of varying versions and editions, and want to document the database landscape quickly and efficiently, you need a tool to automatically gather configuration data. This repetitive and time-consuming task can be completed by using the Microsoft Assessment and Planning Toolkit. 
...
For a full and in-depth look at the new features in SQL Server 2017, please see: [What's new in SQL Server 2017](https://docs.microsoft.com/sql/sql-server/what-s-new-in-sql-server-2017?view=sql-server-2017)

To compare the features between editions, please see: [Editions and supported features of SQL Server 2017](https://docs.microsoft.com/sql/sql-server/editions-and-components-of-sql-server-2017?view=sql-server-2017)
