In this module, you've seen how the Microsoft Assessment and Planning (MAP) toolkit is used to automatically scan the servers in your organization. MAP lists the number of SQL Server instances, with their versions and editions. You've also seen how MAP lists the components installed on each instance, along with the operating systems, processors, and cores.
