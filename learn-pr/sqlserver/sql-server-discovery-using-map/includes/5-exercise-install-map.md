...
> Go to https://github.com/MicrosoftDocs/mslearn-sql-server-map-discovery/blob/master/MAPSetup.exe[https://github.com/MicrosoftDocs/mslearn-sql-server-map-discovery/blob/master/MAPSetup.exe]
