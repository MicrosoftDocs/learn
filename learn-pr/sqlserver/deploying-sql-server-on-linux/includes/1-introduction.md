SQL Server has been one of the most popular and highest performing database systems for some time and Linux is a very popular server operating system but, until now, it has not been possible to run SQL Server directly on a Linux Server. With SQL Server 2017, you can now deploy SQL Server onto a Linux Server.

Suppose, you are a database administrator at the wholesale company Wide World Importers. Wide World Importers exclusively uses Linux on its servers and Linux VMs in the cloud, but you have decided that you can benefit from the functionality of SQL Server. 
