...
![Data Migration Assistant assessment](../media/5-dma-assess.png "Screenshot of the Data Migration Assistant with the New assessment dialog open.")
...
![Data Migration Assistant assessment](../media/5-dma-report-options.png "Screenshot of the Data Migration Assistant assessment tab opened to the first step requiring user to select options.")
