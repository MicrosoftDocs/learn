...
ms.custom:
  - build-2023
---
Data virtualization in SQL Server 2022 is the ability to access the data where it lives. Data virtualization integrates data at query time, without replicating or moving the original data.
...
- **Data abstraction:** Data abstraction hides the complexities of accessing data from the underlying data system, formats, and structures.
...
- **Data hub:** You can use SQL Server as a centralized hub to connect, protect, and query different data sources and files, hiding the complexity of the application. There's no need to use an extract-transform-load (ETL) tool to aggregate, copy, or move the data to a staging area.
...
After you complete this module, you:
  ...
  - Can access and query external data on SQL Server 2022 by using PolyBase.
