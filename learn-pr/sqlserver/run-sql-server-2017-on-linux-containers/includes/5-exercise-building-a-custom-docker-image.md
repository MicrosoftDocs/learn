...
The Dockerfile ensured that the database backup was included in the image. Now you must restore that backup file to create the database. Follow these steps:
...
1. In the query window, type the following code:
...
1. To execute the query, in the top-left of the query window, click **Run**.
...
1. To stop the container you have just deployed, type the following command, and then press Enter:
